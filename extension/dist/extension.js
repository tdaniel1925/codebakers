...
`),raw:this.chunks};return this.event=null,this.data=[],this.chunks=[],i}if(this.chunks.push(e),e.startsWith(":"))return null;let[t,n,s]=Cm(e,":");return s.startsWith(" ")&&(s=s.substring(1)),t==="event"?this.event=s:t==="data"&&this.data.push(s),null}}});async function Cl(a,e,t){if(a=await a,Tm(a))return a;if(Pm(a)){let s=await a.blob();e||(e=new URL(a.url).pathname.split(/[\\/]/).pop()??"unknown_file");let i=jn(s)?[await s.arrayBuffer()]:[s];return new ss(i,e,t)}let n=await Em(a);if(e||(e=Am(a)??"unknown_file"),!t?.type){let s=n[0]?.type;typeof s=="string"&&(t={...t,type:s})}return new ss(n,e,t)}async function Em(a){let e=[];if(typeof a=="string"||ArrayBuffer.isView(a)||a instanceof ArrayBuffer)e.push(a);else if(jn(a))e.push(await a.arrayBuffer());else if(Im(a))for await(let t of a)e.push(t);else throw new Error(`Unexpected data type: ${typeof a}; constructor: ${a?.constructor?.name}; props: ${Nm(a)}`);return e}function Nm(a){return`[${Object.getOwnPropertyNames(a).map(t=>`"${t}"`).join(", ")}]`}function Am(a){return tr(a.name)||tr(a.filename)||tr(a.path)?.split(/[\\/]/).pop()}var Pm,Tm,jn,tr,Im,ar,nr=v(()=>{In();In();Pm=a=>a!=null&&typeof a=="object"&&typeof a.url=="string"&&typeof a.blob=="function",Tm=a=>a!=null&&typeof a=="object"&&typeof a.name=="string"&&typeof a.lastModified=="number"&&jn(a),jn=a=>a!=null&&typeof a=="object"&&typeof a.size=="number"&&typeof a.type=="string"&&typeof a.text=="function"&&typeof a.slice=="function"&&typeof a.arrayBuffer=="function";tr=a=>{if(typeof a=="string")return a;if(typeof Buffer<"u"&&a instanceof Buffer)return String(a)},Im=a=>a!=null&&typeof a=="object"&&typeof a[Symbol.asyncIterator]=="function",ar=a=>a&&typeof a=="object"&&a.body&&a[Symbol.toStringTag]==="MultipartBody"});async function Il(a){let{response:e}=a;if(a.options.stream)return $a("response",e.status,e.url,e.headers,e.body),a.options.__streamClass?a.options.__streamClass.fromSSEResponse(e,a.controller):tt.fromSSEResponse(e,a.controller);if(e.status===204)return null;if(a.options.__binaryResponse)return e;let t=e.headers.get("content-type");if(t?.includes("application/json")||t?.includes("application/vnd.api+json")){let i=await e.json();return $a("response",e.status,e.url,e.headers,i),i}let s=await e.text();return $a("response",e.status,e.url,e.headers,s),s}function Lm(){if(typeof navigator>"u"||!navigator)return null;let a=[{key:"edge",pattern:/Edge(?:\W+(\d+)\.(\d+)(?:\.(\d+))?)?/},{key:"ie",pattern:/MSIE(?:\W+(\d+)\.(\d+)(?:\.(\d+))?)?/},{key:"ie",pattern:/Trident(?:.*rv\:(\d+)\.(\d+)(?:\.(\d+))?)?/},{key:"chrome",pattern:/Chrome(?:\W+(\d+)\.(\d+)(?:\.(\d+))?)?/},{key:"firefox",pattern:/Firefox(?:\W+(\d+)\.(\d+)(?:\.(\d+))?)?/},{key:"safari",pattern:/(?:Version\W+(\d+)\.(\d+)(?:\.(\d+))?)?(?:\W+Mobile\S*)?\W+Safari/}];for(let{key:e,pattern:t}of a){let n=t.exec(navigator.userAgent);if(n){let s=n[1]||0,i=n[2]||0,o=n[3]||0;return{browser:e,version:`${s}.${i}.${o}`}}}return null}function qn(a){if(!a)return!0;for(let e in a)return!1;return!0}function Dl(a,e){return Object.prototype.hasOwnProperty.call(a,e)}function Nl(a,e){for(let t in e){if(!Dl(e,t))continue;let n=t.toLowerCase();if(!n)continue;let s=e[t];s===null?delete a[n]:s!==void 0&&(a[n]=s)}}function $a(a,...e){typeof process<"u"&&process?.env?.DEBUG==="true"&&console.log(`Anthropic:DEBUG:${a}`,...e)}var Bm,Rm,ii,oi,ri,di,ir,er,Mm,zn,Fm,Pl,Tl,El,$m,Om,Vm,jm,zm,sr,ni,pi,qm,Bl,Um,Al,La=v(()=>{Zr();Vn();et();In();nr();Bm=function(a,e,t,n,s){if(n==="m")throw new TypeError("Private method is not writable");if(n==="a"&&!s)throw new TypeError("Private accessor was defined without a setter");if(typeof e=="function"?a!==e||!s:!e.has(a))throw new TypeError("Cannot write private member to an object whose class did not declare it");return n==="a"?s.call(a,t):s?s.value=t:e.set(a,t),t},Rm=function(a,e,t,n){if(t==="a"&&!n)throw new TypeError("Private accessor was defined without a getter");if(typeof e=="function"?a!==e||!n:!e.has(a))throw new TypeError("Cannot read private member from an object whose class did not declare it");return t==="m"?n:t==="a"?n.call(a):n?n.value:e.get(a)};oi=class a extends Promise{constructor(e,t=Il){super(n=>{n(null)}),this.responsePromise=e,this.parseResponse=t}_thenUnwrap(e){return new a(this.responsePromise,async t=>e(await this.parseResponse(t),t))}asResponse(){return this.responsePromise.then(e=>e.response)}async withResponse(){let[e,t]=await Promise.all([this.parse(),this.asResponse()]);return{data:e,response:t}}parse(){return this.parsedPromise||(this.parsedPromise=this.responsePromise.then(this.parseResponse)),this.parsedPromise}then(e,t){return this.parse().then(e,t)}catch(e){return this.parse().catch(e)}finally(e){return this.parse().finally(e)}},ri=class{constructor({baseURL:e,maxRetries:t=2,timeout:n=6e5,httpAgent:s,fetch:i}){this.baseURL=e,this.maxRetries=sr("maxRetries",t),this.timeout=sr("timeout",n),this.httpAgent=s,this.fetch=i??Li}authHeaders(e){return{}}defaultHeaders(e){return{Accept:"application/json","Content-Type":"application/json","User-Agent":this.getUserAgent(),...$m(),...this.authHeaders(e)}}validateHeaders(e,t){}defaultIdempotencyKey(){return`stainless-node-retry-${qm()}`}get(e,t){return this.methodRequest("get",e,t)}post(e,t){return this.methodRequest("post",e,t)}patch(e,t){return this.methodRequest("patch",e,t)}put(e,t){return this.methodRequest("put",e,t)}delete(e,t){return this.methodRequest("delete",e,t)}methodRequest(e,t,n){return this.request(Promise.resolve(n).then(async s=>{let i=s&&jn(s?.body)?new DataView(await s.body.arrayBuffer()):s?.body instanceof DataView?s.body:s?.body instanceof ArrayBuffer?new DataView(s.body):s&&ArrayBuffer.isView(s?.body)?new DataView(s.body.buffer):s?.body;return{method:e,path:t,...s,body:i}}))}getAPIList(e,t,n){return this.requestAPIList(t,{method:"get",path:e,...n})}calculateContentLength(e){if(typeof e=="string"){if(typeof Buffer<"u")return Buffer.byteLength(e,"utf8").toString();if(typeof TextEncoder<"u")return new TextEncoder().encode(e).length.toString()}else if(ArrayBuffer.isView(e))return e.byteLength.toString();return null}buildRequest(e,{retryCount:t=0}={}){let{method:n,path:s,query:i,headers:o={}}=e,r=ArrayBuffer.isView(e.body)||e.__binaryRequest&&typeof e.body=="string"?e.body:ar(e.body)?e.body.body:e.body?JSON.stringify(e.body,null,2):null,d=this.calculateContentLength(r),p=this.buildURL(s,i);"timeout"in e&&sr("timeout",e.timeout);let l=e.timeout??this.timeout,c=e.httpAgent??this.httpAgent??Oi(p),m=l+1e3;typeof c?.options?.timeout=="number"&&m>(c.options.timeout??0)&&(c.options.timeout=m),this.idempotencyHeader&&n!=="get"&&(e.idempotencyKey||(e.idempotencyKey=this.defaultIdempotencyKey()),o[this.idempotencyHeader]=e.idempotencyKey);let u=this.buildHeaders({options:e,headers:o,contentLength:d,retryCount:t});return{req:{method:n,...r&&{body:r},headers:u,...c&&{agent:c},signal:e.signal??null},url:p,timeout:l}}buildHeaders({options:e,headers:t,contentLength:n,retryCount:s}){let i={};n&&(i["content-length"]=n);let o=this.defaultHeaders(e);return Nl(i,o),Nl(i,t),ar(e.body)&&Yt!=="node"&&delete i["content-type"],Al(o,"x-stainless-retry-count")===void 0&&Al(t,"x-stainless-retry-count")===void 0&&(i["x-stainless-retry-count"]=String(s)),this.validateHeaders(i,t),i}async prepareOptions(e){}async prepareRequest(e,{url:t,options:n}){}parseHeaders(e){return e?Symbol.iterator in e?Object.fromEntries(Array.from(e).map(t=>[...t])):{...e}:{}}makeStatusError(e,t,n,s){return me.generate(e,t,n,s)}request(e,t=null){return new oi(this.makeRequest(e,t))}async makeRequest(e,t){let n=await e,s=n.maxRetries??this.maxRetries;t==null&&(t=s),await this.prepareOptions(n);let{req:i,url:o,timeout:r}=this.buildRequest(n,{retryCount:s-t});if(await this.prepareRequest(i,{url:o,options:n}),$a("request",o,n,i.headers),n.signal?.aborted)throw new ge;let d=new AbortController,p=await this.fetchWithTimeout(o,i,r,d).catch(ni);if(p instanceof Error){if(n.signal?.aborted)throw new ge;if(t)return this.retryRequest(n,t);throw p.name==="AbortError"?new Fa:new $t({cause:p})}let l=er(p.headers);if(!p.ok){if(t&&this.shouldRetry(p)){let f=`retrying, ${t} attempts remaining`;return $a(`response (error; ${f})`,p.status,o,l),this.retryRequest(n,t,l)}let c=await p.text().catch(f=>ni(f).message),m=Om(c),u=m?void 0:c;throw $a(`response (error; ${t?"(error; no more retries left)":"(error; not retryable)"})`,p.status,o,l,u),this.makeStatusError(p.status,m,u,l)}return{response:p,options:n,controller:d}}requestAPIList(e,t){let n=this.makeRequest(t,null);return new ir(this,n,e)}buildURL(e,t){let n=jm(e)?new URL(e):new URL(this.baseURL+(this.baseURL.endsWith("/")&&e.startsWith("/")?e.slice(1):e)),s=this.defaultQuery();return qn(s)||(t={...s,...t}),typeof t=="object"&&t&&!Array.isArray(t)&&(n.search=this.stringifyQuery(t)),n.toString()}stringifyQuery(e){return Object.entries(e).filter(([t,n])=>typeof n<"u").map(([t,n])=>{if(typeof n=="string"||typeof n=="number"||typeof n=="boolean")return`${encodeURIComponent(t)}=${encodeURIComponent(n)}`;if(n===null)return`${encodeURIComponent(t)}=`;throw new T(`Cannot stringify type ${typeof n}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`)}).join("&")}async fetchWithTimeout(e,t,n,s){let{signal:i,...o}=t||{};i&&i.addEventListener("abort",()=>s.abort());let r=setTimeout(()=>s.abort(),n);return this.getRequestClient().fetch.call(void 0,e,{signal:s.signal,...o}).finally(()=>{clearTimeout(r)})}getRequestClient(){return{fetch:this.fetch}}shouldRetry(e){let t=e.headers.get("x-should-retry");return t==="true"?!0:t==="false"?!1:e.status===408||e.status===409||e.status===429||e.status>=500}async retryRequest(e,t,n){let s,i=n?.["retry-after-ms"];if(i){let r=parseFloat(i);Number.isNaN(r)||(s=r)}let o=n?.["retry-after"];if(o&&!s){let r=parseFloat(o);Number.isNaN(r)?s=Date.parse(o)-Date.now():s=r*1e3}if(!(s&&0<=s&&s<60*1e3)){let r=e.maxRetries??this.maxRetries;s=this.calculateDefaultRetryTimeoutMillis(t,r)}return await zm(s),this.makeRequest(e,t-1)}calculateDefaultRetryTimeoutMillis(e,t){let i=t-e,o=Math.min(.5*Math.pow(2,i),8),r=1-Math.random()*.25;return o*r*1e3}getUserAgent(){return`${this.constructor.name}/JS ${Gt}`}},di=class{constructor(e,t,n,s){ii.set(this,void 0),Bm(this,ii,e,"f"),this.options=s,this.response=t,this.body=n}hasNextPage(){return this.getPaginatedItems().length?this.nextPageInfo()!=null:!1}async getNextPage(){let e=this.nextPageInfo();if(!e)throw new T("No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.");let t={...this.options};if("params"in e&&typeof t.query=="object")t.query={...t.query,...e.params};else if("url"in e){let n=[...Object.entries(t.query||{}),...e.url.searchParams.entries()];for(let[s,i]of n)e.url.searchParams.set(s,i);t.query=void 0,t.path=e.url.toString()}return await Rm(this,ii,"f").requestAPIList(this.constructor,t)}async*iterPages(){let e=this;for(yield e;e.hasNextPage();)e=await e.getNextPage(),yield e}async*[(ii=new WeakMap,Symbol.asyncIterator)](){for await(let e of this.iterPages())for(let t of e.getPaginatedItems())yield t}},ir=class extends oi{constructor(e,t,n){super(t,async s=>new n(e,s.response,await Il(s),s.options))}async*[Symbol.asyncIterator](){let e=await this;for await(let t of e)yield t}},er=a=>new Proxy(Object.fromEntries(a.entries()),{get(e,t){let n=t.toString();return e[n.toLowerCase()]||e[n]}}),Mm={method:!0,path:!0,query:!0,body:!0,headers:!0,maxRetries:!0,stream:!0,timeout:!0,httpAgent:!0,signal:!0,idempotencyKey:!0,__binaryRequest:!0,__binaryResponse:!0,__streamClass:!0},zn=a=>typeof a=="object"&&a!==null&&!qn(a)&&Object.keys(a).every(e=>Dl(Mm,e)),Fm=()=>{if(typeof Deno<"u"&&Deno.build!=null)return{"X-Stainless-Lang":"js","X-Stainless-Package-Version":Gt,"X-Stainless-OS":Tl(Deno.build.os),"X-Stainless-Arch":Pl(Deno.build.arch),"X-Stainless-Runtime":"deno","X-Stainless-Runtime-Version":typeof Deno.version=="string"?Deno.version:Deno.version?.deno??"unknown"};if(typeof EdgeRuntime<"u")return{"X-Stainless-Lang":"js","X-Stainless-Package-Version":Gt,"X-Stainless-OS":"Unknown","X-Stainless-Arch":`other:${EdgeRuntime}`,"X-Stainless-Runtime":"edge","X-Stainless-Runtime-Version":process.version};if(Object.prototype.toString.call(typeof process<"u"?process:0)==="[object process]")return{"X-Stainless-Lang":"js","X-Stainless-Package-Version":Gt,"X-Stainless-OS":Tl(process.platform),"X-Stainless-Arch":Pl(process.arch),"X-Stainless-Runtime":"node","X-Stainless-Runtime-Version":process.version};let a=Lm();return a?{"X-Stainless-Lang":"js","X-Stainless-Package-Version":Gt,"X-Stainless-OS":"Unknown","X-Stainless-Arch":"unknown","X-Stainless-Runtime":`browser:${a.browser}`,"X-Stainless-Runtime-Version":a.version}:{"X-Stainless-Lang":"js","X-Stainless-Package-Version":Gt,"X-Stainless-OS":"Unknown","X-Stainless-Arch":"unknown","X-Stainless-Runtime":"unknown","X-Stainless-Runtime-Version":"unknown"}};Pl=a=>a==="x32"?"x32":a==="x86_64"||a==="x64"?"x64":a==="arm"?"arm":a==="aarch64"||a==="arm64"?"arm64":a?`other:${a}`:"unknown",Tl=a=>(a=a.toLowerCase(),a.includes("ios")?"iOS":a==="android"?"Android":a==="darwin"?"MacOS":a==="win32"?"Windows":a==="freebsd"?"FreeBSD":a==="openbsd"?"OpenBSD":a==="linux"?"Linux":a?`Other:${a}`:"Unknown"),$m=()=>El??(El=Fm()),Om=a=>{try{return JSON.parse(a)}catch{return}},Vm=new RegExp("^(?:[a-z]+:)?//","i"),jm=a=>Vm.test(a),zm=a=>new Promise(e=>setTimeout(e,a)),sr=(a,e)=>{if(typeof e!="number"||!Number.isInteger(e))throw new T(`${a} must be an integer`);if(e<0)throw new T(`${a} must be a positive integer`);return e},ni=a=>{if(a instanceof Error)return a;if(typeof a=="object"&&a!==null)try{return new Error(JSON.stringify(a))}catch{}return new Error(String(a))},pi=a=>{if(typeof process<"u")return process.env?.[a]?.trim()??void 0;if(typeof Deno<"u")return Deno.env?.get?.(a)?.trim()};qm=()=>"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,a=>{let e=Math.random()*16|0;return(a==="x"?e:e&3|8).toString(16)}),Bl=()=>typeof window<"u"&&typeof window.document<"u"&&typeof navigator<"u",Um=a=>typeof a?.get=="function",Al=(a,e)=>{let t=e.toLowerCase();if(Um(a)){let n=e[0]?.toUpperCase()+e.substring(1).replace(/([^\w])(\w)/g,(s,i,o)=>i+o.toUpperCase());for(let s of[e,t,e.toUpperCase(),n]){let i=a.get(s);if(i)return i}}for(let[n,s]of Object.entries(a))if(n.toLowerCase()===t)return Array.isArray(s)?(s.length<=1||console.warn(`Received ${s.length} entries for the ${e} header, using the first entry.`),s[0]):s}});var li,Rl=v(()=>{La();li=class extends di{constructor(e,t,n,s){super(e,t,n,s),this.data=n.data||[],this.has_more=n.has_more||!1,this.first_id=n.first_id||null,this.last_id=n.last_id||null}getPaginatedItems(){return this.data??[]}nextPageParams(){let e=this.nextPageInfo();if(!e)return null;if("params"in e)return e.params;let t=Object.fromEntries(e.url.searchParams);return Object.keys(t).length?t:null}nextPageInfo(){if(this.options.query?.before_id){let t=this.first_id;return t?{params:{before_id:t}}:null}let e=this.last_id;return e?{params:{after_id:e}}:null}}});var ye,Ot=v(()=>{ye=class{constructor(e){this._client=e}}});var ci,Ml=v(()=>{et();Vn();Zo();ci=class a{constructor(e,t){this.iterator=e,this.controller=t}async*decoder(){let e=new yt;for await(let t of this.iterator)for(let n of e.decode(t))yield JSON.parse(n);for(let t of e.flush())yield JSON.parse(t)}[Symbol.asyncIterator](){return this.decoder()}static fromResponse(e,t){if(!e.body)throw t.abort(),new T("Attempted to iterate over a response with no body");return new a(si(e.body),t)}}});var la,Oa,or=v(()=>{Ot();La();Rl();Ml();et();la=class extends ye{create(e,t){let{betas:n,...s}=e;return this._client.post("/v1/messages/batches?beta=true",{body:s,...t,headers:{"anthropic-beta":[...n??[],"message-batches-2024-09-24"].toString(),...t?.headers}})}retrieve(e,t={},n){if(zn(t))return this.retrieve(e,{},t);let{betas:s}=t;return this._client.get(`/v1/messages/batches/${e}?beta=true`,{...n,headers:{"anthropic-beta":[...s??[],"message-batches-2024-09-24"].toString(),...n?.headers}})}list(e={},t){if(zn(e))return this.list({},e);let{betas:n,...s}=e;return this._client.getAPIList("/v1/messages/batches?beta=true",Oa,{query:s,...t,headers:{"anthropic-beta":[...n??[],"message-batches-2024-09-24"].toString(),...t?.headers}})}cancel(e,t={},n){if(zn(t))return this.cancel(e,{},t);let{betas:s}=t;return this._client.post(`/v1/messages/batches/${e}/cancel?beta=true`,{...n,headers:{"anthropic-beta":[...s??[],"message-batches-2024-09-24"].toString(),...n?.headers}})}async results(e,t={},n){if(zn(t))return this.results(e,{},t);let s=await this.retrieve(e);if(!s.results_url)throw new T(`No batch \`results_url\`; Has it finished processing? ${s.processing_status} - ${s.id}`);let{betas:i}=t;return this._client.get(s.results_url,{...n,headers:{"anthropic-beta":[...i??[],"message-batches-2024-09-24"].toString(),...n?.headers},__binaryResponse:!0})._thenUnwrap((o,r)=>ci.fromResponse(r.response,r.controller))}},Oa=class extends li{};la.BetaMessageBatchesPage=Oa});var Vt,rr=v(()=>{Ot();or();or();Vt=class extends ye{constructor(){super(...arguments),this.batches=new la(this._client)}create(e,t){let{betas:n,...s}=e;return this._client.post("/v1/messages?beta=true",{body:s,timeout:this._client._options.timeout??6e5,...t,headers:{...n?.toString()!=null?{"anthropic-beta":n?.toString()}:void 0,...t?.headers},stream:e.stream??!1})}countTokens(e,t){let{betas:n,...s}=e;return this._client.post("/v1/messages/count_tokens?beta=true",{body:s,...t,headers:{"anthropic-beta":[...n??[],"token-counting-2024-11-01"].toString(),...t?.headers}})}};Vt.Batches=la;Vt.BetaMessageBatchesPage=Oa});var Ym,Va,Xm,Km,mi,dr=v(()=>{Ym=a=>{let e=0,t=[];for(;e<a.length;){let n=a[e];if(n==="\\"){e++;continue}if(n==="{"){t.push({type:"brace",value:"{"}),e++;continue}if(n==="}"){t.push({type:"brace",value:"}"}),e++;continue}if(n==="["){t.push({type:"paren",value:"["}),e++;continue}if(n==="]"){t.push({type:"paren",value:"]"}),e++;continue}if(n===":"){t.push({type:"separator",value:":"}),e++;continue}if(n===","){t.push({type:"delimiter",value:","}),e++;continue}if(n==='"'){let r="",d=!1;for(n=a[++e];n!=='"';){if(e===a.length){d=!0;break}if(n==="\\"){if(e++,e===a.length){d=!0;break}r+=n+a[e],n=a[++e]}else r+=n,n=a[++e]}n=a[++e],d||t.push({type:"string",value:r});continue}if(n&&/\s/.test(n)){e++;continue}let i=/[0-9]/;if(n&&i.test(n)||n==="-"||n==="."){let r="";for(n==="-"&&(r+=n,n=a[++e]);n&&i.test(n)||n===".";)r+=n,n=a[++e];t.push({type:"number",value:r});continue}let o=/[a-z]/i;if(n&&o.test(n)){let r="";for(;n&&o.test(n)&&e!==a.length;)r+=n,n=a[++e];if(r=="true"||r=="false"||r==="null")t.push({type:"name",value:r});else{e++;continue}continue}e++}return t},Va=a=>{if(a.length===0)return a;let e=a[a.length-1];switch(e.type){case"separator":return a=a.slice(0,a.length-1),Va(a);break;case"number":let t=e.value[e.value.length-1];if(t==="."||t==="-")return a=a.slice(0,a.length-1),Va(a);case"string":let n=a[a.length-2];if(n?.type==="delimiter")return a=a.slice(0,a.length-1),Va(a);if(n?.type==="brace"&&n.value==="{")return a=a.slice(0,a.length-1),Va(a);break;case"delimiter":return a=a.slice(0,a.length-1),Va(a);break}return a},Xm=a=>{let e=[];return a.map(t=>{t.type==="brace"&&(t.value==="{"?e.push("}"):e.splice(e.lastIndexOf("}"),1)),t.type==="paren"&&(t.value==="["?e.push("]"):e.splice(e.lastIndexOf("]"),1))}),e.length>0&&e.reverse().map(t=>{t==="}"?a.push({type:"brace",value:"}"}):t==="]"&&a.push({type:"paren",value:"]"})}),a},Km=a=>{let e="";return a.map(t=>{t.type==="string"?e+='"'+t.value+'"':e+=t.value}),e},mi=a=>JSON.parse(Km(Xm(Va(Ym(a)))))});var Pe,B,Re,jt,ui,hi,Un,Wn,gi,Hn,wt,Gn,fi,vi,ja,pr,Fl,lr,cr,mr,ur,Ll,$l,yi,Ol=v(()=>{et();Vn();dr();Pe=function(a,e,t,n,s){if(n==="m")throw new TypeError("Private method is not writable");if(n==="a"&&!s)throw new TypeError("Private accessor was defined without a setter");if(typeof e=="function"?a!==e||!s:!e.has(a))throw new TypeError("Cannot write private member to an object whose class did not declare it");return n==="a"?s.call(a,t):s?s.value=t:e.set(a,t),t},B=function(a,e,t,n){if(t==="a"&&!n)throw new TypeError("Private accessor was defined without a getter");if(typeof e=="function"?a!==e||!n:!e.has(a))throw new TypeError("Cannot read private member from an object whose class did not declare it");return t==="m"?n:t==="a"?n.call(a):n?n.value:e.get(a)},$l="__json_buf",yi=class a{constructor(){Re.add(this),this.messages=[],this.receivedMessages=[],jt.set(this,void 0),this.controller=new AbortController,ui.set(this,void 0),hi.set(this,()=>{}),Un.set(this,()=>{}),Wn.set(this,void 0),gi.set(this,()=>{}),Hn.set(this,()=>{}),wt.set(this,{}),Gn.set(this,!1),fi.set(this,!1),vi.set(this,!1),ja.set(this,!1),lr.set(this,e=>{if(Pe(this,fi,!0,"f"),e instanceof Error&&e.name==="AbortError"&&(e=new ge),e instanceof ge)return Pe(this,vi,!0,"f"),this._emit("abort",e);if(e instanceof T)return this._emit("error",e);if(e instanceof Error){let t=new T(e.message);return t.cause=e,this._emit("error",t)}return this._emit("error",new T(String(e)))}),Pe(this,ui,new Promise((e,t)=>{Pe(this,hi,e,"f"),Pe(this,Un,t,"f")}),"f"),Pe(this,Wn,new Promise((e,t)=>{Pe(this,gi,e,"f"),Pe(this,Hn,t,"f")}),"f"),B(this,ui,"f").catch(()=>{}),B(this,Wn,"f").catch(()=>{})}static fromReadableStream(e){let t=new a;return t._run(()=>t._fromReadableStream(e)),t}static createMessage(e,t,n){let s=new a;for(let i of t.messages)s._addPromptCachingBetaMessageParam(i);return s._run(()=>s._createPromptCachingBetaMessage(e,{...t,stream:!0},{...n,headers:{...n?.headers,"X-Stainless-Helper-Method":"stream"}})),s}_run(e){e().then(()=>{this._emitFinal(),this._emit("end")},B(this,lr,"f"))}_addPromptCachingBetaMessageParam(e){this.messages.push(e)}_addPromptCachingBetaMessage(e,t=!0){this.receivedMessages.push(e),t&&this._emit("message",e)}async _createPromptCachingBetaMessage(e,t,n){let s=n?.signal;s&&(s.aborted&&this.controller.abort(),s.addEventListener("abort",()=>this.controller.abort())),B(this,Re,"m",cr).call(this);let i=await e.create({...t,stream:!0},{...n,signal:this.controller.signal});this._connected();for await(let o of i)B(this,Re,"m",mr).call(this,o);if(i.controller.signal?.aborted)throw new ge;B(this,Re,"m",ur).call(this)}_connected(){this.ended||(B(this,hi,"f").call(this),this._emit("connect"))}get ended(){return B(this,Gn,"f")}get errored(){return B(this,fi,"f")}get aborted(){return B(this,vi,"f")}abort(){this.controller.abort()}on(e,t){return(B(this,wt,"f")[e]||(B(this,wt,"f")[e]=[])).push({listener:t}),this}off(e,t){let n=B(this,wt,"f")[e];if(!n)return this;let s=n.findIndex(i=>i.listener===t);return s>=0&&n.splice(s,1),this}once(e,t){return(B(this,wt,"f")[e]||(B(this,wt,"f")[e]=[])).push({listener:t,once:!0}),this}emitted(e){return new Promise((t,n)=>{Pe(this,ja,!0,"f"),e!=="error"&&this.once("error",n),this.once(e,t)})}async done(){Pe(this,ja,!0,"f"),await B(this,Wn,"f")}get currentMessage(){return B(this,jt,"f")}async finalMessage(){return await this.done(),B(this,Re,"m",pr).call(this)}async finalText(){return await this.done(),B(this,Re,"m",Fl).call(this)}_emit(e,...t){if(B(this,Gn,"f"))return;e==="end"&&(Pe(this,Gn,!0,"f"),B(this,gi,"f").call(this));let n=B(this,wt,"f")[e];if(n&&(B(this,wt,"f")[e]=n.filter(s=>!s.once),n.forEach(({listener:s})=>s(...t))),e==="abort"){let s=t[0];!B(this,ja,"f")&&!n?.length&&Promise.reject(s),B(this,Un,"f").call(this,s),B(this,Hn,"f").call(this,s),this._emit("end");return}if(e==="error"){let s=t[0];!B(this,ja,"f")&&!n?.length&&Promise.reject(s),B(this,Un,"f").call(this,s),B(this,Hn,"f").call(this,s),this._emit("end")}}_emitFinal(){this.receivedMessages.at(-1)&&this._emit("finalPromptCachingBetaMessage",B(this,Re,"m",pr).call(this))}async _fromReadableStream(e,t){let n=t?.signal;n&&(n.aborted&&this.controller.abort(),n.addEventListener("abort",()=>this.controller.abort())),B(this,Re,"m",cr).call(this),this._connected();let s=tt.fromReadableStream(e,this.controller);for await(let i of s)B(this,Re,"m",mr).call(this,i);if(s.controller.signal?.aborted)throw new ge;B(this,Re,"m",ur).call(this)}[(jt=new WeakMap,ui=new WeakMap,hi=new WeakMap,Un=new WeakMap,Wn=new WeakMap,gi=new WeakMap,Hn=new WeakMap,wt=new WeakMap,Gn=new WeakMap,fi=new WeakMap,vi=new WeakMap,ja=new WeakMap,lr=new WeakMap,Re=new WeakSet,pr=function(){if(this.receivedMessages.length===0)throw new T("stream ended without producing a PromptCachingBetaMessage with role=assistant");return this.receivedMessages.at(-1)},Fl=function(){if(this.receivedMessages.length===0)throw new T("stream ended without producing a PromptCachingBetaMessage with role=assistant");let t=this.receivedMessages.at(-1).content.filter(n=>n.type==="text").map(n=>n.text);if(t.length===0)throw new T("stream ended without producing a content block with type=text");return t.join(" ")},cr=function(){this.ended||Pe(this,jt,void 0,"f")},mr=function(t){if(this.ended)return;let n=B(this,Re,"m",Ll).call(this,t);switch(this._emit("streamEvent",t,n),t.type){case"content_block_delta":{let s=n.content.at(-1);t.delta.type==="text_delta"&&s.type==="text"?this._emit("text",t.delta.text,s.text||""):t.delta.type==="input_json_delta"&&s.type==="tool_use"&&s.input&&this._emit("inputJson",t.delta.partial_json,s.input);break}case"message_stop":{this._addPromptCachingBetaMessageParam(n),this._addPromptCachingBetaMessage(n,!0);break}case"content_block_stop":{this._emit("contentBlock",n.content.at(-1));break}case"message_start":{Pe(this,jt,n,"f");break}case"content_block_start":case"message_delta":break}},ur=function(){if(this.ended)throw new T("stream has ended, this shouldn't happen");let t=B(this,jt,"f");if(!t)throw new T("request ended without sending any chunks");return Pe(this,jt,void 0,"f"),t},Ll=function(t){let n=B(this,jt,"f");if(t.type==="message_start"){if(n)throw new T(`Unexpected event order, got ${t.type} before receiving "message_stop"`);return t.message}if(!n)throw new T(`Unexpected event order, got ${t.type} before "message_start"`);switch(t.type){case"message_stop":return n;case"message_delta":return n.stop_reason=t.delta.stop_reason,n.stop_sequence=t.delta.stop_sequence,n.usage.output_tokens=t.usage.output_tokens,n;case"content_block_start":return n.content.push(t.content_block),n;case"content_block_delta":{let s=n.content.at(t.index);if(s?.type==="text"&&t.delta.type==="text_delta")s.text+=t.delta.text;else if(s?.type==="tool_use"&&t.delta.type==="input_json_delta"){let i=s[$l]||"";i+=t.delta.partial_json,Object.defineProperty(s,$l,{value:i,enumerable:!1,writable:!0}),i&&(s.input=mi(i))}return n}case"content_block_stop":return n}},Symbol.asyncIterator)](){let e=[],t=[],n=!1;return this.on("streamEvent",s=>{let i=t.shift();i?i.resolve(s):e.push(s)}),this.on("end",()=>{n=!0;for(let s of t)s.resolve(void 0);t.length=0}),this.on("abort",s=>{n=!0;for(let i of t)i.reject(s);t.length=0}),this.on("error",s=>{n=!0;for(let i of t)i.reject(s);t.length=0}),{next:async()=>e.length?{value:e.shift(),done:!1}:n?{value:void 0,done:!0}:new Promise((i,o)=>t.push({resolve:i,reject:o})).then(i=>i?{value:i,done:!1}:{value:void 0,done:!0}),return:async()=>(this.abort(),{value:void 0,done:!0})}}toReadableStream(){return new tt(this[Symbol.asyncIterator].bind(this),this.controller).toReadableStream()}}});var za,hr=v(()=>{Ot();Ol();za=class extends ye{create(e,t){let{betas:n,...s}=e;return this._client.post("/v1/messages?beta=prompt_caching",{body:s,timeout:this._client._options.timeout??6e5,...t,headers:{"anthropic-beta":[...n??[],"prompt-caching-2024-07-31"].toString(),...t?.headers},stream:e.stream??!1})}stream(e,t){return yi.createMessage(this,e,t)}}});var ca,gr=v(()=>{Ot();hr();hr();ca=class extends ye{constructor(){super(...arguments),this.messages=new za(this._client)}};ca.Messages=za});var bt,fr=v(()=>{Ot();rr();rr();gr();gr();bt=class extends ye{constructor(){super(...arguments),this.messages=new Vt(this._client),this.promptCaching=new ca(this._client)}};bt.Messages=Vt;bt.PromptCaching=ca});var ma,vr=v(()=>{Ot();ma=class extends ye{create(e,t){return this._client.post("/v1/complete",{body:e,timeout:this._client._options.timeout??6e5,...t,stream:e.stream??!1})}}});var Te,R,Me,zt,wi,bi,Yn,Xn,xi,Kn,xt,Jn,_i,Si,qa,yr,Vl,wr,br,xr,_r,jl,zl,ki,ql=v(()=>{et();Vn();dr();Te=function(a,e,t,n,s){if(n==="m")throw new TypeError("Private method is not writable");if(n==="a"&&!s)throw new TypeError("Private accessor was defined without a setter");if(typeof e=="function"?a!==e||!s:!e.has(a))throw new TypeError("Cannot write private member to an object whose class did not declare it");return n==="a"?s.call(a,t):s?s.value=t:e.set(a,t),t},R=function(a,e,t,n){if(t==="a"&&!n)throw new TypeError("Private accessor was defined without a getter");if(typeof e=="function"?a!==e||!n:!e.has(a))throw new TypeError("Cannot read private member from an object whose class did not declare it");return t==="m"?n:t==="a"?n.call(a):n?n.value:e.get(a)},zl="__json_buf",ki=class a{constructor(){Me.add(this),this.messages=[],this.receivedMessages=[],zt.set(this,void 0),this.controller=new AbortController,wi.set(this,void 0),bi.set(this,()=>{}),Yn.set(this,()=>{}),Xn.set(this,void 0),xi.set(this,()=>{}),Kn.set(this,()=>{}),xt.set(this,{}),Jn.set(this,!1),_i.set(this,!1),Si.set(this,!1),qa.set(this,!1),wr.set(this,e=>{if(Te(this,_i,!0,"f"),e instanceof Error&&e.name==="AbortError"&&(e=new ge),e instanceof ge)return Te(this,Si,!0,"f"),this._emit("abort",e);if(e instanceof T)return this._emit("error",e);if(e instanceof Error){let t=new T(e.message);return t.cause=e,this._emit("error",t)}return this._emit("error",new T(String(e)))}),Te(this,wi,new Promise((e,t)=>{Te(this,bi,e,"f"),Te(this,Yn,t,"f")}),"f"),Te(this,Xn,new Promise((e,t)=>{Te(this,xi,e,"f"),Te(this,Kn,t,"f")}),"f"),R(this,wi,"f").catch(()=>{}),R(this,Xn,"f").catch(()=>{})}static fromReadableStream(e){let t=new a;return t._run(()=>t._fromReadableStream(e)),t}static createMessage(e,t,n){let s=new a;for(let i of t.messages)s._addMessageParam(i);return s._run(()=>s._createMessage(e,{...t,stream:!0},{...n,headers:{...n?.headers,"X-Stainless-Helper-Method":"stream"}})),s}_run(e){e().then(()=>{this._emitFinal(),this._emit("end")},R(this,wr,"f"))}_addMessageParam(e){this.messages.push(e)}_addMessage(e,t=!0){this.receivedMessages.push(e),t&&this._emit("message",e)}async _createMessage(e,t,n){let s=n?.signal;s&&(s.aborted&&this.controller.abort(),s.addEventListener("abort",()=>this.controller.abort())),R(this,Me,"m",br).call(this);let i=await e.create({...t,stream:!0},{...n,signal:this.controller.signal});this._connected();for await(let o of i)R(this,Me,"m",xr).call(this,o);if(i.controller.signal?.aborted)throw new ge;R(this,Me,"m",_r).call(this)}_connected(){this.ended||(R(this,bi,"f").call(this),this._emit("connect"))}get ended(){return R(this,Jn,"f")}get errored(){return R(this,_i,"f")}get aborted(){return R(this,Si,"f")}abort(){this.controller.abort()}on(e,t){return(R(this,xt,"f")[e]||(R(this,xt,"f")[e]=[])).push({listener:t}),this}off(e,t){let n=R(this,xt,"f")[e];if(!n)return this;let s=n.findIndex(i=>i.listener===t);return s>=0&&n.splice(s,1),this}once(e,t){return(R(this,xt,"f")[e]||(R(this,xt,"f")[e]=[])).push({listener:t,once:!0}),this}emitted(e){return new Promise((t,n)=>{Te(this,qa,!0,"f"),e!=="error"&&this.once("error",n),this.once(e,t)})}async done(){Te(this,qa,!0,"f"),await R(this,Xn,"f")}get currentMessage(){return R(this,zt,"f")}async finalMessage(){return await this.done(),R(this,Me,"m",yr).call(this)}async finalText(){return await this.done(),R(this,Me,"m",Vl).call(this)}_emit(e,...t){if(R(this,Jn,"f"))return;e==="end"&&(Te(this,Jn,!0,"f"),R(this,xi,"f").call(this));let n=R(this,xt,"f")[e];if(n&&(R(this,xt,"f")[e]=n.filter(s=>!s.once),n.forEach(({listener:s})=>s(...t))),e==="abort"){let s=t[0];!R(this,qa,"f")&&!n?.length&&Promise.reject(s),R(this,Yn,"f").call(this,s),R(this,Kn,"f").call(this,s),this._emit("end");return}if(e==="error"){let s=t[0];!R(this,qa,"f")&&!n?.length&&Promise.reject(s),R(this,Yn,"f").call(this,s),R(this,Kn,"f").call(this,s),this._emit("end")}}_emitFinal(){this.receivedMessages.at(-1)&&this._emit("finalMessage",R(this,Me,"m",yr).call(this))}async _fromReadableStream(e,t){let n=t?.signal;n&&(n.aborted&&this.controller.abort(),n.addEventListener("abort",()=>this.controller.abort())),R(this,Me,"m",br).call(this),this._connected();let s=tt.fromReadableStream(e,this.controller);for await(let i of s)R(this,Me,"m",xr).call(this,i);if(s.controller.signal?.aborted)throw new ge;R(this,Me,"m",_r).call(this)}[(zt=new WeakMap,wi=new WeakMap,bi=new WeakMap,Yn=new WeakMap,Xn=new WeakMap,xi=new WeakMap,Kn=new WeakMap,xt=new WeakMap,Jn=new WeakMap,_i=new WeakMap,Si=new WeakMap,qa=new WeakMap,wr=new WeakMap,Me=new WeakSet,yr=function(){if(this.receivedMessages.length===0)throw new T("stream ended without producing a Message with role=assistant");return this.receivedMessages.at(-1)},Vl=function(){if(this.receivedMessages.length===0)throw new T("stream ended without producing a Message with role=assistant");let t=this.receivedMessages.at(-1).content.filter(n=>n.type==="text").map(n=>n.text);if(t.length===0)throw new T("stream ended without producing a content block with type=text");return t.join(" ")},br=function(){this.ended||Te(this,zt,void 0,"f")},xr=function(t){if(this.ended)return;let n=R(this,Me,"m",jl).call(this,t);switch(this._emit("streamEvent",t,n),t.type){case"content_block_delta":{let s=n.content.at(-1);t.delta.type==="text_delta"&&s.type==="text"?this._emit("text",t.delta.text,s.text||""):t.delta.type==="input_json_delta"&&s.type==="tool_use"&&s.input&&this._emit("inputJson",t.delta.partial_json,s.input);break}case"message_stop":{this._addMessageParam(n),this._addMessage(n,!0);break}case"content_block_stop":{this._emit("contentBlock",n.content.at(-1));break}case"message_start":{Te(this,zt,n,"f");break}case"content_block_start":case"message_delta":break}},_r=function(){if(this.ended)throw new T("stream has ended, this shouldn't happen");let t=R(this,zt,"f");if(!t)throw new T("request ended without sending any chunks");return Te(this,zt,void 0,"f"),t},jl=function(t){let n=R(this,zt,"f");if(t.type==="message_start"){if(n)throw new T(`Unexpected event order, got ${t.type} before receiving "message_stop"`);return t.message}if(!n)throw new T(`Unexpected event order, got ${t.type} before "message_start"`);switch(t.type){case"message_stop":return n;case"message_delta":return n.stop_reason=t.delta.stop_reason,n.stop_sequence=t.delta.stop_sequence,n.usage.output_tokens=t.usage.output_tokens,n;case"content_block_start":return n.content.push(t.content_block),n;case"content_block_delta":{let s=n.content.at(t.index);if(s?.type==="text"&&t.delta.type==="text_delta")s.text+=t.delta.text;else if(s?.type==="tool_use"&&t.delta.type==="input_json_delta"){let i=s[zl]||"";i+=t.delta.partial_json,Object.defineProperty(s,zl,{value:i,enumerable:!1,writable:!0}),i&&(s.input=mi(i))}return n}case"content_block_stop":return n}},Symbol.asyncIterator)](){let e=[],t=[],n=!1;return this.on("streamEvent",s=>{let i=t.shift();i?i.resolve(s):e.push(s)}),this.on("end",()=>{n=!0;for(let s of t)s.resolve(void 0);t.length=0}),this.on("abort",s=>{n=!0;for(let i of t)i.reject(s);t.length=0}),this.on("error",s=>{n=!0;for(let i of t)i.reject(s);t.length=0}),{next:async()=>e.length?{value:e.shift(),done:!1}:n?{value:void 0,done:!0}:new Promise((i,o)=>t.push({resolve:i,reject:o})).then(i=>i?{value:i,done:!1}:{value:void 0,done:!0}),return:async()=>(this.abort(),{value:void 0,done:!0})}}toReadableStream(){return new tt(this[Symbol.asyncIterator].bind(this),this.controller).toReadableStream()}}});var ua,Ul,Sr=v(()=>{Ot();ql();ua=class extends ye{create(e,t){return e.model in Ul&&console.warn(`The model '${e.model}' is deprecated and will reach end-of-life on ${Ul[e.model]}
Please migrate to a newer model. Visit https://docs.anthropic.com/en/docs/resources/model-deprecations for more information.`),this._client.post("/v1/messages",{body:e,timeout:this._client._options.timeout??6e5,...t,stream:e.stream??!1})}stream(e,t){return ki.createMessage(this,e,t)}},Ul={"claude-1.3":"November 6th, 2024","claude-1.3-100k":"November 6th, 2024","claude-instant-1.1":"November 6th, 2024","claude-instant-1.1-100k":"November 6th, 2024","claude-instant-1.2":"November 6th, 2024"}});var Wl=v(()=>{fr();vr();Sr()});var Hl,H,D4,B4,Gl,Yl=v(()=>{La();et();nr();Wl();vr();Sr();fr();H=class extends ri{constructor({baseURL:e=pi("ANTHROPIC_BASE_URL"),apiKey:t=pi("ANTHROPIC_API_KEY")??null,authToken:n=pi("ANTHROPIC_AUTH_TOKEN")??null,...s}={}){let i={apiKey:t,authToken:n,...s,baseURL:e||"https://api.anthropic.com"};if(!i.dangerouslyAllowBrowser&&Bl())throw new T(`It looks like you're running in a browser-like environment.
...
# LOADED PATTERNS
${p}${m}`,h=null;for(let f=1;f<=i;f++)try{if(n?.abortSignal?.aborted)throw new Error("Request was cancelled");let g="",C=this.anthropic.messages.stream({model:"claude-sonnet-4-20250514",max_tokens:16e3,system:u,messages:c.map(J=>({role:J.role,content:J.content}))});n?.abortSignal&&n.abortSignal.addEventListener("abort",()=>{C.abort()}),C.on("text",J=>{if(n?.abortSignal?.aborted){C.abort();return}g+=J;let{thinking:Wt,content:es}=this._parseThinkingAndContent(g);Wt&&n?.onThinking?.(Wt),n?.onContent?.(es)});let j=await C.finalMessage(),_;if(j.usage){let J=j.usage.input_tokens,Wt=j.usage.output_tokens,es=this._calculateCost(J,Wt);_={inputTokens:J,outputTokens:Wt,totalTokens:J+Wt,estimatedCost:es},this.sessionStats.totalInputTokens+=J,this.sessionStats.totalOutputTokens+=Wt,this.sessionStats.totalCost+=es,this.sessionStats.requestCount+=1}if(n?.abortSignal?.aborted)throw new Error("Request was cancelled");n?.onDone?.();let{thinking:L,content:G}=this._parseThinkingAndContent(g),ee=this.parseFileOperations(G),w=this.parseCommands(G),b=this.cleanContentForDisplay(G),A=this._checkCompliance(g,L,ee,b),N,K,S;ee.length>0&&(this.validatorInitialized||(await this.validator.initialize(),this.validatorInitialized=!0),K=this.validator.checkDependencies(ee),N=await this.validator.validateFileOperations(ee),o&&(S=await this.validator.runTypeScriptCheck(),N&&(N.tscResult=S)));let z=this._extractProjectUpdates(b),I=ee.length,O=w.length,be=d.map(J=>J.name).join(", ")||"core",de=!A.passed,St=N&&!N.passed,qr=K&&K.missing.length>0,Ur=S&&!S.passed,Di="\u2705";St||Ur?Di="\u274C":(de||qr)&&(Di="\u26A0\uFE0F");let nt=b;qr&&K&&(nt+=`
...
`}async _detectRelevantPatterns(e){let t=e[e.length-1]?.content?.toLowerCase()||"",n=[],s={"00-core":["any","code","build","create"],"01-database":["database","db","schema","table","query","drizzle","postgres"],"02-auth":["auth","login","signup","session","password","oauth"],"03-api":["api","route","endpoint","rest","fetch"],"04-frontend":["component","react","form","ui","page"],"05-payments":["payment","stripe","billing","subscription","checkout"],"08-testing":["test","testing","playwright","vitest"]};this.patterns.has("00-core")&&n.push(this.patterns.get("00-core"));for(let[i,o]of Object.entries(s))if(i!=="00-core"&&o.some(r=>t.includes(r))){let r=this.patterns.get(i);r&&n.push(r)}return n}_extractProjectUpdates(e){let t={},n=e.match(/(?:using|loaded|applied) pattern[s]?: ([^\n]+)/gi);return n&&(t.patterns=n.flatMap(s=>s.split(":")[1]?.split(",").map(i=>i.trim())||[])),Object.keys(t).length>0?t:void 0}_getApiEndpoint(){return Z.workspace.getConfiguration("codebakers").get("apiEndpoint","https://www.codebakers.ai")}}});var Jl={};kt(Jl,{ProjectContext:()=>Cr});var Fe,U,we,Cr,Zl=v(()=>{"use strict";Fe=q(require("vscode")),U=q(require("fs")),we=q(require("path")),Cr=class{constructor(){this._cache=null;this._cacheTime=0;this.CACHE_TTL=3e4}async getProjectState(){if(this._cache&&Date.now()-this._cacheTime<this.CACHE_TTL)return{...this._cache,...this._getDynamicContext()};let e=Fe.workspace.workspaceFolders?.[0];if(!e)return null;let t=e.uri.fsPath,n={},s=we.join(t,".codebakers.json");if(U.existsSync(s))try{let d=U.readFileSync(s,"utf-8"),p=JSON.parse(d);Object.assign(n,p)}catch(d){console.error("Failed to read .codebakers.json:",d)}let i=we.join(t,"package.json");if(U.existsSync(i))try{let d=U.readFileSync(i,"utf-8"),p=JSON.parse(d);n.packageDeps=[...Object.keys(p.dependencies||{}),...Object.keys(p.devDependencies||{})],n.stack||(n.stack=this._detectStack(n.packageDeps))}catch(d){console.error("Failed to read package.json:",d)}n.hasTests=await this._hasTestFiles(t),n.recentFiles=await this._getRecentFiles(t),n.fileTree=await this._getFileTree(t),n.existingTypes=await this._scanExistingTypes(t),n.installedPackages=n.packageDeps?.slice(0,50);let o=we.join(t,".codebakers","DEVLOG.md");if(U.existsSync(o))try{let d=U.readFileSync(o,"utf-8");n.keyDecisions=this._extractFromDevlog(d,"decisions"),n.completedTasks=this._extractFromDevlog(d,"tasks")}catch(d){console.error("Failed to read devlog:",d)}let r=we.join(t,".codebakers","BLOCKED.md");if(U.existsSync(r))try{let d=U.readFileSync(r,"utf-8");n.blockers=this._extractBlockers(d)}catch(d){console.error("Failed to read blockers:",d)}return n.aiMemory=await this._loadAIMemory(t),this._cache=n,this._cacheTime=Date.now(),{...n,...this._getDynamicContext()}}async applyUpdates(e){let t=Fe.workspace.workspaceFolders?.[0];if(!t)return;let n=t.uri.fsPath,s=we.join(n,".codebakers.json"),i={};if(U.existsSync(s))try{i=JSON.parse(U.readFileSync(s,"utf-8"))}catch{i={}}e.decisions&&(i.decisions={...i.decisions,...e.decisions}),e.tasks&&(i.currentWork=i.currentWork||{},i.currentWork.pendingTasks=e.tasks,i.currentWork.lastUpdated=new Date().toISOString()),e.patterns&&(i.analytics=i.analytics||{},i.analytics.modulesUsed=i.analytics.modulesUsed||{},e.patterns.forEach(o=>{i.analytics.modulesUsed[o]=(i.analytics.modulesUsed[o]||0)+1})),U.writeFileSync(s,JSON.stringify(i,null,2)),this._cache=null}invalidateCache(){this._cache=null}_getDynamicContext(){let e=Fe.window.activeTextEditor;if(!e)return{};let t={openFile:Fe.workspace.asRelativePath(e.document.uri)},n=e.selection;return n.isEmpty||(t.selectedText=e.document.getText(n)),t}_detectStack(e){let t={};e.includes("next")?t.framework="nextjs":e.includes("react")?t.framework="react":e.includes("vue")?t.framework="vue":e.includes("svelte")&&(t.framework="svelte"),e.includes("drizzle-orm")?t.database="drizzle":e.includes("prisma")?t.database="prisma":e.includes("mongoose")&&(t.database="mongodb"),e.includes("@supabase/supabase-js")?t.auth="supabase":e.includes("next-auth")?t.auth="next-auth":e.includes("@clerk/nextjs")&&(t.auth="clerk"),e.some(s=>s.includes("@radix-ui"))?t.ui="shadcn":e.includes("@chakra-ui/react")?t.ui="chakra":e.includes("@mui/material")&&(t.ui="mui");let n=[];return e.includes("stripe")&&n.push("stripe"),e.includes("@paypal/react-paypal-js")&&n.push("paypal"),n.length>0&&(t.payments=n),t}async _hasTestFiles(e){let t=["**/*.test.ts","**/*.test.tsx","**/*.spec.ts","**/tests/**"];for(let n of t)if((await Fe.workspace.findFiles(n,"**/node_modules/**",1)).length>0)return!0;return!1}async _getRecentFiles(e){let t=await Fe.workspace.findFiles("**/*.{ts,tsx,js,jsx}","**/node_modules/**",50);return(await Promise.all(t.map(async s=>{try{let i=await Fe.workspace.fs.stat(s);return{path:Fe.workspace.asRelativePath(s),mtime:i.mtime}}catch{return null}}))).filter(s=>s!==null).sort((s,i)=>i.mtime-s.mtime).slice(0,10).map(s=>s.path)}async _getFileTree(e,t=4){let n=new Set(["node_modules",".git",".next","dist","build",".vercel",".turbo","coverage",".cache",".nuxt",".output","__pycache__"]),s=new Set(["src","app","pages","components","lib","utils","hooks","api","services","types","styles","public","tests","__tests__"]),i=[],o=(r,d,p)=>{if(!(p>t))try{let l=U.readdirSync(r,{withFileTypes:!0}),c=l.filter(g=>g.isDirectory()&&!n.has(g.name)&&!g.name.startsWith(".")),m=l.filter(g=>g.isFile());c.sort((g,C)=>{let j=s.has(g.name),_=s.has(C.name);return j&&!_?-1:!j&&_?1:g.name.localeCompare(C.name)});for(let g=0;g<c.length;g++){let C=c[g],j=g===c.length-1&&m.length===0,_=j?"\u2514\u2500\u2500 ":"\u251C\u2500\u2500 ",L=j?"    ":"\u2502   ";i.push(`${d}${_}${C.name}/`),o(we.join(r,C.name),d+L,p+1)}let u=m.filter(g=>p<=1?["package.json","tsconfig.json",".env.example","next.config.js","next.config.mjs","drizzle.config.ts"].includes(g.name)||g.name.endsWith(".ts")||g.name.endsWith(".tsx"):!0),h=p===0?5:p===1?10:15,y=u.slice(0,h),f=u.length-y.length;for(let g=0;g<y.length;g++){let C=y[g],_=g===y.length-1&&f===0?"\u2514\u2500\u2500 ":"\u251C\u2500\u2500 ";i.push(`${d}${_}${C.name}`)}f>0&&i.push(`${d}\u2514\u2500\u2500 ... (${f} more files)`)}catch{}};return i.push(we.basename(e)+"/"),o(e,"",0),i.join(`
`)}async _scanExistingTypes(e){let t=[],n=["src/types","src/lib","types","lib"];for(let o of n){let r=we.join(e,o);if(U.existsSync(r))try{let d=U.readdirSync(r).filter(p=>p.endsWith(".ts")||p.endsWith(".tsx"));for(let p of d.slice(0,10)){let l=we.join(r,p);try{let c=U.readFileSync(l,"utf-8"),m=we.join(o,p),u=/export\s+interface\s+(\w+)/g,h;for(;(h=u.exec(c))!==null;)t.push({name:h[1],file:m,kind:"interface"});let y=/export\s+type\s+(\w+)/g;for(;(h=y.exec(c))!==null;)t.push({name:h[1],file:m,kind:"type"});let f=/export\s+enum\s+(\w+)/g;for(;(h=f.exec(c))!==null;)t.push({name:h[1],file:m,kind:"enum"})}catch{}}}catch{}}if(t.length===0)return"";let s=["EXISTING TYPES (import these instead of creating new):"],i=new Map;for(let o of t){let r=i.get(o.file)||[];r.push(o),i.set(o.file,r)}for(let[o,r]of i){s.push(`  ${o}:`);for(let d of r.slice(0,5))s.push(`    - ${d.kind} ${d.name}`);r.length>5&&s.push(`    ... and ${r.length-5} more`)}return s.slice(0,30).join(`
...
<body>
  ...
  <script>
    const vscode = acquireVsCodeApi();
    const NODE_COLORS = ${JSON.stringify(Dr)};
...
</html>`}}});var Fr={};kt(Fr,{AIPlanner:()=>Ha,BuildPlannerProvider:()=>Ti,CodeGenerator:()=>Ga,NODE_COLORS:()=>Dr,NODE_DEFAULTS:()=>Ir});var Lr=v(()=>{"use strict";sc();Rr();Mr();Br()});var n0={};kt(n0,{activate:()=>t0,deactivate:()=>a0});module.exports=uc(n0);var E=q(require("vscode")),Or,Vr,jr,zr,Ni,Ai,Le,Ee,ha,$e,Qn,Ii=null;async function e0(){try{return console.log("CodeBakers: Loading ChatPanelProvider..."),Or=(await Promise.resolve().then(()=>(Jr(),Kr))).ChatPanelProvider,console.log("CodeBakers: ChatPanelProvider loaded"),console.log("CodeBakers: Loading CodeBakersClient..."),Vr=(await Promise.resolve().then(()=>(Kl(),Xl))).CodeBakersClient,console.log("CodeBakers: CodeBakersClient loaded"),console.log("CodeBakers: Loading ProjectContext..."),jr=(await Promise.resolve().then(()=>(Zl(),Jl))).ProjectContext,console.log("CodeBakers: ProjectContext loaded"),console.log("CodeBakers: Loading FileOperations..."),zr=(await Promise.resolve().then(()=>(Ri(),Hr))).DiffContentProvider,console.log("CodeBakers: FileOperations loaded"),console.log("CodeBakers: Loading MindMapPanelProvider..."),Ni=(await Promise.resolve().then(()=>(Ar(),Nr))).MindMapPanelProvider,console.log("CodeBakers: MindMapPanelProvider loaded"),console.log("CodeBakers: Loading BuildPlannerProvider..."),Ai=(await Promise.resolve().then(()=>(Lr(),Fr))).BuildPlannerProvider,console.log("CodeBakers: BuildPlannerProvider loaded"),console.log("CodeBakers: All modules loaded successfully"),!0}catch(a){let e=a?.message||a?.toString()||"Unknown error",t=a?.stack||"";return console.error("CodeBakers: Failed to load modules:",e),console.error("CodeBakers: Stack:",t),Ii=`Module load failed: ${e}`,!1}}async function Ei(a){if(!await Ut())return;let t=E.window.activeTextEditor;if(!t){E.window.showWarningMessage("No active editor");return}let n=t.selection;if(n.isEmpty){E.window.showWarningMessage("No text selected");return}let s=t.document.getText(n),i=t.document.fileName,o=E.workspace.asRelativePath(i),r=t.document.languageId,d=n.start.line+1,p=n.end.line+1,l="";switch(a){case"ask":l=`I have a question about this code from ${o} (lines ${d}-${p}):
...
\`\`\`${r}
${s}
\`\`\``;break}try{Le.show(),a==="ask"?Le.setInputWithContext(l):await Le.sendMessage(l)}catch(c){console.error("CodeBakers: Error handling selection command:",c),E.window.showErrorMessage(`CodeBakers error: ${c}`)}}async function Ut(){if(Ee&&ha&&Le)return console.log("CodeBakers: Already initialized"),!0;if((!Or||!Vr||!jr)&&(console.log("CodeBakers: Modules not loaded, loading now..."),!await e0()))return E.window.showErrorMessage(`CodeBakers: ${Ii}`),!1;try{return console.log("CodeBakers: Initializing components..."),Ee||(console.log("CodeBakers: Creating CodeBakersClient..."),Ee=new Vr(Qn),console.log("CodeBakers: CodeBakersClient created successfully")),ha||(console.log("CodeBakers: Creating ProjectContext..."),ha=new jr,console.log("CodeBakers: ProjectContext created successfully")),Le||(console.log("CodeBakers: Creating ChatPanelProvider..."),Le=Or.getInstance(Qn,Ee,ha),console.log("CodeBakers: ChatPanelProvider created successfully")),console.log("CodeBakers: All components initialized successfully"),!0}catch(a){let e=a?.message||a?.toString()||"Unknown error";return console.error("CodeBakers: Component initialization failed:",e),console.error("CodeBakers: Stack:",a?.stack||"no stack"),Ii=`Init failed: ${e}`,E.window.showErrorMessage(`CodeBakers: ${Ii}`),!1}}function t0(a){console.log("CodeBakers: activate() called - v1.0.66"),Qn=a;try{console.log("CodeBakers: Registering commands..."),a.subscriptions.push(E.commands.registerCommand("codebakers.openChat",async()=>{if(console.log("CodeBakers: openChat command executed"),!await Ut()){E.window.showErrorMessage("CodeBakers failed to initialize. Please try reloading VS Code.");return}try{Ee.hasSessionToken()||E.window.showWarningMessage("\u{1F36A} Sign in to CodeBakers to start your free trial","Sign In with GitHub").then(t=>{t==="Sign In with GitHub"&&Ee.login()}),Le.show()}catch(t){console.error("CodeBakers: Error in openChat:",t),E.window.showErrorMessage(`CodeBakers error: ${t}`)}})),a.subscriptions.push(E.commands.registerCommand("codebakers.login",async()=>{if(console.log("CodeBakers: login command executed"),!!await Ut())try{await Ee.login()}catch(t){console.error("CodeBakers: Login error:",t),E.window.showErrorMessage(`Login failed: ${t}`)}})),a.subscriptions.push(E.commands.registerCommand("codebakers.logout",async()=>{if(console.log("CodeBakers: logout command executed"),!!await Ut())try{await Ee.logout(),Le.refresh(),$r()}catch(t){console.error("CodeBakers: Logout error:",t)}})),a.subscriptions.push(E.commands.registerCommand("codebakers.showPatterns",async()=>{if(await Ut())try{let t=await Ee.getAvailablePatterns(),n=E.window.createQuickPick();n.items=t.map(s=>({label:s.name,description:s.description})),n.title="Available CodeBakers Patterns",n.show()}catch(t){console.error("CodeBakers: Error showing patterns:",t)}})),a.subscriptions.push(E.commands.registerCommand("codebakers.runAudit",async()=>{if(await Ut())try{Le.show(),await Le.sendMessage("/audit")}catch(t){console.error("CodeBakers: Error running audit:",t)}})),a.subscriptions.push(E.commands.registerCommand("codebakers.askAboutSelection",async()=>{console.log("CodeBakers: askAboutSelection command executed"),await Ei("ask")})),a.subscriptions.push(E.commands.registerCommand("codebakers.explainSelection",async()=>{console.log("CodeBakers: explainSelection command executed"),await Ei("explain")})),a.subscriptions.push(E.commands.registerCommand("codebakers.refactorSelection",async()=>{console.log("CodeBakers: refactorSelection command executed"),await Ei("refactor")})),a.subscriptions.push(E.commands.registerCommand("codebakers.addTestsForSelection",async()=>{console.log("CodeBakers: addTestsForSelection command executed"),await Ei("tests")})),a.subscriptions.push(E.commands.registerCommand("codebakers.openMindMap",async()=>{if(console.log("CodeBakers: openMindMap command executed"),!Ni)try{Ni=(await Promise.resolve().then(()=>(Ar(),Nr))).MindMapPanelProvider}catch(e){console.error("CodeBakers: Failed to load MindMap module:",e),E.window.showErrorMessage("Failed to load Mind Map module");return}try{Ni.createOrShow(Qn.extensionUri).analyze()}catch(e){console.error("CodeBakers: Error opening mind map:",e),E.window.showErrorMessage(`Mind Map error: ${e}`)}})),a.subscriptions.push(E.commands.registerCommand("codebakers.openBuildPlanner",async()=>{if(console.log("CodeBakers: openBuildPlanner command executed"),!Ai)try{Ai=(await Promise.resolve().then(()=>(Lr(),Fr))).BuildPlannerProvider}catch(e){console.error("CodeBakers: Failed to load Build Planner module:",e),E.window.showErrorMessage("Failed to load Build Planner module");return}try{Ai.createOrShow(Qn.extensionUri)}catch(e){console.error("CodeBakers: Error opening build planner:",e),E.window.showErrorMessage(`Build Planner error: ${e}`)}})),console.log("CodeBakers: All 11 commands registered successfully")}catch(e){console.error("CodeBakers: FATAL - Command registration failed:",e),E.window.showErrorMessage(`CodeBakers FATAL: Failed to register commands - ${e}`);return}try{$e=E.window.createStatusBarItem(E.StatusBarAlignment.Right,100),$e.text="$(code) CodeBakers",$e.tooltip="Open CodeBakers Chat (Ctrl+Alt+C)",$e.command="codebakers.openChat",$e.show(),a.subscriptions.push($e),console.log("CodeBakers: Status bar created")}catch(e){console.error("CodeBakers: Status bar failed:",e)}try{if(zr){let e=new zr;a.subscriptions.push(E.workspace.registerTextDocumentContentProvider("codebakers-diff",e)),console.log("CodeBakers: Diff content provider registered")}}catch(e){console.error("CodeBakers: Diff provider registration failed:",e)}try{a.subscriptions.push(E.window.registerUriHandler({handleUri:async e=>{if(console.log("CodeBakers: URI callback received:",e.toString()),!(!e.path.includes("callback")||!await Ut()))try{let n=new URLSearchParams(e.query),s=n.get("token"),i=n.get("error");if(i){E.window.showErrorMessage(`Login failed: ${n.get("message")||i}`);return}s?await Ee.handleOAuthCallback(s)&&(Le.refresh(),$r(),Le.show()):E.window.showErrorMessage("Login failed: No token received")}catch(n){console.error("CodeBakers: URI handler error:",n),E.window.showErrorMessage(`OAuth error: ${n}`)}}})),console.log("CodeBakers: URI handler registered")}catch(e){console.error("CodeBakers: URI handler registration failed:",e)}setTimeout(async()=>{try{if(await Ut()){$r(),Ee.hasSessionToken()||E.window.showInformationMessage("\u{1F36A} CodeBakers installed! Click the CodeBakers button in the status bar to get started.","Sign In Now").then(t=>{t==="Sign In Now"&&Ee.login()});try{let t=E.workspace.createFileSystemWatcher("**/*.{ts,tsx,js,jsx}");t.onDidChange(()=>ha?.invalidateCache()),t.onDidCreate(()=>ha?.invalidateCache()),t.onDidDelete(()=>ha?.invalidateCache()),a.subscriptions.push(t)}catch(t){console.warn("CodeBakers: File watcher failed:",t)}}}catch(e){console.error("CodeBakers: Background init failed:",e)}},500),console.log("CodeBakers: activate() completed - v1.0.66")}function $r(){if($e)try{if(Ee?.hasSessionToken()){let a=Ee.getPlanInfo();$e.text=`$(code) CodeBakers [${a.plan}]`,$e.backgroundColor=void 0}else $e.text="$(code) CodeBakers (Sign In)",$e.backgroundColor=new E.ThemeColor("statusBarItem.warningBackground")}catch{$e.text="$(code) CodeBakers"}}function a0(){console.log("CodeBakers: deactivate() called")}0&&(module.exports={activate,deactivate});
