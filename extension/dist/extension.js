"use strict";var cc=Object.create;var as=Object.defineProperty;var mc=Object.getOwnPropertyDescriptor;var uc=Object.getOwnPropertyNames;var gc=Object.getPrototypeOf,hc=Object.prototype.hasOwnProperty;var v=(a,e)=>()=>(a&&(e=a(a=0)),e);var re=(a,e)=>()=>(e||a((e={exports:{}}).exports,e),e.exports),Et=(a,e)=>{for(var t in e)as(a,t,{get:e[t],enumerable:!0})},Gr=(a,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of uc(e))!hc.call(a,s)&&s!==t&&as(a,s,{get:()=>e[s],enumerable:!(n=mc(e,s))||n.enumerable});return a};var q=(a,e,t)=>(t=a!=null?cc(gc(a)):{},Gr(e||!a||!a.__esModule?as(t,"default",{value:a,enumerable:!0}):t,a)),fc=a=>Gr(as({},"__esModule",{value:!0}),a);var Yr={};Et(Yr,{DiffContentProvider:()=>Do,FileOperations:()=>Ka});var T,it,ns,Ka,Do,Fo=v(()=>{"use strict";T=q(require("vscode")),it=q(require("path")),ns=q(require("fs")),Ka=class{constructor(){this._backups=new Map;this._operationLock=new Set;this.workspaceRoot=T.workspace.workspaceFolders?.[0]?.uri.fsPath}async fileExists(e){if(!this.workspaceRoot)return!1;try{let t=it.join(this.workspaceRoot,e);return await T.workspace.fs.stat(T.Uri.file(t)),!0}catch{return!1}}async acquireLock(e,t=5e3){let n=Date.now();for(;this._operationLock.has(e);){if(Date.now()-n>t)return console.error(`FileOperations: Timeout waiting for lock on ${e}`),!1;await new Promise(s=>setTimeout(s,50))}return this._operationLock.add(e),!0}releaseLock(e){this._operationLock.delete(e)}async createBackup(e){let t=await this.readFile(e),n={path:e,originalContent:t,timestamp:Date.now()};return this._backups.set(e,n),n}async restoreFromBackup(e){let t=this._backups.get(e);if(!t)return T.window.showWarningMessage(`No backup found for ${e}`),!1;try{return t.originalContent===null?await this.deleteFile(e):await this.writeFile(e,t.originalContent),this._backups.delete(e),T.window.showInformationMessage(`\u2705 Restored ${e}`),!0}catch(n){return T.window.showErrorMessage(`Failed to restore ${e}: ${n}`),!1}}getBackups(){return Array.from(this._backups.values())}cleanupOldBackups(){let e=Date.now()-36e5;for(let[t,n]of this._backups)n.timestamp<e&&this._backups.delete(t)}async readFile(e){if(!this.workspaceRoot)return null;try{let t=it.join(this.workspaceRoot,e),n=T.Uri.file(t),s=await T.workspace.fs.readFile(n);return Buffer.from(s).toString("utf-8")}catch(t){return console.error(`Failed to read file ${e}:`,t),null}}async writeFile(e,t){if(!this.workspaceRoot)return T.window.showErrorMessage("No workspace folder open"),!1;try{let n=it.join(this.workspaceRoot,e),s=T.Uri.file(n),o=it.dirname(n);return ns.existsSync(o)||ns.mkdirSync(o,{recursive:!0}),await T.workspace.fs.writeFile(s,Buffer.from(t,"utf-8")),!0}catch(n){return console.error(`Failed to write file ${e}:`,n),T.window.showErrorMessage(`Failed to write ${e}: ${n}`),!1}}async deleteFile(e){if(!this.workspaceRoot)return console.error("FileOperations: No workspace root"),!1;try{let t=it.join(this.workspaceRoot,e),n=T.Uri.file(t);return await this.fileExists(e)?(await T.workspace.fs.delete(n),console.log(`FileOperations: Deleted ${e}`),!0):(console.log(`FileOperations: File ${e} doesn't exist, treating as success`),!0)}catch(t){return t?.code==="FileNotFound"||t?.code==="ENOENT"?(console.log(`FileOperations: File ${e} already deleted`),!0):(console.error(`FileOperations: Failed to delete ${e}:`,t),T.window.showErrorMessage(`Failed to delete ${e}: ${t.message||t}`),!1)}}async showDiff(e,t,n){if(!this.workspaceRoot)return;let s=it.join(this.workspaceRoot,e),o=T.Uri.file(s),i=T.Uri.parse(`codebakers-diff:${e}?content=${encodeURIComponent(t)}`),r=n||`CodeBakers: ${e}`;await T.commands.executeCommand("vscode.diff",o,i,r)}async applyChange(e){if(!await this.acquireLock(e.path))return T.window.showErrorMessage(`Cannot modify ${e.path} - another operation is in progress`),!1;try{switch((e.action==="edit"||e.action==="delete")&&await this.createBackup(e.path),e.action){case"create":return e.content?(await this.fileExists(e.path)&&await this.createBackup(e.path),this.writeFile(e.path,e.content)):(T.window.showErrorMessage(`Cannot create ${e.path} - no content provided`),!1);case"edit":return e.content?(await this.fileExists(e.path)||console.log(`FileOperations: File ${e.path} doesn't exist, creating instead of editing`),this.writeFile(e.path,e.content)):(T.window.showErrorMessage(`Cannot edit ${e.path} - no content provided`),!1);case"delete":return this.deleteFile(e.path);default:return T.window.showErrorMessage(`Unknown action: ${e.action}`),!1}}finally{this.releaseLock(e.path)}}async applyChanges(e){let t=0,n=0;for(let s of e)await this.applyChange(s)?t++:n++;return{success:t,failed:n}}async runCommand(e,t){let n=T.window.createTerminal({name:t||"CodeBakers",cwd:this.workspaceRoot});n.show(),n.sendText(e)}async runCommandWithOutput(e){return new Promise((t,n)=>{let{exec:s}=require("child_process");s(e,{cwd:this.workspaceRoot,timeout:3e4},(o,i,r)=>{o?n(new Error(r||o.message)):t(i)})})}async findFiles(e,t){return(await T.workspace.findFiles(e,t||"**/node_modules/**")).map(s=>T.workspace.asRelativePath(s))}async openFile(e,t){if(!this.workspaceRoot)return;let n=it.join(this.workspaceRoot,e),s=T.Uri.file(n),o=await T.workspace.openTextDocument(s),i=await T.window.showTextDocument(o);if(t){let r=new T.Position(t.line-1,(t.column||1)-1);i.selection=new T.Selection(r,r),i.revealRange(new T.Range(r,r),T.TextEditorRevealType.InCenter)}}getCurrentFile(){let e=T.window.activeTextEditor;if(!e)return null;let t=T.workspace.asRelativePath(e.document.uri),n=e.document.getText(),s=e.selection.isEmpty?void 0:e.document.getText(e.selection);return{path:t,content:n,selection:s}}async getFileTree(e=2){let t=[],n=async(s,o)=>{if(o>e)return;let i=new T.RelativePattern(s,"*"),r=await T.workspace.findFiles(i,"**/node_modules/**",100);for(let d of r){let p=T.workspace.asRelativePath(d);t.push(p)}};return this.workspaceRoot&&await n(this.workspaceRoot,0),t.sort()}},Do=class{provideTextDocumentContent(e){let n=new URLSearchParams(e.query).get("content");return n?decodeURIComponent(n):""}}});var ss,Yt,va,Kr,Jr,Xr,ba,Lo=v(()=>{"use strict";ss=q(require("vscode")),Yt=q(require("fs")),va=q(require("path")),Kr=require("child_process"),Jr=require("util"),Xr=(0,Jr.promisify)(Kr.exec),ba=class{constructor(){this.typeInventory=null;this.installedPackages=new Set;this.workspaceRoot=ss.workspace.workspaceFolders?.[0]?.uri.fsPath}async initialize(){this.workspaceRoot&&await Promise.all([this.scanInstalledPackages(),this.scanTypeInventory()])}async scanInstalledPackages(){if(!this.workspaceRoot)return;let e=va.join(this.workspaceRoot,"package.json");if(Yt.existsSync(e))try{let t=Yt.readFileSync(e,"utf-8"),n=JSON.parse(t);this.installedPackages.clear();for(let s of Object.keys(n.dependencies||{}))this.installedPackages.add(s);for(let s of Object.keys(n.devDependencies||{}))this.installedPackages.add(s);console.log(`CodeValidator: Found ${this.installedPackages.size} installed packages`)}catch(t){console.error("CodeValidator: Failed to scan packages:",t)}}async scanTypeInventory(){if(!this.workspaceRoot)return;this.typeInventory={types:new Map,exports:new Map};let e=await ss.workspace.findFiles("**/*.{ts,tsx}","**/node_modules/**",200);for(let t of e)try{let n=Yt.readFileSync(t.fsPath,"utf-8"),s=ss.workspace.asRelativePath(t);this.extractTypes(n,s),this.extractExports(n,s)}catch{}console.log(`CodeValidator: Found ${this.typeInventory.types.size} types, ${this.typeInventory.exports.size} files with exports`)}extractTypes(e,t){if(!this.typeInventory)return;let n=/export\s+interface\s+(\w+)/g,s;for(;(s=n.exec(e))!==null;)this.typeInventory.types.set(s[1],{name:s[1],file:t,kind:"interface",exported:!0});let o=/export\s+type\s+(\w+)/g;for(;(s=o.exec(e))!==null;)this.typeInventory.types.set(s[1],{name:s[1],file:t,kind:"type",exported:!0});let i=/export\s+enum\s+(\w+)/g;for(;(s=i.exec(e))!==null;)this.typeInventory.types.set(s[1],{name:s[1],file:t,kind:"enum",exported:!0})}extractExports(e,t){if(!this.typeInventory)return;let n=[],s=/export\s+(?:async\s+)?function\s+(\w+)/g,o;for(;(o=s.exec(e))!==null;)n.push({name:o[1],file:t,kind:"function"});let i=/export\s+const\s+(\w+)/g;for(;(o=i.exec(e))!==null;)n.push({name:o[1],file:t,kind:"const"});let r=/export\s+class\s+(\w+)/g;for(;(o=r.exec(e))!==null;)n.push({name:o[1],file:t,kind:"class"});/export\s+default/.test(e)&&n.push({name:"default",file:t,kind:"default"}),n.length>0&&this.typeInventory.exports.set(t,n)}checkDependencies(e){let t={missing:[],available:[],suggestions:[]},n=new Set;for(let s of e){if(!s.content)continue;let o=/import\s+.*?\s+from\s+['"]([^'"./][^'"]*)['"]/g,i;for(;(i=o.exec(s.content))!==null;){let r=i[1].split("/")[0];if(r.startsWith("@")){let d=i[1].split("/").slice(0,2).join("/");n.add(d)}else n.add(r)}}for(let s of n)this.installedPackages.has(s)?t.available.push(s):["fs","path","http","https","crypto","util","stream","events","url","querystring","os","child_process"].includes(s)||(t.missing.push(s),t.suggestions.push({package:s,command:`npm install ${s}`}));return t}async validateFileOperations(e){let t={passed:!0,errors:[],warnings:[],suggestions:[]};for(let o of e){if(!o.content||o.action==="delete")continue;let i=this.validateImports(o);t.errors.push(...i);let r=this.checkTypeUsage(o);t.warnings.push(...r);let d=this.checkSecurity(o);t.errors.push(...d);let p=this.checkBestPractices(o);t.warnings.push(...p)}!e.some(o=>o.path.includes(".test.")||o.path.includes(".spec.")||o.path.includes("__tests__"))&&e.length>0&&t.warnings.push({file:"project",message:"No test file included with this feature",type:"no-test"});let s=this.suggestExistingTypes(e);return t.suggestions.push(...s),t.passed=t.errors.length===0,t}validateImports(e){let t=[];if(!e.content||!this.workspaceRoot)return t;let n=/import\s+.*?\s+from\s+['"](\.[^'"]+)['"]/g,s;for(;(s=n.exec(e.content))!==null;){let o=s[1],i=va.dirname(e.path),r=va.join(this.workspaceRoot,i,o),p=["",".ts",".tsx",".js",".jsx","/index.ts","/index.tsx"].some(c=>{let m=r+c;return Yt.existsSync(m)}),l=o.replace(/^\.\//,"").replace(/^\.\.\//,"")}return t}checkTypeUsage(e){let t=[];if(!e.content)return t;let n=e.content.match(/:\s*any\b/g)||[];return n.length>2&&t.push({file:e.path,message:`Found ${n.length} uses of 'any' type - consider proper typing`,type:"any-type"}),t}checkSecurity(e){let t=[];if(!e.content)return t;let n=[{pattern:/['"]sk-[a-zA-Z0-9]{20,}['"]/,name:"OpenAI API key"},{pattern:/['"]sk_live_[a-zA-Z0-9]+['"]/,name:"Stripe live key"},{pattern:/['"]ghp_[a-zA-Z0-9]+['"]/,name:"GitHub token"},{pattern:/password\s*[:=]\s*['"][^'"]+['"]/,name:"Hardcoded password"}];for(let{pattern:s,name:o}of n)s.test(e.content)&&t.push({file:e.path,message:`Potential ${o} found in code - use environment variables`,type:"security"});return(e.path.includes("/components/")||e.path.includes("/app/")&&!e.path.includes("/api/"))&&/process\.env\.((?!NEXT_PUBLIC_)[A-Z_]+)/.test(e.content)&&t.push({file:e.path,message:"Server-side env var accessed in client component - use NEXT_PUBLIC_ prefix or move to API route",type:"security"}),t}checkBestPractices(e){let t=[];if(!e.content)return t;if(!/\.test\.|\.spec\./.test(e.path)){let n=(e.content.match(/console\.(log|debug|info)\(/g)||[]).length;n>0&&t.push({file:e.path,message:`Found ${n} console.log statement(s) - remove before production`,type:"console-log"})}return e.content.includes("async ")&&e.content.includes("await ")&&!e.content.includes("try")&&!e.content.includes("catch")&&t.push({file:e.path,message:"Async function without try/catch error handling",type:"missing-error-handling"}),e.path.includes("/api/")&&!e.content.includes("catch")&&!e.content.includes("error")&&t.push({file:e.path,message:"API route may lack error handling",type:"missing-error-handling"}),t}suggestExistingTypes(e){let t=[];if(!this.typeInventory)return t;for(let n of e){if(!n.content)continue;let s=/(?:interface|type)\s+(\w+)/g,o;for(;(o=s.exec(n.content))!==null;){let i=o[1];if(this.typeInventory.types.has(i)){let r=this.typeInventory.types.get(i);t.push(`Type '${i}' already exists in ${r.file} - consider importing instead of redefining`)}}}return t}getTypeInventoryForContext(){if(!this.typeInventory||this.typeInventory.types.size===0)return"No existing types found";let e=["Existing types in project:"],t=new Map;for(let[,n]of this.typeInventory.types){let s=t.get(n.file)||[];s.push(n),t.set(n.file,s)}for(let[n,s]of t)if(s.length>0){e.push(`  ${n}:`);for(let o of s.slice(0,10))e.push(`    - ${o.kind} ${o.name}`);s.length>10&&e.push(`    ... and ${s.length-10} more`)}return e.slice(0,50).join(`
`)}getInstalledPackagesForContext(){return Array.from(this.installedPackages).slice(0,50)}async runTypeScriptCheck(){if(!this.workspaceRoot)return{passed:!0,errors:[],errorCount:0};let e=va.join(this.workspaceRoot,"tsconfig.json");if(!Yt.existsSync(e))return console.log("CodeValidator: No tsconfig.json found, skipping TypeScript check"),{passed:!0,errors:[],errorCount:0};try{return await Xr("npx tsc --noEmit",{cwd:this.workspaceRoot,timeout:6e4}),{passed:!0,errors:[],errorCount:0}}catch(t){let n=t.stdout||t.stderr||"",s=this.parseTypeScriptErrors(n);return{passed:!1,errors:s,errorCount:s.length}}}parseTypeScriptErrors(e){let t=[],n=e.split(`
`),s=/^(.+?)\((\d+),(\d+)\): error (TS\d+): (.+)$/;for(let o of n){let i=o.match(s);i&&t.push({file:i[1],line:parseInt(i[2],10),column:parseInt(i[3],10),code:i[4],message:i[5]})}return t.slice(0,20)}async checkSpecificFiles(e){if(!this.workspaceRoot||e.length===0)return{passed:!0,errors:[],errorCount:0};let t=e.filter(n=>n.endsWith(".ts")||n.endsWith(".tsx"));if(t.length===0)return{passed:!0,errors:[],errorCount:0};try{let n=t.map(s=>`"${s}"`).join(" ");return await Xr(`npx tsc --noEmit ${n}`,{cwd:this.workspaceRoot,timeout:3e4}),{passed:!0,errors:[],errorCount:0}}catch(n){let s=n.stdout||n.stderr||"",o=this.parseTypeScriptErrors(s);return{passed:!1,errors:o,errorCount:o.length}}}}});var Zr={};Et(Zr,{ChatPanelProvider:()=>$o});var y,$o,Qr=v(()=>{"use strict";y=q(require("vscode"));Fo();Lo();$o=class a{constructor(e,t,n){this.context=e;this.client=t;this.projectContext=n;this._messages=[];this._conversationSummary="";this._abortController=null;this._pendingChanges=[];this._pendingCommands=[];this._pinnedFiles=[];this._streamBuffer="";this._thinkingBuffer="";this._streamThrottleTimer=null;this._lastStreamUpdate=0;this.STREAM_THROTTLE_MS=50;this.fileOps=new Ka}static getInstance(e,t,n){return a._instance||(a._instance=new a(e,t,n)),a._instance}show(){if(this._panel){this._panel.reveal(y.ViewColumn.Beside);return}this._panel=y.window.createWebviewPanel("codebakers.chat","CodeBakers",{viewColumn:y.ViewColumn.Beside,preserveFocus:!0},{enableScripts:!0,retainContextWhenHidden:!0,localResourceRoots:[this.context.extensionUri]}),this._panel.iconPath=y.Uri.joinPath(this.context.extensionUri,"media","icon.svg"),this._panel.webview.html=this._getHtmlForWebview(this._panel.webview),this._panel.webview.onDidReceiveMessage(async e=>{switch(e.type){case"sendMessage":await this.sendMessage(e.message);break;case"clearChat":this._messages=[],this._conversationSummary="",this._pendingChanges=[],this._pendingCommands=[],this._updateWebview();break;case"runTool":await this._executeTool(e.tool);break;case"login":await this.client.login();break;case"applyFile":await this._applyFileOperation(e.id);break;case"applyAllFiles":await this._applyAllPendingChanges();break;case"rejectFile":this._rejectFileOperation(e.id);break;case"rejectAllFiles":this._rejectAllPendingChanges();break;case"runCommand":await this._runCommand(e.id);break;case"showDiff":await this._showDiff(e.id);break;case"undoFile":await this._undoFileOperation(e.id);break;case"undoAppliedFiles":await this._undoAppliedFiles(e.files);break;case"cancelRequest":this._cancelCurrentRequest();break;case"addPinnedFile":await this._addPinnedFile();break;case"removePinnedFile":this._removePinnedFile(e.path);break;case"clearPinnedFiles":this._pinnedFiles=[],this._updatePinnedFiles();break;case"resetSessionStats":this.client.resetSessionStats();break;case"logProjectTime":this._logProjectTime(e);break;case"deploy":this._deployToVercel();break;case"gitPush":this._pushToGitHub();break;case"openMindMap":y.commands.executeCommand("codebakers.openMindMap");break;case"openPreview":this._openPreviewInBrowser(e.port||3e3);break;case"loadTeamNotes":this._loadTeamNotes();break;case"saveTeamNotes":this._saveTeamNotes(e.notes);break;case"analyzeImpact":this._analyzeImpact(e.message);break;case"installPackages":this._installPackages(e.packages);break}}),this._panel.onDidDispose(()=>{this._panel=void 0}),this._initializeStatus()}refresh(){this._panel&&(this._initializeStatus(),this._updateWebview())}setInputWithContext(e){this._panel||this.show(),setTimeout(()=>{this._panel?.webview.postMessage({type:"setInputValue",value:e})},100)}async _initializeStatus(){if(this._panel)try{let e=this.client.getPlanInfo();if(this._panel.webview.postMessage({type:"updatePlan",plan:e.plan}),!this.client.hasSessionToken()){this._panel.webview.postMessage({type:"updateHealth",health:0,score:0}),this._panel.webview.postMessage({type:"showLogin"});return}try{let t=await this.client.guardianStatus();this._panel.webview.postMessage({type:"updateHealth",health:t.data?.health||85,score:t.data?.health||85})}catch(t){console.warn("Health check failed:",t),this._panel.webview.postMessage({type:"updateHealth",health:85,score:85})}}catch(e){console.error("Failed to initialize status:",e)}}async _executeTool(e){if(this._panel)try{this._panel.webview.postMessage({type:"typing",isTyping:!0});let t=await this.client.executeTool(e,{});this._messages.push({role:"assistant",content:`**Tool: ${e}**
\`\`\`json
...
${t instanceof Error?t.message:"Tool execution failed"}`,timestamp:new Date})}finally{this._panel?.webview.postMessage({type:"typing",isTyping:!1}),this._updateWebview()}}async _applyFileOperation(e){if(!this._panel)return;let t=this._pendingChanges.find(n=>n.id===e);if(!(!t||t.status!=="pending"))try{if(await this.fileOps.applyChange({path:t.operation.path,action:t.operation.action,content:t.operation.content,description:t.operation.description}))t.status="applied",y.window.showInformationMessage(`\u2705 ${t.operation.action}: ${t.operation.path}`),this._updatePendingChanges(),t.operation.action!=="delete"&&await this.fileOps.openFile(t.operation.path),setTimeout(()=>{this._pendingChanges=this._pendingChanges.filter(s=>s.id!==e),this._updatePendingChanges()},1500);else throw new Error("Operation failed")}catch(n){y.window.showErrorMessage(`\u274C Failed: ${t.operation.path} - ${n}`),this._updatePendingChanges()}}async _applyAllPendingChanges(){if(!this._panel)return;let e=this._pendingChanges.filter(i=>i.status==="pending");if(e.length===0){y.window.showInformationMessage("No pending changes to apply");return}let t=e.length;this._panel?.webview.postMessage({type:"showProgress",text:`Applying 0/${t} files...`,current:0,total:t,show:!0});let n=5,s=0,o=0;for(let i=0;i<e.length;i+=n){let r=e.slice(i,i+n);(await Promise.allSettled(r.map(async l=>{try{return await this.fileOps.applyChange({path:l.operation.path,action:l.operation.action,content:l.operation.content,description:l.operation.description})?(l.status="applied",!0):!1}catch(c){return console.error(`Failed to apply ${l.operation.path}:`,c),!1}}))).forEach(l=>{l.status==="fulfilled"&&l.value?s++:o++});let p=s+o;this._panel?.webview.postMessage({type:"showProgress",text:`Applying ${p}/${t} files...`,current:p,total:t,show:!0}),this._updatePendingChanges()}this._panel?.webview.postMessage({type:"showProgress",show:!1}),y.window.showInformationMessage(`\u2705 Applied ${s} file(s)${o>0?`, ${o} failed`:""}`),this._pendingChanges=this._pendingChanges.filter(i=>i.status==="rejected"),this._updatePendingChanges(),s>0&&await this._runTscCheck()}async _runTscCheck(e=!0){if(await this.fileOps.fileExists("tsconfig.json")){this._panel?.webview.postMessage({type:"showStatus",text:"Checking TypeScript...",show:!0});try{let s=await new ba().runTypeScriptCheck();if(this._panel?.webview.postMessage({type:"showStatus",show:!1}),!s.passed&&s.errors.length>0){this._panel?.webview.postMessage({type:"rippleCheck",errors:s.errorCount,warnings:0,details:s.errors.slice(0,4).map(i=>({type:"error",message:`${i.file}:${i.line} - ${i.message.substring(0,60)}${i.message.length>60?"...":""}`}))});let o=await y.window.showWarningMessage(`\u26A0\uFE0F TypeScript errors found (${s.errorCount})`,"Auto-Fix with AI","Show Errors","Ignore");if(o==="Auto-Fix with AI"&&e){let i=`Please fix these TypeScript errors:

${s.errors.map(r=>`${r.file}:${r.line}: ${r.message}`).join(`
`)}`;this._panel?.webview.postMessage({type:"showStatus",text:"AI fixing TypeScript errors...",show:!0}),await this.sendMessage(i)}else if(o==="Show Errors"){let i=y.window.createOutputChannel("CodeBakers TSC");i.clear(),i.appendLine("TypeScript Errors:"),i.appendLine(`=================
`),s.errors.forEach(r=>{i.appendLine(`${r.file}:${r.line}:${r.column}`),i.appendLine(`  ${r.message}
`)}),i.show()}}else this._panel?.webview.postMessage({type:"rippleCheck",errors:0,warnings:0,details:[{type:"pass",message:"TypeScript compilation successful"}]}),y.window.showInformationMessage("\u2705 TypeScript check passed!")}catch(n){this._panel?.webview.postMessage({type:"showStatus",show:!1}),console.error("TSC check failed:",n)}}}_rejectFileOperation(e){let t=this._pendingChanges.find(n=>n.id===e);t&&t.status==="pending"&&(t.status="rejected",this._updatePendingChanges())}_rejectAllPendingChanges(){for(let e of this._pendingChanges)e.status==="pending"&&(e.status="rejected");this._updatePendingChanges()}async _runCommand(e){if(!this._panel)return;let t=this._pendingCommands.find(n=>n.id===e);if(!(!t||t.status!=="pending")){try{t.status="running",this._updatePendingChanges(),await this.fileOps.runCommand(t.command.command,t.command.description||"CodeBakers"),t.status="done",y.window.showInformationMessage(`\u{1F680} Running: ${t.command.command}`)}catch(n){t.status="pending",y.window.showErrorMessage(`\u274C Failed to run command: ${n}`)}this._updatePendingChanges()}}async _showDiff(e){let t=this._pendingChanges.find(n=>n.id===e);if(!(!t||!t.operation.content))try{await this.fileOps.showDiff(t.operation.path,t.operation.content,`CodeBakers: ${t.operation.path}`)}catch(n){y.window.showErrorMessage(`\u274C Failed to show diff: ${n}`)}}async _undoFileOperation(e){let t=this._pendingChanges.find(n=>n.id===e);if(!t||t.status!=="applied"){y.window.showWarningMessage("Cannot undo - change was not applied");return}try{await this.fileOps.restoreFromBackup(t.operation.path)&&(t.status="pending",this._updatePendingChanges())}catch(n){y.window.showErrorMessage(`\u274C Failed to undo: ${n}`)}}async _undoAppliedFiles(e){if(!e||e.length===0)return;let t=0;for(let n of e)try{await this.fileOps.restoreFromBackup(n)&&(t++,this._pendingChanges=this._pendingChanges.filter(o=>o.operation.path!==n))}catch(s){console.error(`Failed to undo ${n}:`,s)}t>0&&(y.window.showInformationMessage(`\u21A9\uFE0F Undone ${t} file${t>1?"s":""}`),this._updatePendingChanges())}_cancelCurrentRequest(){this._abortController&&(this._abortController.abort(),this._abortController=null,this._panel?.webview.postMessage({type:"requestCancelled"}),y.window.showInformationMessage("Request cancelled"))}_logProjectTime(e){let t=y.workspace.workspaceFolders?.[0];if(!t)return;let n=require("fs"),s=require("path"),o=t.uri.fsPath,i=s.join(o,".codebakers"),r=s.join(i,"timelog.json");n.existsSync(i)||n.mkdirSync(i,{recursive:!0});let d={sessions:[],totals:{totalMinutes:0,totalCost:0,totalRequests:0,totalTokens:0}};if(n.existsSync(r))try{d=JSON.parse(n.readFileSync(r,"utf-8"))}catch{}let p=new Date().toISOString().split("T")[0],l=Math.round(e.activeTime/6e4),c=d.sessions.find(u=>u.date===p);c||(c={date:p,activeMinutes:0,cost:0,requests:0,tokens:0},d.sessions.push(c)),c.activeMinutes=Math.max(c.activeMinutes,l),c.cost=Math.max(c.cost,e.totalCost),c.requests=Math.max(c.requests,e.requests),c.tokens=Math.max(c.tokens,e.tokens),d.totals={totalMinutes:d.sessions.reduce((u,g)=>u+g.activeMinutes,0),totalCost:d.sessions.reduce((u,g)=>u+g.cost,0),totalRequests:d.sessions.reduce((u,g)=>u+g.requests,0),totalTokens:d.sessions.reduce((u,g)=>u+g.tokens,0)};let m=new Date;m.setDate(m.getDate()-90),d.sessions=d.sessions.filter(u=>new Date(u.date)>=m),n.writeFileSync(r,JSON.stringify(d,null,2))}async _deployToVercel(){let e=y.workspace.workspaceFolders?.[0];if(!e){y.window.showErrorMessage("No workspace folder open");return}this._panel?.webview.postMessage({type:"showStatus",show:!0,text:"\u{1F680} Deploying to Vercel..."}),this._messages.push({role:"assistant",content:"\u{1F680} **Starting Vercel deployment...**\n\nRunning `vercel --prod`...",timestamp:new Date}),this._updateWebview();try{let t=require("child_process"),n=e.uri.fsPath,s=await new Promise((d,p)=>{t.exec("npx vercel --prod --yes",{cwd:n,timeout:3e5},(l,c,m)=>{l&&!c?p(l):d({stdout:c,stderr:m})})}),o=s.stdout.match(/https:\/\/[^\s]+\.vercel\.app/),i=o?o[0]:null,r=`\u2705 **Deployment successful!**

`;i&&(r+=`\u{1F517} **Live URL:** [${i}](${i})

`),r+="```\n"+s.stdout.slice(-500)+"\n```",this._messages.push({role:"assistant",content:r,timestamp:new Date}),y.window.showInformationMessage(`\u2705 Deployed successfully!${i?` URL: ${i}`:""}`,"Open URL").then(d=>{d==="Open URL"&&i&&y.env.openExternal(y.Uri.parse(i))})}catch(t){let n=t.message||"Unknown error";n.includes("vercel")&&n.includes("not found")?this._messages.push({role:"assistant",content:"\u274C **Vercel CLI not found**\n\nPlease install it first:\n```bash\nnpm install -g vercel\n```\n\nThen run `vercel login` to authenticate.",timestamp:new Date}):this._messages.push({role:"assistant",content:`\u274C **Deployment failed**
...
3. Project linked (\`vercel link\`)`,timestamp:new Date}),y.window.showErrorMessage(`Deployment failed: ${n}`)}finally{this._panel?.webview.postMessage({type:"showStatus",show:!1}),this._updateWebview()}}async _pushToGitHub(){let e=y.workspace.workspaceFolders?.[0];if(!e){y.window.showErrorMessage("No workspace folder open");return}let t=e.uri.fsPath,n=require("child_process");try{await new Promise((i,r)=>{n.exec("git rev-parse --git-dir",{cwd:t},d=>{d?r(d):i()})})}catch{y.window.showErrorMessage("Not a git repository. Run `git init` first.");return}let s=!1;try{s=(await new Promise((r,d)=>{n.exec("git status --porcelain",{cwd:t},(p,l)=>{p?d(p):r(l)})})).trim().length>0}catch(i){y.window.showErrorMessage(`Git error: ${i.message}`);return}let o="";if(s){let i=await y.window.showInputBox({prompt:"Enter commit message (or leave empty to skip commit)",placeHolder:"feat: add new feature",value:"chore: update from CodeBakers"});if(i===void 0)return;o=i}this._panel?.webview.postMessage({type:"showStatus",show:!0,text:"\u{1F4E4} Pushing to GitHub..."}),this._messages.push({role:"assistant",content:s&&o?`\u{1F4E4} **Pushing to GitHub...**

Committing changes and pushing to remote...`:`\u{1F4E4} **Pushing to GitHub...**

Pushing to remote...`,timestamp:new Date}),this._updateWebview();try{let i="";if(s&&o){await new Promise((c,m)=>{n.exec("git add -A",{cwd:t},u=>{u?m(u):c()})});let l=await new Promise((c,m)=>{n.exec(`git commit -m "${o.replace(/"/g,'\\"')}"`,{cwd:t},(u,g)=>{u&&!g?m(u):c(g)})});i+=l+`
`}let r=await new Promise((l,c)=>{n.exec("git push",{cwd:t,timeout:6e4},(m,u,g)=>{m&&!u&&!g?c(m):l(u+g)})});i+=r;let d="";try{d=await new Promise(l=>{n.exec("git remote get-url origin",{cwd:t},(c,m)=>{l(m.trim())})}),d.startsWith("git@github.com:")&&(d=d.replace("git@github.com:","https://github.com/").replace(/\.git$/,""))}catch{}let p=`\u2705 **Pushed to GitHub successfully!**

`;d&&d.includes("github.com")&&(p+=`\u{1F517} **Repository:** [${d}](${d})

`),s&&o&&(p+=`\u{1F4DD} **Commit:** ${o}

`),p+="```\n"+i.slice(-300)+"\n```",this._messages.push({role:"assistant",content:p,timestamp:new Date}),y.window.showInformationMessage("\u2705 Pushed to GitHub!",d.includes("github.com")?"Open Repository":void 0).then(l=>{l==="Open Repository"&&d&&y.env.openExternal(y.Uri.parse(d))})}catch(i){let r=i.message||"Unknown error";r.includes("no upstream")||r.includes("no tracking")?this._messages.push({role:"assistant",content:"\u274C **No upstream branch set**\n\nRun this to set up tracking:\n```bash\ngit push -u origin main\n```",timestamp:new Date}):r.includes("Permission denied")||r.includes("authentication")?this._messages.push({role:"assistant",content:`\u274C **Authentication failed**
...
\`\`\`
${r}
\`\`\``,timestamp:new Date}),y.window.showErrorMessage(`Push failed: ${r}`)}finally{this._panel?.webview.postMessage({type:"showStatus",show:!1}),this._updateWebview()}}_openPreviewInBrowser(e=3e3){let t=`http://localhost:${e}`;y.env.openExternal(y.Uri.parse(t)),y.window.showInformationMessage(`Opening ${t} in browser...`)}async _installPackages(e){if(!e||e.length===0)return;let t=y.workspace.workspaceFolders?.[0];if(!t){y.window.showErrorMessage("No workspace folder open");return}let n=t.uri.fsPath,s=require("child_process"),o=e.join(" ");this._panel?.webview.postMessage({type:"toast",message:`\u{1F4E6} Installing: ${o}...`});try{await new Promise((i,r)=>{s.exec(`npm install ${o}`,{cwd:n,timeout:12e4},(d,p,l)=>{d?r(d):i()})}),this._panel?.webview.postMessage({type:"toast",message:`\u2705 Installed: ${o}`}),y.window.showInformationMessage(`\u2705 Installed: ${o}`)}catch(i){let r=i.message||"Unknown error";this._panel?.webview.postMessage({type:"toast",message:`\u274C Install failed: ${r}`}),y.window.showErrorMessage(`Package install failed: ${r}`)}}_loadTeamNotes(){let e=y.workspace.workspaceFolders?.[0];if(!e)return;let t=require("fs"),s=require("path").join(e.uri.fsPath,".codebakers","team-notes.md"),o="";if(t.existsSync(s))try{o=t.readFileSync(s,"utf-8")}catch{}this._panel?.webview.postMessage({type:"updateTeamNotes",notes:o})}_saveTeamNotes(e){let t=y.workspace.workspaceFolders?.[0];if(!t)return;let n=require("fs"),s=require("path"),o=s.join(t.uri.fsPath,".codebakers"),i=s.join(o,"team-notes.md");n.existsSync(o)||n.mkdirSync(o,{recursive:!0}),n.writeFileSync(i,e)}async _analyzeImpact(e){if(!this._panel)return;let t=y.workspace.workspaceFolders?.[0];if(!t){this._panel.webview.postMessage({type:"impactAnalysis",files:[{name:"No workspace open",impact:"medium"}],warning:"Open a workspace folder to enable impact analysis"});return}let n=require("fs"),s=require("path"),o=e.toLowerCase(),i=[],r="";try{let d=s.join(t.uri.fsPath,"src");if(n.existsSync(d)){if(o.includes("api")||o.includes("endpoint")||o.includes("route")){let p=s.join(d,"app","api");n.existsSync(p)&&i.push({name:"src/app/api/",impact:"high"})}if(o.includes("component")||o.includes("button")||o.includes("form")||o.includes("modal")){let p=s.join(d,"components");n.existsSync(p)&&i.push({name:"src/components/",impact:"medium"})}if(o.includes("page")||o.includes("layout")){let p=s.join(d,"app");n.existsSync(p)&&i.push({name:"src/app/",impact:"high"})}if(o.includes("database")||o.includes("schema")||o.includes("table")||o.includes("model")){let p=s.join(d,"lib","db","schema.ts");n.existsSync(p)&&(i.push({name:"src/lib/db/schema.ts",impact:"high"}),r="Database schema changes may require migrations")}if(o.includes("auth")||o.includes("login")||o.includes("session")){let p=s.join(d,"lib","auth.ts");n.existsSync(p)&&(i.push({name:"src/lib/auth.ts",impact:"high"}),r="Authentication changes require careful security review")}(o.includes("style")||o.includes("css")||o.includes("theme"))&&i.push({name:"*.css / globals.css",impact:"medium"})}i.length===0&&i.push({name:"src/",impact:"medium"})}catch(d){console.error("Impact analysis error:",d),i.push({name:"Analysis unavailable"})}this._panel.webview.postMessage({type:"impactAnalysis",files:i,warning:r})}_showAppliedToast(e){let t=e.length,n=e.map(s=>s.split("/").pop()).join(", ");this._panel?.webview.postMessage({type:"toast",message:`Applied ${t} file${t>1?"s":""}: ${n}`,action:"undo",files:e}),this._runTscCheck()}async _addPinnedFile(){let e=await y.window.showOpenDialog({canSelectMany:!0,canSelectFolders:!1,openLabel:"Add to Context",filters:{"Code Files":["ts","tsx","js","jsx","json","md","css","html","py","go","rs","java","c","cpp","h"],"All Files":["*"]}});if(!(!e||e.length===0)){for(let t of e){let n=y.workspace.asRelativePath(t);if(!this._pinnedFiles.some(s=>s.path===n))try{let s=await this.fileOps.readFile(n),o=await y.workspace.fs.stat(t);this._pinnedFiles.push({path:n,name:n.split("/").pop()||n,content:s||"",size:o.size})}catch(s){console.error(`Failed to read file ${n}:`,s),y.window.showWarningMessage(`Could not read: ${n}`)}}this._updatePinnedFiles(),y.window.showInformationMessage(`\u{1F4CE} Added ${e.length} file(s) to context`)}}_removePinnedFile(e){this._pinnedFiles=this._pinnedFiles.filter(t=>t.path!==e),this._updatePinnedFiles()}_updatePinnedFiles(){this._panel&&this._panel.webview.postMessage({type:"updatePinnedFiles",files:this._pinnedFiles.map(e=>({path:e.path,name:e.name,size:e.size}))})}_getPinnedFilesContext(){if(this._pinnedFiles.length===0)return"";let e=`
...
`;return e}_filterStreamContent(e){if(!e)return"";let t=e;for(;t.includes("<file_operation>");){let s=t.indexOf("<file_operation>"),o=t.indexOf("</file_operation>",s);if(o===-1)break;t=t.substring(0,s)+t.substring(o+17)}for(;t.includes("```");){let s=t.indexOf("```"),o=t.indexOf("```",s+3);if(o===-1)break;t=t.substring(0,s)+t.substring(o+3)}let n=["content","action","path","thinking","result"];for(let s of n)t=t.split(`<${s}>`).join("").split(`</${s}>`).join("");return t=t.replace(/\n{3,}/g,`

`).trim(),t.length<20?"\u2728 Generating code...":t}_throttledStreamUpdate(){if(Date.now()-this._lastStreamUpdate<this.STREAM_THROTTLE_MS){this._streamThrottleTimer||(this._streamThrottleTimer=setTimeout(()=>{this._streamThrottleTimer=null,this._sendStreamUpdate()},this.STREAM_THROTTLE_MS));return}this._sendStreamUpdate()}_sendStreamUpdate(){this._lastStreamUpdate=Date.now(),this._thinkingBuffer&&this._panel?.webview.postMessage({type:"streamThinking",thinking:this._thinkingBuffer}),this._streamBuffer&&this._panel?.webview.postMessage({type:"streamContent",content:this._streamBuffer})}async sendMessage(e){if(this._panel){if(!this.client.hasSessionToken()){this._panel.webview.postMessage({type:"showLogin"}),y.window.showWarningMessage("Please sign in to CodeBakers first","Sign In with GitHub").then(t=>{t==="Sign In with GitHub"&&this.client.login()});return}this._messages.push({role:"user",content:e,timestamp:new Date}),this._updateWebview(),this._streamBuffer="",this._thinkingBuffer="";try{this._abortController=new AbortController,this._panel.webview.postMessage({type:"typing",isTyping:!0});let t=await this.projectContext.getProjectState(),n=await this._buildContextualizedMessages(e,t),s=await this.client.chat(n,t,{onThinking:o=>{this._thinkingBuffer=o,this._throttledStreamUpdate()},onContent:o=>{this._streamBuffer=this._filterStreamContent(o),this._throttledStreamUpdate()},onDone:()=>{this._panel?.webview.postMessage({type:"validating"})},onError:o=>{this._panel?.webview.postMessage({type:"streamError",error:o.message})},abortSignal:this._abortController.signal});if(this._messages.push({role:"assistant",content:s.content,thinking:s.thinking,timestamp:new Date}),s.usage&&this._panel?.webview.postMessage({type:"updateSessionStats",usage:s.usage}),s.fileOperations&&s.fileOperations.length>0){let o=[];for(let i of s.fileOperations)try{await this.fileOps.applyChange({path:i.path,action:i.action,content:i.content,description:i.description})&&(o.push(i.path),this._pendingChanges.push({id:`file-${Date.now()}-${Math.random().toString(36).substr(2,9)}`,operation:i,status:"applied"}))}catch(r){console.error(`Failed to apply ${i.path}:`,r)}o.length>0&&this._showAppliedToast(o)}if(s.commands&&s.commands.length>0){let o=y.workspace.getConfiguration("codebakers").get("requireApproval",!1);for(let i of s.commands){let r=`cmd-${Date.now()}-${Math.random().toString(36).substring(2,11)}`;if(o)this._pendingCommands.push({id:r,command:i,status:"pending"});else try{this._pendingCommands.push({id:r,command:i,status:"running"}),await this.fileOps.runCommand(i.command,i.description||"CodeBakers");let d=this._pendingCommands.find(p=>p.id===r);d&&(d.status="done"),y.window.showInformationMessage(`\u2705 Ran: ${i.command}`)}catch(d){let p=this._pendingCommands.find(l=>l.id===r);p&&(p.status="error"),console.error(`Failed to run command ${i.command}:`,d),y.window.showErrorMessage(`\u274C Failed: ${i.command}`)}}}s.projectUpdates&&await this.projectContext.applyUpdates(s.projectUpdates),await this.projectContext.learnFromResponse(s.content,e),this._messages.length>20&&await this._summarizeConversation()}catch(t){t.message!=="Request was cancelled"&&this._messages.push({role:"assistant",content:`**Error:** ${t instanceof Error?t.message:"Unknown error"}`,timestamp:new Date})}finally{this._streamThrottleTimer&&(clearTimeout(this._streamThrottleTimer),this._streamThrottleTimer=null),this._abortController=null,this._panel?.webview.postMessage({type:"typing",isTyping:!1}),this._updateWebview()}}}async _buildContextualizedMessages(e,t){let n=[];this._isCodeRequest(e)&&n.push({role:"system",content:`CODEBAKERS PATTERN ENFORCEMENT:
...
This is STRUCTURAL enforcement - do not skip these steps.`}),this._conversationSummary&&n.push({role:"system",content:`Previous conversation summary:
${this._conversationSummary}`}),t&&n.push({role:"system",content:`Current project state:
${JSON.stringify(t,null,2)}`});let s=this._getPinnedFilesContext();if(s&&n.push({role:"system",content:`The user has pinned the following files for context. These files should be referenced when relevant:${s}`}),t?.aiMemory){let i=this.projectContext.formatMemoryForPrompt(t.aiMemory);i&&n.push({role:"system",content:i})}let o=this._messages.slice(-10);for(let i of o)n.push({role:i.role,content:i.content});return n}_isCodeRequest(e){if(!e)return!1;let t=["add","create","build","implement","fix","update","change","modify","write","edit","refactor","delete","remove","feature","component","page","api","route","function","button","form","modal","table","chart","endpoint"],n=e.toLowerCase();return t.some(s=>n.includes(s))}async _summarizeConversation(){let e=this._messages.slice(0,-10);if(e.length===0)return;let t=`Summarize these conversation messages, keeping key decisions and context:
...
</html>`}}});var Xt,ed=v(()=>{Xt="0.32.1"});function od(a,e={auto:!1}){if(td)throw new Error(`you must \`import '@anthropic-ai/sdk/shims/${a.kind}'\` before importing anything else from @anthropic-ai/sdk`);if(Kt)throw new Error(`can't \`import '@anthropic-ai/sdk/shims/${a.kind}'\` after \`import '@anthropic-ai/sdk/shims/${Kt}'\``);td=e.auto,Kt=a.kind,Oo=a.fetch,vc=a.Request,bc=a.Response,yc=a.Headers,ad=a.FormData,wc=a.Blob,os=a.File,jo=a.ReadableStream,nd=a.getMultipartRequestOptions,zo=a.getDefaultAgent,is=a.fileFromPath,sd=a.isFsReadStream}var td,Kt,Oo,vc,bc,yc,ad,wc,os,jo,nd,zo,is,sd,Vo=v(()=>{td=!1});var dd=re((m0,rd)=>{"use strict";var Q={};rd.exports=Q;function id(a){return a<0?-1:1}function kc(a){return a%1===.5&&(a&1)===0?Math.floor(a):Math.round(a)}function Tt(a,e){e.unsigned||--a;let t=e.unsigned?0:-Math.pow(2,a),n=Math.pow(2,a)-1,s=e.moduloBitLength?Math.pow(2,e.moduloBitLength):Math.pow(2,a),o=e.moduloBitLength?Math.pow(2,e.moduloBitLength-1):Math.pow(2,a-1);return function(i,r){r||(r={});let d=+i;if(r.enforceRange){if(!Number.isFinite(d))throw new TypeError("Argument is not a finite number");if(d=id(d)*Math.floor(Math.abs(d)),d<t||d>n)throw new TypeError("Argument is not in byte range");return d}if(!isNaN(d)&&r.clamp)return d=kc(d),d<t&&(d=t),d>n&&(d=n),d;if(!Number.isFinite(d)||d===0)return 0;if(d=id(d)*Math.floor(Math.abs(d)),d=d%s,!e.unsigned&&d>=o)return d-s;if(e.unsigned){if(d<0)d+=s;else if(d===-0)return 0}return d}}Q.void=function(){};Q.boolean=function(a){return!!a};Q.byte=Tt(8,{unsigned:!1});Q.octet=Tt(8,{unsigned:!0});Q.short=Tt(16,{unsigned:!1});Q["unsigned short"]=Tt(16,{unsigned:!0});Q.long=Tt(32,{unsigned:!1});Q["unsigned long"]=Tt(32,{unsigned:!0});Q["long long"]=Tt(32,{unsigned:!1,moduloBitLength:64});Q["unsigned long long"]=Tt(32,{unsigned:!0,moduloBitLength:64});Q.double=function(a){let e=+a;if(!Number.isFinite(e))throw new TypeError("Argument is not a finite floating-point value");return e};Q["unrestricted double"]=function(a){let e=+a;if(isNaN(e))throw new TypeError("Argument is NaN");return e};Q.float=Q.double;Q["unrestricted float"]=Q["unrestricted double"];Q.DOMString=function(a,e){return e||(e={}),e.treatNullAsEmptyString&&a===null?"":String(a)};Q.ByteString=function(a,e){let t=String(a),n;for(let s=0;(n=t.codePointAt(s))!==void 0;++s)if(n>255)throw new TypeError("Argument is not a valid bytestring");return t};Q.USVString=function(a){let e=String(a),t=e.length,n=[];for(let s=0;s<t;++s){let o=e.charCodeAt(s);if(o<55296||o>57343)n.push(String.fromCodePoint(o));else if(56320<=o&&o<=57343)n.push(String.fromCodePoint(65533));else if(s===t-1)n.push(String.fromCodePoint(65533));else{let i=e.charCodeAt(s+1);if(56320<=i&&i<=57343){let r=o&1023,d=i&1023;n.push(String.fromCodePoint(65536+1024*r+d)),++s}else n.push(String.fromCodePoint(65533))}}return n.join("")};Q.Date=function(a,e){if(!(a instanceof Date))throw new TypeError("Argument is not a Date object");if(!isNaN(a))return a};Q.RegExp=function(a,e){return a instanceof RegExp||(a=new RegExp(a)),a}});var pd=re((u0,Nt)=>{"use strict";Nt.exports.mixin=function(e,t){let n=Object.getOwnPropertyNames(t);for(let s=0;s<n.length;++s)Object.defineProperty(e,n[s],Object.getOwnPropertyDescriptor(t,n[s]))};Nt.exports.wrapperSymbol=Symbol("wrapper");Nt.exports.implSymbol=Symbol("impl");Nt.exports.wrapperForImpl=function(a){return a[Nt.exports.wrapperSymbol]};Nt.exports.implForWrapper=function(a){return a[Nt.exports.implSymbol]}});var ld=re((g0,_c)=>{_c.exports=[[[0,44],"disallowed_STD3_valid"],[[45,46],"valid"],[[47,47],"disallowed_STD3_valid"],[[48,57],"valid"],[[58,64],"disallowed_STD3_valid"],[[65,65],"mapped",[97]],[[66,66],"mapped",[98]],[[67,67],"mapped",[99]],[[68,68],"mapped",[100]],[[69,69],"mapped",[101]],[[70,70],"mapped",[102]],[[71,71],"mapped",[103]],[[72,72],"mapped",[104]],[[73,73],"mapped",[105]],[[74,74],"mapped",[106]],[[75,75],"mapped",[107]],[[76,76],"mapped",[108]],[[77,77],"mapped",[109]],[[78,78],"mapped",[110]],[[79,79],"mapped",[111]],[[80,80],"mapped",[112]],[[81,81],"mapped",[113]],[[82,82],"mapped",[114]],[[83,83],"mapped",[115]],[[84,84],"mapped",[116]],[[85,85],"mapped",[117]],[[86,86],"mapped",[118]],[[87,87],"mapped",[119]],[[88,88],"mapped",[120]],[[89,89],"mapped",[121]],[[90,90],"mapped",[122]],[[91,96],"disallowed_STD3_valid"],[[97,122],"valid"],[[123,127],"disallowed_STD3_valid"],[[128,159],"disallowed"],[[160,160],"disallowed_STD3_mapped",[32]],[[161,167],"valid",[],"NV8"],[[168,168],"disallowed_STD3_mapped",[32,776]],[[169,169],"valid",[],"NV8"],[[170,170],"mapped",[97]],[[171,172],"valid",[],"NV8"],[[173,173],"ignored"],[[174,174],"valid",[],"NV8"],[[175,175],"disallowed_STD3_mapped",[32,772]],[[176,177],"valid",[],"NV8"],[[178,178],"mapped",[50]],[[179,179],"mapped",[51]],[[180,180],"disallowed_STD3_mapped",[32,769]],[[181,181],"mapped",[956]],[[182,182],"valid",[],"NV8"],[[183,183],"valid"],[[184,184],"disallowed_STD3_mapped",[32,807]],[[185,185],"mapped",[49]],[[186,186],"mapped",[111]],[[187,187],"valid",[],"NV8"],[[188,188],"mapped",[49,8260,52]],[[189,189],"mapped",[49,8260,50]],[[190,190],"mapped",[51,8260,52]],[[191,191],"valid",[],"NV8"],[[192,192],"mapped",[224]],[[193,193],"mapped",[225]],[[194,194],"mapped",[226]],[[195,195],"mapped",[227]],[[196,196],"mapped",[228]],[
/[\uD800-\uDBFF][\uDC00-\uDFFF]/g;function hd(a){return a.replace(Sc,"_").length}function Cc(a,e,t){for(var n=!1,s="",o=hd(a),i=0;i<o;++i){var r=a.codePointAt(i),d=gd(r);switch(d[1]){case"disallowed":n=!0,s+=String.fromCodePoint(r);break;case"ignored":break;case"mapped":s+=String.fromCodePoint.apply(String,d[2]);break;case"deviation":t===ya.TRANSITIONAL?s+=String.fromCodePoint.apply(String,d[2]):s+=String.fromCodePoint(r);break;case"valid":s+=String.fromCodePoint(r);break;case"disallowed_STD3_mapped":e?(n=!0,s+=String.fromCodePoint(r)):s+=String.fromCodePoint.apply(String,d[2]);break;case"disallowed_STD3_valid":e&&(n=!0),s+=String.fromCodePoint(r);break}}return{string:s,error:n}}var Pc=/[\u0300-\u036F\u0483-\u0489\u0591-\u05BD\u05BF\u05C1\u05C2\u05C4\u05C5\u05C7\u0610-\u061A\u064B-\u065F\u0670\u06D6-\u06DC\u06DF-\u06E4\u06E7\u06E8\u06EA-\u06ED\u0711\u0730-\u074A\u07A6-\u07B0\u07EB-\u07F3\u0816-\u0819\u081B-\u0823\u0825-\u0827\u0829-\u082D\u0859-\u085B\u08E4-\u0903\u093A-\u093C\u093E-\u094F\u0951-\u0957\u0962\u0963\u0981-\u0983\u09BC\u09BE-\u09C4\u09C7\u09C8\u09CB-\u09CD\u09D7\u09E2\u09E3\u0A01-\u0A03\u0A3C\u0A3E-\u0A42\u0A47\u0A48\u0A4B-\u0A4D\u0A51\u0A70\u0A71\u0A75\u0A81-\u0A83\u0ABC\u0ABE-\u0AC5\u0AC7-\u0AC9\u0ACB-\u0ACD\u0AE2\u0AE3\u0B01-\u0B03\u0B3C\u0B3E-\u0B44\u0B47\u0B48\u0B4B-\u0B4D\u0B56\u0B57\u0B62\u0B63\u0B82\u0BBE-\u0BC2\u0BC6-\u0BC8\u0BCA-\u0BCD\u0BD7\u0C00-\u0C03\u0C3E-\u0C44\u0C46-\u0C48\u0C4A-\u0C4D\u0C55\u0C56\u0C62\u0C63\u0C81-\u0C83\u0CBC\u0CBE-\u0CC4\u0CC6-\u0CC8\u0CCA-\u0CCD\u0CD5\u0CD6\u0CE2\u0CE3\u0D01-\u0D03\u0D3E-\u0D44\u0D46-\u0D48\u0D4A-\u0D4D\u0D57\u0D62\u0D63\u0D82\u0D83\u0DCA\u0DCF-\u0DD4\u0DD6\u0DD8-\u0DDF\u0DF2\u0DF3\u0E31\u0E34-\u0E3A\u0E47-\u0E4E\u0EB1\u0EB4-\u0EB9\u0EBB\u0EBC\u0EC8-\u0ECD\u0F18\u0F19\u0F35\u0F37\u0F39\u0F3E\u0F3F\u0F71-\u0F84\u0F86\u0F87\u0F8D-\u0F97\u0F99-\u0FBC\u0FC6\u102B-\u103E\u1056-\u1059\u105E-\u1060\u1062-\u1064\u1067-\u106D\u1071-\u1074\u1082-\u108D\u108F\u109A-\u109D\u135D-\u135F\u1712-\u1714\u1732-\u1734\u1752\u1753\u1772\u1773\u17B4-\u17D3\u17DD\u180B-\u180D\u18A9\u1920-\u192B\u1930-\u193B\u19B0-\u19C0\u19C8\u19C9\u1A17-\u1A1B\u1A55-\u1A5E\u1A60-\u1A7C\u1A7F\u1AB0-\u1ABE\u1B00-\u1B04\u1B34-\u1B44\u1B6B-\u1B73\u1B80-\u1B82\u1BA1-\u1BAD\u1BE6-\u1BF3\u1C24-\u1C37\u1CD0-\u1CD2\u1CD4-\u1CE8\u1CED\u1CF2-\u1CF4\u1CF8\u1CF9\u1DC0-\u1DF5\u1DFC-\u1DFF\u20D0-\u20F0\u2CEF-\u2CF1\u2D7F\u2DE0-\u2DFF\u302A-\u302F\u3099\u309A\uA66F-\uA672\uA674-\uA67D\uA69F\uA6F0\uA6F1\uA802\uA806\uA80B\uA823-\uA827\uA880\uA881\uA8B4-\uA8C4\uA8E0-\uA8F1\uA926-\uA92D\uA947-\uA953\uA980-\uA983\uA9B3-\uA9C0\uA9E5\uAA29-\uAA36\uAA43\uAA4C\uAA4D\uAA7B-\uAA7D\uAAB0\uAAB2-\uAAB4\uAAB7\uAAB8\uAABE\uAABF\uAAC1\uAAEB-\uAAEF\uAAF5\uAAF6\uABE3-\uABEA\uABEC\uABED\uFB1E\uFE00-\uFE0F\uFE20-\uFE2D]|\uD800[\uDDFD\uDEE0\uDF76-\uDF7A]|\uD802[\uDE01-\uDE03\uDE05\uDE06\uDE0C-\uDE0F\uDE38-\uDE3A\uDE3F\uDEE5\uDEE6]|\uD804[\uDC00-\uDC02\uDC38-\uDC46\uDC7F-\uDC82\uDCB0-\uDCBA\uDD00-\uDD02\uDD27-\uDD34\uDD73\uDD80-\uDD82\uDDB3-\uDDC0\uDE2C-\uDE37\uDEDF-\uDEEA\uDF01-\uDF03\uDF3C\uDF3E-\uDF44\uDF47\uDF48\uDF4B-\uDF4D\uDF57\uDF62\uDF63\uDF66-\uDF6C\uDF70-\uDF74]|\uD805[\uDCB0-\uDCC3\uDDAF-\uDDB5\uDDB8-\uDDC0\uDE30-\uDE40\uDEAB-\uDEB7]|\uD81A[\uDEF0-\uDEF4\uDF30-\uDF36]|\uD81B[\uDF51-\uDF7E\uDF8F-\uDF92]|\uD82F[\uDC9D\uDC9E]|\uD834[\uDD65-\uDD69\uDD6D-\uDD72\uDD7B-\uDD82\uDD85-\uDD8B\uDDAA-\uDDAD\uDE42-\uDE44]|\uD83A[\uDCD0-\uDCD6]|\uDB40[\uDD00-\uDDEF]/;function Ec(a,e){a.substr(0,4)==="xn--"&&(a=md.toUnicode(a),e=ya.NONTRANSITIONAL);var t=!1;(ud(a)!==a||a[3]==="-"&&a[4]==="-"||a[0]==="-"||a[a.length-1]==="-"||a.indexOf(".")!==-1||a.search(Pc)===0)&&(t=!0);for(var n=hd(a),s=0;s<n;++s){var o=gd(a.codePointAt(s));if(rs===ya.TRANSITIONAL&&o[1]!=="valid"||rs===ya.NONTRANSITIONAL&&o[1]!=="valid"&&o[1]!=="deviation"){t=!0;break}}return{label:a,error:t}}function rs(a,e,t){var n=Cc(a,e,t);n.string=ud(n.string);for(var s=n.string.split("."),o=0;o<s.length;++o)try{var i=Ec(s[o]);s[o]=i.label,n.error=n.error||i.error}catch{n.error=!0}return{string:s.join("."),error:n.error}}ds.exports.toASCII=function(a,e,t,n){var s=rs(a,e,t),o=s.string.split(".");if(o=o.map(function(d){try{return md.toASCII(d)}catch{return s.error=!0,d}}),n){var i=o.slice(0,o.length-1).join(".").length;(i.length>253||i.length===0)&&(s.error=!0);for(var r=0;r<o.length;++r)if(o.length>63||o.length===0){s.error=!0;break}}return s.error?null:o.join(".")};ds.exports.toUnicode=function(a,e){var t=rs(a,e,ya.NONTRANSITIONAL);return{domain:t.string,error:t.error}};ds.exports.PROCESSING_OPTIONS=ya});var Xe=re((f0,Ne)=>{"use strict";var wa=require("punycode"),vd=fd(),xd={ftp:21,file:null,gopher:70,http:80,https:443,ws:80,wss:443},B=Symbol("failure");function bd(a){return wa.ucs2.decode(a).length}function yd(a,e){let t=a[e];return isNaN(t)?void 0:String.fromCodePoint(t)}function Ja(a){return a>=48&&a<=57}function Za(a){return a>=65&&a<=90||a>=97&&a<=122}function Tc(a){return Za(a)||Ja(a)}function ze(a){return Ja(a)||a>=65&&a<=70||a>=97&&a<=102}function wd(a){return a==="."||a.toLowerCase()==="%2e"}function Nc(a){return a=a.toLowerCase(),a===".."||a==="%2e."||a===".%2e"||a==="%2e%2e"}function Ac(a,e){return Za(a)&&(e===58||e===124)}function kd(a){return a.length===2&&Za(a.codePointAt(0))&&(a[1]===":"||a[1]==="|")}function Ic(a){return a.length===2&&Za(a.codePointAt(0))&&a[1]===":"}function Bc(a){return a.search(/\u0000|\u0009|\u000A|\u000D|\u0020|#|%|\/|:|\?|@|\[|\\|\]/)!==-1}function Rc(a){return a.search(/\u0000|\u0009|\u000A|\u000D|\u0020|#|\/|:|\?|@|\[|\\|\]/)!==-1}function qo(a){return xd[a]!==void 0}function ie(a){return qo(a.scheme)}function Mc(a){return xd[a]}function _d(a){let e=a.toString(16).toUpperCase();return e.length===1&&(e="0"+e),"%"+e}function Dc(a){let e=new Buffer(a),t="";for(let n=0;n<e.length;++n)t+=_d(e[n]);return t}function Fc(a){let e=new Buffer(a),t=[];for(let n=0;n<e.length;++n)e[n]!==37?t.push(e[n]):e[n]===37&&ze(e[n+1])&&ze(e[n+2])?(t.push(parseInt(e.slice(n+1,n+3).toString(),16)),n+=2):t.push(e[n]);return new Buffer(t).toString()}function ps(a){return a<=31||a>126}var Lc=new Set([32,34,35,60,62,63,96,123,125]);function Sd(a){return ps(a)||Lc.has(a)}var $c=new Set([47,58,59,61,64,91,92,93,94,124]);function Ho(a){return Sd(a)||$c.has(a)}function Jt(a,e){let t=String.fromCodePoint(a);return e(a)?Dc(t):t}function Oc(a){let e=10;return a.length>=2&&a.charAt(0)==="0"&&a.charAt(1).toLowerCase()==="x"?(a=a.substring(2),e=16):a.length>=2&&a.charAt(0)==="0"&&(a=a.substring(1),e=8),a===""?0:(e===10?/[^0-9]/:e===16?/[^0-9A-Fa-f]/:/[^0-7]/).test(a)?B:parseInt(a,e)}function jc(a){let e=a.split(".");if(e[e.length-1]===""&&e.length>1&&e.pop(),e.length>4)return a;let t=[];for(let o of e){if(o==="")return a;let i=Oc(o);if(i===B)return a;t.push(i)}for(let o=0;o<t.length-1;++o)if(t[o]>255)return B;if(t[t.length-1]>=Math.pow(256,5-t.length))return B;let n=t.pop(),s=0;for(let o of t)n+=o*Math.pow(256,3-s),++s;return n}function zc(a){let e="",t=a;for(let n=1;n<=4;++n)e=String(t%256)+e,n!==4&&(e="."+e),t=Math.floor(t/256);return e}function Vc(a){let e=[0,0,0,0,0,0,0,0],t=0,n=null,s=0;if(a=wa.ucs2.decode(a),a[s]===58){if(a[s+1]!==58)return B;s+=2,++t,n=t}for(;s<a.length;){if(t===8)return B;if(a[s]===58){if(n!==null)return B;++s,++t,n=t;continue}let o=0,i=0;for(;i<4&&ze(a[s]);)o=o*16+parseInt(yd(a,s),16),++s,++i;if(a[s]===46){if(i===0||(s-=i,t>6))return B;let r=0;for(;a[s]!==void 0;){let d=null;if(r>0)if(a[s]===46&&r<4)++s;else return B;if(!Ja(a[s]))return B;for(;Ja(a[s]);){let p=parseInt(yd(a,s));if(d===null)d=p;else{if(d===0)return B;d=d*10+p}if(d>255)return B;++s}e[t]=e[t]*256+d,++r,(r===2||r===4)&&++t}if(r!==4)return B;break}else if(a[s]===58){if(++s,a[s]===void 0)return B}else if(a[s]!==void 0)return B;e[t]=o,++t}if(n!==null){let o=t-n;for(t=7;t!==0&&o>0;){let i=e[n+o-1];e[n+o-1]=e[t],e[t]=i,--t,--o}}else if(n===null&&t!==8)return B;return e}function qc(a){let e="",n=Hc(a).idx,s=!1;for(let o=0;o<=7;++o)if(!(s&&a[o]===0)){if(s&&(s=!1),n===o){e+=o===0?"::":":",s=!0;continue}e+=a[o].toString(16),o!==7&&(e+=":")}return e}function Uo(a,e){if(a[0]==="[")return a[a.length-1]!=="]"?B:Vc(a.substring(1,a.length-1));if(!e)return Uc(a);let t=Fc(a),n=vd.toASCII(t,!1,vd.PROCESSING_OPTIONS.NONTRANSITIONAL,!1);if(n===null||Bc(n))return B;let s=jc(n);return typeof s=="number"||s===B?s:n}function Uc(a){if(Rc(a))return B;let e="",t=wa.ucs2.decode(a);for(let n=0;n<t.length;++n)e+=Jt(t[n],ps);return e}function Hc(a){let e=null,t=1,n=null,s=0;for(let o=0;o<a.length;++o)a[o]!==0?(s>t&&(e=n,t=s),n=null,s=0):(n===null&&(n=o),++s);return s>t&&(e=n,t=s),{idx:e,len:t}}function Wo(a){return typeof a=="number"?zc(a):a instanceof Array?"["+qc(a)+"]":a}function Wc(a){return a.replace(/^[\u0000-\u001F\u0020]+|[\u0000-\u001F\u0020]+$/g,"")}function Gc(a){return a.replace(/\u0009|\u000A|\u000D/g,"")}function Cd(a){let e=a.path;e.length!==0&&(a.scheme==="file"&&e.length===1&&Xc(e[0])||e.pop())}function Pd(a){return a.username!==""||a.password!==""}function Yc(a){return a.host===null||a.host===""||a.cannotBeABaseURL||a.scheme==="file"}function Xc(a){return/^[A-Za-z]:$/.test(a)}function ee(a,e,t,n,s){if(this.pointer=0,this.input=a,this.base=e||null,this.encodingOverride=t||"utf-8",this.stateOverride=s,this.url=n,this.failure=!1,this.parseError=!1,!this.url){this.url={scheme:"",username:"",password:"",host:null,port:null,path:[],query:null,fragment:null,cannotBeABaseURL:!1};let i=Wc(this.input);i!==this.input&&(this.parseError=!0),this.input=i}let o=Gc(this.input);for(o!==this.input&&(this.parseError=!0),this.input=o,this.state=s||"scheme start",this.buffer="",this.atFlag=!1,this.arrFlag=!1,this.passwordTokenSeenFlag=!1,this.input=wa.ucs2.decode(this.input);this.pointer<=this.input.length;++this.pointer){let i=this.input[this.pointer],r=isNaN(i)?void 0:String.fromCodePoint(i),d=this["parse "+this.state](i,r);if(d){if(d===B){this.failure=!0;break}}else break}}ee.prototype["parse scheme start"]=function(e,t){if(Za(e))this.buffer+=t.toLowerCase(),this.state="scheme";else if(!this.stateOverride)this.state="no scheme",--this.pointer;else return this.parseError=!0,B;return!0};ee.prototype["parse scheme"]=function(e,t){if(Tc(e)||e===43||e===45||e===46)this.buffer+=t.toLowerCase();else if(e===58){if(this.stateOverride&&(ie(this.url)&&!qo(this.buffer)||!ie(this.url)&&qo(this.buffer)||(Pd(this.url)||this.url.port!==null)&&this.buffer==="file"||this.url.scheme==="file"&&(this.url.host===""||this.url.host===null))||(this.url.scheme=this.buffer,this.buffer="",this.stateOverride))return!1;this.url.scheme==="file"?((this.input[this.pointer+1]!==47||this.input[this.pointer+2]!==47)&&(this.parseError=!0),this.state="file"):ie(this.url)&&this.base!==null&&this.base.scheme===this.url.scheme?this.state="special relative or authority":ie(this.url)?this.state="special authority slashes":this.input[this.pointer+1]===47?(this.state="path or authority",++this.pointer):(this.url.cannotBeABaseURL=!0,this.url.path.push(""),this.state="cannot-be-a-base-URL path")}else if(!this.stateOverride)this.buffer="",this.state="no scheme",this.pointer=-1;else return this.parseError=!0,B;return!0};ee.prototype["parse no scheme"]=function(e){return this.base===null||this.base.cannotBeABaseURL&&e!==35?B:(this.base.cannotBeABaseURL&&e===35?(this.url.scheme=this.base.scheme,this.url.path=this.base.path.slice(),this.url.query=this.base.query,this.url.fragment="",this.url.cannotBeABaseURL=!0,this.state="fragment"):this.base.scheme==="file"?(this.state="file",--this.pointer):(this.state="relative",--this.pointer),!0)};ee.prototype["parse special relative or authority"]=function(e){return e===47&&this.input[this.pointer+1]===47?(this.state="special authority ignore slashes",++this.pointer):(this.parseError=!0,this.state="relative",--this.pointer),!0};ee.prototype["parse path or authority"]=function(e){return e===47?this.state="authority":(this.state="path",--this.pointer),!0};ee.prototype["parse relative"]=function(e){return this.url.scheme=this.base.scheme,isNaN(e)?(this.url.username=this.base.username,this.url.password=this.base.password,this.url.host=this.base.host,this.url.port=this.base.port,this.url.path=this.base.path.slice(),this.url.query=this.base.query):e===47?this.state="relative slash":e===63?(this.url.username=this.base.username,this.url.password=this.base.password,this.url.host=this.base.host,this.url.port=this.base.port,this.url.path=this.base.path.slice(),this.url.query="",this.state="query"):e===35?(this.url.username=this.base.username,this.url.password=this.base.password,this.url.host=this.base.host,this.url.port=this.base.port,this.url.path=this.base.path.slice(),this.url.query=this.base.query,this.url.fragment="",this.state="fragment"):ie(this.url)&&e===92?(this.parseError=!0,this.state="relative slash"):(this.url.username=this.base.username,this.url.password=this.base.password,this.url.host=this.base.host,this.url.port=this.base.port,this.url.path=this.base.path.slice(0,this.base.path.length-1),this.state="path",--this.pointer),!0};ee.prototype["parse relative slash"]=function(e){return ie(this.url)&&(e===47||e===92)?(e===92&&(this.parseError=!0),this.state="special authority ignore slashes"):e===47?this.state="authority":(this.url.username=this.base.username,this.url.password=this.base.password,this.url.host=this.base.host,this.url.port=this.base.port,this.state="path",--this.pointer),!0};ee.prototype["parse special authority slashes"]=function(e){return e===47&&this.input[this.pointer+1]===47?(this.state="special authority ignore slashes",++this.pointer):(this.parseError=!0,this.state="special authority ignore slashes",--this.pointer),!0};ee.prototype["parse special authority ignore slashes"]=function(e){return e!==47&&e!==92?(this.state="authority",--this.pointer):this.parseError=!0,!0};ee.prototype["parse authority"]=function(e,t){if(e===64){this.parseError=!0,this.atFlag&&(this.buffer="%40"+this.buffer),this.atFlag=!0;let n=bd(this.buffer);for(let s=0;s<n;++s){let o=this.buffer.codePointAt(s);if(o===58&&!this.passwordTokenSeenFlag){this.passwordTokenSeenFlag=!0;continue}let i=Jt(o,Ho);this.passwordTokenSeenFlag?this.url.password+=i:this.url.username+=i}this.buffer=""}else if(isNaN(e)||e===47||e===63||e===35||ie(this.url)&&e===92){if(this.atFlag&&this.buffer==="")return this.parseError=!0,B;this.pointer-=bd(this.buffer)+1,this.buffer="",this.state="host"}else this.buffer+=t;return!0};ee.prototype["parse hostname"]=ee.prototype["parse host"]=function(e,t){if(this.stateOverride&&this.url.scheme==="file")--this.pointer,this.state="file host";else if(e===58&&!this.arrFlag){if(this.buffer==="")return this.parseError=!0,B;let n=Uo(this.buffer,ie(this.url));if(n===B)return B;if(this.url.host=n,this.buffer="",this.state="port",this.stateOverride==="hostname")return!1}else if(isNaN(e)||e===47||e===63||e===35||ie(this.url)&&e===92){if(--this.pointer,ie(this.url)&&this.buffer==="")return this.parseError=!0,B;if(this.stateOverride&&this.buffer===""&&(Pd(this.url)||this.url.port!==null))return this.parseError=!0,!1;let n=Uo(this.buffer,ie(this.url));if(n===B)return B;if(this.url.host=n,this.buffer="",this.state="path start",this.stateOverride)return!1}else e===91?this.arrFlag=!0:e===93&&(this.arrFlag=!1),this.buffer+=t;return!0};ee.prototype["parse port"]=function(e,t){if(Ja(e))this.buffer+=t;else if(isNaN(e)||e===47||e===63||e===35||ie(this.url)&&e===92||this.stateOverride){if(this.buffer!==""){let n=parseInt(this.buffer);if(n>Math.pow(2,16)-1)return this.parseError=!0,B;this.url.port=n===Mc(this.url.scheme)?null:n,this.buffer=""}if(this.stateOverride)return!1;this.state="path start",--this.pointer}else return this.parseError=!0,B;return!0};var Kc=new Set([47,92,63,35]);ee.prototype["parse file"]=function(e){return this.url.scheme="file",e===47||e===92?(e===92&&(this.parseError=!0),this.state="file slash"):this.base!==null&&this.base.scheme==="file"?isNaN(e)?(this.url.host=this.base.host,this.url.path=this.base.path.slice(),this.url.query=this.base.query):e===63?(this.url.host=this.base.host,this.url.path=this.base.path.slice(),this.url.query="",this.state="query"):e===35?(this.url.host=this.base.host,this.url.path=this.base.path.slice(),this.url.query=this.base.query,this.url.fragment="",this.state="fragment"):(this.input.length-this.pointer-1===0||!Ac(e,this.input[this.pointer+1])||this.input.length-this.pointer-1>=2&&!Kc.has(this.input[this.pointer+2])?(this.url.host=this.base.host,this.url.path=this.base.path.slice(),Cd(this.url)):this.parseError=!0,this.state="path",--this.pointer):(this.state="path",--this.pointer),!0};ee.prototype["parse file slash"]=function(e){return e===47||e===92?(e===92&&(this.parseError=!0),this.state="file host"):(this.base!==null&&this.base.scheme==="file"&&(Ic(this.base.path[0])?this.url.path.push(this.base.path[0]):this.url.host=this.base.host),this.state="path",--this.pointer),!0};ee.prototype["parse file host"]=function(e,t){if(isNaN(e)||e===47||e===92||e===63||e===35)if(--this.pointer,!this.stateOverride&&kd(this.buffer))this.parseError=!0,this.state="path";else if(this.buffer===""){if(this.url.host="",this.stateOverride)return!1;this.state="path start"}else{let n=Uo(this.buffer,ie(this.url));if(n===B)return B;if(n==="localhost"&&(n=""),this.url.host=n,this.stateOverride)return!1;this.buffer="",this.state="path start"}else this.buffer+=t;return!0};ee.prototype["parse path start"]=function(e){return ie(this.url)?(e===92&&(this.parseError=!0),this.state="path",e!==47&&e!==92&&--this.pointer):!this.stateOverride&&e===63?(this.url.query="",this.state="query"):!this.stateOverride&&e===35?(this.url.fragment="",this.state="fragment"):e!==void 0&&(this.state="path",e!==47&&--this.pointer),!0};ee.prototype["parse path"]=function(e){if(isNaN(e)||e===47||ie(this.url)&&e===92||!this.stateOverride&&(e===63||e===35)){if(ie(this.url)&&e===92&&(this.parseError=!0),Nc(this.buffer)?(Cd(this.url),e!==47&&!(ie(this.url)&&e===92)&&this.url.path.push("")):wd(this.buffer)&&e!==47&&!(ie(this.url)&&e===92)?this.url.path.push(""):wd(this.buffer)||(this.url.scheme==="file"&&this.url.path.length===0&&kd(this.buffer)&&(this.url.host!==""&&this.url.host!==null&&(this.parseError=!0,this.url.host=""),this.buffer=this.buffer[0]+":"),this.url.path.push(this.buffer)),this.buffer="",this.url.scheme==="file"&&(e===void 0||e===63||e===35))for(;this.url.path.length>1&&this.url.path[0]==="";)this.parseError=!0,this.url.path.shift();e===63&&(this.url.query="",this.state="query"),e===35&&(this.url.fragment="",this.state="fragment")}else e===37&&(!ze(this.input[this.pointer+1])||!ze(this.input[this.pointer+2]))&&(this.parseError=!0),this.buffer+=Jt(e,Sd);return!0};ee.prototype["parse cannot-be-a-base-URL path"]=function(e){return e===63?(this.url.query="",this.state="query"):e===35?(this.url.fragment="",this.state="fragment"):(!isNaN(e)&&e!==37&&(this.parseError=!0),e===37&&(!ze(this.input[this.pointer+1])||!ze(this.input[this.pointer+2]))&&(this.parseError=!0),isNaN(e)||(this.url.path[0]=this.url.path[0]+Jt(e,ps))),!0};ee.prototype["parse query"]=function(e,t){if(isNaN(e)||!this.stateOverride&&e===35){(!ie(this.url)||this.url.scheme==="ws"||this.url.scheme==="wss")&&(this.encodingOverride="utf-8");let n=new Buffer(this.buffer);for(let s=0;s<n.length;++s)n[s]<33||n[s]>126||n[s]===34||n[s]===35||n[s]===60||n[s]===62?this.url.query+=_d(n[s]):this.url.query+=String.fromCodePoint(n[s]);this.buffer="",e===35&&(this.url.fragment="",this.state="fragment")}else e===37&&(!ze(this.input[this.pointer+1])||!ze(this.input[this.pointer+2]))&&(this.parseError=!0),this.buffer+=t;return!0};ee.prototype["parse fragment"]=function(e){return isNaN(e)||(e===0?this.parseError=!0:(e===37&&(!ze(this.input[this.pointer+1])||!ze(this.input[this.pointer+2]))&&(this.parseError=!0),this.url.fragment+=Jt(e,ps))),!0};function Jc(a,e){let t=a.scheme+":";if(a.host!==null?(t+="//",(a.username!==""||a.password!=="")&&(t+=a.username,a.password!==""&&(t+=":"+a.password),t+="@"),t+=Wo(a.host),a.port!==null&&(t+=":"+a.port)):a.host===null&&a.scheme==="file"&&(t+="//"),a.cannotBeABaseURL)t+=a.path[0];else for(let n of a.path)t+="/"+n;return a.query!==null&&(t+="?"+a.query),!e&&a.fragment!==null&&(t+="#"+a.fragment),t}function Zc(a){let e=a.scheme+"://";return e+=Wo(a.host),a.port!==null&&(e+=":"+a.port),e}Ne.exports.serializeURL=Jc;Ne.exports.serializeURLOrigin=function(a){switch(a.scheme){case"blob":try{return Ne.exports.serializeURLOrigin(Ne.exports.parseURL(a.path[0]))}catch{return"null"}case"ftp":case"gopher":case"http":case"https":case"ws":case"wss":return Zc({scheme:a.scheme,host:a.host,port:a.port});case"file":return"file://";default:return"null"}};Ne.exports.basicURLParse=function(a,e){e===void 0&&(e={});let t=new ee(a,e.baseURL,e.encodingOverride,e.url,e.stateOverride);return t.failure?"failure":t.url};Ne.exports.setTheUsername=function(a,e){a.username="";let t=wa.ucs2.decode(e);for(let n=0;n<t.length;++n)a.username+=Jt(t[n],Ho)};Ne.exports.setThePassword=function(a,e){a.password="";let t=wa.ucs2.decode(e);for(let n=0;n<t.length;++n)a.password+=Jt(t[n],Ho)};Ne.exports.serializeHost=Wo;Ne.exports.cannotHaveAUsernamePasswordPort=Yc;Ne.exports.serializeInteger=function(a){return String(a)};Ne.exports.parseURL=function(a,e){return e===void 0&&(e={}),Ne.exports.basicURLParse(a,{baseURL:e.baseURL,encodingOverride:e.encodingOverride})}});var Td=re(Ed=>{"use strict";var te=Xe();Ed.implementation=class{constructor(e){let t=e[0],n=e[1],s=null;if(n!==void 0&&(s=te.basicURLParse(n),s==="failure"))throw new TypeError("Invalid base URL");let o=te.basicURLParse(t,{baseURL:s});if(o==="failure")throw new TypeError("Invalid URL");this._url=o}get href(){return te.serializeURL(this._url)}set href(e){let t=te.basicURLParse(e);if(t==="failure")throw new TypeError("Invalid URL");this._url=t}get origin(){return te.serializeURLOrigin(this._url)}get protocol(){return this._url.scheme+":"}set protocol(e){te.basicURLParse(e+":",{url:this._url,stateOverride:"scheme start"})}get username(){return this._url.username}set username(e){te.cannotHaveAUsernamePasswordPort(this._url)||te.setTheUsername(this._url,e)}get password(){return this._url.password}set password(e){te.cannotHaveAUsernamePasswordPort(this._url)||te.setThePassword(this._url,e)}get host(){let e=this._url;return e.host===null?"":e.port===null?te.serializeHost(e.host):te.serializeHost(e.host)+":"+te.serializeInteger(e.port)}set host(e){this._url.cannotBeABaseURL||te.basicURLParse(e,{url:this._url,stateOverride:"host"})}get hostname(){return this._url.host===null?"":te.serializeHost(this._url.host)}set hostname(e){this._url.cannotBeABaseURL||te.basicURLParse(e,{url:this._url,stateOverride:"hostname"})}get port(){return this._url.port===null?"":te.serializeInteger(this._url.port)}set port(e){te.cannotHaveAUsernamePasswordPort(this._url)||(e===""?this._url.port=null:te.basicURLParse(e,{url:this._url,stateOverride:"port"}))}get pathname(){return this._url.cannotBeABaseURL?this._url.path[0]:this._url.path.length===0?"":"/"+this._url.path.join("/")}set pathname(e){this._url.cannotBeABaseURL||(this._url.path=[],te.basicURLParse(e,{url:this._url,stateOverride:"path start"}))}get search(){return this._url.query===null||this._url.query===""?"":"?"+this._url.query}set search(e){let t=this._url;if(e===""){t.query=null;return}let n=e[0]==="?"?e.substring(1):e;t.query="",te.basicURLParse(n,{url:t,stateOverride:"query"})}get hash(){return this._url.fragment===null||this._url.fragment===""?"":"#"+this._url.fragment}set hash(e){if(e===""){this._url.fragment=null;return}let t=e[0]==="#"?e.substring(1):e;this._url.fragment="",te.basicURLParse(t,{url:this._url,stateOverride:"fragment"})}toJSON(){return this.href}}});var Id=re((y0,Qa)=>{"use strict";var Be=dd(),Ad=pd(),Nd=Td(),G=Ad.implSymbol;function de(a){if(!this||this[G]||!(this instanceof de))throw new TypeError("Failed to construct 'URL': Please use the 'new' operator, this DOM object constructor cannot be called as a function.");if(arguments.length<1)throw new TypeError("Failed to construct 'URL': 1 argument required, but only "+arguments.length+" present.");let e=[];for(let t=0;t<arguments.length&&t<2;++t)e[t]=arguments[t];e[0]=Be.USVString(e[0]),e[1]!==void 0&&(e[1]=Be.USVString(e[1])),Qa.exports.setup(this,e)}de.prototype.toJSON=function(){if(!this||!Qa.exports.is(this))throw new TypeError("Illegal invocation");let e=[];for(let t=0;t<arguments.length&&t<0;++t)e[t]=arguments[t];return this[G].toJSON.apply(this[G],e)};Object.defineProperty(de.prototype,"href",{get(){return this[G].href},set(a){a=Be.USVString(a),this[G].href=a},enumerable:!0,configurable:!0});de.prototype.toString=function(){if(!this||!Qa.exports.is(this))throw new TypeError("Illegal invocation");return this.href};Object.defineProperty(de.prototype,"origin",{get(){return this[G].origin},enumerable:!0,configurable:!0});Object.defineProperty(de.prototype,"protocol",{get(){return this[G].protocol},set(a){a=Be.USVString(a),this[G].protocol=a},enumerable:!0,configurable:!0});Object.defineProperty(de.prototype,"username",{get(){return this[G].username},set(a){a=Be.USVString(a),this[G].username=a},enumerable:!0,configurable:!0});Object.defineProperty(de.prototype,"password",{get(){return this[G].password},set(a){a=Be.USVString(a),this[G].password=a},enumerable:!0,configurable:!0});Object.defineProperty(de.prototype,"host",{get(){return this[G].host},set(a){a=Be.USVString(a),this[G].host=a},enumerable:!0,configurable:!0});Object.defineProperty(de.prototype,"hostname",{get(){return this[G].hostname},set(a){a=Be.USVString(a),this[G].hostname=a},enumerable:!0,configurable:!0});Object.defineProperty(de.prototype,"port",{get(){return this[G].port},set(a){a=Be.USVString(a),this[G].port=a},enumerable:!0,configurable:!0});Object.defineProperty(de.prototype,"pathname",{get(){return this[G].pathname},set(a){a=Be.USVString(a),this[G].pathname=a},enumerable:!0,configurable:!0});Object.defineProperty(de.prototype,"search",{get(){return this[G].search},set(a){a=Be.USVString(a),this[G].search=a},enumerable:!0,configurable:!0});Object.defineProperty(de.prototype,"hash",{get(){return this[G].hash},set(a){a=Be.USVString(a),this[G].hash=a},enumerable:!0,configurable:!0});Qa.exports={is(a){return!!a&&a[G]instanceof Nd.implementation},create(a,e){let t=Object.create(de.prototype);return this.setup(t,a,e),t},setup(a,e,t){t||(t={}),t.wrapper=a,a[G]=new Nd.implementation(e,t),a[G][Ad.wrapperSymbol]=a},interface:de,expose:{Window:{URL:de},Worker:{URL:de}}}});var Bd=re(Ke=>{"use strict";Ke.URL=Id().interface;Ke.serializeURL=Xe().serializeURL;Ke.serializeURLOrigin=Xe().serializeURLOrigin;Ke.basicURLParse=Xe().basicURLParse;Ke.setTheUsername=Xe().setTheUsername;Ke.setThePassword=Xe().setThePassword;Ke.serializeHost=Xe().serializeHost;Ke.serializeInteger=Xe().serializeInteger;Ke.parseURL=Xe().parseURL});var Ud=re((qe,qd)=>{"use strict";Object.defineProperty(qe,"__esModule",{value:!0});function Sa(a){return a&&typeof a=="object"&&"default"in a?a.default:a}var Ve=Sa(require("stream")),Fd=Sa(require("http")),cs=Sa(require("url")),Ld=Sa(Bd()),Qc=Sa(require("https")),Zt=Sa(require("zlib")),em=Ve.Readable,rt=Symbol("buffer"),Go=Symbol("type"),tn=class a{constructor(){this[Go]="";let e=arguments[0],t=arguments[1],n=[],s=0;if(e){let i=e,r=Number(i.length);for(let d=0;d<r;d++){let p=i[d],l;p instanceof Buffer?l=p:ArrayBuffer.isView(p)?l=Buffer.from(p.buffer,p.byteOffset,p.byteLength):p instanceof ArrayBuffer?l=Buffer.from(p):p instanceof a?l=p[rt]:l=Buffer.from(typeof p=="string"?p:String(p)),s+=l.length,n.push(l)}}this[rt]=Buffer.concat(n);let o=t&&t.type!==void 0&&String(t.type).toLowerCase();o&&!/[^\u0020-\u007E]/.test(o)&&(this[Go]=o)}get size(){return this[rt].length}get type(){return this[Go]}text(){return Promise.resolve(this[rt].toString())}arrayBuffer(){let e=this[rt],t=e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength);return Promise.resolve(t)}stream(){let e=new em;return e._read=function(){},e.push(this[rt]),e.push(null),e}toString(){return"[object Blob]"}slice(){let e=this.size,t=arguments[0],n=arguments[1],s,o;t===void 0?s=0:t<0?s=Math.max(e+t,0):s=Math.min(t,e),n===void 0?o=e:n<0?o=Math.max(e+n,0):o=Math.min(n,e);let i=Math.max(o-s,0),d=this[rt].slice(s,s+i),p=new a([],{type:arguments[2]});return p[rt]=d,p}};Object.defineProperties(tn.prototype,{size:{enumerable:!0},type:{enumerable:!0},slice:{enumerable:!0}});Object.defineProperty(tn.prototype,Symbol.toStringTag,{value:"Blob",writable:!1,enumerable:!1,configurable:!0});function ge(a,e,t){Error.call(this,a),this.message=a,this.type=e,t&&(this.code=this.errno=t.code),Error.captureStackTrace(this,this.constructor)}ge.prototype=Object.create(Error.prototype);ge.prototype.constructor=ge;ge.prototype.name="FetchError";var Jo;try{Jo=require("encoding").convert}catch{}var pt=Symbol("Body internals"),Rd=Ve.PassThrough;function pe(a){var e=this,t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},n=t.size;let s=n===void 0?0:n;var o=t.timeout;let i=o===void 0?0:o;a==null?a=null:$d(a)?a=Buffer.from(a.toString()):nn(a)||Buffer.isBuffer(a)||(Object.prototype.toString.call(a)==="[object ArrayBuffer]"?a=Buffer.from(a):ArrayBuffer.isView(a)?a=Buffer.from(a.buffer,a.byteOffset,a.byteLength):a instanceof Ve||(a=Buffer.from(String(a)))),this[pt]={body:a,disturbed:!1,error:null},this.size=s,this.timeout=i,a instanceof Ve&&a.on("error",function(r){let d=r.name==="AbortError"?r:new ge(`Invalid response body while trying to fetch ${e.url}: ${r.message}`,"system",r);e[pt].error=d})}pe.prototype={get body(){return this[pt].body},get bodyUsed(){return this[pt].disturbed},arrayBuffer(){return xa.call(this).then(function(a){return a.buffer.slice(a.byteOffset,a.byteOffset+a.byteLength)})},blob(){let a=this.headers&&this.headers.get("content-type")||"";return xa.call(this).then(function(e){return Object.assign(new tn([],{type:a.toLowerCase()}),{[rt]:e})})},json(){var a=this;return xa.call(this).then(function(e){try{return JSON.parse(e.toString())}catch(t){return pe.Promise.reject(new ge(`invalid json response body at ${a.url} reason: ${t.message}`,"invalid-json"))}})},text(){return xa.call(this).then(function(a){return a.toString()})},buffer(){return xa.call(this)},textConverted(){var a=this;return xa.call(this).then(function(e){return tm(e,a.headers)})}};Object.defineProperties(pe.prototype,{body:{enumerable:!0},bodyUsed:{enumerable:!0},arrayBuffer:{enumerable:!0},blob:{enumerable:!0},json:{enumerable:!0},text:{enumerable:!0}});pe.mixIn=function(a){for(let e of Object.getOwnPropertyNames(pe.prototype))if(!(e in a)){let t=Object.getOwnPropertyDescriptor(pe.prototype,e);Object.defineProperty(a,e,t)}};function xa(){var a=this;if(this[pt].disturbed)return pe.Promise.reject(new TypeError(`body used already for: ${this.url}`));if(this[pt].disturbed=!0,this[pt].error)return pe.Promise.reject(this[pt].error);let e=this.body;if(e===null)return pe.Promise.resolve(Buffer.alloc(0));if(nn(e)&&(e=e.stream()),Buffer.isBuffer(e))return pe.Promise.resolve(e);if(!(e instanceof Ve))return pe.Promise.resolve(Buffer.alloc(0));let t=[],n=0,s=!1;return new pe.Promise(function(o,i){let r;a.timeout&&(r=setTimeout(function(){s=!0,i(new ge(`Response timeout while trying to fetch ${a.url} (over ${a.timeout}ms)`,"body-timeout"))},a.timeout)),e.on("error",function(d){d.name==="AbortError"?(s=!0,i(d)):i(new ge(`Invalid response body while trying to fetch ${a.url}: ${d.message}`,"system",d))}),e.on("data",function(d){if(!(s||d===null)){if(a.size&&n+d.length>a.size){s=!0,i(new ge(`content size at ${a.url} over limit: ${a.size}`,"max-size"));return}n+=d.length,t.push(d)}}),e.on("end",function(){if(!s){clearTimeout(r);try{o(Buffer.concat(t,n))}catch(d){i(new ge(`Could not create Buffer from response body for ${a.url}: ${d.message}`,"system",d))}}})})}function tm(a,e){if(typeof Jo!="function")throw new Error("The package `encoding` must be installed to use the textConverted() function");let t=e.get("content-type"),n="utf-8",s,o;return t&&(s=/charset=([^;]*)/i.exec(t)),o=a.slice(0,1024).toString(),!s&&o&&(s=/<meta.+?charset=(['"])(.+?)\1/i.exec(o)),!s&&o&&(s=/<meta[\s]+?http-equiv=(['"])content-type\1[\s]+?content=(['"])(.+?)\2/i.exec(o),s||(s=/<meta[\s]+?content=(['"])(.+?)\1[\s]+?http-equiv=(['"])content-type\3/i.exec(o),s&&s.pop()),s&&(s=/charset=(.*)/i.exec(s.pop()))),!s&&o&&(s=/<\?xml.+?encoding=(['"])(.+?)\1/i.exec(o)),s&&(n=s.pop(),(n==="gb2312"||n==="gbk")&&(n="gb18030")),Jo(a,"UTF-8",n).toString()}function $d(a){return typeof a!="object"||typeof a.append!="function"||typeof a.delete!="function"||typeof a.get!="function"||typeof a.getAll!="function"||typeof a.has!="function"||typeof a.set!="function"?!1:a.constructor.name==="URLSearchParams"||Object.prototype.toString.call(a)==="[object URLSearchParams]"||typeof a.sort=="function"}function nn(a){return typeof a=="object"&&typeof a.arrayBuffer=="function"&&typeof a.type=="string"&&typeof a.stream=="function"&&typeof a.constructor=="function"&&typeof a.constructor.name=="string"&&/^(Blob|File)$/.test(a.constructor.name)&&/^(Blob|File)$/.test(a[Symbol.toStringTag])}function Od(a){let e,t,n=a.body;if(a.bodyUsed)throw new Error("cannot clone body after it is used");return n instanceof Ve&&typeof n.getBoundary!="function"&&(e=new Rd,t=new Rd,n.pipe(e),n.pipe(t),a[pt].body=e,n=t),n}function jd(a){return a===null?null:typeof a=="string"?"text/plain;charset=UTF-8":$d(a)?"application/x-www-form-urlencoded;charset=UTF-8":nn(a)?a.type||null:Buffer.isBuffer(a)||Object.prototype.toString.call(a)==="[object ArrayBuffer]"||ArrayBuffer.isView(a)?null:typeof a.getBoundary=="function"?`multipart/form-data;boundary=${a.getBoundary()}`:a instanceof Ve?null:"text/plain;charset=UTF-8"}function zd(a){let e=a.body;return e===null?0:nn(e)?e.size:Buffer.isBuffer(e)?e.length:e&&typeof e.getLengthSync=="function"&&(e._lengthRetrievers&&e._lengthRetrievers.length==0||e.hasKnownLength&&e.hasKnownLength())?e.getLengthSync():null}function am(a,e){let t=e.body;t===null?a.end():nn(t)?t.stream().pipe(a):Buffer.isBuffer(t)?(a.write(t),a.end()):t.pipe(a)}pe.Promise=global.Promise;var Vd=/[^\^_`a-zA-Z\-0-9!#$%&'*+.|~]/,Zo=/[^\t\x20-\x7e\x80-\xff]/;function en(a){if(a=`${a}`,Vd.test(a)||a==="")throw new TypeError(`${a} is not a legal HTTP header name`)}function Md(a){if(a=`${a}`,Zo.test(a))throw new TypeError(`${a} is not a legal HTTP header value`)}function ka(a,e){e=e.toLowerCase();for(let t in a)if(t.toLowerCase()===e)return t}var ae=Symbol("map"),Me=class a{constructor(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:void 0;if(this[ae]=Object.create(null),e instanceof a){let t=e.raw(),n=Object.keys(t);for(let s of n)for(let o of t[s])this.append(s,o);return}if(e!=null)if(typeof e=="object"){let t=e[Symbol.iterator];if(t!=null){if(typeof t!="function")throw new TypeError("Header pairs must be iterable");let n=[];for(let s of e){if(typeof s!="object"||typeof s[Symbol.iterator]!="function")throw new TypeError("Each header pair must be iterable");n.push(Array.from(s))}for(let s of n){if(s.length!==2)throw new TypeError("Each header pair must be a name/value tuple");this.append(s[0],s[1])}}else for(let n of Object.keys(e)){let s=e[n];this.append(n,s)}}else throw new TypeError("Provided initializer must be an object")}get(e){e=`${e}`,en(e);let t=ka(this[ae],e);return t===void 0?null:this[ae][t].join(", ")}forEach(e){let t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:void 0,n=Qo(this),s=0;for(;s<n.length;){var o=n[s];let i=o[0],r=o[1];e.call(t,r,i,this),n=Qo(this),s++}}set(e,t){e=`${e}`,t=`${t}`,en(e),Md(t);let n=ka(this[ae],e);this[ae][n!==void 0?n:e]=[t]}append(e,t){e=`${e}`,t=`${t}`,en(e),Md(t);let n=ka(this[ae],e);n!==void 0?this[ae][n].push(t):this[ae][e]=[t]}has(e){return e=`${e}`,en(e),ka(this[ae],e)!==void 0}delete(e){e=`${e}`,en(e);let t=ka(this[ae],e);t!==void 0&&delete this[ae][t]}raw(){return this[ae]}keys(){return Yo(this,"key")}values(){return Yo(this,"value")}[Symbol.iterator](){return Yo(this,"key+value")}};Me.prototype.entries=Me.prototype[Symbol.iterator];Object.defineProperty(Me.prototype,Symbol.toStringTag,{value:"Headers",writable:!1,enumerable:!1,configurable:!0});Object.defineProperties(Me.prototype,{get:{enumerable:!0},forEach:{enumerable:!0},set:{enumerable:!0},append:{enumerable:!0},has:{enumerable:!0},delete:{enumerable:!0},keys:{enumerable:!0},values:{enumerable:!0},entries:{enumerable:!0}});function Qo(a){let e=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"key+value";return Object.keys(a[ae]).sort().map(e==="key"?function(n){return n.toLowerCase()}:e==="value"?function(n){return a[ae][n].join(", ")}:function(n){return[n.toLowerCase(),a[ae][n].join(", ")]})}var ei=Symbol("internal");function Yo(a,e){let t=Object.create(ti);return t[ei]={target:a,kind:e,index:0},t}var ti=Object.setPrototypeOf({next(){if(!this||Object.getPrototypeOf(this)!==ti)throw new TypeError("Value of `this` is not a HeadersIterator");var a=this[ei];let e=a.target,t=a.kind,n=a.index,s=Qo(e,t),o=s.length;return n>=o?{value:void 0,done:!0}:(this[ei].index=n+1,{value:s[n],done:!1})}},Object.getPrototypeOf(Object.getPrototypeOf([][Symbol.iterator]())));Object.defineProperty(ti,Symbol.toStringTag,{value:"HeadersIterator",writable:!1,enumerable:!1,configurable:!0});function nm(a){let e=Object.assign({__proto__:null},a[ae]),t=ka(a[ae],"Host");return t!==void 0&&(e[t]=e[t][0]),e}function sm(a){let e=new Me;for(let t of Object.keys(a))if(!Vd.test(t))if(Array.isArray(a[t]))for(let n of a[t])Zo.test(n)||(e[ae][t]===void 0?e[ae][t]=[n]:e[ae][t].push(n));else Zo.test(a[t])||(e[ae][t]=[a[t]]);return e}var At=Symbol("Response internals"),om=Fd.STATUS_CODES,Re=class a{constructor(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:null,t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};pe.call(this,e,t);let n=t.status||200,s=new Me(t.headers);if(e!=null&&!s.has("Content-Type")){let o=jd(e);o&&s.append("Content-Type",o)}this[At]={url:t.url,status:n,statusText:t.statusText||om[n],headers:s,counter:t.counter}}get url(){return this[At].url||""}get status(){return this[At].status}get ok(){return this[At].status>=200&&this[At].status<300}get redirected(){return this[At].counter>0}get statusText(){return this[At].statusText}get headers(){return this[At].headers}clone(){return new a(Od(this),{url:this.url,status:this.status,statusText:this.statusText,headers:this.headers,ok:this.ok,redirected:this.redirected})}};pe.mixIn(Re.prototype);Object.defineProperties(Re.prototype,{url:{enumerable:!0},status:{enumerable:!0},ok:{enumerable:!0},redirected:{enumerable:!0},statusText:{enumerable:!0},headers:{enumerable:!0},clone:{enumerable:!0}});Object.defineProperty(Re.prototype,Symbol.toStringTag,{value:"Response",writable:!1,enumerable:!1,configurable:!0});var dt=Symbol("Request internals"),im=cs.URL||Ld.URL,rm=cs.parse,dm=cs.format;function Xo(a){return/^[a-zA-Z][a-zA-Z\d+\-.]*:/.exec(a)&&(a=new im(a).toString()),rm(a)}var pm="destroy"in Ve.Readable.prototype;function ls(a){return typeof a=="object"&&typeof a[dt]=="object"}function lm(a){let e=a&&typeof a=="object"&&Object.getPrototypeOf(a);return!!(e&&e.constructor.name==="AbortSignal")}var Bt=class a{constructor(e){let t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},n;ls(e)?n=Xo(e.url):(e&&e.href?n=Xo(e.href):n=Xo(`${e}`),e={});let s=t.method||e.method||"GET";if(s=s.toUpperCase(),(t.body!=null||ls(e)&&e.body!==null)&&(s==="GET"||s==="HEAD"))throw new TypeError("Request with GET/HEAD method cannot have body");let o=t.body!=null?t.body:ls(e)&&e.body!==null?Od(e):null;pe.call(this,o,{timeout:t.timeout||e.timeout||0,size:t.size||e.size||0});let i=new Me(t.headers||e.headers||{});if(o!=null&&!i.has("Content-Type")){let d=jd(o);d&&i.append("Content-Type",d)}let r=ls(e)?e.signal:null;if("signal"in t&&(r=t.signal),r!=null&&!lm(r))throw new TypeError("Expected signal to be an instanceof AbortSignal");this[dt]={method:s,redirect:t.redirect||e.redirect||"follow",headers:i,parsedURL:n,signal:r},this.follow=t.follow!==void 0?t.follow:e.follow!==void 0?e.follow:20,this.compress=t.compress!==void 0?t.compress:e.compress!==void 0?e.compress:!0,this.counter=t.counter||e.counter||0,this.agent=t.agent||e.agent}get method(){return this[dt].method}get url(){return dm(this[dt].parsedURL)}get headers(){return this[dt].headers}get redirect(){return this[dt].redirect}get signal(){return this[dt].signal}clone(){return new a(this)}};pe.mixIn(Bt.prototype);Object.defineProperty(Bt.prototype,Symbol.toStringTag,{value:"Request",writable:!1,enumerable:!1,configurable:!0});Object.defineProperties(Bt.prototype,{method:{enumerable:!0},url:{enumerable:!0},headers:{enumerable:!0},redirect:{enumerable:!0},clone:{enumerable:!0},signal:{enumerable:!0}});function cm(a){let e=a[dt].parsedURL,t=new Me(a[dt].headers);if(t.has("Accept")||t.set("Accept","*/*"),!e.protocol||!e.hostname)throw new TypeError("Only absolute URLs are supported");if(!/^https?:$/.test(e.protocol))throw new TypeError("Only HTTP(S) protocols are supported");if(a.signal&&a.body instanceof Ve.Readable&&!pm)throw new Error("Cancellation of streamed requests with AbortSignal is not supported in node < 8");let n=null;if(a.body==null&&/^(POST|PUT)$/i.test(a.method)&&(n="0"),a.body!=null){let o=zd(a);typeof o=="number"&&(n=String(o))}n&&t.set("Content-Length",n),t.has("User-Agent")||t.set("User-Agent","node-fetch/1.0 (+https://github.com/bitinn/node-fetch)"),a.compress&&!t.has("Accept-Encoding")&&t.set("Accept-Encoding","gzip,deflate");let s=a.agent;return typeof s=="function"&&(s=s(e)),Object.assign({},e,{method:a.method,headers:nm(t),agent:s})}function _a(a){Error.call(this,a),this.type="aborted",this.message=a,Error.captureStackTrace(this,this.constructor)}_a.prototype=Object.create(Error.prototype);_a.prototype.constructor=_a;_a.prototype.name="AbortError";var an=cs.URL||Ld.URL,Dd=Ve.PassThrough,mm=function(e,t){let n=new an(t).hostname,s=new an(e).hostname;return n===s||n[n.length-s.length-1]==="."&&n.endsWith(s)},um=function(e,t){let n=new an(t).protocol,s=new an(e).protocol;return n===s};function It(a,e){if(!It.Promise)throw new Error("native promise missing, set fetch.Promise to your favorite alternative");return pe.Promise=It.Promise,new It.Promise(function(t,n){let s=new Bt(a,e),o=cm(s),i=(o.protocol==="https:"?Qc:Fd).request,r=s.signal,d=null,p=function(){let k=new _a("The user aborted a request.");n(k),s.body&&s.body instanceof Ve.Readable&&Ko(s.body,k),!(!d||!d.body)&&d.body.emit("error",k)};if(r&&r.aborted){p();return}let l=function(){p(),u()},c=i(o),m;r&&r.addEventListener("abort",l);function u(){c.abort(),r&&r.removeEventListener("abort",l),clearTimeout(m)}s.timeout&&c.once("socket",function(g){m=setTimeout(function(){n(new ge(`network timeout at: ${s.url}`,"request-timeout")),u()},s.timeout)}),c.on("error",function(g){n(new ge(`request to ${s.url} failed, reason: ${g.message}`,"system",g)),d&&d.body&&Ko(d.body,g),u()}),gm(c,function(g){r&&r.aborted||d&&d.body&&Ko(d.body,g)}),parseInt(process.version.substring(1))<14&&c.on("socket",function(g){g.addListener("close",function(k){let f=g.listenerCount("data")>0;if(d&&f&&!k&&!(r&&r.aborted)){let h=new Error("Premature close");h.code="ERR_STREAM_PREMATURE_CLOSE",d.body.emit("error",h)}})}),c.on("response",function(g){clearTimeout(m);let k=sm(g.headers);if(It.isRedirect(g.statusCode)){let x=k.get("Location"),F=null;try{F=x===null?null:new an(x,s.url).toString()}catch{if(s.redirect!=="manual"){n(new ge(`uri requested responds with an invalid redirect URL: ${x}`,"invalid-redirect")),u();return}}switch(s.redirect){case"error":n(new ge(`uri requested responds with a redirect, redirect mode is set to error: ${s.url}`,"no-redirect")),u();return;case"manual":if(F!==null)try{k.set("Location",F)}catch(me){n(me)}break;case"follow":if(F===null)break;if(s.counter>=s.follow){n(new ge(`maximum redirect reached at: ${s.url}`,"max-redirect")),u();return}let U={headers:new Me(s.headers),follow:s.follow,counter:s.counter+1,agent:s.agent,compress:s.compress,method:s.method,body:s.body,signal:s.signal,timeout:s.timeout,size:s.size};if(!mm(s.url,F)||!um(s.url,F))for(let me of["authorization","www-authenticate","cookie","cookie2"])U.headers.delete(me);if(g.statusCode!==303&&s.body&&zd(s)===null){n(new ge("Cannot follow redirect with body being a readable stream","unsupported-redirect")),u();return}(g.statusCode===303||(g.statusCode===301||g.statusCode===302)&&s.method==="POST")&&(U.method="GET",U.body=void 0,U.headers.delete("content-length")),t(It(new Bt(F,U))),u();return}}g.once("end",function(){r&&r.removeEventListener("abort",l)});let f=g.pipe(new Dd),h={url:s.url,status:g.statusCode,statusText:g.statusMessage,headers:k,size:s.size,timeout:s.timeout,counter:s.counter},b=k.get("Content-Encoding");if(!s.compress||s.method==="HEAD"||b===null||g.statusCode===204||g.statusCode===304){d=new Re(f,h),t(d);return}let E={flush:Zt.Z_SYNC_FLUSH,finishFlush:Zt.Z_SYNC_FLUSH};if(b=="gzip"||b=="x-gzip"){f=f.pipe(Zt.createGunzip(E)),d=new Re(f,h),t(d);return}if(b=="deflate"||b=="x-deflate"){let x=g.pipe(new Dd);x.once("data",function(F){(F[0]&15)===8?f=f.pipe(Zt.createInflate()):f=f.pipe(Zt.createInflateRaw()),d=new Re(f,h),t(d)}),x.on("end",function(){d||(d=new Re(f,h),t(d))});return}if(b=="br"&&typeof Zt.createBrotliDecompress=="function"){f=f.pipe(Zt.createBrotliDecompress()),d=new Re(f,h),t(d);return}d=new Re(f,h),t(d)}),am(c,s)})}function gm(a,e){let t;a.on("socket",function(n){t=n}),a.on("response",function(n){let s=n.headers;s["transfer-encoding"]==="chunked"&&!s["content-length"]&&n.once("close",function(o){if(t&&t.listenerCount("data")>0&&!o){let r=new Error("Premature close");r.code="ERR_STREAM_PREMATURE_CLOSE",e(r)}})})}function Ko(a,e){a.destroy?a.destroy(e):(a.emit("error",e),a.end())}It.isRedirect=function(a){return a===301||a===302||a===303||a===307||a===308};It.Promise=global.Promise;qd.exports=qe=It;Object.defineProperty(qe,"__esModule",{value:!0});qe.default=qe;qe.Headers=Me;qe.Request=Bt;qe.Response=Re;qe.FetchError=ge;qe.AbortError=_a});function hp(){}function ve(a){return typeof a=="object"&&a!==null||typeof a=="function"}function O(a,e){try{Object.defineProperty(a,"name",{value:e,configurable:!0})}catch{}}function xe(a){return new gi(a)}function V(a){return fm(a)}function P(a){return vm(a)}function ft(a,e,t){return hm.call(a,e,t)}function fe(a,e,t){ft(ft(a,e,t),void 0,fp)}function Hd(a,e){fe(a,e)}function Wd(a,e){fe(a,void 0,e)}function Ue(a,e,t){return ft(a,e,t)}function Ta(a){ft(a,void 0,fp)}function Ms(a,e,t){if(typeof a!="function")throw new TypeError("Argument is not a function");return Function.prototype.apply.call(a,e,t)}function oa(a,e,t){try{return V(Ms(a,e,t))}catch(n){return P(n)}}function yp(a,e){a._ownerReadableStream=e,e._reader=a,e._state==="readable"?ri(a):e._state==="closed"?(function(t){ri(t),_p(t)})(a):kp(a,e._storedError)}function wp(a,e){return Qp(a._ownerReadableStream,e)}function xp(a){let e=a._ownerReadableStream;e._state==="readable"?bi(a,new TypeError("Reader was released and can no longer be used to monitor the stream's closedness")):(function(t,n){kp(t,n)})(a,new TypeError("Reader was released and can no longer be used to monitor the stream's closedness")),e._readableStreamController[vi](),e._reader=void 0,a._ownerReadableStream=void 0}function Na(a){return new TypeError("Cannot "+a+" a stream using a released reader")}function ri(a){a._closedPromise=xe(((e,t)=>{a._closedPromise_resolve=e,a._closedPromise_reject=t}))}function kp(a,e){ri(a),bi(a,e)}function bi(a,e){a._closedPromise_reject!==void 0&&(Ta(a._closedPromise),a._closedPromise_reject(e),a._closedPromise_resolve=void 0,a._closedPromise_reject=void 0)}function _p(a){a._closedPromise_resolve!==void 0&&(a._closedPromise_resolve(void 0),a._closedPromise_resolve=void 0,a._closedPromise_reject=void 0)}function vt(a,e){if(a!==void 0&&typeof(t=a)!="object"&&typeof t!="function")throw new TypeError(`${e} is not an object.`);var t}function He(a,e){if(typeof a!="function")throw new TypeError(`${e} is not a function.`)}function Sp(a,e){if(!(function(t){return typeof t=="object"&&t!==null||typeof t=="function"})(a))throw new TypeError(`${e} is not an object.`)}function bt(a,e,t){if(a===void 0)throw new TypeError(`Parameter ${e} is required in '${t}'.`)}function di(a,e,t){if(a===void 0)throw new TypeError(`${e} is required in '${t}'.`)}function yi(a){return Number(a)}function Yd(a){return a===0?0:a}function Cp(a,e){let t=Number.MAX_SAFE_INTEGER,n=Number(a);if(n=Yd(n),!Gd(n))throw new TypeError(`${e} is not a finite number`);if(n=(function(s){return Yd(bm(s))})(n),n<0||n>t)throw new TypeError(`${e} is outside the accepted range of 0 to ${t}, inclusive`);return Gd(n)&&n!==0?n:0}function rn(a){if(!ve(a)||typeof a.getReader!="function")return!1;try{return typeof a.locked=="boolean"}catch{return!1}}function Pp(a){if(!ve(a)||typeof a.getWriter!="function")return!1;try{return typeof a.locked=="boolean"}catch{return!1}}function Ep(a,e){if(!na(a))throw new TypeError(`${e} is not a ReadableStream.`)}function Tp(a,e){a._reader._readRequests.push(e)}function wi(a,e,t){let n=a._reader._readRequests.shift();t?n._closeSteps():n._chunkSteps(e)}function Ds(a){return a._reader._readRequests.length}function Np(a){let e=a._reader;return e!==void 0&&!!aa(e)}function aa(a){return!!ve(a)&&!!Object.prototype.hasOwnProperty.call(a,"_readRequests")&&a instanceof lt}function Ap(a,e){let t=a._readRequests;a._readRequests=new Se,t.forEach((n=>{n._errorSteps(e)}))}function ms(a){return new TypeError(`ReadableStreamDefaultReader.prototype.${a} can only be used on a ReadableStreamDefaultReader`)}function Xd(a){if(!ve(a)||!Object.prototype.hasOwnProperty.call(a,"_asyncIteratorImpl"))return!1;try{return a._asyncIteratorImpl instanceof Cs}catch{return!1}}function Kd(a){return new TypeError(`ReadableStreamAsyncIterator.${a} can only be used on a ReadableSteamAsyncIterator`)}function Rp(a,e,t,n,s){new Uint8Array(a).set(new Uint8Array(t,n,s),e)}function Jd(a){let e=(function(t,n,s){if(t.slice)return t.slice(n,s);let o=s-n,i=new ArrayBuffer(o);return Rp(i,0,t,n,o),i})(a.buffer,a.byteOffset,a.byteOffset+a.byteLength);return new Uint8Array(e)}function pi(a){let e=a._queue.shift();return a._queueTotalSize-=e.size,a._queueTotalSize<0&&(a._queueTotalSize=0),e.value}function xi(a,e,t){if(typeof(n=t)!="number"||Bp(n)||n<0||t===1/0)throw new RangeError("Size must be a finite, non-NaN, non-negative number.");var n;a._queue.push({value:e,size:t}),a._queueTotalSize+=t}function Dt(a){a._queue=new Se,a._queueTotalSize=0}function Ca(a){return!!ve(a)&&!!Object.prototype.hasOwnProperty.call(a,"_controlledReadableByteStream")&&a instanceof ct}function ai(a){return!!ve(a)&&!!Object.prototype.hasOwnProperty.call(a,"_associatedReadableByteStreamController")&&a instanceof Rt}function sa(a){if((function(t){let n=t._controlledReadableByteStream;return n._state!=="readable"||t._closeRequested||!t._started?!1:!!(Np(n)&&Ds(n)>0||_i(n)&&Vp(n)>0||zp(t)>0)})(a)){if(a._pulling)return void(a._pullAgain=!0);a._pulling=!0,fe(a._pullAlgorithm(),(()=>(a._pulling=!1,a._pullAgain&&(a._pullAgain=!1,sa(a)),null)),(t=>(Aa(a,t),null)))}}function Mp(a){ki(a),a._pendingPullIntos=new Se}function li(a,e){let t=!1;a._state==="closed"&&(t=!0);let n=Dp(e);e.readerType==="default"?wi(a,n,t):(function(s,o,i){let r=s._reader._readIntoRequests.shift();i?r._closeSteps(o):r._chunkSteps(o)})(a,n,t)}function Dp(a){let e=a.bytesFilled,t=a.elementSize;return new a.viewConstructor(a.buffer,a.byteOffset,e/t)}function xs(a,e,t,n){a._queue.push({buffer:e,byteOffset:t,byteLength:n}),a._queueTotalSize+=n}function Fp(a,e,t,n){let s;try{s=e.slice(t,t+n)}catch(o){throw Aa(a,o),o}xs(a,s,0,n)}function Lp(a,e){e.bytesFilled>0&&Fp(a,e.buffer,e.byteOffset,e.bytesFilled),Ea(a)}function $p(a,e){let t=e.elementSize,n=e.bytesFilled-e.bytesFilled%t,s=Math.min(a._queueTotalSize,e.byteLength-e.bytesFilled),o=e.bytesFilled+s,i=o-o%t,r=s,d=!1;i>n&&(r=i-e.bytesFilled,d=!0);let p=a._queue;for(;r>0;){let l=p.peek(),c=Math.min(r,l.byteLength),m=e.byteOffset+e.bytesFilled;Rp(e.buffer,m,l.buffer,l.byteOffset,c),l.byteLength===c?p.shift():(l.byteOffset+=c,l.byteLength-=c),a._queueTotalSize-=c,Op(a,c,e),r-=c}return d}function Op(a,e,t){t.bytesFilled+=e}function jp(a){a._queueTotalSize===0&&a._closeRequested?(Ps(a),mn(a._controlledReadableByteStream)):sa(a)}function ki(a){a._byobRequest!==null&&(a._byobRequest._associatedReadableByteStreamController=void 0,a._byobRequest._view=null,a._byobRequest=null)}function ci(a){for(;a._pendingPullIntos.length>0;){if(a._queueTotalSize===0)return;let e=a._pendingPullIntos.peek();$p(a,e)&&(Ea(a),li(a._controlledReadableByteStream,e))}}function Zd(a,e){let t=a._pendingPullIntos.peek();ki(a),a._controlledReadableByteStream._state==="closed"?(function(n,s){s.readerType==="none"&&Ea(n);let o=n._controlledReadableByteStream;if(_i(o))for(;Vp(o)>0;)li(o,Ea(n))})(a,t):(function(n,s,o){if(Op(0,s,o),o.readerType==="none")return Lp(n,o),void ci(n);if(o.bytesFilled<o.elementSize)return;Ea(n);let i=o.bytesFilled%o.elementSize;if(i>0){let r=o.byteOffset+o.bytesFilled;Fp(n,o.buffer,r-i,i)}o.bytesFilled-=i,li(n._controlledReadableByteStream,o),ci(n)})(a,e,t),sa(a)}function Ea(a){return a._pendingPullIntos.shift()}function Ps(a){a._pullAlgorithm=void 0,a._cancelAlgorithm=void 0}function Aa(a,e){let t=a._controlledReadableByteStream;t._state==="readable"&&(Mp(a),Dt(a),Ps(a),e1(t,e))}function Qd(a,e){let t=a._queue.shift();a._queueTotalSize-=t.byteLength,jp(a);let n=new Uint8Array(t.buffer,t.byteOffset,t.byteLength);e._chunkSteps(n)}function zp(a){let e=a._controlledReadableByteStream._state;return e==="errored"?null:e==="closed"?0:a._strategyHWM-a._queueTotalSize}function ym(a,e,t){let n=Object.create(ct.prototype),s,o,i;s=e.start!==void 0?()=>e.start(n):()=>{},o=e.pull!==void 0?()=>e.pull(n):()=>V(void 0),i=e.cancel!==void 0?d=>e.cancel(d):()=>V(void 0);let r=e.autoAllocateChunkSize;if(r===0)throw new TypeError("autoAllocateChunkSize must be greater than 0");(function(d,p,l,c,m,u,g){p._controlledReadableByteStream=d,p._pullAgain=!1,p._pulling=!1,p._byobRequest=null,p._queue=p._queueTotalSize=void 0,Dt(p),p._closeRequested=!1,p._started=!1,p._strategyHWM=u,p._pullAlgorithm=c,p._cancelAlgorithm=m,p._autoAllocateChunkSize=g,p._pendingPullIntos=new Se,d._readableStreamController=p,fe(V(l()),(()=>(p._started=!0,sa(p),null)),(k=>(Aa(p,k),null)))})(a,n,s,o,i,t,r)}function ni(a){return new TypeError(`ReadableStreamBYOBRequest.prototype.${a} can only be used on a ReadableStreamBYOBRequest`)}function sn(a){return new TypeError(`ReadableByteStreamController.prototype.${a} can only be used on a ReadableByteStreamController`)}function ep(a,e){a._reader._readIntoRequests.push(e)}function Vp(a){return a._reader._readIntoRequests.length}function _i(a){let e=a._reader;return e!==void 0&&!!Pa(e)}function Pa(a){return!!ve(a)&&!!Object.prototype.hasOwnProperty.call(a,"_readIntoRequests")&&a instanceof mt}function qp(a,e){let t=a._readIntoRequests;a._readIntoRequests=new Se,t.forEach((n=>{n._errorSteps(e)}))}function us(a){return new TypeError(`ReadableStreamBYOBReader.prototype.${a} can only be used on a ReadableStreamBYOBReader`)}function cn(a,e){let{highWaterMark:t}=a;if(t===void 0)return e;if(Bp(t)||t<0)throw new RangeError("Invalid highWaterMark");return t}function Es(a){let{size:e}=a;return e||(()=>1)}function Ts(a,e){vt(a,e);let t=a?.highWaterMark,n=a?.size;return{highWaterMark:t===void 0?void 0:yi(t),size:n===void 0?void 0:wm(n,`${e} has member 'size' that`)}}function wm(a,e){return He(a,e),t=>yi(a(t))}function xm(a,e,t){return He(a,t),n=>oa(a,e,[n])}function km(a,e,t){return He(a,t),()=>oa(a,e,[])}function _m(a,e,t){return He(a,t),n=>Ms(a,e,[n])}function Sm(a,e,t){return He(a,t),(n,s)=>oa(a,e,[n,s])}function Ze(a){return!!ve(a)&&!!Object.prototype.hasOwnProperty.call(a,"_writableStreamController")&&a instanceof ut}function ks(a){return a._writer!==void 0}function Up(a,e){var t;if(a._state==="closed"||a._state==="errored")return V(void 0);a._writableStreamController._abortReason=e,(t=a._writableStreamController._abortController)===null||t===void 0||t.abort(e);let n=a._state;if(n==="closed"||n==="errored")return V(void 0);if(a._pendingAbortRequest!==void 0)return a._pendingAbortRequest._promise;let s=!1;n==="erroring"&&(s=!0,e=void 0);let o=xe(((i,r)=>{a._pendingAbortRequest={_promise:void 0,_resolve:i,_reject:r,_reason:e,_wasAlreadyErroring:s}}));return a._pendingAbortRequest._promise=o,s||Si(a,e),o}function Hp(a){let e=a._state;if(e==="closed"||e==="errored")return P(new TypeError(`The stream (in ${e} state) is not in the writable state and cannot be closed`));let t=xe(((o,i)=>{let r={_resolve:o,_reject:i};a._closeRequest=r})),n=a._writer;var s;return n!==void 0&&a._backpressure&&e==="writable"&&Ni(n),xi(s=a._writableStreamController,Gp,0),Fs(s),t}function mi(a,e){a._state!=="writable"?Ci(a):Si(a,e)}function Si(a,e){let t=a._writableStreamController;a._state="erroring",a._storedError=e;let n=a._writer;n!==void 0&&Wp(n,e),!(function(s){return!(s._inFlightWriteRequest===void 0&&s._inFlightCloseRequest===void 0)})(a)&&t._started&&Ci(a)}function Ci(a){a._state="errored",a._writableStreamController[bp]();let e=a._storedError;if(a._writeRequests.forEach((n=>{n._reject(e)})),a._writeRequests=new Se,a._pendingAbortRequest===void 0)return void gs(a);let t=a._pendingAbortRequest;if(a._pendingAbortRequest=void 0,t._wasAlreadyErroring)return t._reject(e),void gs(a);fe(a._writableStreamController[vp](t._reason),(()=>(t._resolve(),gs(a),null)),(n=>(t._reject(n),gs(a),null)))}function Mt(a){return a._closeRequest!==void 0||a._inFlightCloseRequest!==void 0}function gs(a){a._closeRequest!==void 0&&(a._closeRequest._reject(a._storedError),a._closeRequest=void 0);let e=a._writer;e!==void 0&&Ti(e,a._storedError)}function Pi(a,e){let t=a._writer;t!==void 0&&e!==a._backpressure&&(e?(function(n){Ls(n)})(t):Ni(t)),a._backpressure=e}function Qt(a){return!!ve(a)&&!!Object.prototype.hasOwnProperty.call(a,"_ownerWritableStream")&&a instanceof Je}function Wp(a,e){a._readyPromiseState==="pending"?Jp(a,e):(function(t,n){ui(t,n)})(a,e)}function si(a){return!!ve(a)&&!!Object.prototype.hasOwnProperty.call(a,"_controlledWritableStream")&&a instanceof Ia}function Ns(a){a._writeAlgorithm=void 0,a._closeAlgorithm=void 0,a._abortAlgorithm=void 0,a._strategySizeAlgorithm=void 0}function Yp(a){return a._strategyHWM-a._queueTotalSize}function Fs(a){let e=a._controlledWritableStream;if(!a._started||e._inFlightWriteRequest!==void 0)return;if(e._state==="erroring")return void Ci(e);if(a._queue.length===0)return;let t=a._queue.peek().value;t===Gp?(function(n){let s=n._controlledWritableStream;(function(i){i._inFlightCloseRequest=i._closeRequest,i._closeRequest=void 0})(s),pi(n);let o=n._closeAlgorithm();Ns(n),fe(o,(()=>((function(i){i._inFlightCloseRequest._resolve(void 0),i._inFlightCloseRequest=void 0,i._state==="erroring"&&(i._storedError=void 0,i._pendingAbortRequest!==void 0&&(i._pendingAbortRequest._resolve(),i._pendingAbortRequest=void 0)),i._state="closed";let r=i._writer;r!==void 0&&Kp(r)})(s),null)),(i=>((function(r,d){r._inFlightCloseRequest._reject(d),r._inFlightCloseRequest=void 0,r._pendingAbortRequest!==void 0&&(r._pendingAbortRequest._reject(d),r._pendingAbortRequest=void 0),mi(r,d)})(s,i),null)))})(a):(function(n,s){let o=n._controlledWritableStream;(function(i){i._inFlightWriteRequest=i._writeRequests.shift()})(o),fe(n._writeAlgorithm(s),(()=>{(function(r){r._inFlightWriteRequest._resolve(void 0),r._inFlightWriteRequest=void 0})(o);let i=o._state;if(pi(n),!Mt(o)&&i==="writable"){let r=Ei(n);Pi(o,r)}return Fs(n),null}),(i=>(o._state==="writable"&&Ns(n),(function(r,d){r._inFlightWriteRequest._reject(d),r._inFlightWriteRequest=void 0,mi(r,d)})(o,i),null)))})(a,t)}function tp(a,e){a._controlledWritableStream._state==="writable"&&Xp(a,e)}function Ei(a){return Yp(a)<=0}function Xp(a,e){let t=a._controlledWritableStream;Ns(a),Si(t,e)}function hs(a){return new TypeError(`WritableStream.prototype.${a} can only be used on a WritableStream`)}function oi(a){return new TypeError(`WritableStreamDefaultController.prototype.${a} can only be used on a WritableStreamDefaultController`)}function ea(a){return new TypeError(`WritableStreamDefaultWriter.prototype.${a} can only be used on a WritableStreamDefaultWriter`)}function on(a){return new TypeError("Cannot "+a+" a stream using a released writer")}function _s(a){a._closedPromise=xe(((e,t)=>{a._closedPromise_resolve=e,a._closedPromise_reject=t,a._closedPromiseState="pending"}))}function ap(a,e){_s(a),Ti(a,e)}function Ti(a,e){a._closedPromise_reject!==void 0&&(Ta(a._closedPromise),a._closedPromise_reject(e),a._closedPromise_resolve=void 0,a._closedPromise_reject=void 0,a._closedPromiseState="rejected")}function Kp(a){a._closedPromise_resolve!==void 0&&(a._closedPromise_resolve(void 0),a._closedPromise_resolve=void 0,a._closedPromise_reject=void 0,a._closedPromiseState="resolved")}function Ls(a){a._readyPromise=xe(((e,t)=>{a._readyPromise_resolve=e,a._readyPromise_reject=t})),a._readyPromiseState="pending"}function ui(a,e){Ls(a),Jp(a,e)}function np(a){Ls(a),Ni(a)}function Jp(a,e){a._readyPromise_reject!==void 0&&(Ta(a._readyPromise),a._readyPromise_reject(e),a._readyPromise_resolve=void 0,a._readyPromise_reject=void 0,a._readyPromiseState="rejected")}function Ni(a){a._readyPromise_resolve!==void 0&&(a._readyPromise_resolve(void 0),a._readyPromise_resolve=void 0,a._readyPromise_reject=void 0,a._readyPromiseState="fulfilled")}function op(a,e,t,n,s,o){let i=a.getReader(),r=e.getWriter();na(a)&&(a._disturbed=!0);let d,p,l,c=!1,m=!1,u="readable",g="writable",k=!1,f=!1,h=xe((E=>{l=E})),b=Promise.resolve(void 0);return xe(((E,x)=>{let F;function U(){if(c)return;let S=xe((($,C)=>{(function z(we){we?$():ft((function(){return c?V(!0):ft(r.ready,(()=>ft(i.read(),(ue=>!!ue.done||(b=r.write(ue.value),Ta(b),!1)))))})(),z,C)})(!1)}));Ta(S)}function me(){return u="closed",t?j():I((()=>(Ze(e)&&(k=Mt(e),g=e._state),k||g==="closed"?V(void 0):g==="erroring"||g==="errored"?P(p):(k=!0,r.close()))),!1,void 0),null}function _(S){return c||(u="errored",d=S,n?j(!0,S):I((()=>r.abort(S)),!0,S)),null}function w(S){return m||(g="errored",p=S,s?j(!0,S):I((()=>i.cancel(S)),!0,S)),null}if(o!==void 0&&(F=()=>{let S=o.reason!==void 0?o.reason:new Pm("Aborted","AbortError"),$=[];n||$.push((()=>g==="writable"?r.abort(S):V(void 0))),s||$.push((()=>u==="readable"?i.cancel(S):V(void 0))),I((()=>Promise.all($.map((C=>C())))),!0,S)},o.aborted?F():o.addEventListener("abort",F)),na(a)&&(u=a._state,d=a._storedError),Ze(e)&&(g=e._state,p=e._storedError,k=Mt(e)),na(a)&&Ze(e)&&(f=!0,l()),u==="errored")_(d);else if(g==="erroring"||g==="errored")w(p);else if(u==="closed")me();else if(k||g==="closed"){let S=new TypeError("the destination writable stream closed before all data could be piped to it");s?j(!0,S):I((()=>i.cancel(S)),!0,S)}function I(S,$,C){function z(){return g!=="writable"||k?we():Hd((function(){let ue;return V((function Ct(){if(ue!==b)return ue=b,Ue(b,Ct,Ct)})())})(),we),null}function we(){return S?fe(S(),(()=>oe($,C)),(ue=>oe(!0,ue))):oe($,C),null}c||(c=!0,f?z():Hd(h,z))}function j(S,$){I(void 0,S,$)}function oe(S,$){return m=!0,r.releaseLock(),i.releaseLock(),o!==void 0&&o.removeEventListener("abort",F),S?x($):E(void 0),null}c||(fe(i.closed,me,_),fe(r.closed,(function(){return m||(g="closed"),null}),w)),f?U():ws((()=>{f=!0,l(),U()}))}))}function Em(a,e){return(function(t){try{return t.getReader({mode:"byob"}).releaseLock(),!0}catch{return!1}})(a)?(function(t){let n,s,o,i,r,d=t.getReader(),p=!1,l=!1,c=!1,m=!1,u=!1,g=!1,k=xe((w=>{r=w}));function f(w){Wd(w.closed,(I=>(w!==d||(o.error(I),i.error(I),u&&g||r(void 0)),null)))}function h(){p&&(d.releaseLock(),d=t.getReader(),f(d),p=!1),fe(d.read(),(w=>{var I,j;if(c=!1,m=!1,w.done)return u||o.close(),g||i.close(),(I=o.byobRequest)===null||I===void 0||I.respond(0),(j=i.byobRequest)===null||j===void 0||j.respond(0),u&&g||r(void 0),null;let oe=w.value,S=oe,$=oe;if(!u&&!g)try{$=Jd(oe)}catch(C){return o.error(C),i.error(C),r(d.cancel(C)),null}return u||o.enqueue(S),g||i.enqueue($),l=!1,c?E():m&&x(),null}),(()=>(l=!1,null)))}function b(w,I){p||(d.releaseLock(),d=t.getReader({mode:"byob"}),f(d),p=!0);let j=I?i:o,oe=I?o:i;fe(d.read(w),(S=>{var $;c=!1,m=!1;let C=I?g:u,z=I?u:g;if(S.done){C||j.close(),z||oe.close();let ue=S.value;return ue!==void 0&&(C||j.byobRequest.respondWithNewView(ue),z||($=oe.byobRequest)===null||$===void 0||$.respond(0)),C&&z||r(void 0),null}let we=S.value;if(z)C||j.byobRequest.respondWithNewView(we);else{let ue;try{ue=Jd(we)}catch(Ct){return j.error(Ct),oe.error(Ct),r(d.cancel(Ct)),null}C||j.byobRequest.respondWithNewView(we),oe.enqueue(ue)}return l=!1,c?E():m&&x(),null}),(()=>(l=!1,null)))}function E(){if(l)return c=!0,V(void 0);l=!0;let w=o.byobRequest;return w===null?h():b(w.view,!1),V(void 0)}function x(){if(l)return m=!0,V(void 0);l=!0;let w=i.byobRequest;return w===null?h():b(w.view,!0),V(void 0)}function F(w){if(u=!0,n=w,g){let I=[n,s],j=d.cancel(I);r(j)}return k}function U(w){if(g=!0,s=w,u){let I=[n,s],j=d.cancel(I);r(j)}return k}let me=new se({type:"bytes",start(w){o=w},pull:E,cancel:F}),_=new se({type:"bytes",start(w){i=w},pull:x,cancel:U});return f(d),[me,_]})(a):(function(t,n){let s=t.getReader(),o,i,r,d,p,l=!1,c=!1,m=!1,u=!1,g=xe((x=>{p=x}));function k(){return l?(c=!0,V(void 0)):(l=!0,fe(s.read(),(x=>{if(c=!1,x.done)return m||r.close(),u||d.close(),m&&u||p(void 0),null;let F=x.value,U=F,me=F;return m||r.enqueue(U),u||d.enqueue(me),l=!1,c&&k(),null}),(()=>(l=!1,null))),V(void 0))}function f(x){if(m=!0,o=x,u){let F=[o,i],U=s.cancel(F);p(U)}return g}function h(x){if(u=!0,i=x,m){let F=[o,i],U=s.cancel(F);p(U)}return g}let b=new se({start(x){r=x},pull:k,cancel:f}),E=new se({start(x){d=x},pull:k,cancel:h});return Wd(s.closed,(x=>(r.error(x),d.error(x),m&&u||p(void 0),null))),[b,E]})(a)}function fs(a){return!!ve(a)&&!!Object.prototype.hasOwnProperty.call(a,"_controlledReadableStream")&&a instanceof gt}function pn(a){if((function(t){let n=t._controlledReadableStream;return!dn(t)||!t._started?!1:!!(Ba(n)&&Ds(n)>0||Zp(t)>0)})(a)){if(a._pulling)return void(a._pullAgain=!0);a._pulling=!0,fe(a._pullAlgorithm(),(()=>(a._pulling=!1,a._pullAgain&&(a._pullAgain=!1,pn(a)),null)),(t=>(ln(a,t),null)))}}function Ss(a){a._pullAlgorithm=void 0,a._cancelAlgorithm=void 0,a._strategySizeAlgorithm=void 0}function ln(a,e){let t=a._controlledReadableStream;t._state==="readable"&&(Dt(a),Ss(a),e1(t,e))}function Zp(a){let e=a._controlledReadableStream._state;return e==="errored"?null:e==="closed"?0:a._strategyHWM-a._queueTotalSize}function dn(a){return!a._closeRequested&&a._controlledReadableStream._state==="readable"}function Tm(a,e,t,n){let s=Object.create(gt.prototype),o,i,r;o=e.start!==void 0?()=>e.start(s):()=>{},i=e.pull!==void 0?()=>e.pull(s):()=>V(void 0),r=e.cancel!==void 0?d=>e.cancel(d):()=>V(void 0),(function(d,p,l,c,m,u,g){p._controlledReadableStream=d,p._queue=void 0,p._queueTotalSize=void 0,Dt(p),p._started=!1,p._closeRequested=!1,p._pullAgain=!1,p._pulling=!1,p._strategySizeAlgorithm=g,p._strategyHWM=u,p._pullAlgorithm=c,p._cancelAlgorithm=m,d._readableStreamController=p,fe(V(l()),(()=>(p._started=!0,pn(p),null)),(k=>(ln(p,k),null)))})(a,s,o,i,r,t,n)}function vs(a){return new TypeError(`ReadableStreamDefaultController.prototype.${a} can only be used on a ReadableStreamDefaultController`)}function Nm(a,e,t){return He(a,t),n=>oa(a,e,[n])}function Am(a,e,t){return He(a,t),n=>oa(a,e,[n])}function Im(a,e,t){return He(a,t),n=>Ms(a,e,[n])}function Bm(a,e){if((a=`${a}`)!="bytes")throw new TypeError(`${e} '${a}' is not a valid enumeration value for ReadableStreamType`);return a}function Rm(a,e){if((a=`${a}`)!="byob")throw new TypeError(`${e} '${a}' is not a valid enumeration value for ReadableStreamReaderMode`);return a}function ip(a,e){vt(a,e);let t=a?.preventAbort,n=a?.preventCancel,s=a?.preventClose,o=a?.signal;return o!==void 0&&(function(i,r){if(!(function(d){if(typeof d!="object"||d===null)return!1;try{return typeof d.aborted=="boolean"}catch{return!1}})(i))throw new TypeError(`${r} is not an AbortSignal.`)})(o,`${e} has member 'signal' that`),{preventAbort:!!t,preventCancel:!!n,preventClose:!!s,signal:o}}function Mm(a,e){vt(a,e);let t=a?.readable;di(t,"readable","ReadableWritablePair"),(function(s,o){if(!rn(s))throw new TypeError(`${o} is not a ReadableStream.`)})(t,`${e} has member 'readable' that`);let n=a?.writable;return di(n,"writable","ReadableWritablePair"),(function(s,o){if(!Pp(s))throw new TypeError(`${o} is not a WritableStream.`)})(n,`${e} has member 'writable' that`),{readable:t,writable:n}}function na(a){return!!ve(a)&&!!Object.prototype.hasOwnProperty.call(a,"_readableStreamController")&&a instanceof se}function Ba(a){return a._reader!==void 0}function Qp(a,e){if(a._disturbed=!0,a._state==="closed")return V(void 0);if(a._state==="errored")return P(a._storedError);mn(a);let t=a._reader;if(t!==void 0&&Pa(t)){let n=t._readIntoRequests;t._readIntoRequests=new Se,n.forEach((s=>{s._closeSteps(void 0)}))}return Ue(a._readableStreamController[hi](e),hp)}function mn(a){a._state="closed";let e=a._reader;if(e!==void 0&&(_p(e),aa(e))){let t=e._readRequests;e._readRequests=new Se,t.forEach((n=>{n._closeSteps()}))}}function e1(a,e){a._state="errored",a._storedError=e;let t=a._reader;t!==void 0&&(bi(t,e),aa(t)?Ap(t,e):qp(t,e))}function ta(a){return new TypeError(`ReadableStream.prototype.${a} can only be used on a ReadableStream`)}function t1(a,e){vt(a,e);let t=a?.highWaterMark;return di(t,"highWaterMark","QueuingStrategyInit"),{highWaterMark:yi(t)}}function rp(a){return new TypeError(`ByteLengthQueuingStrategy.prototype.${a} can only be used on a ByteLengthQueuingStrategy`)}function dp(a){return!!ve(a)&&!!Object.prototype.hasOwnProperty.call(a,"_byteLengthQueuingStrategyHighWaterMark")&&a instanceof un}function pp(a){return new TypeError(`CountQueuingStrategy.prototype.${a} can only be used on a CountQueuingStrategy`)}function lp(a){return!!ve(a)&&!!Object.prototype.hasOwnProperty.call(a,"_countQueuingStrategyHighWaterMark")&&a instanceof gn}function Dm(a,e,t){return He(a,t),n=>oa(a,e,[n])}function Fm(a,e,t){return He(a,t),n=>Ms(a,e,[n])}function Lm(a,e,t){return He(a,t),(n,s)=>oa(a,e,[n,s])}function cp(a){return!!ve(a)&&!!Object.prototype.hasOwnProperty.call(a,"_transformStreamController")&&a instanceof hn}function As(a,e){Rs(a,e),$s(a,e)}function $s(a,e){s1(a._transformStreamController),(function(t,n){t._writableController.error(n),t._writableState==="writable"&&d1(t,n)})(a,e),a._backpressure&&Is(a,!1)}function Is(a,e){a._backpressureChangePromise!==void 0&&a._backpressureChangePromise_resolve(),a._backpressureChangePromise=xe((t=>{a._backpressureChangePromise_resolve=t})),a._backpressure=e}function bs(a){return!!ve(a)&&!!Object.prototype.hasOwnProperty.call(a,"_controlledTransformStream")&&a instanceof ht}function s1(a){a._transformAlgorithm=void 0,a._flushAlgorithm=void 0}function o1(a,e){let t=a._controlledTransformStream;if(!Bs(t))throw new TypeError("Readable side is not in a state that permits enqueue");try{(function(s,o){s._readablePulling=!1;try{s._readableController.enqueue(o)}catch(i){throw Rs(s,i),i}})(t,e)}catch(s){throw $s(t,s),t._readableStoredError}(function(s){return!(function(o){return Bs(o)?!!(o._readablePulling||r1(o)>0):!1})(s)})(t)!==t._backpressure&&Is(t,!0)}function mp(a,e){return Ue(a._transformAlgorithm(e),void 0,(t=>{throw As(a._controlledTransformStream,t),t}))}function ys(a){return new TypeError(`TransformStreamDefaultController.prototype.${a} can only be used on a TransformStreamDefaultController`)}function up(a){return new TypeError(`TransformStream.prototype.${a} can only be used on a TransformStream`)}function Bs(a){return!a._readableCloseRequested&&a._readableState==="readable"}function i1(a){a._readableState="closed",a._readableCloseRequested=!0,a._readableController.close()}function Rs(a,e){a._readableState==="readable"&&(a._readableState="errored",a._readableStoredError=e),a._readableController.error(e)}function r1(a){return a._readableController.desiredSize}function ii(a,e){a._writableState!=="writable"?Ai(a):d1(a,e)}function d1(a,e){a._writableState="erroring",a._writableStoredError=e,!(function(t){return t._writableHasInFlightOperation})(a)&&a._writableStarted&&Ai(a)}function Ai(a){a._writableState="errored"}function gp(a){a._writableState==="erroring"&&Ai(a)}var L,fp,gi,hm,fm,vm,ws,Se,vp,bp,hi,fi,vi,Gd,bm,lt,Cs,Ip,Bp,Rt,ct,mt,Cm,ut,Je,Gp,Ia,sp,Pm,gt,se,a1,un,n1,gn,hn,ht,p1=v(()=>{L=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?Symbol:a=>`Symbol(${a})`;fp=hp;gi=Promise,hm=Promise.prototype.then,fm=Promise.resolve.bind(gi),vm=Promise.reject.bind(gi);ws=a=>{if(typeof queueMicrotask=="function")ws=queueMicrotask;else{let e=V(void 0);ws=t=>ft(e,t)}return ws(a)};Se=class{constructor(){this._cursor=0,this._size=0,this._front={_elements:[],_next:void 0},this._back=this._front,this._cursor=0,this._size=0}get length(){return this._size}push(e){let t=this._back,n=t;t._elements.length===16383&&(n={_elements:[],_next:void 0}),t._elements.push(e),n!==t&&(this._back=n,t._next=n),++this._size}shift(){let e=this._front,t=e,n=this._cursor,s=n+1,o=e._elements,i=o[n];return s===16384&&(t=e._next,s=0),--this._size,this._cursor=s,e!==t&&(this._front=t),o[n]=void 0,i}forEach(e){let t=this._cursor,n=this._front,s=n._elements;for(;!(t===s.length&&n._next===void 0||t===s.length&&(n=n._next,s=n._elements,t=0,s.length===0));)e(s[t]),++t}peek(){let e=this._front,t=this._cursor;return e._elements[t]}},vp=L("[[AbortSteps]]"),bp=L("[[ErrorSteps]]"),hi=L("[[CancelSteps]]"),fi=L("[[PullSteps]]"),vi=L("[[ReleaseSteps]]");Gd=Number.isFinite||function(a){return typeof a=="number"&&isFinite(a)},bm=Math.trunc||function(a){return a<0?Math.ceil(a):Math.floor(a)};lt=class{constructor(e){if(bt(e,1,"ReadableStreamDefaultReader"),Ep(e,"First parameter"),Ba(e))throw new TypeError("This stream has already been locked for exclusive reading by another reader");yp(this,e),this._readRequests=new Se}get closed(){return aa(this)?this._closedPromise:P(ms("closed"))}cancel(e){return aa(this)?this._ownerReadableStream===void 0?P(Na("cancel")):wp(this,e):P(ms("cancel"))}read(){if(!aa(this))return P(ms("read"));if(this._ownerReadableStream===void 0)return P(Na("read from"));let e,t,n=xe(((s,o)=>{e=s,t=o}));return(function(s,o){let i=s._ownerReadableStream;i._disturbed=!0,i._state==="closed"?o._closeSteps():i._state==="errored"?o._errorSteps(i._storedError):i._readableStreamController[fi](o)})(this,{_chunkSteps:s=>e({value:s,done:!1}),_closeSteps:()=>e({value:void 0,done:!0}),_errorSteps:s=>t(s)}),n}releaseLock(){if(!aa(this))throw ms("releaseLock");this._ownerReadableStream!==void 0&&(function(e){xp(e);let t=new TypeError("Reader was released");Ap(e,t)})(this)}};Object.defineProperties(lt.prototype,{cancel:{enumerable:!0},read:{enumerable:!0},releaseLock:{enumerable:!0},closed:{enumerable:!0}}),O(lt.prototype.cancel,"cancel"),O(lt.prototype.read,"read"),O(lt.prototype.releaseLock,"releaseLock"),typeof L.toStringTag=="symbol"&&Object.defineProperty(lt.prototype,L.toStringTag,{value:"ReadableStreamDefaultReader",configurable:!0});Cs=class{constructor(e,t){this._ongoingPromise=void 0,this._isFinished=!1,this._reader=e,this._preventCancel=t}next(){let e=()=>this._nextSteps();return this._ongoingPromise=this._ongoingPromise?Ue(this._ongoingPromise,e,e):e(),this._ongoingPromise}return(e){let t=()=>this._returnSteps(e);return this._ongoingPromise?Ue(this._ongoingPromise,t,t):t()}_nextSteps(){if(this._isFinished)return Promise.resolve({value:void 0,done:!0});let e=this._reader;return e===void 0?P(Na("iterate")):ft(e.read(),(t=>{var n;return this._ongoingPromise=void 0,t.done&&(this._isFinished=!0,(n=this._reader)===null||n===void 0||n.releaseLock(),this._reader=void 0),t}),(t=>{var n;throw this._ongoingPromise=void 0,this._isFinished=!0,(n=this._reader)===null||n===void 0||n.releaseLock(),this._reader=void 0,t}))}_returnSteps(e){if(this._isFinished)return Promise.resolve({value:e,done:!0});this._isFinished=!0;let t=this._reader;if(t===void 0)return P(Na("finish iterating"));if(this._reader=void 0,!this._preventCancel){let n=t.cancel(e);return t.releaseLock(),Ue(n,(()=>({value:e,done:!0})))}return t.releaseLock(),V({value:e,done:!0})}},Ip={next(){return Xd(this)?this._asyncIteratorImpl.next():P(Kd("next"))},return(a){return Xd(this)?this._asyncIteratorImpl.return(a):P(Kd("return"))}};typeof L.asyncIterator=="symbol"&&Object.defineProperty(Ip,L.asyncIterator,{value(){return this},writable:!0,configurable:!0});Bp=Number.isNaN||function(a){return a!=a};Rt=class{constructor(){throw new TypeError("Illegal constructor")}get view(){if(!ai(this))throw ni("view");return this._view}respond(e){if(!ai(this))throw ni("respond");if(bt(e,1,"respond"),e=Cp(e,"First parameter"),this._associatedReadableByteStreamController===void 0)throw new TypeError("This BYOB request has been invalidated");this._view.buffer,(function(t,n){let s=t._pendingPullIntos.peek();if(t._controlledReadableByteStream._state==="closed"){if(n!==0)throw new TypeError("bytesWritten must be 0 when calling respond() on a closed stream")}else{if(n===0)throw new TypeError("bytesWritten must be greater than 0 when calling respond() on a readable stream");if(s.bytesFilled+n>s.byteLength)throw new RangeError("bytesWritten out of range")}s.buffer=s.buffer,Zd(t,n)})(this._associatedReadableByteStreamController,e)}respondWithNewView(e){if(!ai(this))throw ni("respondWithNewView");if(bt(e,1,"respondWithNewView"),!ArrayBuffer.isView(e))throw new TypeError("You can only respond with array buffer views");if(this._associatedReadableByteStreamController===void 0)throw new TypeError("This BYOB request has been invalidated");e.buffer,(function(t,n){let s=t._pendingPullIntos.peek();if(t._controlledReadableByteStream._state==="closed"){if(n.byteLength!==0)throw new TypeError("The view's length must be 0 when calling respondWithNewView() on a closed stream")}else if(n.byteLength===0)throw new TypeError("The view's length must be greater than 0 when calling respondWithNewView() on a readable stream");if(s.byteOffset+s.bytesFilled!==n.byteOffset)throw new RangeError("The region specified by view does not match byobRequest");if(s.bufferByteLength!==n.buffer.byteLength)throw new RangeError("The buffer of view has different capacity than byobRequest");if(s.bytesFilled+n.byteLength>s.byteLength)throw new RangeError("The region specified by view is larger than byobRequest");let o=n.byteLength;s.buffer=n.buffer,Zd(t,o)})(this._associatedReadableByteStreamController,e)}};Object.defineProperties(Rt.prototype,{respond:{enumerable:!0},respondWithNewView:{enumerable:!0},view:{enumerable:!0}}),O(Rt.prototype.respond,"respond"),O(Rt.prototype.respondWithNewView,"respondWithNewView"),typeof L.toStringTag=="symbol"&&Object.defineProperty(Rt.prototype,L.toStringTag,{value:"ReadableStreamBYOBRequest",configurable:!0});ct=class{constructor(){throw new TypeError("Illegal constructor")}get byobRequest(){if(!Ca(this))throw sn("byobRequest");return(function(e){if(e._byobRequest===null&&e._pendingPullIntos.length>0){let t=e._pendingPullIntos.peek(),n=new Uint8Array(t.buffer,t.byteOffset+t.bytesFilled,t.byteLength-t.bytesFilled),s=Object.create(Rt.prototype);(function(o,i,r){o._associatedReadableByteStreamController=i,o._view=r})(s,e,n),e._byobRequest=s}return e._byobRequest})(this)}get desiredSize(){if(!Ca(this))throw sn("desiredSize");return zp(this)}close(){if(!Ca(this))throw sn("close");if(this._closeRequested)throw new TypeError("The stream has already been closed; do not close it again!");let e=this._controlledReadableByteStream._state;if(e!=="readable")throw new TypeError(`The stream (in ${e} state) is not in the readable state and cannot be closed`);(function(t){let n=t._controlledReadableByteStream;if(!(t._closeRequested||n._state!=="readable")){if(t._queueTotalSize>0)return void(t._closeRequested=!0);if(t._pendingPullIntos.length>0&&t._pendingPullIntos.peek().bytesFilled>0){let s=new TypeError("Insufficient bytes to fill elements in the given buffer");throw Aa(t,s),s}Ps(t),mn(n)}})(this)}enqueue(e){if(!Ca(this))throw sn("enqueue");if(bt(e,1,"enqueue"),!ArrayBuffer.isView(e))throw new TypeError("chunk must be an array buffer view");if(e.byteLength===0)throw new TypeError("chunk must have non-zero byteLength");if(e.buffer.byteLength===0)throw new TypeError("chunk's buffer must have non-zero byteLength");if(this._closeRequested)throw new TypeError("stream is closed or draining");let t=this._controlledReadableByteStream._state;if(t!=="readable")throw new TypeError(`The stream (in ${t} state) is not in the readable state and cannot be enqueued to`);(function(n,s){let o=n._controlledReadableByteStream;if(n._closeRequested||o._state!=="readable")return;let i=s.buffer,r=s.byteOffset,d=s.byteLength,p=i;if(n._pendingPullIntos.length>0){let l=n._pendingPullIntos.peek();l.buffer,ki(n),l.buffer=l.buffer,l.readerType==="none"&&Lp(n,l)}Np(o)?((function(l){let c=l._controlledReadableByteStream._reader;for(;c._readRequests.length>0;){if(l._queueTotalSize===0)return;Qd(l,c._readRequests.shift())}})(n),Ds(o)===0?xs(n,p,r,d):(n._pendingPullIntos.length>0&&Ea(n),wi(o,new Uint8Array(p,r,d),!1))):_i(o)?(xs(n,p,r,d),ci(n)):xs(n,p,r,d),sa(n)})(this,e)}error(e){if(!Ca(this))throw sn("error");Aa(this,e)}[hi](e){Mp(this),Dt(this);let t=this._cancelAlgorithm(e);return Ps(this),t}[fi](e){let t=this._controlledReadableByteStream;if(this._queueTotalSize>0)return void Qd(this,e);let n=this._autoAllocateChunkSize;if(n!==void 0){let s;try{s=new ArrayBuffer(n)}catch(i){return void e._errorSteps(i)}let o={buffer:s,bufferByteLength:n,byteOffset:0,byteLength:n,bytesFilled:0,elementSize:1,viewConstructor:Uint8Array,readerType:"default"};this._pendingPullIntos.push(o)}Tp(t,e),sa(this)}[vi](){if(this._pendingPullIntos.length>0){let e=this._pendingPullIntos.peek();e.readerType="none",this._pendingPullIntos=new Se,this._pendingPullIntos.push(e)}}};Object.defineProperties(ct.prototype,{close:{enumerable:!0},enqueue:{enumerable:!0},error:{enumerable:!0},byobRequest:{enumerable:!0},desiredSize:{enumerable:!0}}),O(ct.prototype.close,"close"),O(ct.prototype.enqueue,"enqueue"),O(ct.prototype.error,"error"),typeof L.toStringTag=="symbol"&&Object.defineProperty(ct.prototype,L.toStringTag,{value:"ReadableByteStreamController",configurable:!0});mt=class{constructor(e){if(bt(e,1,"ReadableStreamBYOBReader"),Ep(e,"First parameter"),Ba(e))throw new TypeError("This stream has already been locked for exclusive reading by another reader");if(!Ca(e._readableStreamController))throw new TypeError("Cannot construct a ReadableStreamBYOBReader for a stream not constructed with a byte source");yp(this,e),this._readIntoRequests=new Se}get closed(){return Pa(this)?this._closedPromise:P(us("closed"))}cancel(e){return Pa(this)?this._ownerReadableStream===void 0?P(Na("cancel")):wp(this,e):P(us("cancel"))}read(e){if(!Pa(this))return P(us("read"));if(!ArrayBuffer.isView(e))return P(new TypeError("view must be an array buffer view"));if(e.byteLength===0)return P(new TypeError("view must have non-zero byteLength"));if(e.buffer.byteLength===0)return P(new TypeError("view's buffer must have non-zero byteLength"));if(e.buffer,this._ownerReadableStream===void 0)return P(Na("read from"));let t,n,s=xe(((o,i)=>{t=o,n=i}));return(function(o,i,r){let d=o._ownerReadableStream;d._disturbed=!0,d._state==="errored"?r._errorSteps(d._storedError):(function(p,l,c){let m=p._controlledReadableByteStream,u=1;l.constructor!==DataView&&(u=l.constructor.BYTES_PER_ELEMENT);let g=l.constructor,k=l.buffer,f={buffer:k,bufferByteLength:k.byteLength,byteOffset:l.byteOffset,byteLength:l.byteLength,bytesFilled:0,elementSize:u,viewConstructor:g,readerType:"byob"};if(p._pendingPullIntos.length>0)return p._pendingPullIntos.push(f),void ep(m,c);if(m._state!=="closed"){if(p._queueTotalSize>0){if($p(p,f)){let h=Dp(f);return jp(p),void c._chunkSteps(h)}if(p._closeRequested){let h=new TypeError("Insufficient bytes to fill elements in the given buffer");return Aa(p,h),void c._errorSteps(h)}}p._pendingPullIntos.push(f),ep(m,c),sa(p)}else{let h=new g(f.buffer,f.byteOffset,0);c._closeSteps(h)}})(d._readableStreamController,i,r)})(this,e,{_chunkSteps:o=>t({value:o,done:!1}),_closeSteps:o=>t({value:o,done:!0}),_errorSteps:o=>n(o)}),s}releaseLock(){if(!Pa(this))throw us("releaseLock");this._ownerReadableStream!==void 0&&(function(e){xp(e);let t=new TypeError("Reader was released");qp(e,t)})(this)}};Object.defineProperties(mt.prototype,{cancel:{enumerable:!0},read:{enumerable:!0},releaseLock:{enumerable:!0},closed:{enumerable:!0}}),O(mt.prototype.cancel,"cancel"),O(mt.prototype.read,"read"),O(mt.prototype.releaseLock,"releaseLock"),typeof L.toStringTag=="symbol"&&Object.defineProperty(mt.prototype,L.toStringTag,{value:"ReadableStreamBYOBReader",configurable:!0});Cm=typeof AbortController=="function",ut=class{constructor(e={},t={}){e===void 0?e=null:Sp(e,"First parameter");let n=Ts(t,"Second parameter"),s=(function(r,d){vt(r,d);let p=r?.abort,l=r?.close,c=r?.start,m=r?.type,u=r?.write;return{abort:p===void 0?void 0:xm(p,r,`${d} has member 'abort' that`),close:l===void 0?void 0:km(l,r,`${d} has member 'close' that`),start:c===void 0?void 0:_m(c,r,`${d} has member 'start' that`),write:u===void 0?void 0:Sm(u,r,`${d} has member 'write' that`),type:m}})(e,"First parameter");var o;if((o=this)._state="writable",o._storedError=void 0,o._writer=void 0,o._writableStreamController=void 0,o._writeRequests=new Se,o._inFlightWriteRequest=void 0,o._closeRequest=void 0,o._inFlightCloseRequest=void 0,o._pendingAbortRequest=void 0,o._backpressure=!1,s.type!==void 0)throw new RangeError("Invalid type is specified");let i=Es(n);(function(r,d,p,l){let c=Object.create(Ia.prototype),m,u,g,k;m=d.start!==void 0?()=>d.start(c):()=>{},u=d.write!==void 0?f=>d.write(f,c):()=>V(void 0),g=d.close!==void 0?()=>d.close():()=>V(void 0),k=d.abort!==void 0?f=>d.abort(f):()=>V(void 0),(function(f,h,b,E,x,F,U,me){h._controlledWritableStream=f,f._writableStreamController=h,h._queue=void 0,h._queueTotalSize=void 0,Dt(h),h._abortReason=void 0,h._abortController=(function(){if(Cm)return new AbortController})(),h._started=!1,h._strategySizeAlgorithm=me,h._strategyHWM=U,h._writeAlgorithm=E,h._closeAlgorithm=x,h._abortAlgorithm=F;let _=Ei(h);Pi(f,_);let w=b();fe(V(w),(()=>(h._started=!0,Fs(h),null)),(I=>(h._started=!0,mi(f,I),null)))})(r,c,m,u,g,k,p,l)})(this,s,cn(n,1),i)}get locked(){if(!Ze(this))throw hs("locked");return ks(this)}abort(e){return Ze(this)?ks(this)?P(new TypeError("Cannot abort a stream that already has a writer")):Up(this,e):P(hs("abort"))}close(){return Ze(this)?ks(this)?P(new TypeError("Cannot close a stream that already has a writer")):Mt(this)?P(new TypeError("Cannot close an already-closing stream")):Hp(this):P(hs("close"))}getWriter(){if(!Ze(this))throw hs("getWriter");return new Je(this)}};Object.defineProperties(ut.prototype,{abort:{enumerable:!0},close:{enumerable:!0},getWriter:{enumerable:!0},locked:{enumerable:!0}}),O(ut.prototype.abort,"abort"),O(ut.prototype.close,"close"),O(ut.prototype.getWriter,"getWriter"),typeof L.toStringTag=="symbol"&&Object.defineProperty(ut.prototype,L.toStringTag,{value:"WritableStream",configurable:!0});Je=class{constructor(e){if(bt(e,1,"WritableStreamDefaultWriter"),(function(s,o){if(!Ze(s))throw new TypeError(`${o} is not a WritableStream.`)})(e,"First parameter"),ks(e))throw new TypeError("This stream has already been locked for exclusive writing by another writer");this._ownerWritableStream=e,e._writer=this;let t=e._state;if(t==="writable")!Mt(e)&&e._backpressure?Ls(this):np(this),_s(this);else if(t==="erroring")ui(this,e._storedError),_s(this);else if(t==="closed")np(this),_s(n=this),Kp(n);else{let s=e._storedError;ui(this,s),ap(this,s)}var n}get closed(){return Qt(this)?this._closedPromise:P(ea("closed"))}get desiredSize(){if(!Qt(this))throw ea("desiredSize");if(this._ownerWritableStream===void 0)throw on("desiredSize");return(function(e){let t=e._ownerWritableStream,n=t._state;return n==="errored"||n==="erroring"?null:n==="closed"?0:Yp(t._writableStreamController)})(this)}get ready(){return Qt(this)?this._readyPromise:P(ea("ready"))}abort(e){return Qt(this)?this._ownerWritableStream===void 0?P(on("abort")):(function(t,n){return Up(t._ownerWritableStream,n)})(this,e):P(ea("abort"))}close(){if(!Qt(this))return P(ea("close"));let e=this._ownerWritableStream;return e===void 0?P(on("close")):Mt(e)?P(new TypeError("Cannot close an already-closing stream")):Hp(this._ownerWritableStream)}releaseLock(){if(!Qt(this))throw ea("releaseLock");this._ownerWritableStream!==void 0&&(function(e){let t=e._ownerWritableStream,n=new TypeError("Writer was released and can no longer be used to monitor the stream's closedness");Wp(e,n),(function(s,o){s._closedPromiseState==="pending"?Ti(s,o):(function(i,r){ap(i,r)})(s,o)})(e,n),t._writer=void 0,e._ownerWritableStream=void 0})(this)}write(e){return Qt(this)?this._ownerWritableStream===void 0?P(on("write to")):(function(t,n){let s=t._ownerWritableStream,o=s._writableStreamController,i=(function(p,l){try{return p._strategySizeAlgorithm(l)}catch(c){return tp(p,c),1}})(o,n);if(s!==t._ownerWritableStream)return P(on("write to"));let r=s._state;if(r==="errored")return P(s._storedError);if(Mt(s)||r==="closed")return P(new TypeError("The stream is closing or closed and cannot be written to"));if(r==="erroring")return P(s._storedError);let d=(function(p){return xe(((l,c)=>{let m={_resolve:l,_reject:c};p._writeRequests.push(m)}))})(s);return(function(p,l,c){try{xi(p,l,c)}catch(u){return void tp(p,u)}let m=p._controlledWritableStream;!Mt(m)&&m._state==="writable"&&Pi(m,Ei(p)),Fs(p)})(o,n,i),d})(this,e):P(ea("write"))}};Object.defineProperties(Je.prototype,{abort:{enumerable:!0},close:{enumerable:!0},releaseLock:{enumerable:!0},write:{enumerable:!0},closed:{enumerable:!0},desiredSize:{enumerable:!0},ready:{enumerable:!0}}),O(Je.prototype.abort,"abort"),O(Je.prototype.close,"close"),O(Je.prototype.releaseLock,"releaseLock"),O(Je.prototype.write,"write"),typeof L.toStringTag=="symbol"&&Object.defineProperty(Je.prototype,L.toStringTag,{value:"WritableStreamDefaultWriter",configurable:!0});Gp={},Ia=class{constructor(){throw new TypeError("Illegal constructor")}get abortReason(){if(!si(this))throw oi("abortReason");return this._abortReason}get signal(){if(!si(this))throw oi("signal");if(this._abortController===void 0)throw new TypeError("WritableStreamDefaultController.prototype.signal is not supported");return this._abortController.signal}error(e){if(!si(this))throw oi("error");this._controlledWritableStream._state==="writable"&&Xp(this,e)}[vp](e){let t=this._abortAlgorithm(e);return Ns(this),t}[bp](){Dt(this)}};Object.defineProperties(Ia.prototype,{abortReason:{enumerable:!0},signal:{enumerable:!0},error:{enumerable:!0}}),typeof L.toStringTag=="symbol"&&Object.defineProperty(Ia.prototype,L.toStringTag,{value:"WritableStreamDefaultController",configurable:!0});sp=typeof DOMException<"u"?DOMException:void 0,Pm=(function(a){if(typeof a!="function"&&typeof a!="object")return!1;try{return new a,!0}catch{return!1}})(sp)?sp:(function(){let a=function(e,t){this.message=e||"",this.name=t||"Error",Error.captureStackTrace&&Error.captureStackTrace(this,this.constructor)};return a.prototype=Object.create(Error.prototype),Object.defineProperty(a.prototype,"constructor",{value:a,writable:!0,configurable:!0}),a})();gt=class{constructor(){throw new TypeError("Illegal constructor")}get desiredSize(){if(!fs(this))throw vs("desiredSize");return Zp(this)}close(){if(!fs(this))throw vs("close");if(!dn(this))throw new TypeError("The stream is not in a state that permits close");(function(e){if(!dn(e))return;let t=e._controlledReadableStream;e._closeRequested=!0,e._queue.length===0&&(Ss(e),mn(t))})(this)}enqueue(e){if(!fs(this))throw vs("enqueue");if(!dn(this))throw new TypeError("The stream is not in a state that permits enqueue");return(function(t,n){if(!dn(t))return;let s=t._controlledReadableStream;if(Ba(s)&&Ds(s)>0)wi(s,n,!1);else{let o;try{o=t._strategySizeAlgorithm(n)}catch(i){throw ln(t,i),i}try{xi(t,n,o)}catch(i){throw ln(t,i),i}}pn(t)})(this,e)}error(e){if(!fs(this))throw vs("error");ln(this,e)}[hi](e){Dt(this);let t=this._cancelAlgorithm(e);return Ss(this),t}[fi](e){let t=this._controlledReadableStream;if(this._queue.length>0){let n=pi(this);this._closeRequested&&this._queue.length===0?(Ss(this),mn(t)):pn(this),e._chunkSteps(n)}else Tp(t,e),pn(this)}[vi](){}};Object.defineProperties(gt.prototype,{close:{enumerable:!0},enqueue:{enumerable:!0},error:{enumerable:!0},desiredSize:{enumerable:!0}}),O(gt.prototype.close,"close"),O(gt.prototype.enqueue,"enqueue"),O(gt.prototype.error,"error"),typeof L.toStringTag=="symbol"&&Object.defineProperty(gt.prototype,L.toStringTag,{value:"ReadableStreamDefaultController",configurable:!0});se=class{constructor(e={},t={}){e===void 0?e=null:Sp(e,"First parameter");let n=Ts(t,"Second parameter"),s=(function(i,r){vt(i,r);let d=i,p=d?.autoAllocateChunkSize,l=d?.cancel,c=d?.pull,m=d?.start,u=d?.type;return{autoAllocateChunkSize:p===void 0?void 0:Cp(p,`${r} has member 'autoAllocateChunkSize' that`),cancel:l===void 0?void 0:Nm(l,d,`${r} has member 'cancel' that`),pull:c===void 0?void 0:Am(c,d,`${r} has member 'pull' that`),start:m===void 0?void 0:Im(m,d,`${r} has member 'start' that`),type:u===void 0?void 0:Bm(u,`${r} has member 'type' that`)}})(e,"First parameter");var o;if((o=this)._state="readable",o._reader=void 0,o._storedError=void 0,o._disturbed=!1,s.type==="bytes"){if(n.size!==void 0)throw new RangeError("The strategy for a byte stream cannot have a size function");ym(this,s,cn(n,0))}else{let i=Es(n);Tm(this,s,cn(n,1),i)}}get locked(){if(!na(this))throw ta("locked");return Ba(this)}cancel(e){return na(this)?Ba(this)?P(new TypeError("Cannot cancel a stream that already has a reader")):Qp(this,e):P(ta("cancel"))}getReader(e){if(!na(this))throw ta("getReader");return(function(t,n){vt(t,n);let s=t?.mode;return{mode:s===void 0?void 0:Rm(s,`${n} has member 'mode' that`)}})(e,"First parameter").mode===void 0?new lt(this):(function(t){return new mt(t)})(this)}pipeThrough(e,t={}){if(!rn(this))throw ta("pipeThrough");bt(e,1,"pipeThrough");let n=Mm(e,"First parameter"),s=ip(t,"Second parameter");if(this.locked)throw new TypeError("ReadableStream.prototype.pipeThrough cannot be used on a locked ReadableStream");if(n.writable.locked)throw new TypeError("ReadableStream.prototype.pipeThrough cannot be used on a locked WritableStream");return Ta(op(this,n.writable,s.preventClose,s.preventAbort,s.preventCancel,s.signal)),n.readable}pipeTo(e,t={}){if(!rn(this))return P(ta("pipeTo"));if(e===void 0)return P("Parameter 1 is required in 'pipeTo'.");if(!Pp(e))return P(new TypeError("ReadableStream.prototype.pipeTo's first argument must be a WritableStream"));let n;try{n=ip(t,"Second parameter")}catch(s){return P(s)}return this.locked?P(new TypeError("ReadableStream.prototype.pipeTo cannot be used on a locked ReadableStream")):e.locked?P(new TypeError("ReadableStream.prototype.pipeTo cannot be used on a locked WritableStream")):op(this,e,n.preventClose,n.preventAbort,n.preventCancel,n.signal)}tee(){if(!rn(this))throw ta("tee");if(this.locked)throw new TypeError("Cannot tee a stream that already has a reader");return Em(this)}values(e){if(!rn(this))throw ta("values");return(function(t,n){let s=t.getReader(),o=new Cs(s,n),i=Object.create(Ip);return i._asyncIteratorImpl=o,i})(this,(function(t,n){return vt(t,n),{preventCancel:!!t?.preventCancel}})(e,"First parameter").preventCancel)}};Object.defineProperties(se.prototype,{cancel:{enumerable:!0},getReader:{enumerable:!0},pipeThrough:{enumerable:!0},pipeTo:{enumerable:!0},tee:{enumerable:!0},values:{enumerable:!0},locked:{enumerable:!0}}),O(se.prototype.cancel,"cancel"),O(se.prototype.getReader,"getReader"),O(se.prototype.pipeThrough,"pipeThrough"),O(se.prototype.pipeTo,"pipeTo"),O(se.prototype.tee,"tee"),O(se.prototype.values,"values"),typeof L.toStringTag=="symbol"&&Object.defineProperty(se.prototype,L.toStringTag,{value:"ReadableStream",configurable:!0}),typeof L.asyncIterator=="symbol"&&Object.defineProperty(se.prototype,L.asyncIterator,{value:se.prototype.values,writable:!0,configurable:!0});a1=a=>a.byteLength;O(a1,"size");un=class{constructor(e){bt(e,1,"ByteLengthQueuingStrategy"),e=t1(e,"First parameter"),this._byteLengthQueuingStrategyHighWaterMark=e.highWaterMark}get highWaterMark(){if(!dp(this))throw rp("highWaterMark");return this._byteLengthQueuingStrategyHighWaterMark}get size(){if(!dp(this))throw rp("size");return a1}};Object.defineProperties(un.prototype,{highWaterMark:{enumerable:!0},size:{enumerable:!0}}),typeof L.toStringTag=="symbol"&&Object.defineProperty(un.prototype,L.toStringTag,{value:"ByteLengthQueuingStrategy",configurable:!0});n1=()=>1;O(n1,"size");gn=class{constructor(e){bt(e,1,"CountQueuingStrategy"),e=t1(e,"First parameter"),this._countQueuingStrategyHighWaterMark=e.highWaterMark}get highWaterMark(){if(!lp(this))throw pp("highWaterMark");return this._countQueuingStrategyHighWaterMark}get size(){if(!lp(this))throw pp("size");return n1}};Object.defineProperties(gn.prototype,{highWaterMark:{enumerable:!0},size:{enumerable:!0}}),typeof L.toStringTag=="symbol"&&Object.defineProperty(gn.prototype,L.toStringTag,{value:"CountQueuingStrategy",configurable:!0});hn=class{constructor(e={},t={},n={}){e===void 0&&(e=null);let s=Ts(t,"Second parameter"),o=Ts(n,"Third parameter"),i=(function(m,u){vt(m,u);let g=m?.flush,k=m?.readableType,f=m?.start,h=m?.transform,b=m?.writableType;return{flush:g===void 0?void 0:Dm(g,m,`${u} has member 'flush' that`),readableType:k,start:f===void 0?void 0:Fm(f,m,`${u} has member 'start' that`),transform:h===void 0?void 0:Lm(h,m,`${u} has member 'transform' that`),writableType:b}})(e,"First parameter");if(i.readableType!==void 0)throw new RangeError("Invalid readableType specified");if(i.writableType!==void 0)throw new RangeError("Invalid writableType specified");let r=cn(o,0),d=Es(o),p=cn(s,1),l=Es(s),c;(function(m,u,g,k,f,h){function b(){return u}function E(_){return(function(w,I){let j=w._transformStreamController;return w._backpressure?Ue(w._backpressureChangePromise,(()=>{if((Ze(w._writable)?w._writable._state:w._writableState)==="erroring")throw Ze(w._writable)?w._writable._storedError:w._writableStoredError;return mp(j,I)})):mp(j,I)})(m,_)}function x(_){return(function(w,I){return As(w,I),V(void 0)})(m,_)}function F(){return(function(_){let w=_._transformStreamController,I=w._flushAlgorithm();return s1(w),Ue(I,(()=>{if(_._readableState==="errored")throw _._readableStoredError;Bs(_)&&i1(_)}),(j=>{throw As(_,j),_._readableStoredError}))})(m)}function U(){return(function(_){return Is(_,!1),_._backpressureChangePromise})(m)}function me(_){return $s(m,_),V(void 0)}m._writableState="writable",m._writableStoredError=void 0,m._writableHasInFlightOperation=!1,m._writableStarted=!1,m._writable=(function(_,w,I,j,oe,S,$){return new ut({start(C){_._writableController=C;try{let z=C.signal;z!==void 0&&z.addEventListener("abort",(()=>{_._writableState==="writable"&&(_._writableState="erroring",z.reason&&(_._writableStoredError=z.reason))}))}catch{}return Ue(w(),(()=>(_._writableStarted=!0,gp(_),null)),(z=>{throw _._writableStarted=!0,ii(_,z),z}))},write:C=>((function(z){z._writableHasInFlightOperation=!0})(_),Ue(I(C),(()=>((function(z){z._writableHasInFlightOperation=!1})(_),gp(_),null)),(z=>{throw(function(we,ue){we._writableHasInFlightOperation=!1,ii(we,ue)})(_,z),z}))),close:()=>((function(C){C._writableHasInFlightOperation=!0})(_),Ue(j(),(()=>((function(C){C._writableHasInFlightOperation=!1,C._writableState==="erroring"&&(C._writableStoredError=void 0),C._writableState="closed"})(_),null)),(C=>{throw(function(z,we){z._writableHasInFlightOperation=!1,z._writableState,ii(z,we)})(_,C),C}))),abort:C=>(_._writableState="errored",_._writableStoredError=C,oe(C))},{highWaterMark:S,size:$})})(m,b,E,F,x,g,k),m._readableState="readable",m._readableStoredError=void 0,m._readableCloseRequested=!1,m._readablePulling=!1,m._readable=(function(_,w,I,j,oe,S){return new se({start:$=>(_._readableController=$,w().catch((C=>{Rs(_,C)}))),pull:()=>(_._readablePulling=!0,I().catch(($=>{Rs(_,$)}))),cancel:$=>(_._readableState="closed",j($))},{highWaterMark:oe,size:S})})(m,b,U,me,f,h),m._backpressure=void 0,m._backpressureChangePromise=void 0,m._backpressureChangePromise_resolve=void 0,Is(m,!0),m._transformStreamController=void 0})(this,xe((m=>{c=m})),p,l,r,d),(function(m,u){let g=Object.create(ht.prototype),k,f;k=u.transform!==void 0?h=>u.transform(h,g):h=>{try{return o1(g,h),V(void 0)}catch(b){return P(b)}},f=u.flush!==void 0?()=>u.flush(g):()=>V(void 0),(function(h,b,E,x){b._controlledTransformStream=h,h._transformStreamController=b,b._transformAlgorithm=E,b._flushAlgorithm=x})(m,g,k,f)})(this,i),i.start!==void 0?c(i.start(this._transformStreamController)):c(void 0)}get readable(){if(!cp(this))throw up("readable");return this._readable}get writable(){if(!cp(this))throw up("writable");return this._writable}};Object.defineProperties(hn.prototype,{readable:{enumerable:!0},writable:{enumerable:!0}}),typeof L.toStringTag=="symbol"&&Object.defineProperty(hn.prototype,L.toStringTag,{value:"TransformStream",configurable:!0});ht=class{constructor(){throw new TypeError("Illegal constructor")}get desiredSize(){if(!bs(this))throw ys("desiredSize");return r1(this._controlledTransformStream)}enqueue(e){if(!bs(this))throw ys("enqueue");o1(this,e)}error(e){if(!bs(this))throw ys("error");var t;t=e,As(this._controlledTransformStream,t)}terminate(){if(!bs(this))throw ys("terminate");(function(e){let t=e._controlledTransformStream;Bs(t)&&i1(t);let n=new TypeError("TransformStream terminated");$s(t,n)})(this)}};Object.defineProperties(ht.prototype,{enqueue:{enumerable:!0},error:{enumerable:!0},terminate:{enumerable:!0},desiredSize:{enumerable:!0}}),O(ht.prototype.enqueue,"enqueue"),O(ht.prototype.error,"error"),O(ht.prototype.terminate,"terminate"),typeof L.toStringTag=="symbol"&&Object.defineProperty(ht.prototype,L.toStringTag,{value:"TransformStreamDefaultController",configurable:!0})});var ne,Os=v(()=>{ne=a=>typeof a=="function"});async function*$m(a){let e=a.byteOffset+a.byteLength,t=a.byteOffset;for(;t!==e;){let n=Math.min(e-t,l1),s=a.buffer.slice(t,t+n);t+=s.byteLength,yield new Uint8Array(s)}}async function*Om(a){let e=0;for(;e!==a.size;){let n=await a.slice(e,Math.min(a.size,e+l1)).arrayBuffer();e+=n.byteLength,yield new Uint8Array(n)}}async function*js(a,e=!1){for(let t of a)ArrayBuffer.isView(t)?e?yield*$m(t):yield t:ne(t.stream)?yield*t.stream():yield*Om(t)}function*c1(a,e,t=0,n){n??(n=e);let s=t<0?Math.max(e+t,0):Math.min(t,e),o=n<0?Math.max(e+n,0):Math.min(n,e),i=Math.max(o-s,0),r=0;for(let d of a){if(r>=i)break;let p=ArrayBuffer.isView(d)?d.byteLength:d.size;if(s&&p<=s)s-=p,o-=p;else{let l;ArrayBuffer.isView(d)?(l=d.subarray(s,Math.min(p,o)),r+=l.byteLength):(l=d.slice(s,Math.min(p,o)),r+=l.size),o-=p,s=0,yield l}}}var l1,m1=v(()=>{Os();l1=65536});var Ft,u1,ia,zs,fn,Qe,Vs=v(()=>{p1();Os();m1();Ft=function(a,e,t,n){if(t==="a"&&!n)throw new TypeError("Private accessor was defined without a getter");if(typeof e=="function"?a!==e||!n:!e.has(a))throw new TypeError("Cannot read private member from an object whose class did not declare it");return t==="m"?n:t==="a"?n.call(a):n?n.value:e.get(a)},u1=function(a,e,t,n,s){if(n==="m")throw new TypeError("Private method is not writable");if(n==="a"&&!s)throw new TypeError("Private accessor was defined without a setter");if(typeof e=="function"?a!==e||!s:!e.has(a))throw new TypeError("Cannot write private member to an object whose class did not declare it");return n==="a"?s.call(a,t):s?s.value=t:e.set(a,t),t},Qe=class a{constructor(e=[],t={}){if(ia.set(this,[]),zs.set(this,""),fn.set(this,0),t??(t={}),typeof e!="object"||e===null)throw new TypeError("Failed to construct 'Blob': The provided value cannot be converted to a sequence.");if(!ne(e[Symbol.iterator]))throw new TypeError("Failed to construct 'Blob': The object must have a callable @@iterator property.");if(typeof t!="object"&&!ne(t))throw new TypeError("Failed to construct 'Blob': parameter 2 cannot convert to dictionary.");let n=new TextEncoder;for(let o of e){let i;ArrayBuffer.isView(o)?i=new Uint8Array(o.buffer.slice(o.byteOffset,o.byteOffset+o.byteLength)):o instanceof ArrayBuffer?i=new Uint8Array(o.slice(0)):o instanceof a?i=o:i=n.encode(String(o)),u1(this,fn,Ft(this,fn,"f")+(ArrayBuffer.isView(i)?i.byteLength:i.size),"f"),Ft(this,ia,"f").push(i)}let s=t.type===void 0?"":String(t.type);u1(this,zs,/^[\x20-\x7E]*$/.test(s)?s:"","f")}static[(ia=new WeakMap,zs=new WeakMap,fn=new WeakMap,Symbol.hasInstance)](e){return!!(e&&typeof e=="object"&&ne(e.constructor)&&(ne(e.stream)||ne(e.arrayBuffer))&&/^(Blob|File)$/.test(e[Symbol.toStringTag]))}get type(){return Ft(this,zs,"f")}get size(){return Ft(this,fn,"f")}slice(e,t,n){return new a(c1(Ft(this,ia,"f"),this.size,e,t),{type:n})}async text(){let e=new TextDecoder,t="";for await(let n of js(Ft(this,ia,"f")))t+=e.decode(n,{stream:!0});return t+=e.decode(),t}async arrayBuffer(){let e=new Uint8Array(this.size),t=0;for await(let n of js(Ft(this,ia,"f")))e.set(n,t),t+=n.length;return e.buffer}stream(){let e=js(Ft(this,ia,"f"),!0);return new se({async pull(t){let{value:n,done:s}=await e.next();if(s)return queueMicrotask(()=>t.close());t.enqueue(n)},async cancel(){await e.return()}})}get[Symbol.toStringTag](){return"Blob"}};Object.defineProperties(Qe.prototype,{type:{enumerable:!0},size:{enumerable:!0},slice:{enumerable:!0},stream:{enumerable:!0},text:{enumerable:!0},arrayBuffer:{enumerable:!0}})});var g1,h1,qs,Us,We,vn=v(()=>{Vs();g1=function(a,e,t,n,s){if(n==="m")throw new TypeError("Private method is not writable");if(n==="a"&&!s)throw new TypeError("Private accessor was defined without a setter");if(typeof e=="function"?a!==e||!s:!e.has(a))throw new TypeError("Cannot write private member to an object whose class did not declare it");return n==="a"?s.call(a,t):s?s.value=t:e.set(a,t),t},h1=function(a,e,t,n){if(t==="a"&&!n)throw new TypeError("Private accessor was defined without a getter");if(typeof e=="function"?a!==e||!n:!e.has(a))throw new TypeError("Cannot read private member from an object whose class did not declare it");return t==="m"?n:t==="a"?n.call(a):n?n.value:e.get(a)},We=class extends Qe{constructor(e,t,n={}){if(super(e,n),qs.set(this,void 0),Us.set(this,0),arguments.length<2)throw new TypeError(`Failed to construct 'File': 2 arguments required, but only ${arguments.length} present.`);g1(this,qs,String(t),"f");let s=n.lastModified===void 0?Date.now():Number(n.lastModified);Number.isNaN(s)||g1(this,Us,s,"f")}static[(qs=new WeakMap,Us=new WeakMap,Symbol.hasInstance)](e){return e instanceof Qe&&e[Symbol.toStringTag]==="File"&&typeof e.name=="string"}get name(){return h1(this,qs,"f")}get lastModified(){return h1(this,Us,"f")}get webkitRelativePath(){return""}get[Symbol.toStringTag](){return"File"}}});var Ii,Bi=v(()=>{vn();Ii=a=>a instanceof We});var f1,v1=v(()=>{Vs();f1=a=>a instanceof Qe});var b1,y1,w1=v(()=>{b1=require("util"),y1=(0,b1.deprecate)(()=>{},'Constructor "entries" argument is not spec-compliant and will be removed in next major release.')});var x1,et,Hs,tt,Ri,Ws,k1=v(()=>{x1=require("util");vn();Bi();v1();Os();w1();et=function(a,e,t,n){if(t==="a"&&!n)throw new TypeError("Private accessor was defined without a getter");if(typeof e=="function"?a!==e||!n:!e.has(a))throw new TypeError("Cannot read private member from an object whose class did not declare it");return t==="m"?n:t==="a"?n.call(a):n?n.value:e.get(a)},Ws=class{constructor(e){Hs.add(this),tt.set(this,new Map),e&&(y1(),e.forEach(({name:t,value:n,fileName:s})=>this.append(t,n,s)))}static[(tt=new WeakMap,Hs=new WeakSet,Symbol.hasInstance)](e){return!!(e&&ne(e.constructor)&&e[Symbol.toStringTag]==="FormData"&&ne(e.append)&&ne(e.set)&&ne(e.get)&&ne(e.getAll)&&ne(e.has)&&ne(e.delete)&&ne(e.entries)&&ne(e.values)&&ne(e.keys)&&ne(e[Symbol.iterator])&&ne(e.forEach))}append(e,t,n){et(this,Hs,"m",Ri).call(this,{name:e,fileName:n,append:!0,rawValue:t,argsLength:arguments.length})}set(e,t,n){et(this,Hs,"m",Ri).call(this,{name:e,fileName:n,append:!1,rawValue:t,argsLength:arguments.length})}get(e){let t=et(this,tt,"f").get(String(e));return t?t[0]:null}getAll(e){let t=et(this,tt,"f").get(String(e));return t?t.slice():[]}has(e){return et(this,tt,"f").has(String(e))}delete(e){et(this,tt,"f").delete(String(e))}*keys(){for(let e of et(this,tt,"f").keys())yield e}*entries(){for(let e of this.keys()){let t=this.getAll(e);for(let n of t)yield[e,n]}}*values(){for(let[,e]of this)yield e}[(Ri=function({name:t,rawValue:n,append:s,fileName:o,argsLength:i}){let r=s?"append":"set";if(i<2)throw new TypeError(`Failed to execute '${r}' on 'FormData': 2 arguments required, but only ${i} present.`);t=String(t);let d;if(Ii(n))d=o===void 0?n:new We([n],o,{type:n.type,lastModified:n.lastModified});else if(f1(n))d=new We([n],o===void 0?"blob":o,{type:n.type});else{if(o)throw new TypeError(`Failed to execute '${r}' on 'FormData': parameter 2 is not of type 'Blob'.`);d=String(n)}let p=et(this,tt,"f").get(t);if(!p)return void et(this,tt,"f").set(t,[d]);if(!s)return void et(this,tt,"f").set(t,[d]);p.push(d)},Symbol.iterator)](){return this.entries()}forEach(e,t){for(let[n,s]of this)e.call(t,s,n,this)}get[Symbol.toStringTag](){return"FormData"}[x1.inspect.custom](){return this[Symbol.toStringTag]}}});var _1=v(()=>{k1();Vs();vn()});var C1=re((H0,S1)=>{var Ra=1e3,Ma=Ra*60,Da=Ma*60,ra=Da*24,zm=ra*7,Vm=ra*365.25;S1.exports=function(a,e){e=e||{};var t=typeof a;if(t==="string"&&a.length>0)return qm(a);if(t==="number"&&isFinite(a))return e.long?Hm(a):Um(a);throw new Error("val is not a non-empty string or a valid number. val="+JSON.stringify(a))};function qm(a){if(a=String(a),!(a.length>100)){var e=/^(-?(?:\d+)?\.?\d+) *(milliseconds?|msecs?|ms|seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)?$/i.exec(a);if(e){var t=parseFloat(e[1]),n=(e[2]||"ms").toLowerCase();switch(n){case"years":case"year":case"yrs":case"yr":case"y":return t*Vm;case"weeks":case"week":case"w":return t*zm;case"days":case"day":case"d":return t*ra;case"hours":case"hour":case"hrs":case"hr":case"h":return t*Da;case"minutes":case"minute":case"mins":case"min":case"m":return t*Ma;case"seconds":case"second":case"secs":case"sec":case"s":return t*Ra;case"milliseconds":case"millisecond":case"msecs":case"msec":case"ms":return t;default:return}}}}function Um(a){var e=Math.abs(a);return e>=ra?Math.round(a/ra)+"d":e>=Da?Math.round(a/Da)+"h":e>=Ma?Math.round(a/Ma)+"m":e>=Ra?Math.round(a/Ra)+"s":a+"ms"}function Hm(a){var e=Math.abs(a);return e>=ra?Gs(a,e,ra,"day"):e>=Da?Gs(a,e,Da,"hour"):e>=Ma?Gs(a,e,Ma,"minute"):e>=Ra?Gs(a,e,Ra,"second"):a+" ms"}function Gs(a,e,t,n){var s=e>=t*1.5;return Math.round(a/t)+" "+n+(s?"s":"")}});var E1=re((W0,P1)=>{"use strict";var Wm=require("util"),Gm=C1();P1.exports=function(a){if(typeof a=="number")return a;var e=Gm(a);if(e===void 0){var t=new Error(Wm.format("humanize-ms(%j) result undefined",a));console.warn(t.stack)}return e}});var Ys=re((G0,T1)=>{"use strict";T1.exports={CURRENT_ID:Symbol("agentkeepalive#currentId"),CREATE_ID:Symbol("agentkeepalive#createId"),INIT_SOCKET:Symbol("agentkeepalive#initSocket"),CREATE_HTTPS_CONNECTION:Symbol("agentkeepalive#createHttpsConnection"),SOCKET_CREATED_TIME:Symbol("agentkeepalive#socketCreatedTime"),SOCKET_NAME:Symbol("agentkeepalive#socketName"),SOCKET_REQUEST_COUNT:Symbol("agentkeepalive#socketRequestCount"),SOCKET_REQUEST_FINISHED_COUNT:Symbol("agentkeepalive#socketRequestFinishedCount")}});var Oi=re((Y0,B1)=>{"use strict";var Ym=require("http").Agent,Mi=E1(),ke=require("util").debuglog("agentkeepalive"),{INIT_SOCKET:N1,CURRENT_ID:Xs,CREATE_ID:A1,SOCKET_CREATED_TIME:I1,SOCKET_NAME:Ce,SOCKET_REQUEST_COUNT:De,SOCKET_REQUEST_FINISHED_COUNT:at}=Ys(),Li=1,Di=parseInt(process.version.split(".",1)[0].substring(1));Di>=11&&Di<=12?Li=2:Di>=13&&(Li=3);function bn(a){console.log("[agentkeepalive:deprecated] %s",a)}var $i=class extends Ym{constructor(e){e=e||{},e.keepAlive=e.keepAlive!==!1,e.freeSocketTimeout===void 0&&(e.freeSocketTimeout=4e3),e.keepAliveTimeout&&(bn("options.keepAliveTimeout is deprecated, please use options.freeSocketTimeout instead"),e.freeSocketTimeout=e.keepAliveTimeout,delete e.keepAliveTimeout),e.freeSocketKeepAliveTimeout&&(bn("options.freeSocketKeepAliveTimeout is deprecated, please use options.freeSocketTimeout instead"),e.freeSocketTimeout=e.freeSocketKeepAliveTimeout,delete e.freeSocketKeepAliveTimeout),e.timeout===void 0&&(e.timeout=Math.max(e.freeSocketTimeout*2,8e3)),e.timeout=Mi(e.timeout),e.freeSocketTimeout=Mi(e.freeSocketTimeout),e.socketActiveTTL=e.socketActiveTTL?Mi(e.socketActiveTTL):0,super(e),this[Xs]=0,this.createSocketCount=0,this.createSocketCountLastCheck=0,this.createSocketErrorCount=0,this.createSocketErrorCountLastCheck=0,this.closeSocketCount=0,this.closeSocketCountLastCheck=0,this.errorSocketCount=0,this.errorSocketCountLastCheck=0,this.requestCount=0,this.requestCountLastCheck=0,this.timeoutSocketCount=0,this.timeoutSocketCountLastCheck=0,this.on("free",t=>{let n=this.calcSocketTimeout(t);n>0&&t.timeout!==n&&t.setTimeout(n)})}get freeSocketKeepAliveTimeout(){return bn("agent.freeSocketKeepAliveTimeout is deprecated, please use agent.options.freeSocketTimeout instead"),this.options.freeSocketTimeout}get timeout(){return bn("agent.timeout is deprecated, please use agent.options.timeout instead"),this.options.timeout}get socketActiveTTL(){return bn("agent.socketActiveTTL is deprecated, please use agent.options.socketActiveTTL instead"),this.options.socketActiveTTL}calcSocketTimeout(e){let t=this.options.freeSocketTimeout,n=this.options.socketActiveTTL;if(n){let s=Date.now()-e[I1],o=n-s;if(o<=0)return o;t&&o<t&&(t=o)}if(t)return e.freeSocketTimeout||e.freeSocketKeepAliveTimeout||t}keepSocketAlive(e){let t=super.keepSocketAlive(e);if(!t)return t;let n=this.calcSocketTimeout(e);return typeof n>"u"?!0:n<=0?(ke("%s(requests: %s, finished: %s) free but need to destroy by TTL, request count %s, diff is %s",e[Ce],e[De],e[at],n),!1):(e.timeout!==n&&e.setTimeout(n),!0)}reuseSocket(...e){super.reuseSocket(...e);let t=e[0],n=e[1];n.reusedSocket=!0;let s=this.options.timeout;yn(t)!==s&&(t.setTimeout(s),ke("%s reset timeout to %sms",t[Ce],s)),t[De]++,ke("%s(requests: %s, finished: %s) reuse on addRequest, timeout %sms",t[Ce],t[De],t[at],yn(t))}[A1](){let e=this[Xs]++;return this[Xs]===Number.MAX_SAFE_INTEGER&&(this[Xs]=0),e}[N1](e,t){t.timeout&&(yn(e)||e.setTimeout(t.timeout)),this.options.keepAlive&&e.setNoDelay(!0),this.createSocketCount++,this.options.socketActiveTTL&&(e[I1]=Date.now()),e[Ce]=`sock[${this[A1]()}#${t._agentKey}]`.split("-----BEGIN",1)[0],e[De]=1,e[at]=0,Xm(this,e,t)}createConnection(e,t){let n=!1,s=(i,r)=>{if(!n){if(n=!0,i)return this.createSocketErrorCount++,t(i);this[N1](r,e),t(i,r)}},o=super.createConnection(e,s);return o&&s(null,o),o}get statusChanged(){let e=this.createSocketCount!==this.createSocketCountLastCheck||this.createSocketErrorCount!==this.createSocketErrorCountLastCheck||this.closeSocketCount!==this.closeSocketCountLastCheck||this.errorSocketCount!==this.errorSocketCountLastCheck||this.timeoutSocketCount!==this.timeoutSocketCountLastCheck||this.requestCount!==this.requestCountLastCheck;return e&&(this.createSocketCountLastCheck=this.createSocketCount,this.createSocketErrorCountLastCheck=this.createSocketErrorCount,this.closeSocketCountLastCheck=this.closeSocketCount,this.errorSocketCountLastCheck=this.errorSocketCount,this.timeoutSocketCountLastCheck=this.timeoutSocketCount,this.requestCountLastCheck=this.requestCount),e}getCurrentStatus(){return{createSocketCount:this.createSocketCount,createSocketErrorCount:this.createSocketErrorCount,closeSocketCount:this.closeSocketCount,errorSocketCount:this.errorSocketCount,timeoutSocketCount:this.timeoutSocketCount,requestCount:this.requestCount,freeSockets:Fi(this.freeSockets),sockets:Fi(this.sockets),requests:Fi(this.requests)}}};function yn(a){return a.timeout||a._idleTimeout}function Xm(a,e,t){ke("%s create, timeout %sms",e[Ce],yn(e));function n(){if(!e._httpMessage&&e[De]===1)return;e[at]++,a.requestCount++,ke("%s(requests: %s, finished: %s) free",e[Ce],e[De],e[at]);let d=a.getName(t);e.writable&&a.requests[d]&&a.requests[d].length&&(e[De]++,ke("%s(requests: %s, finished: %s) will be reuse on agent free event",e[Ce],e[De],e[at]))}e.on("free",n);function s(d){ke("%s(requests: %s, finished: %s) close, isError: %s",e[Ce],e[De],e[at],d),a.closeSocketCount++}e.on("close",s);function o(){let d=e.listeners("timeout").length,p=yn(e),l=e._httpMessage,c=l&&l.listeners("timeout").length||0;ke("%s(requests: %s, finished: %s) timeout after %sms, listeners %s, defaultTimeoutListenerCount %s, hasHttpRequest %s, HttpRequest timeoutListenerCount %s",e[Ce],e[De],e[at],p,d,Li,!!l,c),ke.enabled&&ke("timeout listeners: %s",e.listeners("timeout").map(u=>u.name).join(", ")),a.timeoutSocketCount++;let m=a.getName(t);if(a.freeSockets[m]&&a.freeSockets[m].indexOf(e)!==-1)e.destroy(),a.removeSocket(e,t),ke("%s is free, destroy quietly",e[Ce]);else if(c===0){let u=new Error("Socket timeout");u.code="ERR_SOCKET_TIMEOUT",u.timeout=p,e.destroy(u),a.removeSocket(e,t),ke("%s destroy with timeout error",e[Ce])}}e.on("timeout",o);function i(d){let p=e.listeners("error").length;ke("%s(requests: %s, finished: %s) error: %s, listenerCount: %s",e[Ce],e[De],e[at],d,p),a.errorSocketCount++,p===1&&(ke("%s emit uncaught error event",e[Ce]),e.removeListener("error",i),e.emit("error",d))}e.on("error",i);function r(){ke("%s(requests: %s, finished: %s) agentRemove",e[Ce],e[De],e[at]),e.removeListener("close",s),e.removeListener("error",i),e.removeListener("free",n),e.removeListener("timeout",o),e.removeListener("agentRemove",r)}e.on("agentRemove",r)}B1.exports=$i;function Fi(a){let e={};for(let t in a)e[t]=a[t].length;return e}});var D1=re((X0,M1)=>{"use strict";var ji=require("https").Agent,Km=Oi(),{INIT_SOCKET:Jm,CREATE_HTTPS_CONNECTION:R1}=Ys(),wn=class extends Km{constructor(e){super(e),this.defaultPort=443,this.protocol="https:",this.maxCachedSessions=this.options.maxCachedSessions,this.maxCachedSessions===void 0&&(this.maxCachedSessions=100),this._sessionCache={map:{},list:[]}}createConnection(e,t){let n=this[R1](e,t);return this[Jm](n,e),n}};wn.prototype[R1]=ji.prototype.createConnection;["getName","_getSession","_cacheSession","_evictSession"].forEach(function(a){typeof ji.prototype[a]=="function"&&(wn.prototype[a]=ji.prototype[a])});M1.exports=wn});var L1=re((K0,xn)=>{"use strict";var F1=Oi();xn.exports=F1;xn.exports.HttpAgent=F1;xn.exports.HttpsAgent=D1();xn.exports.constants=Ys()});var G1=re((Sn,_n)=>{"use strict";Object.defineProperty(Sn,"__esModule",{value:!0});var q1=new WeakMap,zi=new WeakMap;function X(a){let e=q1.get(a);return console.assert(e!=null,"'this' is expected an Event object, but got",a),e}function $1(a){if(a.passiveListener!=null){typeof console<"u"&&typeof console.error=="function"&&console.error("Unable to preventDefault inside passive event listener invocation.",a.passiveListener);return}a.event.cancelable&&(a.canceled=!0,typeof a.event.preventDefault=="function"&&a.event.preventDefault())}function Fa(a,e){q1.set(this,{eventTarget:a,event:e,eventPhase:2,currentTarget:a,canceled:!1,stopped:!1,immediateStopped:!1,passiveListener:null,timeStamp:e.timeStamp||Date.now()}),Object.defineProperty(this,"isTrusted",{value:!1,enumerable:!0});let t=Object.keys(e);for(let n=0;n<t.length;++n){let s=t[n];s in this||Object.defineProperty(this,s,U1(s))}}Fa.prototype={get type(){return X(this).event.type},get target(){return X(this).eventTarget},get currentTarget(){return X(this).currentTarget},composedPath(){let a=X(this).currentTarget;return a==null?[]:[a]},get NONE(){return 0},get CAPTURING_PHASE(){return 1},get AT_TARGET(){return 2},get BUBBLING_PHASE(){return 3},get eventPhase(){return X(this).eventPhase},stopPropagation(){let a=X(this);a.stopped=!0,typeof a.event.stopPropagation=="function"&&a.event.stopPropagation()},stopImmediatePropagation(){let a=X(this);a.stopped=!0,a.immediateStopped=!0,typeof a.event.stopImmediatePropagation=="function"&&a.event.stopImmediatePropagation()},get bubbles(){return!!X(this).event.bubbles},get cancelable(){return!!X(this).event.cancelable},preventDefault(){$1(X(this))},get defaultPrevented(){return X(this).canceled},get composed(){return!!X(this).event.composed},get timeStamp(){return X(this).timeStamp},get srcElement(){return X(this).eventTarget},get cancelBubble(){return X(this).stopped},set cancelBubble(a){if(!a)return;let e=X(this);e.stopped=!0,typeof e.event.cancelBubble=="boolean"&&(e.event.cancelBubble=!0)},get returnValue(){return!X(this).canceled},set returnValue(a){a||$1(X(this))},initEvent(){}};Object.defineProperty(Fa.prototype,"constructor",{value:Fa,configurable:!0,writable:!0});typeof window<"u"&&typeof window.Event<"u"&&(Object.setPrototypeOf(Fa.prototype,window.Event.prototype),zi.set(window.Event.prototype,Fa));function U1(a){return{get(){return X(this).event[a]},set(e){X(this).event[a]=e},configurable:!0,enumerable:!0}}function Zm(a){return{value(){let e=X(this).event;return e[a].apply(e,arguments)},configurable:!0,enumerable:!0}}function Qm(a,e){let t=Object.keys(e);if(t.length===0)return a;function n(s,o){a.call(this,s,o)}n.prototype=Object.create(a.prototype,{constructor:{value:n,configurable:!0,writable:!0}});for(let s=0;s<t.length;++s){let o=t[s];if(!(o in a.prototype)){let r=typeof Object.getOwnPropertyDescriptor(e,o).value=="function";Object.defineProperty(n.prototype,o,r?Zm(o):U1(o))}}return n}function H1(a){if(a==null||a===Object.prototype)return Fa;let e=zi.get(a);return e==null&&(e=Qm(H1(Object.getPrototypeOf(a)),a),zi.set(a,e)),e}function e2(a,e){let t=H1(Object.getPrototypeOf(e));return new t(a,e)}function t2(a){return X(a).immediateStopped}function a2(a,e){X(a).eventPhase=e}function n2(a,e){X(a).currentTarget=e}function O1(a,e){X(a).passiveListener=e}var W1=new WeakMap,j1=1,z1=2,Ks=3;function Js(a){return a!==null&&typeof a=="object"}function kn(a){let e=W1.get(a);if(e==null)throw new TypeError("'this' is expected an EventTarget object, but got another value.");return e}function s2(a){return{get(){let t=kn(this).get(a);for(;t!=null;){if(t.listenerType===Ks)return t.listener;t=t.next}return null},set(e){typeof e!="function"&&!Js(e)&&(e=null);let t=kn(this),n=null,s=t.get(a);for(;s!=null;)s.listenerType===Ks?n!==null?n.next=s.next:s.next!==null?t.set(a,s.next):t.delete(a):n=s,s=s.next;if(e!==null){let o={listener:e,listenerType:Ks,passive:!1,once:!1,next:null};n===null?t.set(a,o):n.next=o}},configurable:!0,enumerable:!0}}function Vi(a,e){Object.defineProperty(a,`on${e}`,s2(e))}function V1(a){function e(){Ge.call(this)}e.prototype=Object.create(Ge.prototype,{constructor:{value:e,configurable:!0,writable:!0}});for(let t=0;t<a.length;++t)Vi(e.prototype,a[t]);return e}function Ge(){if(this instanceof Ge){W1.set(this,new Map);return}if(arguments.length===1&&Array.isArray(arguments[0]))return V1(arguments[0]);if(arguments.length>0){let a=new Array(arguments.length);for(let e=0;e<arguments.length;++e)a[e]=arguments[e];return V1(a)}throw new TypeError("Cannot call a class as a function")}Ge.prototype={addEventListener(a,e,t){if(e==null)return;if(typeof e!="function"&&!Js(e))throw new TypeError("'listener' should be a function or an object.");let n=kn(this),s=Js(t),i=(s?!!t.capture:!!t)?j1:z1,r={listener:e,listenerType:i,passive:s&&!!t.passive,once:s&&!!t.once,next:null},d=n.get(a);if(d===void 0){n.set(a,r);return}let p=null;for(;d!=null;){if(d.listener===e&&d.listenerType===i)return;p=d,d=d.next}p.next=r},removeEventListener(a,e,t){if(e==null)return;let n=kn(this),o=(Js(t)?!!t.capture:!!t)?j1:z1,i=null,r=n.get(a);for(;r!=null;){if(r.listener===e&&r.listenerType===o){i!==null?i.next=r.next:r.next!==null?n.set(a,r.next):n.delete(a);return}i=r,r=r.next}},dispatchEvent(a){if(a==null||typeof a.type!="string")throw new TypeError('"event.type" should be a string.');let e=kn(this),t=a.type,n=e.get(t);if(n==null)return!0;let s=e2(this,a),o=null;for(;n!=null;){if(n.once?o!==null?o.next=n.next:n.next!==null?e.set(t,n.next):e.delete(t):o=n,O1(s,n.passive?n.listener:null),typeof n.listener=="function")try{n.listener.call(this,s)}catch(i){typeof console<"u"&&typeof console.error=="function"&&console.error(i)}else n.listenerType!==Ks&&typeof n.listener.handleEvent=="function"&&n.listener.handleEvent(s);if(t2(s))break;n=n.next}return O1(s,null),a2(s,0),n2(s,null),!s.defaultPrevented}};Object.defineProperty(Ge.prototype,"constructor",{value:Ge,configurable:!0,writable:!0});typeof window<"u"&&typeof window.EventTarget<"u"&&Object.setPrototypeOf(Ge.prototype,window.EventTarget.prototype);Sn.defineEventAttribute=Vi;Sn.EventTarget=Ge;Sn.default=Ge;_n.exports=Ge;_n.exports.EventTarget=_n.exports.default=Ge;_n.exports.defineEventAttribute=Vi});var K1=re((Pn,Cn)=>{"use strict";Object.defineProperty(Pn,"__esModule",{value:!0});var qi=G1(),Lt=class extends qi.EventTarget{constructor(){throw super(),new TypeError("AbortSignal cannot be constructed directly")}get aborted(){let e=Zs.get(this);if(typeof e!="boolean")throw new TypeError(`Expected 'this' to be an 'AbortSignal' object, but got ${this===null?"null":typeof this}`);return e}};qi.defineEventAttribute(Lt.prototype,"abort");function o2(){let a=Object.create(Lt.prototype);return qi.EventTarget.call(a),Zs.set(a,!1),a}function i2(a){Zs.get(a)===!1&&(Zs.set(a,!0),a.dispatchEvent({type:"abort"}))}var Zs=new WeakMap;Object.defineProperties(Lt.prototype,{aborted:{enumerable:!0}});typeof Symbol=="function"&&typeof Symbol.toStringTag=="symbol"&&Object.defineProperty(Lt.prototype,Symbol.toStringTag,{configurable:!0,value:"AbortSignal"});var $t=class{constructor(){X1.set(this,o2())}get signal(){return Y1(this)}abort(){i2(Y1(this))}},X1=new WeakMap;function Y1(a){let e=X1.get(a);if(e==null)throw new TypeError(`Expected 'this' to be an 'AbortController' object, but got ${a===null?"null":typeof a}`);return e}Object.defineProperties($t.prototype,{signal:{enumerable:!0},abort:{enumerable:!0}});typeof Symbol=="function"&&typeof Symbol.toStringTag=="symbol"&&Object.defineProperty($t.prototype,Symbol.toStringTag,{configurable:!0,value:"AbortController"});Pn.AbortController=$t;Pn.AbortSignal=Lt;Pn.default=$t;Cn.exports=$t;Cn.exports.AbortController=Cn.exports.default=$t;Cn.exports.AbortSignal=Lt});function r2(){let a=16,e="";for(;a--;)e+=J1[Math.random()*J1.length<<0];return e}var J1,Z1,Q1=v(()=>{J1="abcdefghijklmnopqrstuvwxyz0123456789";Z1=r2});function p2(a){if(d2(a)!=="object")return!1;let e=Object.getPrototypeOf(a);return e==null?!0:(e.constructor&&e.constructor.toString())===Object.toString()}var d2,Ui,el=v(()=>{d2=a=>Object.prototype.toString.call(a).slice(8,-1).toLowerCase();Ui=p2});var l2,Hi,tl=v(()=>{l2=a=>String(a).replace(/\r|\n/g,(e,t,n)=>e==="\r"&&n[t+1]!==`
`||e===`
`&&n[t-1]!=="\r"?`\r
`:e),Hi=l2});var c2,Wi,al=v(()=>{c2=a=>String(a).replace(/\r/g,"%0D").replace(/\n/g,"%0A").replace(/"/g,"%22"),Wi=c2});var m2,yt,Gi=v(()=>{m2=a=>typeof a=="function",yt=m2});var da,Yi=v(()=>{Gi();da=a=>!!(a&&typeof a=="object"&&yt(a.constructor)&&a[Symbol.toStringTag]==="File"&&yt(a.stream)&&a.name!=null&&a.size!=null&&a.lastModified!=null)});var nl,Xi=v(()=>{Gi();nl=a=>!!(a&&yt(a.constructor)&&a[Symbol.toStringTag]==="FormData"&&yt(a.append)&&yt(a.getAll)&&yt(a.entries)&&yt(a[Symbol.iterator]))});var En,K,Qs,Ot,Tn,eo,Nn,pa,An,In,to,Ki,u2,ao,sl=v(()=>{Q1();el();tl();al();Yi();Xi();En=function(a,e,t,n,s){if(n==="m")throw new TypeError("Private method is not writable");if(n==="a"&&!s)throw new TypeError("Private accessor was defined without a setter");if(typeof e=="function"?a!==e||!s:!e.has(a))throw new TypeError("Cannot write private member to an object whose class did not declare it");return n==="a"?s.call(a,t):s?s.value=t:e.set(a,t),t},K=function(a,e,t,n){if(t==="a"&&!n)throw new TypeError("Private accessor was defined without a getter");if(typeof e=="function"?a!==e||!n:!e.has(a))throw new TypeError("Cannot read private member from an object whose class did not declare it");return t==="m"?n:t==="a"?n.call(a):n?n.value:e.get(a)},u2={enableAdditionalHeaders:!1},ao=class{constructor(e,t,n){if(Qs.add(this),Ot.set(this,`\r
`),Tn.set(this,void 0),eo.set(this,void 0),Nn.set(this,"-".repeat(2)),pa.set(this,new TextEncoder),An.set(this,void 0),In.set(this,void 0),to.set(this,void 0),!nl(e))throw new TypeError("Expected first argument to be a FormData instance.");let s;if(Ui(t)?n=t:s=t,s||(s=Z1()),typeof s!="string")throw new TypeError("Expected boundary argument to be a string.");if(n&&!Ui(n))throw new TypeError("Expected options argument to be an object.");En(this,In,e,"f"),En(this,to,{...u2,...n},"f"),En(this,Tn,K(this,pa,"f").encode(K(this,Ot,"f")),"f"),En(this,eo,K(this,Tn,"f").byteLength,"f"),this.boundary=`form-data-boundary-${s}`,this.contentType=`multipart/form-data; boundary=${this.boundary}`,En(this,An,K(this,pa,"f").encode(`${K(this,Nn,"f")}${this.boundary}${K(this,Nn,"f")}${K(this,Ot,"f").repeat(2)}`),"f"),this.contentLength=String(this.getContentLength()),this.headers=Object.freeze({"Content-Type":this.contentType,"Content-Length":this.contentLength}),Object.defineProperties(this,{boundary:{writable:!1,configurable:!1},contentType:{writable:!1,configurable:!1},contentLength:{writable:!1,configurable:!1},headers:{writable:!1,configurable:!1}})}getContentLength(){let e=0;for(let[t,n]of K(this,In,"f")){let s=da(n)?n:K(this,pa,"f").encode(Hi(n));e+=K(this,Qs,"m",Ki).call(this,t,s).byteLength,e+=da(s)?s.size:s.byteLength,e+=K(this,eo,"f")}return e+K(this,An,"f").byteLength}*values(){for(let[e,t]of K(this,In,"f").entries()){let n=da(t)?t:K(this,pa,"f").encode(Hi(t));yield K(this,Qs,"m",Ki).call(this,e,n),yield n,yield K(this,Tn,"f")}yield K(this,An,"f")}async*encode(){for(let e of this.values())da(e)?yield*e.stream():yield e}[(Ot=new WeakMap,Tn=new WeakMap,eo=new WeakMap,Nn=new WeakMap,pa=new WeakMap,An=new WeakMap,In=new WeakMap,to=new WeakMap,Qs=new WeakSet,Ki=function(t,n){let s="";return s+=`${K(this,Nn,"f")}${this.boundary}${K(this,Ot,"f")}`,s+=`Content-Disposition: form-data; name="${Wi(t)}"`,da(n)&&(s+=`; filename="${Wi(n.name)}"${K(this,Ot,"f")}`,s+=`Content-Type: ${n.type||"application/octet-stream"}`),K(this,to,"f").enableAdditionalHeaders===!0&&(s+=`${K(this,Ot,"f")}Content-Length: ${da(n)?n.size:n.byteLength}`),K(this,pa,"f").encode(`${s}${K(this,Ot,"f").repeat(2)}`)},Symbol.iterator)](){return this.values()}[Symbol.asyncIterator](){return this.encode()}}});var ol=v(()=>{});var il=v(()=>{});var rl=v(()=>{sl();ol();il();Yi();Xi()});var no,dl=v(()=>{no=class{constructor(e){this.body=e}get[Symbol.toStringTag](){return"MultipartBody"}}});var ll=re((wu,pl)=>{if(!globalThis.DOMException)try{let{MessageChannel:a}=require("worker_threads"),e=new a().port1,t=new ArrayBuffer;e.postMessage(t,[t,t])}catch(a){a.constructor.name==="DOMException"&&(globalThis.DOMException=a.constructor)}pl.exports=globalThis.DOMException});function h2(a){if(g2(a)!=="object")return!1;let e=Object.getPrototypeOf(a);return e==null?!0:(e.constructor&&e.constructor.toString())===Object.toString()}var g2,cl,ml=v(()=>{g2=a=>Object.prototype.toString.call(a).slice(8,-1).toLowerCase();cl=h2});var vl={};Et(vl,{fileFromPath:()=>b2,fileFromPathSync:()=>v2,isFile:()=>Ii});function fl(a,{mtimeMs:e,size:t},n,s={}){let o;cl(n)?[s,o]=[n,void 0]:o=n;let i=new Ji({path:a,size:t,lastModified:e});return o||(o=i.name),new We([i],o,{...s,lastModified:i.lastModified})}function v2(a,e,t={}){let n=(0,ca.statSync)(a);return fl(a,n,e,t)}async function b2(a,e,t){let n=await ca.promises.stat(a);return fl(a,n,e,t)}var ca,gl,hl,ul,La,la,Bn,f2,Ji,bl=v(()=>{ca=require("fs"),gl=require("path"),hl=q(ll(),1);vn();ml();Bi();ul=function(a,e,t,n,s){if(n==="m")throw new TypeError("Private method is not writable");if(n==="a"&&!s)throw new TypeError("Private accessor was defined without a setter");if(typeof e=="function"?a!==e||!s:!e.has(a))throw new TypeError("Cannot write private member to an object whose class did not declare it");return n==="a"?s.call(a,t):s?s.value=t:e.set(a,t),t},La=function(a,e,t,n){if(t==="a"&&!n)throw new TypeError("Private accessor was defined without a getter");if(typeof e=="function"?a!==e||!n:!e.has(a))throw new TypeError("Cannot read private member from an object whose class did not declare it");return t==="m"?n:t==="a"?n.call(a):n?n.value:e.get(a)},f2="The requested file could not be read, typically due to permission problems that have occurred after a reference to a file was acquired.",Ji=class a{constructor(e){la.set(this,void 0),Bn.set(this,void 0),ul(this,la,e.path,"f"),ul(this,Bn,e.start||0,"f"),this.name=(0,gl.basename)(La(this,la,"f")),this.size=e.size,this.lastModified=e.lastModified}slice(e,t){return new a({path:La(this,la,"f"),lastModified:this.lastModified,size:t-e,start:e})}async*stream(){let{mtimeMs:e}=await ca.promises.stat(La(this,la,"f"));if(e>this.lastModified)throw new hl.default(f2,"NotReadableError");this.size&&(yield*(0,ca.createReadStream)(La(this,la,"f"),{start:La(this,Bn,"f"),end:La(this,Bn,"f")+this.size-1}))}get[(la=new WeakMap,Bn=new WeakMap,Symbol.toStringTag)](){return"File"}}});async function y2(a,...e){let{fileFromPath:t}=await Promise.resolve().then(()=>(bl(),vl));return yl||(console.warn(`fileFromPath is deprecated; use fs.createReadStream(${JSON.stringify(a)}) instead`),yl=!0),await t(a,...e)}async function k2(a,e){let t=new ao(a),n=kl.Readable.from(t),s=new no(n),o={...e.headers,...t.headers,"Content-Length":t.contentLength};return{...e,body:s,headers:o}}function Sl(){return typeof AbortController>"u"&&(globalThis.AbortController=wl.AbortController),{kind:"node",fetch:jt.default,Request:jt.Request,Response:jt.Response,Headers:jt.Headers,FormData:Ws,Blob:Qe,File:We,ReadableStream:_l.ReadableStream,getMultipartRequestOptions:k2,getDefaultAgent:a=>a.startsWith("https")?x2:w2,fileFromPath:y2,isFsReadStream:a=>a instanceof xl.ReadStream}}var jt,Zi,wl,xl,kl,_l,yl,w2,x2,Cl=v(()=>{jt=q(Ud(),1);_1();Zi=q(L1(),1),wl=q(K1(),1),xl=require("node:fs");rl();kl=require("node:stream");dl();_l=require("node:stream/web"),yl=!1;w2=new Zi.default({keepAlive:!0,timeout:300*1e3}),x2=new Zi.default.HttpsAgent({keepAlive:!0,timeout:300*1e3})});var Pl=v(()=>{Cl()});var Rn=v(()=>{Vo();Pl();Vo();Kt||od(Sl(),{auto:!0})});var N,le,he,zt,$a,Mn,Dn,Fn,Ln,$n,On,jn,zn,nt=v(()=>{Oa();N=class extends Error{},le=class a extends N{constructor(e,t,n,s){super(`${a.makeMessage(e,t,n)}`),this.status=e,this.headers=s,this.request_id=s?.["request-id"],this.error=t}static makeMessage(e,t,n){let s=t?.message?typeof t.message=="string"?t.message:JSON.stringify(t.message):t?JSON.stringify(t):n;return e&&s?`${e} ${s}`:e?`${e} status code (no body)`:s||"(no status code or body)"}static generate(e,t,n,s){if(!e)return new zt({message:n,cause:so(t)});let o=t;return e===400?new Mn(e,o,n,s):e===401?new Dn(e,o,n,s):e===403?new Fn(e,o,n,s):e===404?new Ln(e,o,n,s):e===409?new $n(e,o,n,s):e===422?new On(e,o,n,s):e===429?new jn(e,o,n,s):e>=500?new zn(e,o,n,s):new a(e,o,n,s)}},he=class extends le{constructor({message:e}={}){super(void 0,void 0,e||"Request was aborted.",void 0),this.status=void 0}},zt=class extends le{constructor({message:e,cause:t}){super(void 0,void 0,e||"Connection error.",void 0),this.status=void 0,t&&(this.cause=t)}},$a=class extends zt{constructor({message:e}={}){super({message:e??"Request timed out."})}},Mn=class extends le{constructor(){super(...arguments),this.status=400}},Dn=class extends le{constructor(){super(...arguments),this.status=401}},Fn=class extends le{constructor(){super(...arguments),this.status=403}},Ln=class extends le{constructor(){super(...arguments),this.status=404}},$n=class extends le{constructor(){super(...arguments),this.status=409}},On=class extends le{constructor(){super(...arguments),this.status=422}},jn=class extends le{constructor(){super(...arguments),this.status=429}},zn=class extends le{}});var wt,Qi=v(()=>{nt();wt=class a{constructor(){this.buffer=[],this.trailingCR=!1}decode(e){let t=this.decodeText(e);if(this.trailingCR&&(t="\r"+t,this.trailingCR=!1),t.endsWith("\r")&&(this.trailingCR=!0,t=t.slice(0,-1)),!t)return[];let n=a.NEWLINE_CHARS.has(t[t.length-1]||""),s=t.split(a.NEWLINE_REGEXP);return n&&s.pop(),s.length===1&&!n?(this.buffer.push(s[0]),[]):(this.buffer.length>0&&(s=[this.buffer.join("")+s[0],...s.slice(1)],this.buffer=[]),n||(this.buffer=[s.pop()||""]),s)}decodeText(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof Buffer<"u"){if(e instanceof Buffer)return e.toString();if(e instanceof Uint8Array)return Buffer.from(e).toString();throw new N(`Unexpected: received non-Uint8Array (${e.constructor.name}) stream chunk in an environment with a global "Buffer" defined, which this library assumes to be Node. Please report this error.`)}if(typeof TextDecoder<"u"){if(e instanceof Uint8Array||e instanceof ArrayBuffer)return this.textDecoder??(this.textDecoder=new TextDecoder("utf8")),this.textDecoder.decode(e);throw new N(`Unexpected: received non-Uint8Array/ArrayBuffer (${e.constructor.name}) in a web platform. Please report this error.`)}throw new N("Unexpected: neither Buffer nor TextDecoder are available as globals. Please report this error.")}flush(){if(!this.buffer.length&&!this.trailingCR)return[];let e=[this.buffer.join("")];return this.buffer=[],this.trailingCR=!1,e}};wt.NEWLINE_CHARS=new Set([`
`,"\r"]);wt.NEWLINE_REGEXP=/\r\n|[\n\r]/g});async function*C2(a,e){if(!a.body)throw e.abort(),new N("Attempted to iterate over a response with no body");let t=new er,n=new wt,s=oo(a.body);for await(let o of P2(s))for(let i of n.decode(o)){let r=t.decode(i);r&&(yield r)}for(let o of n.flush()){let i=t.decode(o);i&&(yield i)}}async function*P2(a){let e=new Uint8Array;for await(let t of a){if(t==null)continue;let n=t instanceof ArrayBuffer?new Uint8Array(t):typeof t=="string"?new TextEncoder().encode(t):t,s=new Uint8Array(e.length+n.length);s.set(e),s.set(n,e.length),e=s;let o;for(;(o=E2(e))!==-1;)yield e.slice(0,o),e=e.slice(o)}e.length>0&&(yield e)}function E2(a){for(let n=0;n<a.length-2;n++){if(a[n]===10&&a[n+1]===10||a[n]===13&&a[n+1]===13)return n+2;if(a[n]===13&&a[n+1]===10&&n+3<a.length&&a[n+2]===13&&a[n+3]===10)return n+4}return-1}function T2(a,e){let t=a.indexOf(e);return t!==-1?[a.substring(0,t),e,a.substring(t+e.length)]:[a,"",""]}function oo(a){if(a[Symbol.asyncIterator])return a;let e=a.getReader();return{async next(){try{let t=await e.read();return t?.done&&e.releaseLock(),t}catch(t){throw e.releaseLock(),t}},async return(){let t=e.cancel();return e.releaseLock(),await t,{done:!0,value:void 0}},[Symbol.asyncIterator](){return this}}}var st,er,Vn=v(()=>{Rn();nt();Qi();Oa();nt();st=class a{constructor(e,t){this.iterator=e,this.controller=t}static fromSSEResponse(e,t){let n=!1;async function*s(){if(n)throw new Error("Cannot iterate over a consumed stream, use `.tee()` to split the stream.");n=!0;let o=!1;try{for await(let i of C2(e,t)){if(i.event==="completion")try{yield JSON.parse(i.data)}catch(r){throw console.error("Could not parse message into JSON:",i.data),console.error("From chunk:",i.raw),r}if(i.event==="message_start"||i.event==="message_delta"||i.event==="message_stop"||i.event==="content_block_start"||i.event==="content_block_delta"||i.event==="content_block_stop")try{yield JSON.parse(i.data)}catch(r){throw console.error("Could not parse message into JSON:",i.data),console.error("From chunk:",i.raw),r}if(i.event!=="ping"&&i.event==="error")throw le.generate(void 0,`SSE Error: ${i.data}`,i.data,tr(e.headers))}o=!0}catch(i){if(i instanceof Error&&i.name==="AbortError")return;throw i}finally{o||t.abort()}}return new a(s,t)}static fromReadableStream(e,t){let n=!1;async function*s(){let i=new wt,r=oo(e);for await(let d of r)for(let p of i.decode(d))yield p;for(let d of i.flush())yield d}async function*o(){if(n)throw new Error("Cannot iterate over a consumed stream, use `.tee()` to split the stream.");n=!0;let i=!1;try{for await(let r of s())i||r&&(yield JSON.parse(r));i=!0}catch(r){if(r instanceof Error&&r.name==="AbortError")return;throw r}finally{i||t.abort()}}return new a(o,t)}[Symbol.asyncIterator](){return this.iterator()}tee(){let e=[],t=[],n=this.iterator(),s=o=>({next:()=>{if(o.length===0){let i=n.next();e.push(i),t.push(i)}return o.shift()}});return[new a(()=>s(e),this.controller),new a(()=>s(t),this.controller)]}toReadableStream(){let e=this,t,n=new TextEncoder;return new jo({async start(){t=e[Symbol.asyncIterator]()},async pull(s){try{let{value:o,done:i}=await t.next();if(i)return s.close();let r=n.encode(JSON.stringify(o)+`
`);s.enqueue(r)}catch(o){s.error(o)}},async cancel(){await t.return?.()}})}};er=class{constructor(){this.event=null,this.data=[],this.chunks=[]}decode(e){if(e.endsWith("\r")&&(e=e.substring(0,e.length-1)),!e){if(!this.event&&!this.data.length)return null;let o={event:this.event,data:this.data.join(`
`),raw:this.chunks};return this.event=null,this.data=[],this.chunks=[],o}if(this.chunks.push(e),e.startsWith(":"))return null;let[t,n,s]=T2(e,":");return s.startsWith(" ")&&(s=s.substring(1)),t==="event"?this.event=s:t==="data"&&this.data.push(s),null}}});async function El(a,e,t){if(a=await a,A2(a))return a;if(N2(a)){let s=await a.blob();e||(e=new URL(a.url).pathname.split(/[\\/]/).pop()??"unknown_file");let o=qn(s)?[await s.arrayBuffer()]:[s];return new os(o,e,t)}let n=await I2(a);if(e||(e=R2(a)??"unknown_file"),!t?.type){let s=n[0]?.type;typeof s=="string"&&(t={...t,type:s})}return new os(n,e,t)}async function I2(a){let e=[];if(typeof a=="string"||ArrayBuffer.isView(a)||a instanceof ArrayBuffer)e.push(a);else if(qn(a))e.push(await a.arrayBuffer());else if(M2(a))for await(let t of a)e.push(t);else throw new Error(`Unexpected data type: ${typeof a}; constructor: ${a?.constructor?.name}; props: ${B2(a)}`);return e}function B2(a){return`[${Object.getOwnPropertyNames(a).map(t=>`"${t}"`).join(", ")}]`}function R2(a){return ar(a.name)||ar(a.filename)||ar(a.path)?.split(/[\\/]/).pop()}var N2,A2,qn,ar,M2,nr,sr=v(()=>{Rn();Rn();N2=a=>a!=null&&typeof a=="object"&&typeof a.url=="string"&&typeof a.blob=="function",A2=a=>a!=null&&typeof a=="object"&&typeof a.name=="string"&&typeof a.lastModified=="number"&&qn(a),qn=a=>a!=null&&typeof a=="object"&&typeof a.size=="number"&&typeof a.type=="string"&&typeof a.text=="function"&&typeof a.slice=="function"&&typeof a.arrayBuffer=="function";ar=a=>{if(typeof a=="string")return a;if(typeof Buffer<"u"&&a instanceof Buffer)return String(a)},M2=a=>a!=null&&typeof a=="object"&&typeof a[Symbol.asyncIterator]=="function",nr=a=>a&&typeof a=="object"&&a.body&&a[Symbol.toStringTag]==="MultipartBody"});async function Rl(a){let{response:e}=a;if(a.options.stream)return ja("response",e.status,e.url,e.headers,e.body),a.options.__streamClass?a.options.__streamClass.fromSSEResponse(e,a.controller):st.fromSSEResponse(e,a.controller);if(e.status===204)return null;if(a.options.__binaryResponse)return e;let t=e.headers.get("content-type");if(t?.includes("application/json")||t?.includes("application/vnd.api+json")){let o=await e.json();return ja("response",e.status,e.url,e.headers,o),o}let s=await e.text();return ja("response",e.status,e.url,e.headers,s),s}function j2(){if(typeof navigator>"u"||!navigator)return null;let a=[{key:"edge",pattern:/Edge(?:\W+(\d+)\.(\d+)(?:\.(\d+))?)?/},{key:"ie",pattern:/MSIE(?:\W+(\d+)\.(\d+)(?:\.(\d+))?)?/},{key:"ie",pattern:/Trident(?:.*rv\:(\d+)\.(\d+)(?:\.(\d+))?)?/},{key:"chrome",pattern:/Chrome(?:\W+(\d+)\.(\d+)(?:\.(\d+))?)?/},{key:"firefox",pattern:/Firefox(?:\W+(\d+)\.(\d+)(?:\.(\d+))?)?/},{key:"safari",pattern:/(?:Version\W+(\d+)\.(\d+)(?:\.(\d+))?)?(?:\W+Mobile\S*)?\W+Safari/}];for(let{key:e,pattern:t}of a){let n=t.exec(navigator.userAgent);if(n){let s=n[1]||0,o=n[2]||0,i=n[3]||0;return{browser:e,version:`${s}.${o}.${i}`}}}return null}function Hn(a){if(!a)return!0;for(let e in a)return!1;return!0}function Ml(a,e){return Object.prototype.hasOwnProperty.call(a,e)}function Il(a,e){for(let t in e){if(!Ml(e,t))continue;let n=t.toLowerCase();if(!n)continue;let s=e[t];s===null?delete a[n]:s!==void 0&&(a[n]=s)}}function ja(a,...e){typeof process<"u"&&process?.env?.DEBUG==="true"&&console.log(`Anthropic:DEBUG:${a}`,...e)}var F2,L2,io,ro,po,lo,ir,tr,$2,Un,O2,Tl,Nl,Al,z2,V2,q2,U2,H2,or,so,co,W2,Dl,G2,Bl,Oa=v(()=>{ed();Vn();nt();Rn();sr();F2=function(a,e,t,n,s){if(n==="m")throw new TypeError("Private method is not writable");if(n==="a"&&!s)throw new TypeError("Private accessor was defined without a setter");if(typeof e=="function"?a!==e||!s:!e.has(a))throw new TypeError("Cannot write private member to an object whose class did not declare it");return n==="a"?s.call(a,t):s?s.value=t:e.set(a,t),t},L2=function(a,e,t,n){if(t==="a"&&!n)throw new TypeError("Private accessor was defined without a getter");if(typeof e=="function"?a!==e||!n:!e.has(a))throw new TypeError("Cannot read private member from an object whose class did not declare it");return t==="m"?n:t==="a"?n.call(a):n?n.value:e.get(a)};ro=class a extends Promise{constructor(e,t=Rl){super(n=>{n(null)}),this.responsePromise=e,this.parseResponse=t}_thenUnwrap(e){return new a(this.responsePromise,async t=>e(await this.parseResponse(t),t))}asResponse(){return this.responsePromise.then(e=>e.response)}async withResponse(){let[e,t]=await Promise.all([this.parse(),this.asResponse()]);return{data:e,response:t}}parse(){return this.parsedPromise||(this.parsedPromise=this.responsePromise.then(this.parseResponse)),this.parsedPromise}then(e,t){return this.parse().then(e,t)}catch(e){return this.parse().catch(e)}finally(e){return this.parse().finally(e)}},po=class{constructor({baseURL:e,maxRetries:t=2,timeout:n=6e5,httpAgent:s,fetch:o}){this.baseURL=e,this.maxRetries=or("maxRetries",t),this.timeout=or("timeout",n),this.httpAgent=s,this.fetch=o??Oo}authHeaders(e){return{}}defaultHeaders(e){return{Accept:"application/json","Content-Type":"application/json","User-Agent":this.getUserAgent(),...z2(),...this.authHeaders(e)}}validateHeaders(e,t){}defaultIdempotencyKey(){return`stainless-node-retry-${W2()}`}get(e,t){return this.methodRequest("get",e,t)}post(e,t){return this.methodRequest("post",e,t)}patch(e,t){return this.methodRequest("patch",e,t)}put(e,t){return this.methodRequest("put",e,t)}delete(e,t){return this.methodRequest("delete",e,t)}methodRequest(e,t,n){return this.request(Promise.resolve(n).then(async s=>{let o=s&&qn(s?.body)?new DataView(await s.body.arrayBuffer()):s?.body instanceof DataView?s.body:s?.body instanceof ArrayBuffer?new DataView(s.body):s&&ArrayBuffer.isView(s?.body)?new DataView(s.body.buffer):s?.body;return{method:e,path:t,...s,body:o}}))}getAPIList(e,t,n){return this.requestAPIList(t,{method:"get",path:e,...n})}calculateContentLength(e){if(typeof e=="string"){if(typeof Buffer<"u")return Buffer.byteLength(e,"utf8").toString();if(typeof TextEncoder<"u")return new TextEncoder().encode(e).length.toString()}else if(ArrayBuffer.isView(e))return e.byteLength.toString();return null}buildRequest(e,{retryCount:t=0}={}){let{method:n,path:s,query:o,headers:i={}}=e,r=ArrayBuffer.isView(e.body)||e.__binaryRequest&&typeof e.body=="string"?e.body:nr(e.body)?e.body.body:e.body?JSON.stringify(e.body,null,2):null,d=this.calculateContentLength(r),p=this.buildURL(s,o);"timeout"in e&&or("timeout",e.timeout);let l=e.timeout??this.timeout,c=e.httpAgent??this.httpAgent??zo(p),m=l+1e3;typeof c?.options?.timeout=="number"&&m>(c.options.timeout??0)&&(c.options.timeout=m),this.idempotencyHeader&&n!=="get"&&(e.idempotencyKey||(e.idempotencyKey=this.defaultIdempotencyKey()),i[this.idempotencyHeader]=e.idempotencyKey);let u=this.buildHeaders({options:e,headers:i,contentLength:d,retryCount:t});return{req:{method:n,...r&&{body:r},headers:u,...c&&{agent:c},signal:e.signal??null},url:p,timeout:l}}buildHeaders({options:e,headers:t,contentLength:n,retryCount:s}){let o={};n&&(o["content-length"]=n);let i=this.defaultHeaders(e);return Il(o,i),Il(o,t),nr(e.body)&&Kt!=="node"&&delete o["content-type"],Bl(i,"x-stainless-retry-count")===void 0&&Bl(t,"x-stainless-retry-count")===void 0&&(o["x-stainless-retry-count"]=String(s)),this.validateHeaders(o,t),o}async prepareOptions(e){}async prepareRequest(e,{url:t,options:n}){}parseHeaders(e){return e?Symbol.iterator in e?Object.fromEntries(Array.from(e).map(t=>[...t])):{...e}:{}}makeStatusError(e,t,n,s){return le.generate(e,t,n,s)}request(e,t=null){return new ro(this.makeRequest(e,t))}async makeRequest(e,t){let n=await e,s=n.maxRetries??this.maxRetries;t==null&&(t=s),await this.prepareOptions(n);let{req:o,url:i,timeout:r}=this.buildRequest(n,{retryCount:s-t});if(await this.prepareRequest(o,{url:i,options:n}),ja("request",i,n,o.headers),n.signal?.aborted)throw new he;let d=new AbortController,p=await this.fetchWithTimeout(i,o,r,d).catch(so);if(p instanceof Error){if(n.signal?.aborted)throw new he;if(t)return this.retryRequest(n,t);throw p.name==="AbortError"?new $a:new zt({cause:p})}let l=tr(p.headers);if(!p.ok){if(t&&this.shouldRetry(p)){let f=`retrying, ${t} attempts remaining`;return ja(`response (error; ${f})`,p.status,i,l),this.retryRequest(n,t,l)}let c=await p.text().catch(f=>so(f).message),m=V2(c),u=m?void 0:c;throw ja(`response (error; ${t?"(error; no more retries left)":"(error; not retryable)"})`,p.status,i,l,u),this.makeStatusError(p.status,m,u,l)}return{response:p,options:n,controller:d}}requestAPIList(e,t){let n=this.makeRequest(t,null);return new ir(this,n,e)}buildURL(e,t){let n=U2(e)?new URL(e):new URL(this.baseURL+(this.baseURL.endsWith("/")&&e.startsWith("/")?e.slice(1):e)),s=this.defaultQuery();return Hn(s)||(t={...s,...t}),typeof t=="object"&&t&&!Array.isArray(t)&&(n.search=this.stringifyQuery(t)),n.toString()}stringifyQuery(e){return Object.entries(e).filter(([t,n])=>typeof n<"u").map(([t,n])=>{if(typeof n=="string"||typeof n=="number"||typeof n=="boolean")return`${encodeURIComponent(t)}=${encodeURIComponent(n)}`;if(n===null)return`${encodeURIComponent(t)}=`;throw new N(`Cannot stringify type ${typeof n}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`)}).join("&")}async fetchWithTimeout(e,t,n,s){let{signal:o,...i}=t||{};o&&o.addEventListener("abort",()=>s.abort());let r=setTimeout(()=>s.abort(),n);return this.getRequestClient().fetch.call(void 0,e,{signal:s.signal,...i}).finally(()=>{clearTimeout(r)})}getRequestClient(){return{fetch:this.fetch}}shouldRetry(e){let t=e.headers.get("x-should-retry");return t==="true"?!0:t==="false"?!1:e.status===408||e.status===409||e.status===429||e.status>=500}async retryRequest(e,t,n){let s,o=n?.["retry-after-ms"];if(o){let r=parseFloat(o);Number.isNaN(r)||(s=r)}let i=n?.["retry-after"];if(i&&!s){let r=parseFloat(i);Number.isNaN(r)?s=Date.parse(i)-Date.now():s=r*1e3}if(!(s&&0<=s&&s<60*1e3)){let r=e.maxRetries??this.maxRetries;s=this.calculateDefaultRetryTimeoutMillis(t,r)}return await H2(s),this.makeRequest(e,t-1)}calculateDefaultRetryTimeoutMillis(e,t){let o=t-e,i=Math.min(.5*Math.pow(2,o),8),r=1-Math.random()*.25;return i*r*1e3}getUserAgent(){return`${this.constructor.name}/JS ${Xt}`}},lo=class{constructor(e,t,n,s){io.set(this,void 0),F2(this,io,e,"f"),this.options=s,this.response=t,this.body=n}hasNextPage(){return this.getPaginatedItems().length?this.nextPageInfo()!=null:!1}async getNextPage(){let e=this.nextPageInfo();if(!e)throw new N("No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.");let t={...this.options};if("params"in e&&typeof t.query=="object")t.query={...t.query,...e.params};else if("url"in e){let n=[...Object.entries(t.query||{}),...e.url.searchParams.entries()];for(let[s,o]of n)e.url.searchParams.set(s,o);t.query=void 0,t.path=e.url.toString()}return await L2(this,io,"f").requestAPIList(this.constructor,t)}async*iterPages(){let e=this;for(yield e;e.hasNextPage();)e=await e.getNextPage(),yield e}async*[(io=new WeakMap,Symbol.asyncIterator)](){for await(let e of this.iterPages())for(let t of e.getPaginatedItems())yield t}},ir=class extends ro{constructor(e,t,n){super(t,async s=>new n(e,s.response,await Rl(s),s.options))}async*[Symbol.asyncIterator](){let e=await this;for await(let t of e)yield t}},tr=a=>new Proxy(Object.fromEntries(a.entries()),{get(e,t){let n=t.toString();return e[n.toLowerCase()]||e[n]}}),$2={method:!0,path:!0,query:!0,body:!0,headers:!0,maxRetries:!0,stream:!0,timeout:!0,httpAgent:!0,signal:!0,idempotencyKey:!0,__binaryRequest:!0,__binaryResponse:!0,__streamClass:!0},Un=a=>typeof a=="object"&&a!==null&&!Hn(a)&&Object.keys(a).every(e=>Ml($2,e)),O2=()=>{if(typeof Deno<"u"&&Deno.build!=null)return{"X-Stainless-Lang":"js","X-Stainless-Package-Version":Xt,"X-Stainless-OS":Nl(Deno.build.os),"X-Stainless-Arch":Tl(Deno.build.arch),"X-Stainless-Runtime":"deno","X-Stainless-Runtime-Version":typeof Deno.version=="string"?Deno.version:Deno.version?.deno??"unknown"};if(typeof EdgeRuntime<"u")return{"X-Stainless-Lang":"js","X-Stainless-Package-Version":Xt,"X-Stainless-OS":"Unknown","X-Stainless-Arch":`other:${EdgeRuntime}`,"X-Stainless-Runtime":"edge","X-Stainless-Runtime-Version":process.version};if(Object.prototype.toString.call(typeof process<"u"?process:0)==="[object process]")return{"X-Stainless-Lang":"js","X-Stainless-Package-Version":Xt,"X-Stainless-OS":Nl(process.platform),"X-Stainless-Arch":Tl(process.arch),"X-Stainless-Runtime":"node","X-Stainless-Runtime-Version":process.version};let a=j2();return a?{"X-Stainless-Lang":"js","X-Stainless-Package-Version":Xt,"X-Stainless-OS":"Unknown","X-Stainless-Arch":"unknown","X-Stainless-Runtime":`browser:${a.browser}`,"X-Stainless-Runtime-Version":a.version}:{"X-Stainless-Lang":"js","X-Stainless-Package-Version":Xt,"X-Stainless-OS":"Unknown","X-Stainless-Arch":"unknown","X-Stainless-Runtime":"unknown","X-Stainless-Runtime-Version":"unknown"}};Tl=a=>a==="x32"?"x32":a==="x86_64"||a==="x64"?"x64":a==="arm"?"arm":a==="aarch64"||a==="arm64"?"arm64":a?`other:${a}`:"unknown",Nl=a=>(a=a.toLowerCase(),a.includes("ios")?"iOS":a==="android"?"Android":a==="darwin"?"MacOS":a==="win32"?"Windows":a==="freebsd"?"FreeBSD":a==="openbsd"?"OpenBSD":a==="linux"?"Linux":a?`Other:${a}`:"Unknown"),z2=()=>Al??(Al=O2()),V2=a=>{try{return JSON.parse(a)}catch{return}},q2=new RegExp("^(?:[a-z]+:)?//","i"),U2=a=>q2.test(a),H2=a=>new Promise(e=>setTimeout(e,a)),or=(a,e)=>{if(typeof e!="number"||!Number.isInteger(e))throw new N(`${a} must be an integer`);if(e<0)throw new N(`${a} must be a positive integer`);return e},so=a=>{if(a instanceof Error)return a;if(typeof a=="object"&&a!==null)try{return new Error(JSON.stringify(a))}catch{}return new Error(String(a))},co=a=>{if(typeof process<"u")return process.env?.[a]?.trim()??void 0;if(typeof Deno<"u")return Deno.env?.get?.(a)?.trim()};W2=()=>"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,a=>{let e=Math.random()*16|0;return(a==="x"?e:e&3|8).toString(16)}),Dl=()=>typeof window<"u"&&typeof window.document<"u"&&typeof navigator<"u",G2=a=>typeof a?.get=="function",Bl=(a,e)=>{let t=e.toLowerCase();if(G2(a)){let n=e[0]?.toUpperCase()+e.substring(1).replace(/([^\w])(\w)/g,(s,o,i)=>o+i.toUpperCase());for(let s of[e,t,e.toUpperCase(),n]){let o=a.get(s);if(o)return o}}for(let[n,s]of Object.entries(a))if(n.toLowerCase()===t)return Array.isArray(s)?(s.length<=1||console.warn(`Received ${s.length} entries for the ${e} header, using the first entry.`),s[0]):s}});var mo,Fl=v(()=>{Oa();mo=class extends lo{constructor(e,t,n,s){super(e,t,n,s),this.data=n.data||[],this.has_more=n.has_more||!1,this.first_id=n.first_id||null,this.last_id=n.last_id||null}getPaginatedItems(){return this.data??[]}nextPageParams(){let e=this.nextPageInfo();if(!e)return null;if("params"in e)return e.params;let t=Object.fromEntries(e.url.searchParams);return Object.keys(t).length?t:null}nextPageInfo(){if(this.options.query?.before_id){let t=this.first_id;return t?{params:{before_id:t}}:null}let e=this.last_id;return e?{params:{after_id:e}}:null}}});var be,Vt=v(()=>{be=class{constructor(e){this._client=e}}});var uo,Ll=v(()=>{nt();Vn();Qi();uo=class a{constructor(e,t){this.iterator=e,this.controller=t}async*decoder(){let e=new wt;for await(let t of this.iterator)for(let n of e.decode(t))yield JSON.parse(n);for(let t of e.flush())yield JSON.parse(t)}[Symbol.asyncIterator](){return this.decoder()}static fromResponse(e,t){if(!e.body)throw t.abort(),new N("Attempted to iterate over a response with no body");return new a(oo(e.body),t)}}});var ma,za,rr=v(()=>{Vt();Oa();Fl();Ll();nt();ma=class extends be{create(e,t){let{betas:n,...s}=e;return this._client.post("/v1/messages/batches?beta=true",{body:s,...t,headers:{"anthropic-beta":[...n??[],"message-batches-2024-09-24"].toString(),...t?.headers}})}retrieve(e,t={},n){if(Un(t))return this.retrieve(e,{},t);let{betas:s}=t;return this._client.get(`/v1/messages/batches/${e}?beta=true`,{...n,headers:{"anthropic-beta":[...s??[],"message-batches-2024-09-24"].toString(),...n?.headers}})}list(e={},t){if(Un(e))return this.list({},e);let{betas:n,...s}=e;return this._client.getAPIList("/v1/messages/batches?beta=true",za,{query:s,...t,headers:{"anthropic-beta":[...n??[],"message-batches-2024-09-24"].toString(),...t?.headers}})}cancel(e,t={},n){if(Un(t))return this.cancel(e,{},t);let{betas:s}=t;return this._client.post(`/v1/messages/batches/${e}/cancel?beta=true`,{...n,headers:{"anthropic-beta":[...s??[],"message-batches-2024-09-24"].toString(),...n?.headers}})}async results(e,t={},n){if(Un(t))return this.results(e,{},t);let s=await this.retrieve(e);if(!s.results_url)throw new N(`No batch \`results_url\`; Has it finished processing? ${s.processing_status} - ${s.id}`);let{betas:o}=t;return this._client.get(s.results_url,{...n,headers:{"anthropic-beta":[...o??[],"message-batches-2024-09-24"].toString(),...n?.headers},__binaryResponse:!0})._thenUnwrap((i,r)=>uo.fromResponse(r.response,r.controller))}},za=class extends mo{};ma.BetaMessageBatchesPage=za});var qt,dr=v(()=>{Vt();rr();rr();qt=class extends be{constructor(){super(...arguments),this.batches=new ma(this._client)}create(e,t){let{betas:n,...s}=e;return this._client.post("/v1/messages?beta=true",{body:s,timeout:this._client._options.timeout??6e5,...t,headers:{...n?.toString()!=null?{"anthropic-beta":n?.toString()}:void 0,...t?.headers},stream:e.stream??!1})}countTokens(e,t){let{betas:n,...s}=e;return this._client.post("/v1/messages/count_tokens?beta=true",{body:s,...t,headers:{"anthropic-beta":[...n??[],"token-counting-2024-11-01"].toString(),...t?.headers}})}};qt.Batches=ma;qt.BetaMessageBatchesPage=za});var J2,Va,Z2,Q2,go,pr=v(()=>{J2=a=>{let e=0,t=[];for(;e<a.length;){let n=a[e];if(n==="\\"){e++;continue}if(n==="{"){t.push({type:"brace",value:"{"}),e++;continue}if(n==="}"){t.push({type:"brace",value:"}"}),e++;continue}if(n==="["){t.push({type:"paren",value:"["}),e++;continue}if(n==="]"){t.push({type:"paren",value:"]"}),e++;continue}if(n===":"){t.push({type:"separator",value:":"}),e++;continue}if(n===","){t.push({type:"delimiter",value:","}),e++;continue}if(n==='"'){let r="",d=!1;for(n=a[++e];n!=='"';){if(e===a.length){d=!0;break}if(n==="\\"){if(e++,e===a.length){d=!0;break}r+=n+a[e],n=a[++e]}else r+=n,n=a[++e]}n=a[++e],d||t.push({type:"string",value:r});continue}if(n&&/\s/.test(n)){e++;continue}let o=/[0-9]/;if(n&&o.test(n)||n==="-"||n==="."){let r="";for(n==="-"&&(r+=n,n=a[++e]);n&&o.test(n)||n===".";)r+=n,n=a[++e];t.push({type:"number",value:r});continue}let i=/[a-z]/i;if(n&&i.test(n)){let r="";for(;n&&i.test(n)&&e!==a.length;)r+=n,n=a[++e];if(r=="true"||r=="false"||r==="null")t.push({type:"name",value:r});else{e++;continue}continue}e++}return t},Va=a=>{if(a.length===0)return a;let e=a[a.length-1];switch(e.type){case"separator":return a=a.slice(0,a.length-1),Va(a);break;case"number":let t=e.value[e.value.length-1];if(t==="."||t==="-")return a=a.slice(0,a.length-1),Va(a);case"string":let n=a[a.length-2];if(n?.type==="delimiter")return a=a.slice(0,a.length-1),Va(a);if(n?.type==="brace"&&n.value==="{")return a=a.slice(0,a.length-1),Va(a);break;case"delimiter":return a=a.slice(0,a.length-1),Va(a);break}return a},Z2=a=>{let e=[];return a.map(t=>{t.type==="brace"&&(t.value==="{"?e.push("}"):e.splice(e.lastIndexOf("}"),1)),t.type==="paren"&&(t.value==="["?e.push("]"):e.splice(e.lastIndexOf("]"),1))}),e.length>0&&e.reverse().map(t=>{t==="}"?a.push({type:"brace",value:"}"}):t==="]"&&a.push({type:"paren",value:"]"})}),a},Q2=a=>{let e="";return a.map(t=>{t.type==="string"?e+='"'+t.value+'"':e+=t.value}),e},go=a=>JSON.parse(Q2(Z2(Va(J2(a)))))});var Pe,R,Fe,Ut,ho,fo,Wn,Gn,vo,Yn,xt,Xn,bo,yo,qa,lr,$l,cr,mr,ur,gr,Ol,jl,wo,zl=v(()=>{nt();Vn();pr();Pe=function(a,e,t,n,s){if(n==="m")throw new TypeError("Private method is not writable");if(n==="a"&&!s)throw new TypeError("Private accessor was defined without a setter");if(typeof e=="function"?a!==e||!s:!e.has(a))throw new TypeError("Cannot write private member to an object whose class did not declare it");return n==="a"?s.call(a,t):s?s.value=t:e.set(a,t),t},R=function(a,e,t,n){if(t==="a"&&!n)throw new TypeError("Private accessor was defined without a getter");if(typeof e=="function"?a!==e||!n:!e.has(a))throw new TypeError("Cannot read private member from an object whose class did not declare it");return t==="m"?n:t==="a"?n.call(a):n?n.value:e.get(a)},jl="__json_buf",wo=class a{constructor(){Fe.add(this),this.messages=[],this.receivedMessages=[],Ut.set(this,void 0),this.controller=new AbortController,ho.set(this,void 0),fo.set(this,()=>{}),Wn.set(this,()=>{}),Gn.set(this,void 0),vo.set(this,()=>{}),Yn.set(this,()=>{}),xt.set(this,{}),Xn.set(this,!1),bo.set(this,!1),yo.set(this,!1),qa.set(this,!1),cr.set(this,e=>{if(Pe(this,bo,!0,"f"),e instanceof Error&&e.name==="AbortError"&&(e=new he),e instanceof he)return Pe(this,yo,!0,"f"),this._emit("abort",e);if(e instanceof N)return this._emit("error",e);if(e instanceof Error){let t=new N(e.message);return t.cause=e,this._emit("error",t)}return this._emit("error",new N(String(e)))}),Pe(this,ho,new Promise((e,t)=>{Pe(this,fo,e,"f"),Pe(this,Wn,t,"f")}),"f"),Pe(this,Gn,new Promise((e,t)=>{Pe(this,vo,e,"f"),Pe(this,Yn,t,"f")}),"f"),R(this,ho,"f").catch(()=>{}),R(this,Gn,"f").catch(()=>{})}static fromReadableStream(e){let t=new a;return t._run(()=>t._fromReadableStream(e)),t}static createMessage(e,t,n){let s=new a;for(let o of t.messages)s._addPromptCachingBetaMessageParam(o);return s._run(()=>s._createPromptCachingBetaMessage(e,{...t,stream:!0},{...n,headers:{...n?.headers,"X-Stainless-Helper-Method":"stream"}})),s}_run(e){e().then(()=>{this._emitFinal(),this._emit("end")},R(this,cr,"f"))}_addPromptCachingBetaMessageParam(e){this.messages.push(e)}_addPromptCachingBetaMessage(e,t=!0){this.receivedMessages.push(e),t&&this._emit("message",e)}async _createPromptCachingBetaMessage(e,t,n){let s=n?.signal;s&&(s.aborted&&this.controller.abort(),s.addEventListener("abort",()=>this.controller.abort())),R(this,Fe,"m",mr).call(this);let o=await e.create({...t,stream:!0},{...n,signal:this.controller.signal});this._connected();for await(let i of o)R(this,Fe,"m",ur).call(this,i);if(o.controller.signal?.aborted)throw new he;R(this,Fe,"m",gr).call(this)}_connected(){this.ended||(R(this,fo,"f").call(this),this._emit("connect"))}get ended(){return R(this,Xn,"f")}get errored(){return R(this,bo,"f")}get aborted(){return R(this,yo,"f")}abort(){this.controller.abort()}on(e,t){return(R(this,xt,"f")[e]||(R(this,xt,"f")[e]=[])).push({listener:t}),this}off(e,t){let n=R(this,xt,"f")[e];if(!n)return this;let s=n.findIndex(o=>o.listener===t);return s>=0&&n.splice(s,1),this}once(e,t){return(R(this,xt,"f")[e]||(R(this,xt,"f")[e]=[])).push({listener:t,once:!0}),this}emitted(e){return new Promise((t,n)=>{Pe(this,qa,!0,"f"),e!=="error"&&this.once("error",n),this.once(e,t)})}async done(){Pe(this,qa,!0,"f"),await R(this,Gn,"f")}get currentMessage(){return R(this,Ut,"f")}async finalMessage(){return await this.done(),R(this,Fe,"m",lr).call(this)}async finalText(){return await this.done(),R(this,Fe,"m",$l).call(this)}_emit(e,...t){if(R(this,Xn,"f"))return;e==="end"&&(Pe(this,Xn,!0,"f"),R(this,vo,"f").call(this));let n=R(this,xt,"f")[e];if(n&&(R(this,xt,"f")[e]=n.filter(s=>!s.once),n.forEach(({listener:s})=>s(...t))),e==="abort"){let s=t[0];!R(this,qa,"f")&&!n?.length&&Promise.reject(s),R(this,Wn,"f").call(this,s),R(this,Yn,"f").call(this,s),this._emit("end");return}if(e==="error"){let s=t[0];!R(this,qa,"f")&&!n?.length&&Promise.reject(s),R(this,Wn,"f").call(this,s),R(this,Yn,"f").call(this,s),this._emit("end")}}_emitFinal(){this.receivedMessages.at(-1)&&this._emit("finalPromptCachingBetaMessage",R(this,Fe,"m",lr).call(this))}async _fromReadableStream(e,t){let n=t?.signal;n&&(n.aborted&&this.controller.abort(),n.addEventListener("abort",()=>this.controller.abort())),R(this,Fe,"m",mr).call(this),this._connected();let s=st.fromReadableStream(e,this.controller);for await(let o of s)R(this,Fe,"m",ur).call(this,o);if(s.controller.signal?.aborted)throw new he;R(this,Fe,"m",gr).call(this)}[(Ut=new WeakMap,ho=new WeakMap,fo=new WeakMap,Wn=new WeakMap,Gn=new WeakMap,vo=new WeakMap,Yn=new WeakMap,xt=new WeakMap,Xn=new WeakMap,bo=new WeakMap,yo=new WeakMap,qa=new WeakMap,cr=new WeakMap,Fe=new WeakSet,lr=function(){if(this.receivedMessages.length===0)throw new N("stream ended without producing a PromptCachingBetaMessage with role=assistant");return this.receivedMessages.at(-1)},$l=function(){if(this.receivedMessages.length===0)throw new N("stream ended without producing a PromptCachingBetaMessage with role=assistant");let t=this.receivedMessages.at(-1).content.filter(n=>n.type==="text").map(n=>n.text);if(t.length===0)throw new N("stream ended without producing a content block with type=text");return t.join(" ")},mr=function(){this.ended||Pe(this,Ut,void 0,"f")},ur=function(t){if(this.ended)return;let n=R(this,Fe,"m",Ol).call(this,t);switch(this._emit("streamEvent",t,n),t.type){case"content_block_delta":{let s=n.content.at(-1);t.delta.type==="text_delta"&&s.type==="text"?this._emit("text",t.delta.text,s.text||""):t.delta.type==="input_json_delta"&&s.type==="tool_use"&&s.input&&this._emit("inputJson",t.delta.partial_json,s.input);break}case"message_stop":{this._addPromptCachingBetaMessageParam(n),this._addPromptCachingBetaMessage(n,!0);break}case"content_block_stop":{this._emit("contentBlock",n.content.at(-1));break}case"message_start":{Pe(this,Ut,n,"f");break}case"content_block_start":case"message_delta":break}},gr=function(){if(this.ended)throw new N("stream has ended, this shouldn't happen");let t=R(this,Ut,"f");if(!t)throw new N("request ended without sending any chunks");return Pe(this,Ut,void 0,"f"),t},Ol=function(t){let n=R(this,Ut,"f");if(t.type==="message_start"){if(n)throw new N(`Unexpected event order, got ${t.type} before receiving "message_stop"`);return t.message}if(!n)throw new N(`Unexpected event order, got ${t.type} before "message_start"`);switch(t.type){case"message_stop":return n;case"message_delta":return n.stop_reason=t.delta.stop_reason,n.stop_sequence=t.delta.stop_sequence,n.usage.output_tokens=t.usage.output_tokens,n;case"content_block_start":return n.content.push(t.content_block),n;case"content_block_delta":{let s=n.content.at(t.index);if(s?.type==="text"&&t.delta.type==="text_delta")s.text+=t.delta.text;else if(s?.type==="tool_use"&&t.delta.type==="input_json_delta"){let o=s[jl]||"";o+=t.delta.partial_json,Object.defineProperty(s,jl,{value:o,enumerable:!1,writable:!0}),o&&(s.input=go(o))}return n}case"content_block_stop":return n}},Symbol.asyncIterator)](){let e=[],t=[],n=!1;return this.on("streamEvent",s=>{let o=t.shift();o?o.resolve(s):e.push(s)}),this.on("end",()=>{n=!0;for(let s of t)s.resolve(void 0);t.length=0}),this.on("abort",s=>{n=!0;for(let o of t)o.reject(s);t.length=0}),this.on("error",s=>{n=!0;for(let o of t)o.reject(s);t.length=0}),{next:async()=>e.length?{value:e.shift(),done:!1}:n?{value:void 0,done:!0}:new Promise((o,i)=>t.push({resolve:o,reject:i})).then(o=>o?{value:o,done:!1}:{value:void 0,done:!0}),return:async()=>(this.abort(),{value:void 0,done:!0})}}toReadableStream(){return new st(this[Symbol.asyncIterator].bind(this),this.controller).toReadableStream()}}});var Ua,hr=v(()=>{Vt();zl();Ua=class extends be{create(e,t){let{betas:n,...s}=e;return this._client.post("/v1/messages?beta=prompt_caching",{body:s,timeout:this._client._options.timeout??6e5,...t,headers:{"anthropic-beta":[...n??[],"prompt-caching-2024-07-31"].toString(),...t?.headers},stream:e.stream??!1})}stream(e,t){return wo.createMessage(this,e,t)}}});var ua,fr=v(()=>{Vt();hr();hr();ua=class extends be{constructor(){super(...arguments),this.messages=new Ua(this._client)}};ua.Messages=Ua});var kt,vr=v(()=>{Vt();dr();dr();fr();fr();kt=class extends be{constructor(){super(...arguments),this.messages=new qt(this._client),this.promptCaching=new ua(this._client)}};kt.Messages=qt;kt.PromptCaching=ua});var ga,br=v(()=>{Vt();ga=class extends be{create(e,t){return this._client.post("/v1/complete",{body:e,timeout:this._client._options.timeout??6e5,...t,stream:e.stream??!1})}}});var Ee,M,Le,Ht,xo,ko,Kn,Jn,_o,Zn,_t,Qn,So,Co,Ha,yr,Vl,wr,xr,kr,_r,ql,Ul,Po,Hl=v(()=>{nt();Vn();pr();Ee=function(a,e,t,n,s){if(n==="m")throw new TypeError("Private method is not writable");if(n==="a"&&!s)throw new TypeError("Private accessor was defined without a setter");if(typeof e=="function"?a!==e||!s:!e.has(a))throw new TypeError("Cannot write private member to an object whose class did not declare it");return n==="a"?s.call(a,t):s?s.value=t:e.set(a,t),t},M=function(a,e,t,n){if(t==="a"&&!n)throw new TypeError("Private accessor was defined without a getter");if(typeof e=="function"?a!==e||!n:!e.has(a))throw new TypeError("Cannot read private member from an object whose class did not declare it");return t==="m"?n:t==="a"?n.call(a):n?n.value:e.get(a)},Ul="__json_buf",Po=class a{constructor(){Le.add(this),this.messages=[],this.receivedMessages=[],Ht.set(this,void 0),this.controller=new AbortController,xo.set(this,void 0),ko.set(this,()=>{}),Kn.set(this,()=>{}),Jn.set(this,void 0),_o.set(this,()=>{}),Zn.set(this,()=>{}),_t.set(this,{}),Qn.set(this,!1),So.set(this,!1),Co.set(this,!1),Ha.set(this,!1),wr.set(this,e=>{if(Ee(this,So,!0,"f"),e instanceof Error&&e.name==="AbortError"&&(e=new he),e instanceof he)return Ee(this,Co,!0,"f"),this._emit("abort",e);if(e instanceof N)return this._emit("error",e);if(e instanceof Error){let t=new N(e.message);return t.cause=e,this._emit("error",t)}return this._emit("error",new N(String(e)))}),Ee(this,xo,new Promise((e,t)=>{Ee(this,ko,e,"f"),Ee(this,Kn,t,"f")}),"f"),Ee(this,Jn,new Promise((e,t)=>{Ee(this,_o,e,"f"),Ee(this,Zn,t,"f")}),"f"),M(this,xo,"f").catch(()=>{}),M(this,Jn,"f").catch(()=>{})}static fromReadableStream(e){let t=new a;return t._run(()=>t._fromReadableStream(e)),t}static createMessage(e,t,n){let s=new a;for(let o of t.messages)s._addMessageParam(o);return s._run(()=>s._createMessage(e,{...t,stream:!0},{...n,headers:{...n?.headers,"X-Stainless-Helper-Method":"stream"}})),s}_run(e){e().then(()=>{this._emitFinal(),this._emit("end")},M(this,wr,"f"))}_addMessageParam(e){this.messages.push(e)}_addMessage(e,t=!0){this.receivedMessages.push(e),t&&this._emit("message",e)}async _createMessage(e,t,n){let s=n?.signal;s&&(s.aborted&&this.controller.abort(),s.addEventListener("abort",()=>this.controller.abort())),M(this,Le,"m",xr).call(this);let o=await e.create({...t,stream:!0},{...n,signal:this.controller.signal});this._connected();for await(let i of o)M(this,Le,"m",kr).call(this,i);if(o.controller.signal?.aborted)throw new he;M(this,Le,"m",_r).call(this)}_connected(){this.ended||(M(this,ko,"f").call(this),this._emit("connect"))}get ended(){return M(this,Qn,"f")}get errored(){return M(this,So,"f")}get aborted(){return M(this,Co,"f")}abort(){this.controller.abort()}on(e,t){return(M(this,_t,"f")[e]||(M(this,_t,"f")[e]=[])).push({listener:t}),this}off(e,t){let n=M(this,_t,"f")[e];if(!n)return this;let s=n.findIndex(o=>o.listener===t);return s>=0&&n.splice(s,1),this}once(e,t){return(M(this,_t,"f")[e]||(M(this,_t,"f")[e]=[])).push({listener:t,once:!0}),this}emitted(e){return new Promise((t,n)=>{Ee(this,Ha,!0,"f"),e!=="error"&&this.once("error",n),this.once(e,t)})}async done(){Ee(this,Ha,!0,"f"),await M(this,Jn,"f")}get currentMessage(){return M(this,Ht,"f")}async finalMessage(){return await this.done(),M(this,Le,"m",yr).call(this)}async finalText(){return await this.done(),M(this,Le,"m",Vl).call(this)}_emit(e,...t){if(M(this,Qn,"f"))return;e==="end"&&(Ee(this,Qn,!0,"f"),M(this,_o,"f").call(this));let n=M(this,_t,"f")[e];if(n&&(M(this,_t,"f")[e]=n.filter(s=>!s.once),n.forEach(({listener:s})=>s(...t))),e==="abort"){let s=t[0];!M(this,Ha,"f")&&!n?.length&&Promise.reject(s),M(this,Kn,"f").call(this,s),M(this,Zn,"f").call(this,s),this._emit("end");return}if(e==="error"){let s=t[0];!M(this,Ha,"f")&&!n?.length&&Promise.reject(s),M(this,Kn,"f").call(this,s),M(this,Zn,"f").call(this,s),this._emit("end")}}_emitFinal(){this.receivedMessages.at(-1)&&this._emit("finalMessage",M(this,Le,"m",yr).call(this))}async _fromReadableStream(e,t){let n=t?.signal;n&&(n.aborted&&this.controller.abort(),n.addEventListener("abort",()=>this.controller.abort())),M(this,Le,"m",xr).call(this),this._connected();let s=st.fromReadableStream(e,this.controller);for await(let o of s)M(this,Le,"m",kr).call(this,o);if(s.controller.signal?.aborted)throw new he;M(this,Le,"m",_r).call(this)}[(Ht=new WeakMap,xo=new WeakMap,ko=new WeakMap,Kn=new WeakMap,Jn=new WeakMap,_o=new WeakMap,Zn=new WeakMap,_t=new WeakMap,Qn=new WeakMap,So=new WeakMap,Co=new WeakMap,Ha=new WeakMap,wr=new WeakMap,Le=new WeakSet,yr=function(){if(this.receivedMessages.length===0)throw new N("stream ended without producing a Message with role=assistant");return this.receivedMessages.at(-1)},Vl=function(){if(this.receivedMessages.length===0)throw new N("stream ended without producing a Message with role=assistant");let t=this.receivedMessages.at(-1).content.filter(n=>n.type==="text").map(n=>n.text);if(t.length===0)throw new N("stream ended without producing a content block with type=text");return t.join(" ")},xr=function(){this.ended||Ee(this,Ht,void 0,"f")},kr=function(t){if(this.ended)return;let n=M(this,Le,"m",ql).call(this,t);switch(this._emit("streamEvent",t,n),t.type){case"content_block_delta":{let s=n.content.at(-1);t.delta.type==="text_delta"&&s.type==="text"?this._emit("text",t.delta.text,s.text||""):t.delta.type==="input_json_delta"&&s.type==="tool_use"&&s.input&&this._emit("inputJson",t.delta.partial_json,s.input);break}case"message_stop":{this._addMessageParam(n),this._addMessage(n,!0);break}case"content_block_stop":{this._emit("contentBlock",n.content.at(-1));break}case"message_start":{Ee(this,Ht,n,"f");break}case"content_block_start":case"message_delta":break}},_r=function(){if(this.ended)throw new N("stream has ended, this shouldn't happen");let t=M(this,Ht,"f");if(!t)throw new N("request ended without sending any chunks");return Ee(this,Ht,void 0,"f"),t},ql=function(t){let n=M(this,Ht,"f");if(t.type==="message_start"){if(n)throw new N(`Unexpected event order, got ${t.type} before receiving "message_stop"`);return t.message}if(!n)throw new N(`Unexpected event order, got ${t.type} before "message_start"`);switch(t.type){case"message_stop":return n;case"message_delta":return n.stop_reason=t.delta.stop_reason,n.stop_sequence=t.delta.stop_sequence,n.usage.output_tokens=t.usage.output_tokens,n;case"content_block_start":return n.content.push(t.content_block),n;case"content_block_delta":{let s=n.content.at(t.index);if(s?.type==="text"&&t.delta.type==="text_delta")s.text+=t.delta.text;else if(s?.type==="tool_use"&&t.delta.type==="input_json_delta"){let o=s[Ul]||"";o+=t.delta.partial_json,Object.defineProperty(s,Ul,{value:o,enumerable:!1,writable:!0}),o&&(s.input=go(o))}return n}case"content_block_stop":return n}},Symbol.asyncIterator)](){let e=[],t=[],n=!1;return this.on("streamEvent",s=>{let o=t.shift();o?o.resolve(s):e.push(s)}),this.on("end",()=>{n=!0;for(let s of t)s.resolve(void 0);t.length=0}),this.on("abort",s=>{n=!0;for(let o of t)o.reject(s);t.length=0}),this.on("error",s=>{n=!0;for(let o of t)o.reject(s);t.length=0}),{next:async()=>e.length?{value:e.shift(),done:!1}:n?{value:void 0,done:!0}:new Promise((o,i)=>t.push({resolve:o,reject:i})).then(o=>o?{value:o,done:!1}:{value:void 0,done:!0}),return:async()=>(this.abort(),{value:void 0,done:!0})}}toReadableStream(){return new st(this[Symbol.asyncIterator].bind(this),this.controller).toReadableStream()}}});var ha,Wl,Sr=v(()=>{Vt();Hl();ha=class extends be{create(e,t){return e.model in Wl&&console.warn(`The model '${e.model}' is deprecated and will reach end-of-life on ${Wl[e.model]}
Please migrate to a newer model. Visit https://docs.anthropic.com/en/docs/resources/model-deprecations for more information.`),this._client.post("/v1/messages",{body:e,timeout:this._client._options.timeout??6e5,...t,stream:e.stream??!1})}stream(e,t){return Po.createMessage(this,e,t)}},Wl={"claude-1.3":"November 6th, 2024","claude-1.3-100k":"November 6th, 2024","claude-instant-1.1":"November 6th, 2024","claude-instant-1.1-100k":"November 6th, 2024","claude-instant-1.2":"November 6th, 2024"}});var Gl=v(()=>{vr();br();Sr()});var Yl,Y,D6,F6,Xl,Kl=v(()=>{Oa();nt();sr();Gl();br();Sr();vr();Y=class extends po{constructor({baseURL:e=co("ANTHROPIC_BASE_URL"),apiKey:t=co("ANTHROPIC_API_KEY")??null,authToken:n=co("ANTHROPIC_AUTH_TOKEN")??null,...s}={}){let o={apiKey:t,authToken:n,...s,baseURL:e||"https://api.anthropic.com"};if(!o.dangerouslyAllowBrowser&&Dl())throw new N(`It looks like you're running in a browser-like environment.
...
TODO: link!
`);super({baseURL:o.baseURL,timeout:o.timeout??6e5,httpAgent:o.httpAgent,maxRetries:o.maxRetries,fetch:o.fetch}),this.completions=new ga(this),this.messages=new ha(this),this.beta=new kt(this),this._options=o,this.apiKey=t,this.authToken=n}defaultQuery(){return this._options.defaultQuery}defaultHeaders(e){return{...super.defaultHeaders(e),...this._options.dangerouslyAllowBrowser?{"anthropic-dangerous-direct-browser-access":"true"}:void 0,"anthropic-version":"2023-06-01",...this._options.defaultHeaders}}validateHeaders(e,t){if(!(this.apiKey&&e["x-api-key"])&&t["x-api-key"]!==null&&!(this.authToken&&e.authorization)&&t.authorization!==null)throw new Error('Could not resolve authentication method. Expected either apiKey or authToken to be set. Or for one of the "X-Api-Key" or "Authorization" headers to be explicitly omitted')}authHeaders(e){let t=this.apiKeyAuth(e),n=this.bearerAuth(e);return t!=null&&!Hn(t)?t:n!=null&&!Hn(n)?n:{}}apiKeyAuth(e){return this.apiKey==null?{}:{"X-Api-Key":this.apiKey}}bearerAuth(e){return this.authToken==null?{}:{Authorization:`Bearer ${this.authToken}`}}};Yl=Y;Y.Anthropic=Yl;Y.HUMAN_PROMPT=`

Human:`;Y.AI_PROMPT=`

Assistant:`;Y.DEFAULT_TIMEOUT=6e5;Y.AnthropicError=N;Y.APIError=le;Y.APIConnectionError=zt;Y.APIConnectionTimeoutError=$a;Y.APIUserAbortError=he;Y.NotFoundError=Ln;Y.ConflictError=$n;Y.RateLimitError=jn;Y.BadRequestError=Mn;Y.AuthenticationError=Dn;Y.InternalServerError=zn;Y.PermissionDeniedError=Fn;Y.UnprocessableEntityError=On;Y.toFile=El;Y.fileFromPath=is;({HUMAN_PROMPT:D6,AI_PROMPT:F6}=Y);Y.Completions=ga;Y.Messages=ha;Y.Beta=kt;Xl=Y});var Jl={};Et(Jl,{CodeBakersClient:()=>Cr});var J,Cr,Zl=v(()=>{"use strict";J=q(require("vscode"));Kl();Lo();Cr=class{constructor(e){this.context=e;this.anthropic=null;this.sessionToken=null;this.patterns=new Map;this.DEFAULT_TIMEOUT=1e4;this.validatorInitialized=!1;this.sessionStats={totalInputTokens:0,totalOutputTokens:0,totalCost:0,requestCount:0,startTime:new Date};this.currentEnforcementSession=null;this.PRICE_PER_1K_INPUT=.003;this.PRICE_PER_1K_OUTPUT=.015;this.currentPlan="trial";this.isUnlimited=!1;this.trialInfo=null;this.validator=new ba,this.sessionToken=e.globalState.get("codebakers.sessionToken")||null,this.sessionToken&&this.sessionToken.includes("%")&&(console.log("CodeBakers: Clearing corrupted URL-encoded token"),this.sessionToken=null,e.globalState.update("codebakers.sessionToken",void 0))}async logout(){this.sessionToken=null,this.anthropic=null,await this.context.globalState.update("codebakers.sessionToken",void 0),await this.context.globalState.update("codebakers.user",void 0),J.window.showInformationMessage("Logged out of CodeBakers")}getSessionStats(){let t=new Date().getTime()-this.sessionStats.startTime.getTime(),n=Math.floor(t/6e4),s=Math.floor(n/60);return{...this.sessionStats,formattedCost:`$${this.sessionStats.totalCost.toFixed(4)}`,formattedDuration:s>0?`${s}h ${n%60}m`:`${n}m`}}resetSessionStats(){this.sessionStats={totalInputTokens:0,totalOutputTokens:0,totalCost:0,requestCount:0,startTime:new Date}}_calculateCost(e,t){let n=e/1e3*this.PRICE_PER_1K_INPUT,s=t/1e3*this.PRICE_PER_1K_OUTPUT;return n+s}async _fetchWithTimeout(e,t={},n=this.DEFAULT_TIMEOUT){let s=new AbortController,o=setTimeout(()=>s.abort(),n);try{return await fetch(e,{...t,signal:s.signal})}finally{clearTimeout(o)}}hasSessionToken(){return!!this.sessionToken}async handleOAuthCallback(e){try{if(console.log("handleOAuthCallback: token length:",e?.length),console.log("handleOAuthCallback: token preview:",e?.substring(0,50)),!e)return J.window.showErrorMessage("Login failed: No token received"),!1;let t=e;e.includes("%")&&(t=decodeURIComponent(e),console.log("handleOAuthCallback: URL-decoded token"));let n;try{n=Buffer.from(t,"base64url").toString("utf-8")}catch{let i=t.replace(/-/g,"+").replace(/_/g,"/");n=Buffer.from(i,"base64").toString("utf-8")}console.log("handleOAuthCallback: decoded preview:",n?.substring(0,100));let s=JSON.parse(n),o=e.includes("%")?decodeURIComponent(e):e;return this.sessionToken=o,await this.context.globalState.update("codebakers.sessionToken",o),this.currentPlan=s.plan,this.trialInfo=s.trial,this.isUnlimited=s.plan==="pro",await this.context.globalState.update("codebakers.user",{teamId:s.teamId,profileId:s.profileId,githubUsername:s.githubUsername,email:s.email}),await this._initializeAnthropic(),J.window.showInformationMessage(`Welcome to CodeBakers, @${s.githubUsername}! ${s.trial?`Trial: ${s.trial.daysRemaining} days remaining`:""}`),!0}catch(t){return console.error("Failed to handle OAuth callback:",t),console.error("Token was:",e?.substring(0,100)),J.window.showErrorMessage(`Login failed: ${t instanceof Error?t.message:"Invalid token"}`),!1}}async checkAuth(){if(!this.sessionToken)return!1;try{let e=`${this._getApiEndpoint()}/api/auth/check?token=${encodeURIComponent(this.sessionToken)}`;return(await this._fetchWithTimeout(e,{headers:{Authorization:`Bearer ${this.sessionToken}`}},5e3)).ok}catch{return!1}}async login(){try{console.log("CodeBakers: login() called");let e=J.env.uriScheme;console.log("CodeBakers: uriScheme =",e);let t=J.Uri.parse(`${e}://codebakers.codebakers/callback`);console.log("CodeBakers: rawCallbackUri =",t.toString());let n=await J.env.asExternalUri(t);console.log("CodeBakers: callbackUri =",n.toString());let s=this._getApiEndpoint();console.log("CodeBakers: apiEndpoint =",s);let o=`${s}/vscode-login?callback=${encodeURIComponent(n.toString())}`;return console.log("CodeBakers: loginUrl =",o),await J.env.openExternal(J.Uri.parse(o)),console.log("CodeBakers: openExternal called successfully"),!0}catch(e){throw console.error("CodeBakers: login() error:",e),e}}async _initializeAnthropic(){try{if(console.log("_initializeAnthropic: sessionToken exists:",!!this.sessionToken),console.log("_initializeAnthropic: sessionToken length:",this.sessionToken?.length),console.log("_initializeAnthropic: sessionToken preview:",this.sessionToken?.substring(0,50)),console.log("_initializeAnthropic: contains %:",this.sessionToken?.includes("%")),this.sessionToken)try{let c=Buffer.from(this.sessionToken,"base64url").toString("utf-8"),m=JSON.parse(c);console.log("_initializeAnthropic: token decoded successfully, teamId:",m.teamId)}catch(c){console.error("_initializeAnthropic: FAILED to decode token locally:",c)}let e=`Bearer ${this.sessionToken}`;console.log("_initializeAnthropic: authHeader length:",e.length),console.log("_initializeAnthropic: authHeader preview:",e.substring(0,60));let t={method:"GET",headers:{Authorization:e,"Content-Type":"application/json"}};console.log("_initializeAnthropic: fetchOptions.headers:",JSON.stringify(t.headers));let n=`${this._getApiEndpoint()}/api/claude/key?token=${encodeURIComponent(this.sessionToken||"")}`;console.log("_initializeAnthropic: fetching:",n.substring(0,80)+"...");let s=await this._fetchWithTimeout(n,t),o=await s.json(),i=o.data||o;if(console.log("Claude key response:",s.status,JSON.stringify(i)),s.status===402){let c=await J.window.showWarningMessage(o.message||"Subscribe to CodeBakers Pro ($99/month) for unlimited access","Subscribe Now","Start Free Trial");throw c==="Subscribe Now"?J.env.openExternal(J.Uri.parse(o.upgradeUrl||"https://www.codebakers.ai/dashboard/billing")):c==="Start Free Trial"&&J.env.openExternal(J.Uri.parse(o.trialUrl||"https://www.codebakers.ai/dashboard/billing")),new Error("SUBSCRIPTION_REQUIRED")}if(!s.ok){console.error("API error response:",JSON.stringify(o));let c=this.sessionToken?`token len=${this.sessionToken.length}, starts=${this.sessionToken.substring(0,10)}`:"NO TOKEN";throw new Error(`API ${s.status}: ${o.error||o.message||"Unknown"} [${c}]`)}if(!i.apiKey)throw new Error(`No API key in response: ${JSON.stringify(i)}`);let{apiKey:r,plan:d,unlimited:p,trial:l}=i;this.currentPlan=d||"trial",this.isUnlimited=p||!1,this.trialInfo=l||null,l&&l.daysRemaining<=3&&J.window.showWarningMessage(`Your CodeBakers trial expires in ${l.daysRemaining} day${l.daysRemaining===1?"":"s"}. Subscribe to keep using the extension.`,"Subscribe Now").then(c=>{c==="Subscribe Now"&&J.env.openExternal(J.Uri.parse("https://www.codebakers.ai/dashboard/billing"))}),this.anthropic=new Xl({apiKey:r}),await this._loadPatterns()}catch(e){throw console.error("Failed to initialize Anthropic client:",e),e}}getPlanInfo(){return{plan:this.currentPlan,unlimited:this.isUnlimited,trial:this.trialInfo}}async _loadPatterns(){try{let e=`${this._getApiEndpoint()}/api/patterns/list?token=${encodeURIComponent(this.sessionToken||"")}`,t=await this._fetchWithTimeout(e,{headers:{Authorization:`Bearer ${this.sessionToken}`}},15e3);if(t.ok){let n=await t.json();n.patterns&&n.patterns.forEach(s=>this.patterns.set(s.name,s))}}catch(e){console.error("Failed to load patterns:",e)}}async chat(e,t,n,s){let o=s?.maxRetries??3,i=s?.runTypeScriptCheck??!0;if(this.anthropic||await this._initializeAnthropic(),!this.anthropic)throw new Error("Not authenticated. Please login first.");let r=this._buildSystemPrompt(t),d=e[e.length-1]?.content||"",p=[];try{let b=this._extractKeywords(d),E=await this._callDiscoverPatterns(d,b);E&&E.sessionToken&&(this.currentEnforcementSession={token:E.sessionToken,patterns:E.patterns||[],expiresAt:E.expiresAt||new Date(Date.now()+36e5).toISOString()},p=E.patterns||[],console.log("CodeBakers: GATE 1 passed - enforcement session created:",E.sessionToken.substring(0,20)+"..."))}catch(b){console.warn("CodeBakers: Server pattern discovery failed, falling back to local patterns:",b),p=(await this._detectRelevantPatterns(e)).map(x=>({name:x.name,content:x.content,relevance:1}))}let l=p.length>0?p.map(b=>`## Pattern: ${b.name}
${b.content}`).join(`

`):(await this._detectRelevantPatterns(e)).map(b=>`## Pattern: ${b.name}
${b.content}`).join(`

`),c=e.filter(b=>b.role==="system"),m=e.filter(b=>b.role!=="system"),u=c.length>0?`

# CONTEXT
`+c.map(b=>b.content).join(`

`):"",g=this.currentEnforcementSession?`

# ENFORCEMENT
You are in an enforced session. Follow the loaded patterns exactly. Your code will be validated against these patterns before being applied.`:"",k=`${r}

# LOADED PATTERNS
${l}${u}${g}`,f=null;for(let b=1;b<=o;b++)try{if(n?.abortSignal?.aborted)throw new Error("Request was cancelled");let E="",x=this.anthropic.messages.stream({model:"claude-sonnet-4-20250514",max_tokens:16e3,system:k,messages:m.map(W=>({role:W.role,content:W.content}))});n?.abortSignal&&n.abortSignal.addEventListener("abort",()=>{x.abort()}),x.on("text",W=>{if(n?.abortSignal?.aborted){x.abort();return}E+=W;let{thinking:Ye,content:Ie}=this._parseThinkingAndContent(E);Ye&&n?.onThinking?.(Ye),n?.onContent?.(Ie)});let F=await x.finalMessage(),U;if(F.usage){let W=F.usage.input_tokens,Ye=F.usage.output_tokens,Ie=this._calculateCost(W,Ye);U={inputTokens:W,outputTokens:Ye,totalTokens:W+Ye,estimatedCost:Ie},this.sessionStats.totalInputTokens+=W,this.sessionStats.totalOutputTokens+=Ye,this.sessionStats.totalCost+=Ie,this.sessionStats.requestCount+=1}if(n?.abortSignal?.aborted)throw new Error("Request was cancelled");n?.onDone?.();let{thinking:me,content:_}=this._parseThinkingAndContent(E),w=this.parseFileOperations(_),I=this.parseCommands(_),j=this.cleanContentForDisplay(_),oe=this._checkCompliance(E,me,w,j),S,$,C;w.length>0&&(this.validatorInitialized||(await this.validator.initialize(),this.validatorInitialized=!0),$=this.validator.checkDependencies(w),S=await this.validator.validateFileOperations(w),i&&(C=await this.validator.runTypeScriptCheck(),S&&(S.tscResult=C)));let z=this._extractProjectUpdates(j),we=w.length,ue=I.length,Ct=p.map(W=>W.name).join(", ")||"core",Ur=!oe.passed,rc=S&&!S.passed,Hr=$&&$.missing.length>0,Wr=C&&!C.passed,Mo="\u2705";rc||Wr?Mo="\u274C":(Ur||Hr)&&(Mo="\u26A0\uFE0F");let Ae=j;Hr&&$&&(Ae+=`
...
`+C.errors.slice(0,5).map(W=>`- ${W.file}:${W.line} - ${W.message}`).join(`
`),C.errorCount>5&&(Ae+=`
  ...and ${C.errorCount-5} more`)),S&&(S.errors.length>0&&(Ae+=`

---
\u274C **Validation Errors:**
`+S.errors.map(W=>`- ${W.file}: ${W.message}`).join(`
`)),S.warnings.length>0&&(Ae+=`

---
\u26A0\uFE0F **Warnings:**
`+S.warnings.map(W=>`- ${W.file}: ${W.message}`).join(`
`)),S.suggestions.length>0&&(Ae+=`

---
\u{1F4A1} **Suggestions:**
`+S.suggestions.map(W=>`- ${W}`).join(`
`))),Ur&&(Ae+=`

---
\u26A0\uFE0F **Quality Warning:** `+oe.issues.join(", "));let dc=C?C.passed?"\u2705":"\u274C":"\u23ED\uFE0F",pc=U?` | Cost: $${U.estimatedCost.toFixed(4)}`:"",lc=U?` | Tokens: ${U.totalTokens.toLocaleString()}`:"";Ae+=`

---
\u{1F36A} **CodeBakers** `+Mo+" | Files: "+we+" | Commands: "+ue+" | TSC: "+dc+lc+pc+" | "+Ct;let Pt=null;if(this.currentEnforcementSession&&w.length>0)try{let W=w.map(Ie=>Ie.path),Ye=w.filter(Ie=>Ie.path.includes(".test.")||Ie.path.includes(".spec.")||Ie.path.includes("/__tests__/")).map(Ie=>Ie.path);Pt=await this._callValidateComplete(this.currentEnforcementSession.token,d.substring(0,100),W,Ye,Ye.length>0,C?.passed??!0,C?.passed??!0),Pt&&(Pt.passed?(console.log("CodeBakers: GATE 2 passed - compliance score:",Pt.compliance.score),Ae+=` | Gate 2: \u2705 (${Pt.compliance.score}/100)`):(console.warn("CodeBakers: GATE 2 failed:",Pt.issues),Ae+=`

\u26A0\uFE0F **Gate 2 Issues:** ${Pt.issues.join(", ")}`,Ae+=" | Gate 2: \u274C")),this.currentEnforcementSession=null}catch(W){console.warn("CodeBakers: Gate 2 validation error:",W)}return{content:Ae,thinking:me||void 0,fileOperations:w.length>0?w:void 0,commands:I.length>0?I:void 0,projectUpdates:z,validation:S,dependencyCheck:$,usage:U,gate2:Pt||void 0}}catch(E){if(f=E,console.error(`Claude API error (attempt ${b}/${o}):`,E),E.message==="Request was cancelled"||E.message?.includes("authenticated")||E.message?.includes("SUBSCRIPTION"))throw E;if(b<o){let x=Math.min(1e3*Math.pow(2,b-1),1e4);n?.onError?.(new Error(`Request failed, retrying in ${x/1e3}s...`)),await new Promise(F=>setTimeout(F,x))}}let h=f||new Error("Request failed after multiple retries");throw n?.onError?.(h),h}_parseThinkingAndContent(e){let t=e.match(/<thinking>([\s\S]*?)<\/thinking>/);if(t){let n=t[1].trim(),s=e.replace(/<thinking>[\s\S]*?<\/thinking>\s*/g,"").trim();return{thinking:n,content:s}}return{thinking:null,content:e}}parseFileOperations(e){let t=[],n=/<file_operation>([\s\S]*?)<\/file_operation>/g,s;for(;(s=n.exec(e))!==null;){let o=s[1],i=o.match(/<action>(create|edit|delete)<\/action>/);if(!i)continue;let r=o.match(/<path>([^<]+)<\/path>/);if(!r)continue;let d=o.match(/<description>([^<]+)<\/description>/),p=o.match(/<content>([\s\S]*?)<\/content>/);t.push({action:i[1],path:r[1].trim(),description:d?d[1].trim():void 0,content:p?p[1].trim():void 0})}return t}parseCommands(e){let t=[],n=/<run_command>([\s\S]*?)<\/run_command>/g,s;for(;(s=n.exec(e))!==null;){let o=s[1],i=o.match(/<command>([^<]+)<\/command>/);if(!i)continue;let r=o.match(/<description>([^<]+)<\/description>/);t.push({command:i[1].trim(),description:r?r[1].trim():void 0})}return t}cleanContentForDisplay(e){return e.replace(/<file_operation>[\s\S]*?<\/file_operation>/g,"").replace(/<run_command>[\s\S]*?<\/run_command>/g,"").trim()}_checkCompliance(e,t,n,s){let o=[];!t&&s.length>200&&o.push("Missing reasoning (thinking block)");let i=/```[\s\S]*?```/.test(e),r=/\.(tsx?|jsx?|css|json|md)\b/.test(s);i&&r&&n.length===0&&o.push("Code in markdown instead of file_operation tags");for(let d of n)if(d.content){let p=(d.content.match(/:\s*any\b/g)||[]).length;p>2&&o.push(`Excessive 'any' types in ${d.path} (${p} found)`),d.content.includes("async ")&&!d.content.includes("try")&&!d.content.includes("catch")&&d.content.includes("await ")&&o.push(`Missing try/catch in ${d.path}`)}for(let d of n)d.path.includes("/api/")&&d.content&&!d.content.includes("catch")&&!d.content.includes("NextResponse.json")&&o.push(`API route ${d.path} may lack error handling`);return{passed:o.length===0,issues:o}}async summarize(e){if(!this.anthropic)throw new Error("Not authenticated");let t=await this.anthropic.messages.create({model:"claude-sonnet-4-20250514",max_tokens:1024,system:"You are a conversation summarizer. Create concise summaries that preserve key decisions, code changes, and context. Be specific about file names and technical decisions.",messages:[{role:"user",content:e}]});return t.content[0].type==="text"?t.content[0].text:""}async getAvailablePatterns(){return Array.from(this.patterns.values())}async executeTool(e,t={}){if(!this.sessionToken)throw new Error("Not authenticated. Please login first.");let n=J.workspace.workspaceFolders?.[0]?.uri.fsPath,s=`${this._getApiEndpoint()}/api/tools?token=${encodeURIComponent(this.sessionToken)}`,o=await this._fetchWithTimeout(s,{method:"POST",headers:{Authorization:`Bearer ${this.sessionToken}`,"Content-Type":"application/json"},body:JSON.stringify({tool:e,args:t,projectPath:n})},3e4);if(!o.ok){let i=await o.json();throw new Error(i.message||`Tool execution failed: ${e}`)}return o.json()}async listTools(){if(!this.sessionToken)return[];let e=`${this._getApiEndpoint()}/api/tools?token=${encodeURIComponent(this.sessionToken)}`,t=await this._fetchWithTimeout(e,{headers:{Authorization:`Bearer ${this.sessionToken}`}});if(!t.ok)throw new Error("Failed to fetch tools");return(await t.json()).data?.tools||[]}async discoverPatterns(e,t=[]){return this.executeTool("discover_patterns",{task:e,keywords:t})}async validateComplete(e,t){return this.executeTool("validate_complete",{feature:e,files:t})}async guardianAnalyze(e){return this.executeTool("guardian_analyze",{files:e})}async guardianHeal(e){return this.executeTool("guardian_heal",{issues:e})}async guardianVerify(){return this.executeTool("guardian_verify",{})}async guardianStatus(){return this.executeTool("guardian_status",{})}async rippleCheck(e,t){return this.executeTool("ripple_check",{entityName:e,changeType:t})}async runAudit(){return this.executeTool("run_audit",{})}async runTests(){return this.executeTool("run_tests",{})}async detectIntent(e){return this.executeTool("detect_intent",{message:e})}_buildSystemPrompt(e){return`# CodeBakers AI Assistant
Version: 1.0.37
...
`}async _detectRelevantPatterns(e){let t=e[e.length-1]?.content?.toLowerCase()||"",n=[],s={"00-core":["any","code","build","create"],"01-database":["database","db","schema","table","query","drizzle","postgres"],"02-auth":["auth","login","signup","session","password","oauth"],"03-api":["api","route","endpoint","rest","fetch"],"04-frontend":["component","react","form","ui","page"],"05-payments":["payment","stripe","billing","subscription","checkout"],"08-testing":["test","testing","playwright","vitest"]};this.patterns.has("00-core")&&n.push(this.patterns.get("00-core"));for(let[o,i]of Object.entries(s))if(o!=="00-core"&&i.some(r=>t.includes(r))){let r=this.patterns.get(o);r&&n.push(r)}return n}_extractProjectUpdates(e){let t={},n=e.match(/(?:using|loaded|applied) pattern[s]?: ([^\n]+)/gi);return n&&(t.patterns=n.flatMap(s=>s.split(":")[1]?.split(",").map(o=>o.trim())||[])),Object.keys(t).length>0?t:void 0}_extractKeywords(e){let t={database:["database","db","schema","table","query","drizzle","postgres","sql"],auth:["auth","login","signup","session","password","oauth","jwt","token"],api:["api","route","endpoint","rest","fetch","request","response"],frontend:["component","react","form","ui","page","button","modal"],payments:["payment","stripe","billing","subscription","checkout","price"],testing:["test","testing","playwright","vitest","jest","spec"]},n=e.toLowerCase(),s=[];for(let[o,i]of Object.entries(t))i.some(r=>n.includes(r))&&s.push(o);return s.length>0?s:["general"]}async _callDiscoverPatterns(e,t){if(!this.sessionToken)return console.log("CodeBakers: No session token, skipping server pattern discovery"),null;try{let n=`${this._getApiEndpoint()}/api/patterns/discover`,s=J.workspace.workspaceFolders?.[0]?.uri.fsPath,o=await this._fetchWithTimeout(n,{method:"POST",headers:{Authorization:`Bearer ${this.sessionToken}`,"Content-Type":"application/json"},body:JSON.stringify({task:e,keywords:t,projectPath:s})},15e3);if(!o.ok){let r=await o.json().catch(()=>({}));return console.warn("CodeBakers: Pattern discovery failed:",r),null}let i=await o.json();return{sessionToken:i.sessionToken||"",patterns:i.patterns||[],expiresAt:i.expiresAt||"",message:i.message}}catch(n){return console.warn("CodeBakers: Pattern discovery error:",n),null}}async _callValidateComplete(e,t,n,s=[],o=!1,i=!1,r=!0){if(!this.sessionToken)return null;try{let d=`${this._getApiEndpoint()}/api/patterns/validate`,p=await this._fetchWithTimeout(d,{method:"POST",headers:{Authorization:`Bearer ${this.sessionToken}`,"Content-Type":"application/json"},body:JSON.stringify({sessionToken:e,featureName:t,filesModified:n,testsWritten:s,testsRun:o,testsPassed:i,typescriptPassed:r})},15e3);if(!p.ok){let c=await p.json().catch(()=>({}));return console.warn("CodeBakers: Validation failed:",c),{passed:!1,issues:[c.error||"Validation failed"],compliance:{score:0,deductions:[]}}}let l=await p.json();return{passed:l.passed??!1,issues:l.issues||[],compliance:l.compliance||{score:100,deductions:[]},message:l.message}}catch(d){return console.warn("CodeBakers: Validation error:",d),null}}_getApiEndpoint(){return J.workspace.getConfiguration("codebakers").get("apiEndpoint","https://www.codebakers.ai")}}});var Ql={};Et(Ql,{ProjectContext:()=>Pr});var $e,H,ye,Pr,ec=v(()=>{"use strict";$e=q(require("vscode")),H=q(require("fs")),ye=q(require("path")),Pr=class{constructor(){this._cache=null;this._cacheTime=0;this.CACHE_TTL=3e4}async getProjectState(){if(this._cache&&Date.now()-this._cacheTime<this.CACHE_TTL)return{...this._cache,...this._getDynamicContext()};let e=$e.workspace.workspaceFolders?.[0];if(!e)return null;let t=e.uri.fsPath,n={},s=ye.join(t,".codebakers.json");if(H.existsSync(s))try{let d=H.readFileSync(s,"utf-8"),p=JSON.parse(d);Object.assign(n,p)}catch(d){console.error("Failed to read .codebakers.json:",d)}let o=ye.join(t,"package.json");if(H.existsSync(o))try{let d=H.readFileSync(o,"utf-8"),p=JSON.parse(d);n.packageDeps=[...Object.keys(p.dependencies||{}),...Object.keys(p.devDependencies||{})],n.stack||(n.stack=this._detectStack(n.packageDeps))}catch(d){console.error("Failed to read package.json:",d)}n.hasTests=await this._hasTestFiles(t),n.recentFiles=await this._getRecentFiles(t),n.fileTree=await this._getFileTree(t),n.existingTypes=await this._scanExistingTypes(t),n.installedPackages=n.packageDeps?.slice(0,50);let i=ye.join(t,".codebakers","DEVLOG.md");if(H.existsSync(i))try{let d=H.readFileSync(i,"utf-8");n.keyDecisions=this._extractFromDevlog(d,"decisions"),n.completedTasks=this._extractFromDevlog(d,"tasks")}catch(d){console.error("Failed to read devlog:",d)}let r=ye.join(t,".codebakers","BLOCKED.md");if(H.existsSync(r))try{let d=H.readFileSync(r,"utf-8");n.blockers=this._extractBlockers(d)}catch(d){console.error("Failed to read blockers:",d)}return n.aiMemory=await this._loadAIMemory(t),this._cache=n,this._cacheTime=Date.now(),{...n,...this._getDynamicContext()}}async applyUpdates(e){let t=$e.workspace.workspaceFolders?.[0];if(!t)return;let n=t.uri.fsPath,s=ye.join(n,".codebakers.json"),o={};if(H.existsSync(s))try{o=JSON.parse(H.readFileSync(s,"utf-8"))}catch{o={}}e.decisions&&(o.decisions={...o.decisions,...e.decisions}),e.tasks&&(o.currentWork=o.currentWork||{},o.currentWork.pendingTasks=e.tasks,o.currentWork.lastUpdated=new Date().toISOString()),e.patterns&&(o.analytics=o.analytics||{},o.analytics.modulesUsed=o.analytics.modulesUsed||{},e.patterns.forEach(i=>{o.analytics.modulesUsed[i]=(o.analytics.modulesUsed[i]||0)+1})),H.writeFileSync(s,JSON.stringify(o,null,2)),this._cache=null}invalidateCache(){this._cache=null}_getDynamicContext(){let e=$e.window.activeTextEditor;if(!e)return{};let t={openFile:$e.workspace.asRelativePath(e.document.uri)},n=e.selection;return n.isEmpty||(t.selectedText=e.document.getText(n)),t}_detectStack(e){let t={};e.includes("next")?t.framework="nextjs":e.includes("react")?t.framework="react":e.includes("vue")?t.framework="vue":e.includes("svelte")&&(t.framework="svelte"),e.includes("drizzle-orm")?t.database="drizzle":e.includes("prisma")?t.database="prisma":e.includes("mongoose")&&(t.database="mongodb"),e.includes("@supabase/supabase-js")?t.auth="supabase":e.includes("next-auth")?t.auth="next-auth":e.includes("@clerk/nextjs")&&(t.auth="clerk"),e.some(s=>s.includes("@radix-ui"))?t.ui="shadcn":e.includes("@chakra-ui/react")?t.ui="chakra":e.includes("@mui/material")&&(t.ui="mui");let n=[];return e.includes("stripe")&&n.push("stripe"),e.includes("@paypal/react-paypal-js")&&n.push("paypal"),n.length>0&&(t.payments=n),t}async _hasTestFiles(e){let t=["**/*.test.ts","**/*.test.tsx","**/*.spec.ts","**/tests/**"];for(let n of t)if((await $e.workspace.findFiles(n,"**/node_modules/**",1)).length>0)return!0;return!1}async _getRecentFiles(e){let t=await $e.workspace.findFiles("**/*.{ts,tsx,js,jsx}","**/node_modules/**",50);return(await Promise.all(t.map(async s=>{try{let o=await $e.workspace.fs.stat(s);return{path:$e.workspace.asRelativePath(s),mtime:o.mtime}}catch{return null}}))).filter(s=>s!==null).sort((s,o)=>o.mtime-s.mtime).slice(0,10).map(s=>s.path)}async _getFileTree(e,t=4){let n=new Set(["node_modules",".git",".next","dist","build",".vercel",".turbo","coverage",".cache",".nuxt",".output","__pycache__"]),s=new Set(["src","app","pages","components","lib","utils","hooks","api","services","types","styles","public","tests","__tests__"]),o=[],i=(r,d,p)=>{if(!(p>t))try{let l=H.readdirSync(r,{withFileTypes:!0}),c=l.filter(h=>h.isDirectory()&&!n.has(h.name)&&!h.name.startsWith(".")),m=l.filter(h=>h.isFile());c.sort((h,b)=>{let E=s.has(h.name),x=s.has(b.name);return E&&!x?-1:!E&&x?1:h.name.localeCompare(b.name)});for(let h=0;h<c.length;h++){let b=c[h],E=h===c.length-1&&m.length===0,x=E?"\u2514\u2500\u2500 ":"\u251C\u2500\u2500 ",F=E?"    ":"\u2502   ";o.push(`${d}${x}${b.name}/`),i(ye.join(r,b.name),d+F,p+1)}let u=m.filter(h=>p<=1?["package.json","tsconfig.json",".env.example","next.config.js","next.config.mjs","drizzle.config.ts"].includes(h.name)||h.name.endsWith(".ts")||h.name.endsWith(".tsx"):!0),g=p===0?5:p===1?10:15,k=u.slice(0,g),f=u.length-k.length;for(let h=0;h<k.length;h++){let b=k[h],x=h===k.length-1&&f===0?"\u2514\u2500\u2500 ":"\u251C\u2500\u2500 ";o.push(`${d}${x}${b.name}`)}f>0&&o.push(`${d}\u2514\u2500\u2500 ... (${f} more files)`)}catch{}};return o.push(ye.basename(e)+"/"),i(e,"",0),o.join(`
`)}async _scanExistingTypes(e){let t=[],n=["src/types","src/lib","types","lib"];for(let i of n){let r=ye.join(e,i);if(H.existsSync(r))try{let d=H.readdirSync(r).filter(p=>p.endsWith(".ts")||p.endsWith(".tsx"));for(let p of d.slice(0,10)){let l=ye.join(r,p);try{let c=H.readFileSync(l,"utf-8"),m=ye.join(i,p),u=/export\s+interface\s+(\w+)/g,g;for(;(g=u.exec(c))!==null;)t.push({name:g[1],file:m,kind:"interface"});let k=/export\s+type\s+(\w+)/g;for(;(g=k.exec(c))!==null;)t.push({name:g[1],file:m,kind:"type"});let f=/export\s+enum\s+(\w+)/g;for(;(g=f.exec(c))!==null;)t.push({name:g[1],file:m,kind:"enum"})}catch{}}}catch{}}if(t.length===0)return"";let s=["EXISTING TYPES (import these instead of creating new):"],o=new Map;for(let i of t){let r=o.get(i.file)||[];r.push(i),o.set(i.file,r)}for(let[i,r]of o){s.push(`  ${i}:`);for(let d of r.slice(0,5))s.push(`    - ${d.kind} ${d.name}`);r.length>5&&s.push(`    ... and ${r.length-5} more`)}return s.slice(0,30).join(`
`)}_extractFromDevlog(e,t){let n=[],s=e.split(`
`),o=!1,i=!1;for(let r of s){if(r.startsWith("## "))o=!0;else if(r.startsWith("---"))break;if(o){if(t==="decisions"&&r.toLowerCase().includes("decision")){i=!0;continue}if(t==="tasks"&&r.toLowerCase().includes("what was done")){i=!0;continue}i&&(r.startsWith("###")||r.startsWith("## ")?i=!1:r.startsWith("- ")&&n.push(r.substring(2).trim()))}}return n.slice(0,5)}_extractBlockers(e){let t=[],n=e.split(`
`);for(let s=0;s<n.length;s++){let o=n[s];o.startsWith("**Blocking Issue:**")&&t.push(o.replace("**Blocking Issue:**","").trim())}return t}async _loadAIMemory(e){let t=ye.join(e,".codebakers","memory.json");if(H.existsSync(t))try{let n=H.readFileSync(t,"utf-8");return JSON.parse(n)}catch(n){console.error("Failed to load AI memory:",n);return}}async _saveAIMemory(e,t){let n=ye.join(e,".codebakers"),s=ye.join(n,"memory.json");H.existsSync(n)||H.mkdirSync(n,{recursive:!0}),t.lastUpdated=new Date().toISOString(),H.writeFileSync(s,JSON.stringify(t,null,2))}async addMemory(e,t,n="inferred",s=.7){let o=$e.workspace.workspaceFolders?.[0];if(!o)return;let i=o.uri.fsPath,r=await this._loadAIMemory(i);r||(r={architecture:[],preferences:[],keyFiles:[],patterns:[],avoid:[],lastUpdated:new Date().toISOString()});let d=r[e].find(l=>this._similarContent(l.content,t));if(d){s>d.confidence&&(d.confidence=s,d.timestamp=new Date().toISOString());return}let p={content:t,confidence:s,source:n,timestamp:new Date().toISOString()};r[e].push(p),r[e]=r[e].sort((l,c)=>c.confidence-l.confidence).slice(0,20),await this._saveAIMemory(i,r),this._cache=null}_similarContent(e,t){let n=l=>l.toLowerCase().replace(/[^a-z0-9]/g,""),s=n(e),o=n(t);if(s.includes(o)||o.includes(s))return!0;let i=new Set(e.toLowerCase().split(/\s+/)),r=new Set(t.toLowerCase().split(/\s+/)),d=[...i].filter(l=>r.has(l)),p=new Set([...i,...r]);return d.length/p.size>.7}formatMemoryForPrompt(e){let t=["## \u{1F9E0} AI Project Memory (learned from previous sessions)"],n=(s,o,i)=>{let r=s.filter(d=>d.confidence>=.5);if(r.length!==0){t.push(`
### ${i} ${o}`);for(let d of r.slice(0,10)){let p=d.confidence>=.9?"\u2713":d.confidence>=.7?"~":"?";t.push(`- [${p}] ${d.content}`)}}};return n(e.architecture,"Architecture Decisions","\u{1F3D7}\uFE0F"),n(e.preferences,"User Preferences","\u2699\uFE0F"),n(e.keyFiles,"Key Files","\u{1F4C1}"),n(e.patterns,"Common Patterns","\u{1F504}"),n(e.avoid,"Things to Avoid","\u26D4"),t.length===1?"":t.join(`
`)}async learnFromResponse(e,t){let n=[{pattern:/REMEMBER:\s*(.+?)(?:\n|$)/gi,category:"architecture"},{pattern:/USER PREFERS:\s*(.+?)(?:\n|$)/gi,category:"preferences"},{pattern:/KEY FILE:\s*(.+?)(?:\n|$)/gi,category:"keyFiles"},{pattern:/PATTERN:\s*(.+?)(?:\n|$)/gi,category:"patterns"},{pattern:/AVOID:\s*(.+?)(?:\n|$)/gi,category:"avoid"}];for(let{pattern:s,category:o}of n){let i;for(;(i=s.exec(e))!==null;)await this.addMemory(o,i[1].trim(),"explicit",.95)}if(t.toLowerCase().includes("don't")||t.toLowerCase().includes("never")||t.toLowerCase().includes("stop")){let s=t.match(/(?:don't|never|stop)\s+(.+?)(?:\.|$)/i);s&&await this.addMemory("avoid",s[1].trim(),"user",.9)}if(t.toLowerCase().includes("always")||t.toLowerCase().includes("prefer")){let s=t.match(/(?:always|prefer)\s+(.+?)(?:\.|$)/i);s&&await this.addMemory("preferences",s[1].trim(),"user",.9)}}async clearMemory(){let e=$e.workspace.workspaceFolders?.[0];if(!e)return;let t=ye.join(e.uri.fsPath,".codebakers","memory.json");H.existsSync(t)&&H.unlinkSync(t),this._cache=null}}});var tc=v(()=>{"use strict"});var Er,ac,ce,Wa,Tr=v(()=>{"use strict";Er=q(require("vscode")),ac=q(require("fs")),ce=q(require("path")),Wa=class{constructor(){this.nodes=new Map;this.edges=new Map;this.groups=[];this.FILE_PATTERNS=["**/*.ts","**/*.tsx","**/*.js","**/*.jsx"];this.IGNORE_DIRS=["node_modules",".next","dist","build",".git","coverage","__tests__","__mocks__"];this.projectPath="",this.projectName=""}async analyzeProject(){let e=Er.workspace.workspaceFolders?.[0];if(!e)throw new Error("No workspace folder open");this.projectPath=e.uri.fsPath,this.projectName=ce.basename(this.projectPath),this.nodes.clear(),this.edges.clear(),this.groups=[],console.log(`MindMap: Analyzing project at ${this.projectPath}`);let t=await this.findFiles();console.log(`MindMap: Found ${t.length} files to analyze`);for(let i of t)try{await this.analyzeFile(i)}catch(r){console.error(`MindMap: Error analyzing ${i}:`,r)}this.buildEdges(),this.autoGroupByDirectory();let n=this.findCoherenceIssues(),s=this.calculateCoherenceScore(n);this.calculateLayout();let o={projectName:this.projectName,projectPath:this.projectPath,analyzedAt:new Date().toISOString(),totalFiles:t.length,totalNodes:this.nodes.size,totalEdges:this.countEdges(),coherenceScore:s,issues:n};return{nodes:Array.from(this.nodes.values()),edges:this.getAllEdges(),groups:this.groups,metadata:o}}async findFiles(){let e=[],t=`{${this.IGNORE_DIRS.join(",")}}`;for(let n of this.FILE_PATTERNS){let s=await Er.workspace.findFiles(n,`**/${t}/**`);for(let o of s)e.push(o.fsPath)}return e}async analyzeFile(e){let t=ac.readFileSync(e,"utf-8"),n=ce.relative(this.projectPath,e),s=ce.basename(e),o=ce.extname(e),i=this.pathToId(n),r=this.createFileNode(i,n,t);this.nodes.set(i,r),r.imports=this.extractImports(t),r.exports=this.extractExports(t);let d=this.detectNodeType(e,t);switch(r.type=d,d){case"component":r.props=this.extractProps(t),r.hooks=this.extractHooks(t);break;case"type":case"interface":r.fields=this.extractFields(t);break;case"api":r.methods=this.extractApiMethods(t);break;case"hook":r.methods=this.extractHookMethods(t);break;case"class":r.methods=this.extractClassMethods(t),r.fields=this.extractClassFields(t);break}r.style=this.getStyleForType(d)}createFileNode(e,t,n){let s=n.split(`
`);return{id:e,type:"file",name:ce.basename(t,ce.extname(t)),path:t,position:{x:0,y:0},linesOfCode:s.length,complexity:this.calculateComplexity(n),imports:[],exports:[]}}detectNodeType(e,t){let n=ce.basename(e).toLowerCase(),s=ce.dirname(e).toLowerCase();return e.includes("/api/")&&n==="route.ts"||e.includes("/pages/api/")?"api":n.startsWith("use")&&n.endsWith(".ts")||s.includes("hooks")?"hook":n.includes("context")||n.includes("provider")?"context":s.includes("types")||n.includes(".types.")?"type":(t.includes("export default function")||t.includes("export function")||t.includes("React.FC")||t.includes(": FC<")||t.includes("return (")||t.includes("return <"))&&t.includes("<")&&(t.includes("/>")||t.includes("</"))?"component":/class\s+\w+/.test(t)?"class":/export\s+(interface|type)\s+\w+/.test(t)?"interface":/export\s+enum\s+\w+/.test(t)?"enum":/export\s+const\s+[A-Z_]+\s*=/.test(t)?"constant":/export\s+(async\s+)?function/.test(t)?"function":"file"}extractImports(e){let t=[],n=e.split(`
`),s=[/import\s*\{([^}]+)\}\s*from\s*['"]([^'"]+)['"]/g,/import\s+(\w+)\s+from\s*['"]([^'"]+)['"]/g,/import\s+\*\s+as\s+(\w+)\s+from\s*['"]([^'"]+)['"]/g,/import\s+type\s*\{([^}]+)\}\s*from\s*['"]([^'"]+)['"]/g];for(let o=0;o<n.length;o++){let i=n[o],r=i.match(/import\s*\{([^}]+)\}\s*from\s*['"]([^'"]+)['"]/);if(r){let l=r[1].split(",").map(m=>m.trim().split(" as ")[0].trim()),c=r[2];for(let m of l)m&&t.push({name:m,from:c,type:i.includes("import type")?"type":"named",line:o+1});continue}let d=i.match(/import\s+(\w+)\s+from\s*['"]([^'"]+)['"]/);if(d&&!i.includes("{")){t.push({name:d[1],from:d[2],type:"default",line:o+1});continue}let p=i.match(/import\s+\*\s+as\s+(\w+)\s+from\s*['"]([^'"]+)['"]/);p&&t.push({name:p[1],from:p[2],type:"namespace",line:o+1})}return t}extractExports(e){let t=[],n=e.split(`
`);for(let s=0;s<n.length;s++){let o=n[s];if(/export\s+default/.test(o)){let p=o.match(/export\s+default\s+(?:function\s+|class\s+)?(\w+)/);t.push({name:p?p[1]:"default",type:"default",line:s+1});continue}let i=o.match(/export\s+interface\s+(\w+)/);if(i){t.push({name:i[1],type:"interface",line:s+1});continue}let r=o.match(/export\s+type\s+(\w+)/);if(r){t.push({name:r[1],type:"type",line:s+1});continue}let d=o.match(/export\s+(?:async\s+)?(?:function|const|let|var|class)\s+(\w+)/);d&&t.push({name:d[1],type:"named",line:s+1})}return t}extractProps(e){let t=[],n=e.match(/(?:interface|type)\s+\w*Props\w*\s*(?:=\s*)?\{([^}]+)\}/);if(n){let o=n[1].split(`
`);for(let i of o){let r=i.match(/(\w+)(\?)?:\s*([^;,]+)/);r&&t.push({name:r[1],type:r[3].trim(),required:!r[2]})}}return t}extractHooks(e){let t=[],n=e.matchAll(/\b(use\w+)\s*\(/g);for(let s of n)t.includes(s[1])||t.push(s[1]);return t}extractFields(e){let t=[],n=e.match(/(?:interface|type)\s+\w+\s*(?:=\s*)?\{([^}]+)\}/);if(n){let o=n[1].split(`
`);for(let i=0;i<o.length;i++){let d=o[i].trim().match(/(\w+)(\?)?:\s*([^;,]+)/);d&&t.push({name:d[1],type:d[3].trim(),optional:!!d[2],line:i+1})}}return t}extractApiMethods(e){let t=[],n=["GET","POST","PUT","PATCH","DELETE","HEAD","OPTIONS"];for(let s of n){let o=new RegExp(`export\\s+(?:async\\s+)?function\\s+${s}`,"g"),i=e.match(o);if(i){let r=e.indexOf(i[0]),d=e.substring(0,r).split(`
...
`),o;for(;(o=n.exec(e))!==null;){let i=e.substring(0,o.index).split(`
`).length;o[1]!=="function"&&o[1]!=="if"&&o[1]!=="for"&&o[1]!=="while"&&t.push({name:o[1],params:[],returnType:"unknown",async:o[0].includes("async"),line:i})}return t}extractClassFields(e){let t=[],n=/(?:private|public|protected)?\s*(\w+)\s*(?:\?)?:\s*([^;=]+)/g,s;for(;(s=n.exec(e))!==null;)t.push({name:s[1],type:s[2].trim(),optional:e.charAt(s.index+s[1].length)==="?"});return t}calculateComplexity(e){let t=1,n=[/\bif\s*\(/g,/\belse\s+if\s*\(/g,/\bfor\s*\(/g,/\bwhile\s*\(/g,/\bcase\s+/g,/\bcatch\s*\(/g,/\?\?/g,/\?[^:]/g,/&&/g,/\|\|/g];for(let s of n){let o=e.match(s);o&&(t+=o.length)}return t}getStyleForType(e){let t={file:{color:"#6b7280",icon:"\u{1F4C4}"},component:{color:"#3b82f6",icon:"\u269B\uFE0F"},function:{color:"#10b981",icon:"\u0192"},type:{color:"#8b5cf6",icon:"T"},interface:{color:"#8b5cf6",icon:"I"},api:{color:"#f59e0b",icon:"\u{1F50C}"},hook:{color:"#ec4899",icon:"\u{1FA9D}"},context:{color:"#06b6d4",icon:"\u{1F310}"},class:{color:"#ef4444",icon:"\u{1F4E6}"},enum:{color:"#84cc16",icon:"E"},constant:{color:"#f97316",icon:"C"},database:{color:"#14b8a6",icon:"\u{1F5C3}\uFE0F"},external:{color:"#9ca3af",icon:"\u{1F4E1}"}};return t[e]||t.file}buildEdges(){for(let[e,t]of this.nodes)if(t.imports)for(let n of t.imports){let s=this.resolveImport(n.from,t.path);if(s&&this.nodes.has(s)){let o=n.type==="type"?"uses_type":"imports";this.addEdge(e,s,o,n.name)}}}resolveImport(e,t){if(!e.startsWith(".")&&!e.startsWith("@/"))return null;let n;if(e.startsWith("@/"))n=e.replace("@/","src/");else{let o=ce.dirname(t);n=ce.join(o,e)}let s=["",".ts",".tsx",".js",".jsx","/index.ts","/index.tsx"];for(let o of s){let i=n+o,r=this.pathToId(i);if(this.nodes.has(r))return r}return null}addEdge(e,t,n,s){let i={id:`${e}->${t}:${n}`,source:e,target:t,type:n,label:s,weight:this.getEdgeWeight(n)};this.edges.has(e)||this.edges.set(e,[]),this.edges.get(e).push(i)}getEdgeWeight(e){return{imports:5,exports:3,calls:7,extends:9,implements:8,uses_type:4,renders:6,provides_context:7,consumes_context:6,has_field:3,references:2}[e]||5}autoGroupByDirectory(){let e=new Map;for(let[s,o]of this.nodes){let i=ce.dirname(o.path),r=i.split(ce.sep)[0]||i;e.has(r)||e.set(r,[]),e.get(r).push(s)}let t=["#3b82f6","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],n=0;for(let[s,o]of e)o.length>=2&&(this.groups.push({id:`group-${s}`,name:s,nodeIds:o,color:t[n%t.length]}),n++)}findCoherenceIssues(){let e=[],t=this.findCircularDependencies();for(let s of t)e.push({id:`circular-${s.join("-")}`,type:"circular_dependency",severity:"high",nodeIds:s,message:`Circular dependency: ${s.map(o=>this.nodes.get(o)?.name).join(" \u2192 ")}`,suggestion:"Extract shared logic to a separate module"});let n=this.findUnusedExports();for(let{nodeId:s,exportName:o}of n)e.push({id:`unused-export-${s}-${o}`,type:"unused_export",severity:"low",nodeIds:[s],message:`Unused export: ${o} in ${this.nodes.get(s)?.name}`,suggestion:"Consider removing if not needed"});for(let[s,o]of this.nodes){let i=this.hasIncomingEdges(s),r=this.edges.has(s);!i&&!r&&o.type!=="api"&&e.push({id:`orphan-${s}`,type:"orphaned_file",severity:"medium",nodeIds:[s],message:`Orphaned file: ${o.name} has no connections`,suggestion:"This file might be unused or missing imports"})}for(let[s,o]of this.nodes){let i=this.edges.get(s)?.length||0,r=this.countIncomingEdges(s);i+r>15&&e.push({id:`god-object-${s}`,type:"god_object",severity:"medium",nodeIds:[s],message:`High coupling: ${o.name} has ${i+r} connections`,suggestion:"Consider splitting into smaller modules"})}return e}findCircularDependencies(){let e=[],t=new Set,n=new Set,s=(o,i)=>{t.add(o),n.add(o),i.push(o);let r=this.edges.get(o)||[];for(let d of r)if(!t.has(d.target))s(d.target,[...i]);else if(n.has(d.target)){let p=i.indexOf(d.target),l=i.slice(p);l.push(d.target),e.push(l)}n.delete(o)};for(let o of this.nodes.keys())t.has(o)||s(o,[]);return e}findUnusedExports(){let e=[],t=new Set;for(let n of this.nodes.values())for(let s of n.imports||[])t.add(s.name);for(let[n,s]of this.nodes)for(let o of s.exports||[])o.type!=="default"&&!t.has(o.name)&&e.push({nodeId:n,exportName:o.name});return e}hasIncomingEdges(e){for(let t of this.edges.values())if(t.some(n=>n.target===e))return!0;return!1}countIncomingEdges(e){let t=0;for(let n of this.edges.values())t+=n.filter(s=>s.target===e).length;return t}calculateCoherenceScore(e){let t=100;for(let n of e)switch(n.severity){case"critical":t-=15;break;case"high":t-=10;break;case"medium":t-=5;break;case"low":t-=2;break;case"info":t-=1;break}return Math.max(0,Math.min(100,t))}calculateLayout(){let s=new Map;for(let r of this.nodes.values())s.has(r.type)||s.set(r.type,[]),s.get(r.type).push(r);let o=0,i=["type","interface","context","hook","component","api","function","class","file"];for(let r of i){let d=s.get(r)||[];if(d.length!==0){for(let p=0;p<d.length;p++){let l=p%5*300,c=o+Math.floor(p/5)*150;d[p].position={x:l,y:c}}o+=Math.ceil(d.length/5)*150+100}}}pathToId(e){return e.replace(/[\\\/]/g,"-").replace(/\./g,"_")}countEdges(){let e=0;for(let t of this.edges.values())e+=t.length;return e}getAllEdges(){let e=[];for(let t of this.edges.values())e.push(...t);return e}getNode(e){return this.nodes.get(e)}getDependents(e){let t=[];for(let n of this.edges.values())for(let s of n)if(s.target===e){let o=this.nodes.get(s.source);o&&t.push(o)}return t}getDependencies(e){return(this.edges.get(e)||[]).map(n=>this.nodes.get(n.target)).filter(n=>n!==void 0)}getEdges(e){return this.edges.get(e)||[]}}});var nc,ot,Eo,Ga,Nr=v(()=>{"use strict";nc=q(require("vscode")),ot=q(require("fs")),Eo=q(require("path")),Ga=class{constructor(e){this.appliedPatches=[];this.graph=e;let t=nc.workspace.workspaceFolders?.[0];this.projectPath=t?.uri.fsPath||""}async analyzeImpact(e){let t=this.graph.getNode(e.nodeId);if(!t)throw new Error(`Node not found: ${e.nodeId}`);let n=[],s=[],o=[],i=[],r=this.graph.getDependents(e.nodeId);for(let l of r){let c=await this.analyzeNodeImpact(l,t,e);c.breaking&&o.push(...c.breaking),c.affected&&n.push(c.affected),c.fixes&&i.push(...c.fixes)}let d=new Set([e.nodeId,...r.map(l=>l.id)]);for(let l of r){let c=this.graph.getDependents(l.id);for(let m of c)d.has(m.id)||(d.add(m.id),s.push({nodeId:m.id,nodeName:m.name,path:m.path,impactType:"update_usage",description:`Transitively affected through ${l.name}`}))}let p=this.calculateRiskLevel(n.length,o.length,e.changeType);return{targetNode:e.nodeId,change:e,directImpact:n,transitiveImpact:s,breakingChanges:o,suggestedFixes:i,riskLevel:p}}async analyzeNodeImpact(e,t,n){let s=[],o=[],i=Eo.join(this.projectPath,e.path);if(!ot.existsSync(i))return{};let r=ot.readFileSync(i,"utf-8"),d=r.split(`
`);switch(n.changeType){case"rename":return this.analyzeRenameImpact(e,t,n,r,d);case"add_field":return this.analyzeAddFieldImpact(e,t,n,r,d);case"remove_field":return this.analyzeRemoveFieldImpact(e,t,n,r,d);case"change_type":return this.analyzeTypeChangeImpact(e,t,n,r,d);case"delete":return this.analyzeDeleteImpact(e,t,n,r,d);default:return{affected:{nodeId:e.id,nodeName:e.name,path:e.path,impactType:"update_usage",description:`May be affected by ${n.changeType} on ${t.name}`}}}}analyzeRenameImpact(e,t,n,s,o){let i=n.before,r=n.after,d=[],p=new RegExp(`\\b${this.escapeRegex(i)}\\b`,"g");for(let l=0;l<o.length;l++){let c=o[l];if(p.test(c)){let m=c.replace(p,r);d.push({nodeId:e.id,path:e.path,line:l+1,description:`Rename ${i} to ${r}`,oldCode:c,newCode:m,autoFixable:!0})}}return d.length===0?{}:{affected:{nodeId:e.id,nodeName:e.name,path:e.path,impactType:"update_import",description:`${d.length} reference(s) to ${i} need updating`},fixes:d}}analyzeAddFieldImpact(e,t,n,s,o){let i=n.after?.name,r=n.after?.type,d=[],p=t.name,l=new RegExp(`:\\s*${p}\\s*=\\s*\\{`,"g");for(let c=0;c<o.length;c++)l.test(o[c])&&d.push({nodeId:e.id,path:e.path,line:c+1,description:`Consider adding ${i}: ${r} to ${p} object`,oldCode:o[c],newCode:o[c],autoFixable:!1});return d.length===0?{}:{affected:{nodeId:e.id,nodeName:e.name,path:e.path,impactType:"missing_field",description:`May need to add ${i} to ${p} usages`},fixes:d}}analyzeRemoveFieldImpact(e,t,n,s,o){let i=n.before?.name,r=[],d=[],p=new RegExp(`\\.${i}\\b`,"g"),l=new RegExp(`\\{[^}]*\\b${i}\\b[^}]*\\}`,"g");for(let c=0;c<o.length;c++){let m=o[c];p.test(m)&&(r.push({nodeId:e.id,path:e.path,line:c+1,currentCode:m,reason:`Uses removed field .${i}`}),d.push({nodeId:e.id,path:e.path,line:c+1,description:`Remove usage of .${i}`,oldCode:m,newCode:m.replace(p,""),autoFixable:!1})),l.test(m)&&r.push({nodeId:e.id,path:e.path,line:c+1,currentCode:m,reason:`Destructures removed field ${i}`})}return r.length===0?{}:{affected:{nodeId:e.id,nodeName:e.name,path:e.path,impactType:"breaking",description:`${r.length} usage(s) of removed field ${i}`},breaking:r,fixes:d}}analyzeTypeChangeImpact(e,t,n,s,o){let i=n.before?.name,r=n.before?.type,d=n.after?.type,p=[],l=[],c=new RegExp(`\\.${i}\\b`,"g");for(let m=0;m<o.length;m++){let u=o[m];c.test(u)&&this.mightHaveTypeConflict(u,i,r,d)&&(p.push({nodeId:e.id,path:e.path,line:m+1,currentCode:u,reason:`Type change: ${i} changed from ${r} to ${d}`}),l.push({nodeId:e.id,path:e.path,line:m+1,description:`Update usage for new type ${d}`,oldCode:u,newCode:u,autoFixable:!1}))}return p.length===0?{affected:{nodeId:e.id,nodeName:e.name,path:e.path,impactType:"type_mismatch",description:`Uses ${i} which changed from ${r} to ${d}`}}:{affected:{nodeId:e.id,nodeName:e.name,path:e.path,impactType:"type_mismatch",description:`${p.length} potential type conflict(s)`},breaking:p,fixes:l}}analyzeDeleteImpact(e,t,n,s,o){let i=[],r=[],d=new RegExp(`import\\s+(?:.*\\{[^}]*\\b${t.name}\\b[^}]*\\}|${t.name})\\s+from`,"g");for(let p=0;p<o.length;p++){let l=o[p];d.test(l)&&(i.push({nodeId:e.id,path:e.path,line:p+1,currentCode:l,reason:`Imports deleted module ${t.name}`}),r.push({nodeId:e.id,path:e.path,line:p+1,description:`Remove import of deleted ${t.name}`,oldCode:l,newCode:"",autoFixable:!0}))}return i.length===0?{}:{affected:{nodeId:e.id,nodeName:e.name,path:e.path,impactType:"breaking",description:`Imports deleted ${t.name}`},breaking:i,fixes:r}}mightHaveTypeConflict(e,t,n,s){return!!((n.includes("string")&&s.includes("number")||n.includes("number")&&s.includes("string"))&&(e.includes(".length")||e.includes(".charAt")||e.includes(".split")||/[+\-*/]/.test(e))||s.includes("|")||n.includes("|"))}calculateRiskLevel(e,t,n){return t>5||n==="delete"&&e>3?"critical":t>0||e>10?"high":e>5?"medium":"low"}async applyPatches(e){let t=[],n=[],s=[],o=new Set,i=new Map;for(let r of e)i.has(r.path)||i.set(r.path,[]),i.get(r.path).push(r);for(let[r,d]of i)try{let p=Eo.join(this.projectPath,r);if(!ot.existsSync(p)){s.push(`File not found: ${r}`);for(let m of d)m.error="File not found",n.push(m);continue}let l=ot.readFileSync(p,"utf-8"),c=l.split(`
`);d.sort((m,u)=>u.line-m.line);for(let m of d)try{let u=m.line-1;if(u<0||u>=c.length){m.error=`Line ${m.line} out of range`,n.push(m);continue}if(c[u].trim()!==m.oldCode.trim()){let g=this.findMatchingLine(c,m.oldCode,m.line);if(g===-1){m.error="Code has changed, cannot apply patch",n.push(m);continue}m.line=g+1}m.newCode===""?c.splice(m.line-1,1):c[m.line-1]=m.newCode,m.applied=!0,t.push(m)}catch(u){m.error=u.message,n.push(m)}l=c.join(`
`),ot.writeFileSync(p,l,"utf-8"),o.add(r)}catch(p){s.push(`Error processing ${r}: ${p.message}`);for(let l of d)l.applied||(l.error=p.message,n.push(l))}return this.appliedPatches.push(...t),{success:n.length===0,patchesApplied:t,patchesFailed:n,errors:s,filesModified:Array.from(o)}}findMatchingLine(e,t,n){let s=t.trim(),o=5;for(let i=0;i<=o;i++){if(n-1-i>=0&&e[n-1-i].trim()===s)return n-1-i;if(n-1+i<e.length&&e[n-1+i].trim()===s)return n-1+i}return-1}async rollback(e){let t=e.length>0?this.appliedPatches.filter(o=>e.includes(o.id)):[...this.appliedPatches],n=t.map(o=>({...o,id:`rollback-${o.id}`,oldCode:o.newCode,newCode:o.oldCode,description:`Rollback: ${o.description}`,applied:!1})),s=await this.applyPatches(n);if(s.success){let o=new Set(t.map(i=>i.id));this.appliedPatches=this.appliedPatches.filter(i=>!o.has(i.id))}return s}async generateRenamePatches(e,t,n){let s=[],o=this.graph.getDependents(e);for(let i of o){let r=Eo.join(this.projectPath,i.path);if(!ot.existsSync(r))continue;let p=ot.readFileSync(r,"utf-8").split(`
`),l=new RegExp(`\\b${this.escapeRegex(t)}\\b`,"g");for(let c=0;c<p.length;c++){let m=p[c];l.test(m)&&s.push({id:`rename-${i.id}-${c}`,path:i.path,line:c+1,oldCode:m,newCode:m.replace(l,n),description:`Rename ${t} to ${n}`,autoFixable:!0})}}return s}escapeRegex(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}getAppliedPatches(){return[...this.appliedPatches]}clearHistory(){this.appliedPatches=[]}}});var Z,es,St,To,sc=v(()=>{"use strict";Z=q(require("vscode")),es=q(require("path")),St=q(require("fs"));Tr();Nr();To=class a{constructor(e,t){this._disposables=[];this.graphData=null;this._panel=e,this._extensionUri=t,this.graph=new Wa,this.propagation=new Ga(this.graph),this._update(),this._panel.onDidDispose(()=>this.dispose(),null,this._disposables),this._panel.webview.onDidReceiveMessage(async n=>{await this._handleMessage(n)},null,this._disposables)}static createOrShow(e){let t=Z.window.activeTextEditor?Z.window.activeTextEditor.viewColumn:void 0;if(a.currentPanel)return a.currentPanel._panel.reveal(t),a.currentPanel;let n=Z.window.createWebviewPanel("codebakers.mindmap","CodeBakers Mind Map",t||Z.ViewColumn.One,{enableScripts:!0,retainContextWhenHidden:!0,localResourceRoots:[e]});return a.currentPanel=new a(n,e),a.currentPanel}async analyze(){this._postMessage({type:"loading",isLoading:!0});try{let e=await this._loadSavedData();if(this.graphData=await this.graph.analyzeProject(),e?.userPositions)for(let t of this.graphData.nodes)e.userPositions[t.id]&&(t.position=e.userPositions[t.id]);this._postMessage({type:"init",data:this.graphData})}catch(e){console.error("MindMap: Analysis failed:",e),this._postMessage({type:"error",message:e.message})}finally{this._postMessage({type:"loading",isLoading:!1})}}async _handleMessage(e){switch(e.type){case"ready":await this.analyze();break;case"refresh":await this.analyze();break;case"selectNode":let t=this.graph.getNode(e.nodeId);if(t){let o=this.graph.getDependents(e.nodeId),i=this.graph.getDependencies(e.nodeId);this._postMessage({type:"nodeDetails",node:t,dependents:o,dependencies:i})}break;case"analyzeImpact":try{let o=await this.propagation.analyzeImpact(e.change);this._postMessage({type:"impactResult",data:o})}catch(o){this._postMessage({type:"error",message:o.message})}break;case"applyChanges":try{let o=await this.propagation.applyPatches(e.patches);this._postMessage({type:"propagationResult",data:o}),await this.analyze()}catch(o){this._postMessage({type:"error",message:o.message})}break;case"openFile":let n=Z.workspace.workspaceFolders?.[0];if(!n){Z.window.showErrorMessage("No workspace folder open");break}let s=Z.Uri.file(es.join(n.uri.fsPath,e.path));try{let o=await Z.workspace.openTextDocument(s),i=await Z.window.showTextDocument(o);if(e.line){let r=new Z.Position(e.line-1,0);i.selection=new Z.Selection(r,r),i.revealRange(new Z.Range(r,r))}}catch(o){Z.window.showErrorMessage(`Could not open file: ${o.message}`)}break;case"savePositions":await this._savePositions(e.positions);break;case"exportImage":Z.window.showInformationMessage("Export feature coming soon!");break}}async _loadSavedData(){let e=Z.workspace.workspaceFolders?.[0];if(!e)return null;let t=es.join(e.uri.fsPath,".codebakers","mindmap.json");if(!St.existsSync(t))return null;try{let n=St.readFileSync(t,"utf-8");return JSON.parse(n)}catch{return null}}async _savePositions(e){let t=Z.workspace.workspaceFolders?.[0];if(!t)return;let n=es.join(t.uri.fsPath,".codebakers"),s=es.join(n,"mindmap.json");St.existsSync(n)||St.mkdirSync(n,{recursive:!0});let o={version:"1.0",lastSync:new Date().toISOString(),userPositions:e},i=await this._loadSavedData();i&&(o.userPositions={...i.userPositions,...e}),St.writeFileSync(s,JSON.stringify(o,null,2))}_postMessage(e){this._panel.webview.postMessage(e)}_update(){this._panel.webview.html=this._getHtmlForWebview()}_getHtmlForWebview(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`}dispose(){for(a.currentPanel=void 0,this._panel.dispose();this._disposables.length;){let e=this._disposables.pop();e&&e.dispose()}}}});var Ar={};Et(Ar,{DependencyGraph:()=>Wa,MindMapPanelProvider:()=>To,PropagationEngine:()=>Ga});var Ir=v(()=>{"use strict";tc();Tr();Nr();sc()});var Br,Rr,Mr=v(()=>{"use strict";Br={page:{type:"page",description:"A screen users can visit. Like the homepage, login page, or dashboard. Each page has its own URL (e.g., /about, /settings).",details:{route:"/",isProtected:!1}},component:{type:"component",description:"A reusable building block for your pages. Like a button, card, or navigation bar. Build once, use anywhere.",details:{props:[],hasState:!1}},api:{type:"api",description:"A backend endpoint that handles data. When users submit a form, log in, or load their profile, an API handles it behind the scenes.",details:{httpMethod:"GET",requestBody:[],requiresAuth:!0}},database:{type:"database",description:"A table to store your data permanently. Like a spreadsheet that saves users, orders, or posts. Your app reads from and writes to this.",details:{columns:[],relations:[]}},type:{type:"type",description:'A blueprint that defines the shape of your data. Like saying "a User has a name, email, and age". Helps prevent bugs.',details:{fields:[]}},hook:{type:"hook",description:'Reusable logic for your components. Like "fetch user data" or "track form input". Write the logic once, use it in any component.',details:{dependencies:[]}},service:{type:"service",description:"A helper module that does a specific job. Like sending emails, processing payments, or talking to external services. Keeps your code organized.",details:{methods:[]}},middleware:{type:"middleware",description:"A security checkpoint that runs before pages load. Checks if users are logged in, have permission, or blocks bad requests.",details:{}},context:{type:"context",description:"Shared data that many components can access. Like the current user, theme (dark/light), or language. No need to pass it manually everywhere.",details:{}},action:{type:"action",description:"A function that runs on the server when users submit forms. Handles things like creating posts, updating profiles, or processing orders securely.",details:{formFields:[]}},job:{type:"job",description:"A task that runs automatically in the background. Like sending weekly emails, cleaning up old data, or syncing with other services.",details:{}}},Rr={page:{bg:"#dbeafe",border:"#3b82f6",icon:"\u{1F4C4}"},component:{bg:"#dcfce7",border:"#22c55e",icon:"\u{1F9E9}"},api:{bg:"#fef3c7",border:"#f59e0b",icon:"\u{1F50C}"},database:{bg:"#fce7f3",border:"#ec4899",icon:"\u{1F5C4}\uFE0F"},type:{bg:"#e0e7ff",border:"#6366f1",icon:"\u{1F4DD}"},hook:{bg:"#f3e8ff",border:"#a855f7",icon:"\u{1FA9D}"},service:{bg:"#ccfbf1",border:"#14b8a6",icon:"\u2699\uFE0F"},middleware:{bg:"#fed7aa",border:"#f97316",icon:"\u{1F500}"},context:{bg:"#cffafe",border:"#06b6d4",icon:"\u{1F310}"},action:{bg:"#fecaca",border:"#ef4444",icon:"\u26A1"},job:{bg:"#e5e7eb",border:"#6b7280",icon:"\u23F0"}}});var oc,Ya,Dr=v(()=>{"use strict";oc=q(require("vscode")),Ya=class{constructor(e={}){this.conversationContext=[];console.log("AIPlanner: Initializing...");try{this.config={proactivityLevel:"balanced",autoSuggestConnections:!0,warnMissingPatterns:!0,projectType:"nextjs",patterns:[],...e};let t=oc.workspace.getConfiguration("codebakers");this.apiEndpoint=t.get("apiEndpoint")||"https://www.codebakers.ai",console.log("AIPlanner: Initialized with endpoint:",this.apiEndpoint)}catch(t){let n=t instanceof Error?t.message:String(t);console.error("AIPlanner: Initialization failed:",n),this.config={proactivityLevel:"balanced",autoSuggestConnections:!0,warnMissingPatterns:!0,projectType:"nextjs",patterns:[]},this.apiEndpoint="https://www.codebakers.ai"}}async chat(e,t){console.log("AIPlanner: Processing chat message, length:",e.length);let n=`msg_${Date.now()}`;try{console.log("AIPlanner: Building plan context...");let s=this.buildPlanContext(t),o=this.detectIntent(e,t);console.log("AIPlanner: Detected intent:",o);let i,r=[];try{console.log("AIPlanner: Calling AI API...");let p=await this.callAI(e,s,o,t);i=p.message,r=p.actions,console.log("AIPlanner: AI response received, actions:",r.length)}catch(p){let l=p instanceof Error?p.message:String(p);console.error("AIPlanner: Error calling AI:",l),console.log("AIPlanner: Using fallback response"),i=this.generateFallbackResponse(e,t,o),r=this.generateFallbackActions(o,t)}let d={id:n,role:"assistant",content:i,timestamp:Date.now(),suggestedActions:r};return this.conversationContext.push(`User: ${e}`),this.conversationContext.push(`Assistant: ${i}`),this.conversationContext.length>20&&(console.log("AIPlanner: Trimming conversation context"),this.conversationContext=this.conversationContext.slice(-20)),console.log("AIPlanner: Chat completed successfully"),d}catch(s){let o=s instanceof Error?s.message:String(s);return console.error("AIPlanner: Chat processing failed:",o),console.error("AIPlanner: Stack:",s instanceof Error?s.stack:"No stack"),{id:n,role:"assistant",content:"I'm having trouble processing that right now. Could you try rephrasing your request?",timestamp:Date.now(),suggestedActions:[]}}}async getInitialGreeting(e){console.log("AIPlanner: Generating initial greeting, plan nodes:",e.nodes.length);let t=`msg_${Date.now()}`;try{let n,s=[];if(e.nodes.length===0)console.log("AIPlanner: Empty plan, showing welcome message"),n=`Hey! I'm here to help you plan your build. Let's figure out what you're making together.

**What are you building?** Give me the quick pitch - what's this app supposed to do?

Or if you want to get started faster, pick a template:`,s=[{id:"tpl_saas",type:"use-template",label:"SaaS Starter",description:"Auth, billing, dashboard, settings",payload:{templateId:"saas-starter"},status:"pending"},{id:"tpl_ecom",type:"use-template",label:"E-commerce",description:"Products, cart, checkout, orders",payload:{templateId:"ecommerce"},status:"pending"},{id:"tpl_dash",type:"use-template",label:"Admin Dashboard",description:"Data tables, charts, CRUD",payload:{templateId:"dashboard"},status:"pending"}];else{console.log("AIPlanner: Resuming existing plan");let o=[...new Set(e.nodes.map(r=>r.type))];n=`Welcome back! You've got ${e.nodes.length} pieces planned: ${o.join(", ")}.

What do you want to work on next?`;let i=this.analyzePlanCompleteness(e);console.log("AIPlanner: Found",i.length,"improvement suggestions"),i.length>0&&(n+=`

**I noticed some things you might want to add:**`,i.slice(0,3).forEach(r=>{n+=`
- ${r.title}`}))}return console.log("AIPlanner: Initial greeting generated"),{id:t,role:"assistant",content:n,timestamp:Date.now(),suggestedActions:s}}catch(n){let s=n instanceof Error?n.message:String(n);return console.error("AIPlanner: Failed to generate greeting:",s),{id:t,role:"assistant",content:"Hey! I'm here to help you plan your build. What are you building?",timestamp:Date.now(),suggestedActions:[]}}}analyzeAndSuggest(e){console.log("AIPlanner: Analyzing plan for suggestions...");let t=[];try{let n=e.nodes.some(p=>p.name.toLowerCase().includes("auth")||p.name.toLowerCase().includes("login")),s=e.nodes.some(p=>p.type==="api"),o=e.nodes.some(p=>p.type==="database"),i=e.nodes.some(p=>p.type==="page"),r=e.nodes.some(p=>p.name.toLowerCase().includes("error")||p.type==="middleware");if(console.log("AIPlanner: Plan analysis - hasAuth:",n,"hasApi:",s,"hasDatabase:",o),s&&!n&&t.push({id:`sug_${Date.now()}_auth`,type:"missing-piece",severity:"warning",title:"No authentication detected",description:"You have API routes but no auth. Should I add login/signup pages and auth middleware?",suggestedNodes:[{type:"page",name:"LoginPage",description:"User login page",details:{route:"/login",isProtected:!1}},{type:"page",name:"SignupPage",description:"User registration page",details:{route:"/signup",isProtected:!1}},{type:"middleware",name:"authMiddleware",description:"Protects routes requiring authentication"}],dismissed:!1,createdAt:Date.now()}),o){let p=e.nodes.filter(m=>m.type==="database"),l=e.nodes.filter(m=>m.type==="type"),c=p.filter(m=>!l.some(u=>u.name.toLowerCase().includes(m.name.toLowerCase())));c.length>0&&t.push({id:`sug_${Date.now()}_types`,type:"improvement",severity:"info",title:"Missing TypeScript types for database models",description:`You have ${c.length} database table(s) without matching types. Want me to create types for ${c.map(m=>m.name).join(", ")}?`,suggestedNodes:c.map(m=>({type:"type",name:`${m.name}Type`,description:`Type for ${m.name} table`,details:{fields:m.details.columns?.map(u=>({name:u.name,type:this.sqlToTsType(u.type),required:u.required}))}})),dismissed:!1,createdAt:Date.now()})}if(i&&e.nodes.length>=3){let p=e.nodes.filter(c=>c.type==="page");!e.nodes.some(c=>c.name.toLowerCase().includes("layout")||c.name.toLowerCase().includes("shell"))&&p.length>=2&&t.push({id:`sug_${Date.now()}_layout`,type:"improvement",severity:"info",title:"Consider adding a shared layout",description:"You have multiple pages but no shared layout. Want me to add a layout component with navigation?",suggestedNodes:[{type:"component",name:"AppLayout",description:"Shared layout with navigation and footer",details:{props:[{name:"children",type:"React.ReactNode",required:!0}]}}],dismissed:!1,createdAt:Date.now()})}s&&!r&&t.push({id:`sug_${Date.now()}_errors`,type:"warning",severity:"warning",title:"No error handling detected",description:"Your API routes need error handling. Should I add an error boundary and API error middleware?",suggestedNodes:[{type:"middleware",name:"errorHandler",description:"Catches and formats API errors"},{type:"component",name:"ErrorBoundary",description:"Catches React rendering errors"}],dismissed:!1,createdAt:Date.now()});let d=e.nodes.filter(p=>p.type==="api"&&p.details.httpMethod&&["POST","PUT","PATCH","DELETE"].includes(p.details.httpMethod));return d.length>0&&(e.nodes.some(l=>l.type==="service"&&(l.name.toLowerCase().includes("valid")||l.name.toLowerCase().includes("schema")))||t.push({id:`sug_${Date.now()}_validation`,type:"improvement",severity:"info",title:"Add input validation",description:"You have APIs that accept data. Consider adding Zod schemas for validation.",suggestedNodes:[{type:"service",name:"validationSchemas",description:"Zod schemas for API input validation",details:{methods:d.map(l=>({name:`${l.name}Schema`,params:"",returnType:"z.ZodSchema",isAsync:!1}))}}],dismissed:!1,createdAt:Date.now()})),console.log("AIPlanner: Generated",t.length,"suggestions"),t}catch(n){let s=n instanceof Error?n.message:String(n);return console.error("AIPlanner: Failed to analyze plan:",s),[]}}suggestConnectionsForNode(e,t){console.log("AIPlanner: Suggesting connections for node:",e.name,"type:",e.type);try{if(!this.config.autoSuggestConnections)return console.log("AIPlanner: Auto-suggest connections disabled"),[];let n=[];switch(e.type){case"page":t.filter(s=>s.type==="component").forEach(s=>{this.areRelated(e.name,s.name)&&n.push({id:`edge_${Date.now()}_${Math.random().toString(36).substr(2,9)}`,source:e.id,target:s.id,type:"renders",aiGenerated:!0,aiNotes:`${e.name} likely renders ${s.name}`})}),t.filter(s=>s.type==="api").forEach(s=>{this.areRelated(e.name,s.name)&&n.push({id:`edge_${Date.now()}_${Math.random().toString(36).substr(2,9)}`,source:e.id,target:s.id,type:"calls",aiGenerated:!0,aiNotes:`${e.name} likely calls ${s.name}`})});break;case"api":t.filter(s=>s.type==="database").forEach(s=>{if(this.areRelated(e.name,s.name)){let o=e.details.httpMethod==="GET"?"queries":"mutates";n.push({id:`edge_${Date.now()}_${Math.random().toString(36).substr(2,9)}`,source:e.id,target:s.id,type:o,aiGenerated:!0,aiNotes:`${e.name} ${o} ${s.name}`})}});break;case"component":t.filter(s=>s.type==="hook").forEach(s=>{this.areRelated(e.name,s.name)&&n.push({id:`edge_${Date.now()}_${Math.random().toString(36).substr(2,9)}`,source:e.id,target:s.id,type:"uses",aiGenerated:!0,aiNotes:`${e.name} might use ${s.name}`})});break;case"hook":t.filter(s=>s.type==="api"||s.type==="service").forEach(s=>{this.areRelated(e.name,s.name)&&n.push({id:`edge_${Date.now()}_${Math.random().toString(36).substr(2,9)}`,source:e.id,target:s.id,type:"calls",aiGenerated:!0,aiNotes:`${e.name} might call ${s.name}`})});break}return console.log("AIPlanner: Suggested",n.length,"connections"),n}catch(n){let s=n instanceof Error?n.message:String(n);return console.error("AIPlanner: Failed to suggest connections:",s),[]}}autoFillNodeDetails(e,t){console.log("AIPlanner: Auto-filling details for node:",e.name,"type:",e.type);try{let n={};switch(e.type){case"page":if(!e.details.route){let i=this.nameToRoute(e.name);n.route=i}t.nodes.some(i=>i.name.toLowerCase().includes("auth")||i.name.toLowerCase().includes("login"))&&!e.name.toLowerCase().includes("login")&&(n.isProtected=!0);break;case"api":if(!e.details.httpMethod){let i=e.name.toLowerCase();i.includes("create")||i.includes("add")||i.includes("post")?n.httpMethod="POST":i.includes("update")||i.includes("edit")?n.httpMethod="PUT":i.includes("delete")||i.includes("remove")?n.httpMethod="DELETE":n.httpMethod="GET"}break;case"database":e.details.tableName||(n.tableName=this.nameToTableName(e.name)),(!e.details.columns||e.details.columns.length===0)&&(n.columns=[{name:"id",type:"serial",required:!0,description:"Primary key"},{name:"created_at",type:"timestamp",required:!0},{name:"updated_at",type:"timestamp",required:!0}]);break;case"component":let o=t.nodes.find(i=>i.type==="database"&&this.areRelated(e.name,i.name));o&&(!e.details.props||e.details.props.length===0)&&(n.props=[{name:o.name.toLowerCase(),type:`${o.name}Type`,required:!0}]);break}return console.log("AIPlanner: Auto-filled details:",Object.keys(n)),n}catch(n){let s=n instanceof Error?n.message:String(n);return console.error("AIPlanner: Failed to auto-fill details:",s),{}}}buildPlanContext(e){let t=[`Project Type: ${this.config.projectType||"nextjs"}`,`Total Nodes: ${e.nodes.length}`,`Total Connections: ${e.edges.length}`,"","Current Architecture:"],n=new Map;return e.nodes.forEach(s=>{let o=n.get(s.type)||[];o.push(s),n.set(s.type,o)}),n.forEach((s,o)=>{t.push(`
...
`)}detectIntent(e,t){let n=e.toLowerCase();return n.includes("generate")||n.includes("build")||n.includes("let's go")?"generate":n.includes("review")||n.includes("check")||n.includes("ready")?"review":n.includes("add")||n.includes("create")||n.includes("need")||n.includes("want")?"add":n.includes("change")||n.includes("update")||n.includes("modify")?"modify":n.includes("?")||n.includes("what")||n.includes("how")?"question":"describe"}async callAI(e,t,n,s){let o=`You are an AI architect helping users design their application architecture. You're collaborative and proactive.
...
What would you like to do?`}}generateReviewResponse(e){let t=this.analyzePlanCompleteness(e),n=e.nodes.length,s=e.edges.length;if(n===0)return"There's nothing to review yet. Start by telling me what you're building!";let o=`**Plan Review**

`;return o+=`\u{1F4E6} ${n} components planned
...
`,r}generateComponentCode(e,t){let n=this.toPascalCase(e.name),s=e.details.props||[],o="",i="";return s.length>0&&(o=`interface ${n}Props {
`,s.forEach(d=>{let p=d.required?"":"?";o+=`  ${d.name}${p}: ${d.type};
`}),o+=`}

`,i=`{ ${s.map(d=>d.name).join(", ")} }: ${n}Props`),`/**
 * ${e.description||n}
 * Generated by CodeBakers Build Planner
 */
...
`,r}generateDatabaseCode(e,t){let n=e.details.tableName||this.toSnakeCase(e.name.replace(/Table$/i,""))+"s",s=e.details.columns||[],o=e.details.relations||[],i=`/**
 * ${e.description||e.name}
 * Table: ${n}
 * Generated by CodeBakers Build Planner
 */
...
`}),i+=`});
`,o.length>0){let r=this.toCamelCase(n);i+=`
...
`,i+=`export type New${this.toPascalCase(e.name.replace(/Table$/i,""))} = typeof ${this.toCamelCase(n)}.$inferInsert;
`,i}generateTypeCode(e,t){let n=this.toPascalCase(e.name.replace(/Type$/i,"")),s=e.details.fields||[],o=e.details.extends,i=`/**
 * ${e.description||n}
 * Generated by CodeBakers Build Planner
 */

`,r=o?` extends ${o}`:"";return i+=`export interface ${n}${r} {
...
`),i+=`  ${d.name}${p}: ${d.type};
`}),i+=`}
`,i}generateHookCode(e,t){let n=e.name.startsWith("use")?e.name:`use${this.toPascalCase(e.name)}`,s=e.details.dependencies||[],o=e.details.returnValue||"void",i=t.edges.filter(p=>p.source===e.id&&p.type==="calls").map(p=>t.nodes.find(l=>l.id===p.target&&l.type==="api")).filter(Boolean),r=["import { useState, useEffect } from 'react';"],d=`/**
 * ${e.description||n}
 * Generated by CodeBakers Build Planner
 */
...
`,d}generateServiceCode(e,t){let n=this.toPascalCase(e.name.replace(/Service$/i,""))+"Service",s=e.details.methods||[],o=`/**
 * ${e.description||n}
 * Generated by CodeBakers Build Planner
 */
...
`,o+=`  }${r<s.length-1?",":""}
`}),o+=`};
`,o}generateMiddlewareCode(e,t){let n=this.toCamelCase(e.name);return`/**
 * ${e.description||n}
 * Generated by CodeBakers Build Planner
 */
...
`}generateActionCode(e,t){let n=this.toCamelCase(e.name.replace(/Action$/i,"")),s=e.details.formFields||[],o=`/**
 * ${e.description||n}
 * Server Action
 * Generated by CodeBakers Build Planner
 */
...
`,o}generateJobCode(e,t){let n=this.toCamelCase(e.name.replace(/Job$/i,"")),s=e.details.schedule||"0 0 * * *";return`/**
 * ${e.description||n}
 * Schedule: ${s}
 * Generated by CodeBakers Build Planner
 */
...
<body>
  ...
  <script>
    const vscode = acquireVsCodeApi();
    const NODE_COLORS = ${JSON.stringify(Rr)};
...
</html>`}}});var Lr={};Et(Lr,{AIPlanner:()=>Ya,BuildPlannerProvider:()=>No,CodeGenerator:()=>Xa,NODE_COLORS:()=>Rr,NODE_DEFAULTS:()=>Br});var $r=v(()=>{"use strict";ic();Dr();Fr();Mr()});var i0={};Et(i0,{activate:()=>s0,deactivate:()=>o0});module.exports=fc(i0);var A=q(require("vscode")),jr,zr,Vr,qr,Io,Bo,Oe,Te,fa,je,ts,Ro=null;async function n0(){try{return console.log("CodeBakers: Loading ChatPanelProvider..."),jr=(await Promise.resolve().then(()=>(Qr(),Zr))).ChatPanelProvider,console.log("CodeBakers: ChatPanelProvider loaded"),console.log("CodeBakers: Loading CodeBakersClient..."),zr=(await Promise.resolve().then(()=>(Zl(),Jl))).CodeBakersClient,console.log("CodeBakers: CodeBakersClient loaded"),console.log("CodeBakers: Loading ProjectContext..."),Vr=(await Promise.resolve().then(()=>(ec(),Ql))).ProjectContext,console.log("CodeBakers: ProjectContext loaded"),console.log("CodeBakers: Loading FileOperations..."),qr=(await Promise.resolve().then(()=>(Fo(),Yr))).DiffContentProvider,console.log("CodeBakers: FileOperations loaded"),console.log("CodeBakers: Loading MindMapPanelProvider..."),Io=(await Promise.resolve().then(()=>(Ir(),Ar))).MindMapPanelProvider,console.log("CodeBakers: MindMapPanelProvider loaded"),console.log("CodeBakers: Loading BuildPlannerProvider..."),Bo=(await Promise.resolve().then(()=>($r(),Lr))).BuildPlannerProvider,console.log("CodeBakers: BuildPlannerProvider loaded"),console.log("CodeBakers: All modules loaded successfully"),!0}catch(a){let e=a?.message||a?.toString()||"Unknown error",t=a?.stack||"";return console.error("CodeBakers: Failed to load modules:",e),console.error("CodeBakers: Stack:",t),Ro=`Module load failed: ${e}`,!1}}async function Ao(a){if(!await Gt())return;let t=A.window.activeTextEditor;if(!t){A.window.showWarningMessage("No active editor");return}let n=t.selection;if(n.isEmpty){A.window.showWarningMessage("No text selected");return}let s=t.document.getText(n),o=t.document.fileName,i=A.workspace.asRelativePath(o),r=t.document.languageId,d=n.start.line+1,p=n.end.line+1,l="";switch(a){case"ask":l=`I have a question about this code from ${i} (lines ${d}-${p}):
...
\`\`\`${r}
${s}
\`\`\``;break}try{Oe.show(),a==="ask"?Oe.setInputWithContext(l):await Oe.sendMessage(l)}catch(c){console.error("CodeBakers: Error handling selection command:",c),A.window.showErrorMessage(`CodeBakers error: ${c}`)}}async function Gt(){if(Te&&fa&&Oe)return console.log("CodeBakers: Already initialized"),!0;if((!jr||!zr||!Vr)&&(console.log("CodeBakers: Modules not loaded, loading now..."),!await n0()))return A.window.showErrorMessage(`CodeBakers: ${Ro}`),!1;try{return console.log("CodeBakers: Initializing components..."),Te||(console.log("CodeBakers: Creating CodeBakersClient..."),Te=new zr(ts),console.log("CodeBakers: CodeBakersClient created successfully")),fa||(console.log("CodeBakers: Creating ProjectContext..."),fa=new Vr,console.log("CodeBakers: ProjectContext created successfully")),Oe||(console.log("CodeBakers: Creating ChatPanelProvider..."),Oe=jr.getInstance(ts,Te,fa),console.log("CodeBakers: ChatPanelProvider created successfully")),console.log("CodeBakers: All components initialized successfully"),!0}catch(a){let e=a?.message||a?.toString()||"Unknown error";return console.error("CodeBakers: Component initialization failed:",e),console.error("CodeBakers: Stack:",a?.stack||"no stack"),Ro=`Init failed: ${e}`,A.window.showErrorMessage(`CodeBakers: ${Ro}`),!1}}function s0(a){console.log("CodeBakers: activate() called - v1.0.106"),ts=a;try{console.log("CodeBakers: Registering commands..."),a.subscriptions.push(A.commands.registerCommand("codebakers.openChat",async()=>{if(console.log("CodeBakers: openChat command executed"),!await Gt()){A.window.showErrorMessage("CodeBakers failed to initialize. Please try reloading VS Code.");return}try{Te.hasSessionToken()||A.window.showWarningMessage("\u{1F36A} Sign in to CodeBakers to start your free trial","Sign In with GitHub").then(t=>{t==="Sign In with GitHub"&&Te.login()}),Oe.show()}catch(t){console.error("CodeBakers: Error in openChat:",t),A.window.showErrorMessage(`CodeBakers error: ${t}`)}})),a.subscriptions.push(A.commands.registerCommand("codebakers.login",async()=>{if(console.log("CodeBakers: login command executed"),!!await Gt())try{await Te.login()}catch(t){console.error("CodeBakers: Login error:",t),A.window.showErrorMessage(`Login failed: ${t}`)}})),a.subscriptions.push(A.commands.registerCommand("codebakers.logout",async()=>{if(console.log("CodeBakers: logout command executed"),!!await Gt())try{await Te.logout(),Oe.refresh(),Or()}catch(t){console.error("CodeBakers: Logout error:",t)}})),a.subscriptions.push(A.commands.registerCommand("codebakers.showPatterns",async()=>{if(await Gt())try{let t=await Te.getAvailablePatterns(),n=A.window.createQuickPick();n.items=t.map(s=>({label:s.name,description:s.description})),n.title="Available CodeBakers Patterns",n.show()}catch(t){console.error("CodeBakers: Error showing patterns:",t)}})),a.subscriptions.push(A.commands.registerCommand("codebakers.runAudit",async()=>{if(await Gt())try{Oe.show(),await Oe.sendMessage("/audit")}catch(t){console.error("CodeBakers: Error running audit:",t)}})),a.subscriptions.push(A.commands.registerCommand("codebakers.askAboutSelection",async()=>{console.log("CodeBakers: askAboutSelection command executed"),await Ao("ask")})),a.subscriptions.push(A.commands.registerCommand("codebakers.explainSelection",async()=>{console.log("CodeBakers: explainSelection command executed"),await Ao("explain")})),a.subscriptions.push(A.commands.registerCommand("codebakers.refactorSelection",async()=>{console.log("CodeBakers: refactorSelection command executed"),await Ao("refactor")})),a.subscriptions.push(A.commands.registerCommand("codebakers.addTestsForSelection",async()=>{console.log("CodeBakers: addTestsForSelection command executed"),await Ao("tests")})),a.subscriptions.push(A.commands.registerCommand("codebakers.openMindMap",async()=>{if(console.log("CodeBakers: openMindMap command executed"),!Io)try{Io=(await Promise.resolve().then(()=>(Ir(),Ar))).MindMapPanelProvider}catch(e){console.error("CodeBakers: Failed to load MindMap module:",e),A.window.showErrorMessage("Failed to load Mind Map module");return}try{Io.createOrShow(ts.extensionUri).analyze()}catch(e){console.error("CodeBakers: Error opening mind map:",e),A.window.showErrorMessage(`Mind Map error: ${e}`)}})),a.subscriptions.push(A.commands.registerCommand("codebakers.openBuildPlanner",async()=>{if(console.log("CodeBakers: openBuildPlanner command executed"),!Bo)try{Bo=(await Promise.resolve().then(()=>($r(),Lr))).BuildPlannerProvider}catch(e){console.error("CodeBakers: Failed to load Build Planner module:",e),A.window.showErrorMessage("Failed to load Build Planner module");return}try{Bo.createOrShow(ts.extensionUri)}catch(e){console.error("CodeBakers: Error opening build planner:",e),A.window.showErrorMessage(`Build Planner error: ${e}`)}})),console.log("CodeBakers: All 11 commands registered successfully")}catch(e){console.error("CodeBakers: FATAL - Command registration failed:",e),A.window.showErrorMessage(`CodeBakers FATAL: Failed to register commands - ${e}`);return}try{je=A.window.createStatusBarItem(A.StatusBarAlignment.Right,100),je.text="$(code) CodeBakers",je.tooltip="Open CodeBakers Chat (Ctrl+Alt+C)",je.command="codebakers.openChat",je.show(),a.subscriptions.push(je),console.log("CodeBakers: Status bar created")}catch(e){console.error("CodeBakers: Status bar failed:",e)}try{if(qr){let e=new qr;a.subscriptions.push(A.workspace.registerTextDocumentContentProvider("codebakers-diff",e)),console.log("CodeBakers: Diff content provider registered")}}catch(e){console.error("CodeBakers: Diff provider registration failed:",e)}try{a.subscriptions.push(A.window.registerUriHandler({handleUri:async e=>{if(console.log("CodeBakers: URI callback received:",e.toString()),!(!e.path.includes("callback")||!await Gt()))try{let n=new URLSearchParams(e.query),s=n.get("token"),o=n.get("error");if(o){A.window.showErrorMessage(`Login failed: ${n.get("message")||o}`);return}s?await Te.handleOAuthCallback(s)&&(Oe.refresh(),Or(),Oe.show()):A.window.showErrorMessage("Login failed: No token received")}catch(n){console.error("CodeBakers: URI handler error:",n),A.window.showErrorMessage(`OAuth error: ${n}`)}}})),console.log("CodeBakers: URI handler registered")}catch(e){console.error("CodeBakers: URI handler registration failed:",e)}setTimeout(async()=>{try{if(await Gt()){Or(),Te.hasSessionToken()||A.window.showInformationMessage("\u{1F36A} CodeBakers installed! Click the CodeBakers button in the status bar to get started.","Sign In Now").then(t=>{t==="Sign In Now"&&Te.login()});try{let t=A.workspace.createFileSystemWatcher("**/*.{ts,tsx,js,jsx}");t.onDidChange(()=>fa?.invalidateCache()),t.onDidCreate(()=>fa?.invalidateCache()),t.onDidDelete(()=>fa?.invalidateCache()),a.subscriptions.push(t)}catch(t){console.warn("CodeBakers: File watcher failed:",t)}}}catch(e){console.error("CodeBakers: Background init failed:",e)}},500),console.log("CodeBakers: activate() completed - v1.0.106")}function Or(){if(je)try{if(Te?.hasSessionToken()){let a=Te.getPlanInfo();je.text=`$(code) CodeBakers [${a.plan}]`,je.backgroundColor=void 0}else je.text="$(code) CodeBakers (Sign In)",je.backgroundColor=new A.ThemeColor("statusBarItem.warningBackground")}catch{je.text="$(code) CodeBakers"}}function o0(){console.log("CodeBakers: deactivate() called")}0&&(module.exports={activate,deactivate});
