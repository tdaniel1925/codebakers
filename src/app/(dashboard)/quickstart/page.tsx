    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div>
        ...
        <p className="text-neutral-400 text-lg">
          Just 2 steps, then describe what you want to build.
        </p>
      </div>
        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription className="text-neutral-400">One command in your terminal - does everything automatically</CardDescription>
            </div>
          </div>
        </CardHeader>
      ...
      <Card className="bg-gradient-to-r from-green-900/30 to-emerald-900/30 border-green-600/30">
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-white">That's It - Just Describe What You Want</CardTitle>
          ...
          <CardContent className="pt-0">
            <div className="grid gap-3 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-neutral-500">Create new project (same as asking AI)</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                <code className="text-red-400 font-mono w-48">codebakers status</code>
                <span className="text-neutral-500">Check what's installed</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <p className="text-neutral-600 text-xs mt-4">
              These commands do the same thing as asking the AI - they're just another way to access the same functionality.
            </p>
          </CardContent>
        )}
      </Card>
